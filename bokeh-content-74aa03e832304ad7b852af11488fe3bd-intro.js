(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d820edb9-4bb3-4584-9def-c29be485f69c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd820edb9-4bb3-4584-9def-c29be485f69c' but no matching script tag was found.")
        }
