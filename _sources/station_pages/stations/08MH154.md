...
# 08MH154: MAHOOD CREEK AT 144 STREET, SURREY
...
result = plot_station_polygon("08MH154")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH154">stations/08MH154 folder on GitHub</a>.
:::
...
<tr><td>08MH154</td><td>MAHOOD CREEK AT 144 STREET, SURREY</td><td>49.146</td><td>-122.822</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 14.0 years
<br><strong>Timeseries Summary:</strong> 5,082 daily observations, minor gaps: 31 days avg (N=1) | 5.8% flagged (estimated: 151, backwater: 119, partial day: 23)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 60.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>5,082 daily observations, minor gaps: 31 days avg (N=1) | 5.8% flagged (estimated: 151, backwater: 119, partial day: 23) | Record: 14.0 years</td></tr>
...
show(plot_station_timeseries("08MH154"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH154")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH154/08MH154_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH154/08MH154_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH154"))
:::
...
<div class="download-section">
  <a href="../../08MH154/08MH154_field_visits.csv" download class="download-btn">
