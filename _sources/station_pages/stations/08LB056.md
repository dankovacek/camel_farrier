...
# 08LB056: PAUL CREEK NEAR KAMLOOPS (STATION D)
...
result = plot_station_polygon("08LB056")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB056">stations/08LB056 folder on GitHub</a>.
:::
...
<tr><td>08LB056</td><td>PAUL CREEK NEAR KAMLOOPS (STATION D)</td><td>50.726</td><td>-120.260</td><td>212.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 275 daily observations, continuous record | 58.5% flagged (estimated: 161)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 640.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>275 daily observations, continuous record | 58.5% flagged (estimated: 161) | Record: 0.8 years</td></tr>
...
show(plot_station_timeseries("08LB056"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB056")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB056/08LB056_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LB056/08LB056_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB056"))
:::
