...
# 08NG017: GOLD CREEK NEAR CRANBROOK
...
result = plot_station_polygon("08NG017")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG017">stations/08NG017 folder on GitHub</a>.
:::
...
<tr><td>08NG017</td><td>GOLD CREEK NEAR CRANBROOK</td><td>49.399</td><td>-115.620</td><td>95.3 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,654 daily observations, seasonal gaps: 2077 days avg (N=8) | 52.7% flagged (estimated: 919, backwater: 480)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 238.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,654 daily observations, seasonal gaps: 2077 days avg (N=8) | 52.7% flagged (estimated: 919, backwater: 480) | Record: 52.8 years</td></tr>
...
show(plot_station_timeseries("08NG017"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG017")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG017/08NG017_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG017/08NG017_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG017"))
:::
...
<div class="download-section">
  <a href="../../08NG017/08NG017_field_visits.csv" download class="download-btn">
