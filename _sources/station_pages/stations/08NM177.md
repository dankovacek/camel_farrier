...
# 08NM177: DEEP CREEK AT YOUNG ROAD
...
result = plot_station_polygon("08NM177")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM177">stations/08NM177 folder on GitHub</a>.
:::
...
<tr><td>08NM177</td><td>DEEP CREEK AT YOUNG ROAD</td><td>50.462</td><td>-119.177</td><td>115.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,887 daily observations, continuous record | 5.4% flagged (estimated: 56, backwater: 45)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 198.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,887 daily observations, continuous record | 5.4% flagged (estimated: 56, backwater: 45) | Record: 5.2 years</td></tr>
...
show(plot_station_timeseries("08NM177"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM177")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM177/08NM177_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM177/08NM177_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM177"))
:::
...
<div class="download-section">
  <a href="../../08NM177/08NM177_field_visits.csv" download class="download-btn">
