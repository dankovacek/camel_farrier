...
# 08GA003: HIXON CREEK NEAR THE MOUTH
...
result = plot_station_polygon("08GA003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA003">stations/08GA003 folder on GitHub</a>.
:::
...
<tr><td>08GA003</td><td>HIXON CREEK NEAR THE MOUTH</td><td>49.511</td><td>-122.881</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 1.9 years
<br><strong>Timeseries Summary:</strong> 700 daily observations, continuous record | 46.9% flagged (estimated: 328)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 83.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>700 daily observations, continuous record | 46.9% flagged (estimated: 328) | Record: 1.9 years</td></tr>
...
show(plot_station_timeseries("08GA003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA003/08GA003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA003/08GA003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA003"))
:::
...
<div class="download-section">
  <a href="../../08GA003/08GA003_field_visits.csv" download class="download-btn">
