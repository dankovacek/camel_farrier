...
result = plot_station_polygon("08GA038")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA038">stations/08GA038 folder on GitHub</a>.
:::
...
<tr><td>08GA038</td><td>CHANCE CREEK NEAR GARIBALDI</td><td>49.960</td><td>-123.168</td><td>24.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,096 daily observations, continuous record | 5.8% flagged (backwater: 36, estimated: 28)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 43.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,096 daily observations, continuous record | 5.8% flagged (backwater: 36, estimated: 28) | Record: 3.0 years</td></tr>
...
show(plot_station_timeseries("08GA038"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA038")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA038/08GA038_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA038/08GA038_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA038"))
:::
...
<div class="download-section">
  <a href="../../08GA038/08GA038_field_visits.csv" download class="download-btn">
