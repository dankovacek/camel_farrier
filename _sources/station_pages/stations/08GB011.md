...
# 08GB011: TROUT CREEK AT OUTLET OF TROUT LAKE
...
result = plot_station_polygon("08GB011")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GB011">stations/08GB011 folder on GitHub</a>.
:::
...
<tr><td>08GB011</td><td>TROUT CREEK AT OUTLET OF TROUT LAKE</td><td>49.501</td><td>-123.882</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 0.7 years
<br><strong>Timeseries Summary:</strong> 273 daily observations, continuous record | 34.4% flagged (estimated: 94)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 7.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>273 daily observations, continuous record | 34.4% flagged (estimated: 94) | Record: 0.7 years</td></tr>
...
show(plot_station_timeseries("08GB011"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GB011")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GB011/08GB011_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GB011/08GB011_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GB011"))
:::
...
<div class="download-section">
  <a href="../../08GB011/08GB011_field_visits.csv" download class="download-btn">
