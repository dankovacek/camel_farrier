...
# 08EE022: DEEP CREEK BELOW GIBSON CREEK
...
result = plot_station_polygon("08EE022")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EE022">stations/08EE022 folder on GitHub</a>.
:::
...
<tr><td>08EE022</td><td>DEEP CREEK BELOW GIBSON CREEK</td><td>54.592</td><td>-126.834</td><td>89.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 336 daily observations, seasonal gaps: 182 days avg (N=1) | 0.9% flagged (estimated: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 286.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>336 daily observations, seasonal gaps: 182 days avg (N=1) | 0.9% flagged (estimated: 3) | Record: 1.4 years</td></tr>
...
show(plot_station_timeseries("08EE022"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EE022")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EE022/08EE022_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08EE022/08EE022_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08EE022"))
:::
...
<div class="download-section">
  <a href="../../08EE022/08EE022_field_visits.csv" download class="download-btn">
