...
result = plot_station_polygon("07GG001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07GG001">stations/07GG001 folder on GitHub</a>.
:::
...
<tr><td>07GG001</td><td>WASKAHIGAN RIVER NEAR THE MOUTH</td><td>54.752</td><td>-117.206</td><td>1040.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 56.9 years
<br><strong>Timeseries Summary:</strong> 20,549 daily observations, seasonal gaps: 120 days avg (N=2) | 48.2% flagged (backwater: 9566, estimated: 196, partial day: 140)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3070.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>20,549 daily observations, seasonal gaps: 120 days avg (N=2) | 48.2% flagged (backwater: 9566, estimated: 196, partial day: 140) | Record: 56.9 years</td></tr>
...
show(plot_station_timeseries("07GG001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07GG001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07GG001/07GG001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07GG001/07GG001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07GG001/07GG001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Same as Curve 5, only adjusted low end E Grade based on new low end mmnts</td>
    </tr>
    <tr>
      <td>5.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Appears some fill has happened from 2020 highwater / April 2020 ice out period. New curve to replace...</td>
    </tr>
    <tr>
      <td>4.000</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Extended to 3.90 m.</td>
    </tr>
    <tr>
      <td>4.000-SC1</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07GG001"))
:::
