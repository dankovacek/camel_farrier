...
# 10VC013: SNOWBIRD CREEK NEAR BRADFORD ISLAND
...
result = plot_station_polygon("10VC013")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10VC013">stations/10VC013 folder on GitHub</a>.
:::
...
<tr><td>10VC013</td><td>SNOWBIRD CREEK NEAR BRADFORD ISLAND</td><td>75.631</td><td>-101.317</td><td>87.0 (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 92 daily observations, continuous record | 67.4% flagged (backwater: 57, estimated: 5)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 997.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>92 daily observations, continuous record | 67.4% flagged (backwater: 57, estimated: 5) | Record: 0.2 years</td></tr>
...
show(plot_station_timeseries("10VC013"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10VC013")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10VC013/10VC013_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10VC013/10VC013_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10VC013"))
:::
