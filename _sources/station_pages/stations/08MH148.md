...
result = plot_station_polygon("08MH148")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH148">stations/08MH148 folder on GitHub</a>.
:::
...
<tr><td>08MH148</td><td>ALOUETTE LAKE FOREBAY</td><td>49.287</td><td>-122.484</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 475.1 km²</td></tr>
...
show(plot_station_timeseries("08MH148"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH148")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH148/08MH148_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08MH148/08MH148_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH148"))
:::
...
<div class="download-section">
  <a href="../../08MH148/08MH148_field_visits.csv" download class="download-btn">
