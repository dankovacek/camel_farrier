...
# 08LF005: CHERRY CREEK NEAR KAMLOOPS
...
result = plot_station_polygon("08LF005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF005">stations/08LF005 folder on GitHub</a>.
:::
...
<tr><td>08LF005</td><td>CHERRY CREEK NEAR KAMLOOPS</td><td>50.625</td><td>-120.537</td><td>53.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,992 daily observations, seasonal gaps: 186 days avg (N=16) | 2.8% flagged (estimated: 76, backwater: 8)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 123.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,992 daily observations, seasonal gaps: 186 days avg (N=16) | 2.8% flagged (estimated: 76, backwater: 8) | Record: 16.3 years</td></tr>
...
show(plot_station_timeseries("08LF005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF005/08LF005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF005/08LF005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF005"))
:::
...
<div class="download-section">
  <a href="../../08LF005/08LF005_field_visits.csv" download class="download-btn">
