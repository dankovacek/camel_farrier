...
# 10KC001: MOUNTAIN RIVER BELOW CAMBRIAN CREEK
...
result = plot_station_polygon("10KC001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10KC001">stations/10KC001 folder on GitHub</a>.
:::
...
<tr><td>10KC001</td><td>MOUNTAIN RIVER BELOW CAMBRIAN CREEK</td><td>65.229</td><td>-128.563</td><td>11060.0 (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 8,861 daily observations, seasonal gaps: 1038 days avg (N=8) | 61.7% flagged (backwater: 4878, estimated: 524, partial day: 64)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 60180.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>8,861 daily observations, seasonal gaps: 1038 days avg (N=8) | 61.7% flagged (backwater: 4878, estimated: 524, partial day: 64) | Record: 47.0 years</td></tr>
...
show(plot_station_timeseries("10KC001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10KC001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10KC001/10KC001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10KC001/10KC001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10KC001/10KC001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Refer to document 10KC001_20210401_RMD9.0 for details on curve development. New curve after substant...</td>
    </tr>
    <tr>
      <td>8.0</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("10KC001"))
:::
...
<div class="download-section">
  <a href="../../10KC001/10KC001_field_visits.csv" download class="download-btn">
