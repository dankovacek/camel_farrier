...
result = plot_station_polygon("08ME027")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08ME027">stations/08ME027 folder on GitHub</a>.
:::
...
<tr><td>08ME027</td><td>HURLEY RIVER BELOW LONE GOAT CREEK</td><td>50.731</td><td>-122.942</td><td>312.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 10,593 daily observations, continuous record | 34.0% flagged (backwater: 3406, estimated: 166, partial day: 27)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 775.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>10,593 daily observations, continuous record | 34.0% flagged (backwater: 3406, estimated: 166, partial day: 27) | Record: 29.0 years</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08ME027")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08ME027/08ME027_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08ME027/08ME027_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08ME027/08ME027_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Curve created using open water measurements from 2021-2022 along with measurements above 30cms from ...</td>
    </tr>
    <tr>
      <td>22.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Minor Change in Zero flow point at 2012 second peak, Extended top end</td>
    </tr>
    <tr>
      <td>19.0</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08ME027"))
:::
...
<div class="download-section">
  <a href="../../08ME027/08ME027_field_visits.csv" download class="download-btn">
