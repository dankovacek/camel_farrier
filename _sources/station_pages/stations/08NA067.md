...
# 08NA067: BOWER CREEK NEAR THE MOUTH
...
result = plot_station_polygon("08NA067")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA067">stations/08NA067 folder on GitHub</a>.
:::
...
<tr><td>08NA067</td><td>BOWER CREEK NEAR THE MOUTH</td><td>51.198</td><td>-116.850</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 10.7 years
<br><strong>Timeseries Summary:</strong> 3,897 daily observations, continuous record | 66.1% flagged (estimated: 2576)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 7.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>3,897 daily observations, continuous record | 66.1% flagged (estimated: 2576) | Record: 10.7 years</td></tr>
...
show(plot_station_timeseries("08NA067"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA067")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA067/08NA067_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA067/08NA067_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA067"))
:::
