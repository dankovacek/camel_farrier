...
result = plot_station_polygon("08NH119")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH119">stations/08NH119 folder on GitHub</a>.
:::
...
<tr><td>08NH119</td><td>DUNCAN RIVER BELOW B.B. CREEK</td><td>50.638</td><td>-117.048</td><td>1310.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 62.3 years
<br><strong>Timeseries Summary:</strong> 22,618 daily observations, minor gaps: 60 days avg (N=2) | 11.7% flagged (backwater: 2295, estimated: 176, partial day: 169)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3289.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>22,618 daily observations, minor gaps: 60 days avg (N=2) | 11.7% flagged (backwater: 2295, estimated: 176, partial day: 169) | Record: 62.3 years</td></tr>
...
show(plot_station_timeseries("08NH119"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH119")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH119/08NH119_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NH119/08NH119_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NH119/08NH119_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>curve starts after small peak in may.  mmts all plotting to right of old rating</td>
    </tr>
    <tr>
      <td>47.000</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>CLONE OF 44.0 WITH UPPPER END EXTENSION</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08NH119"))
:::
...
<div class="download-section">
  <a href="../../08NH119/08NH119_field_visits.csv" download class="download-btn">
