...
# 10LD002: JACKFISH CREEK NEAR FORT GOOD HOPE
...
result = plot_station_polygon("10LD002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10LD002">stations/10LD002 folder on GitHub</a>.
:::
...
<tr><td>10LD002</td><td>JACKFISH CREEK NEAR FORT GOOD HOPE</td><td>66.256</td><td>-128.640</td><td>62.9 (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 6.5 years
<br><strong>Timeseries Summary:</strong> 2,254 daily observations, seasonal gaps: 121 days avg (N=1) | 61.4% flagged (backwater: 1297, estimated: 80, partial day: 6)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 638.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,254 daily observations, seasonal gaps: 121 days avg (N=1) | 61.4% flagged (backwater: 1297, estimated: 80, partial day: 6) | Record: 6.5 years</td></tr>
...
show(plot_station_timeseries("10LD002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10LD002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10LD002/10LD002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10LD002/10LD002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10LD002"))
:::
...
<div class="download-section">
  <a href="../../10LD002/10LD002_field_visits.csv" download class="download-btn">
