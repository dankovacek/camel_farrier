...
# 08MC025: MISSIONER CREEK BELOW RESERVOIR LAKE
...
result = plot_station_polygon("08MC025")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MC025">stations/08MC025 folder on GitHub</a>.
:::
...
<tr><td>08MC025</td><td>MISSIONER CREEK BELOW RESERVOIR LAKE</td><td>52.171</td><td>-122.102</td><td>31.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,075 daily observations, seasonal gaps: 176 days avg (N=10) | 44.9% flagged (estimated: 932)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 46.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,075 daily observations, seasonal gaps: 176 days avg (N=10) | 44.9% flagged (estimated: 932) | Record: 10.5 years</td></tr>
...
show(plot_station_timeseries("08MC025"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MC025")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MC025/08MC025_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MC025/08MC025_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MC025"))
:::
