...
# 08EC007: FULTON LAKE NEAR SMITHERS
...
result = plot_station_polygon("08EC007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EC007">stations/08EC007 folder on GitHub</a>.
:::
...
<tr><td>08EC007</td><td>FULTON LAKE NEAR SMITHERS</td><td>54.804</td><td>-126.211</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4209.4 km²</td></tr>
...
show(plot_station_timeseries("08EC007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EC007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EC007/08EC007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08EC007/08EC007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08EC007"))
:::
...
<div class="download-section">
  <a href="../../08EC007/08EC007_field_visits.csv" download class="download-btn">
