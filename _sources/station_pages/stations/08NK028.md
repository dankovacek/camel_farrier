...
result = plot_station_polygon("08NK028")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NK028">stations/08NK028 folder on GitHub</a>.
:::
...
<tr><td>08NK028</td><td>MICHEL CREEK ABOVE CORBIN CREEK</td><td>49.512</td><td>-114.676</td><td>35.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 11.6 years
<br><strong>Timeseries Summary:</strong> 2,693 daily observations, seasonal gaps: 128 days avg (N=12) | 9.5% flagged (estimated: 138, partial day: 97, backwater: 21)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 82.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,693 daily observations, seasonal gaps: 128 days avg (N=12) | 9.5% flagged (estimated: 138, partial day: 97, backwater: 21) | Record: 11.6 years</td></tr>
...
show(plot_station_timeseries("08NK028"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NK028")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NK028/08NK028_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NK028/08NK028_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NK028"))
:::
...
<div class="download-section">
  <a href="../../08NK028/08NK028_field_visits.csv" download class="download-btn">
