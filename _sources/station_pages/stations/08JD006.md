...
result = plot_station_polygon("08JD006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08JD006">stations/08JD006 folder on GitHub</a>.
:::
...
<tr><td>08JD006</td><td>DRIFTWOOD RIVER ABOVE KASTBERG CREEK</td><td>55.976</td><td>-126.678</td><td>403.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 44.2 years
<br><strong>Timeseries Summary:</strong> 15,371 daily observations, seasonal gaps: 792 days avg (N=1) | 28.6% flagged (backwater: 3833, estimated: 507, partial day: 62)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1160.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>15,371 daily observations, seasonal gaps: 792 days avg (N=1) | 28.6% flagged (backwater: 3833, estimated: 507, partial day: 62) | Record: 44.2 years</td></tr>
...
show(plot_station_timeseries("08JD006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08JD006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08JD006/08JD006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08JD006/08JD006_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08JD006/08JD006_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>All open-water discharge measurements from 2022 freshet peak to present (Dec, 2024) have >5% shift f...</td>
    </tr>
    <tr>
      <td>37.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New curve 37.00 developed based on highest recorded measurement in 2022. Shift to left of 29% at upp...</td>
    </tr>
    <tr>
      <td>37.00</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New curve 36.00 developed based on measurements obtained since beaver dam was washed away in 2019 fr...</td>
    </tr>
    <tr>
      <td>35.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Aggradation following 2017 freshet, new curve drawn for 2018. beaver activity on control (2018 and 2...</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08JD006"))
:::
...
<div class="download-section">
  <a href="../../08JD006/08JD006_field_visits.csv" download class="download-btn">
