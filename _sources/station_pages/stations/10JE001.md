...
# 10JE001: SLOAN RIVER NEAR THE MOUTH
...
result = plot_station_polygon("10JE001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10JE001">stations/10JE001 folder on GitHub</a>.
:::
...
<tr><td>10JE001</td><td>SLOAN RIVER NEAR THE MOUTH</td><td>66.522</td><td>-117.274</td><td>2040.0 (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 15.4 years
<br><strong>Timeseries Summary:</strong> 5,299 daily observations, seasonal gaps: 166 days avg (N=2) | 60.0% flagged (backwater: 2969, estimated: 136, partial day: 76)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 18096.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>5,299 daily observations, seasonal gaps: 166 days avg (N=2) | 60.0% flagged (backwater: 2969, estimated: 136, partial day: 76) | Record: 15.4 years</td></tr>
...
show(plot_station_timeseries("10JE001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10JE001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10JE001/10JE001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10JE001/10JE001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10JE001"))
:::
...
<div class="download-section">
  <a href="../../10JE001/10JE001_field_visits.csv" download class="download-btn">
