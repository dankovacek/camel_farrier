...
# 08MF034: WAHLEACH CREEK NEAR LAIDLAW (LOWER STATION)
...
result = plot_station_polygon("08MF034")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MF034">stations/08MF034 folder on GitHub</a>.
:::
...
<tr><td>08MF034</td><td>WAHLEACH CREEK NEAR LAIDLAW (LOWER STATION)</td><td>49.313</td><td>-121.626</td><td>114.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 19.8 years
<br><strong>Timeseries Summary:</strong> 7,033 daily observations, seasonal gaps: 182 days avg (N=1) | 5.7% flagged (estimated: 221, backwater: 183)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 268.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>7,033 daily observations, seasonal gaps: 182 days avg (N=1) | 5.7% flagged (estimated: 221, backwater: 183) | Record: 19.8 years</td></tr>
...
show(plot_station_timeseries("08MF034"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MF034")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MF034/08MF034_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MF034/08MF034_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MF034"))
:::
...
<div class="download-section">
  <a href="../../08MF034/08MF034_field_visits.csv" download class="download-btn">
