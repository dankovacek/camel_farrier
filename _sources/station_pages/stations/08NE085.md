...
# 08NE085: SYRINGA CREEK NEAR SYRINGA CREEK
...
result = plot_station_polygon("08NE085")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE085">stations/08NE085 folder on GitHub</a>.
:::
...
<tr><td>08NE085</td><td>SYRINGA CREEK NEAR SYRINGA CREEK</td><td>49.344</td><td>-117.871</td><td>21.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 459 daily observations, seasonal gaps: 212 days avg (N=2) | 44.9% flagged (estimated: 206)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 50.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>459 daily observations, seasonal gaps: 212 days avg (N=2) | 44.9% flagged (estimated: 206) | Record: 2.4 years</td></tr>
...
show(plot_station_timeseries("08NE085"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE085")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE085/08NE085_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE085/08NE085_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE085"))
:::
...
<div class="download-section">
  <a href="../../08NE085/08NE085_field_visits.csv" download class="download-btn">
