...
# 10KA006: JUNGLE RIDGE CREEK NEAR THE MOUTH
...
result = plot_station_polygon("10KA006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10KA006">stations/10KA006 folder on GitHub</a>.
:::
...
<tr><td>10KA006</td><td>JUNGLE RIDGE CREEK NEAR THE MOUTH</td><td>65.058</td><td>-126.122</td><td>60.0 (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-03-10</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 1.00, ΔArea: +0.3%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 43.8 years
<br><strong>Timeseries Summary:</strong> 7,746 daily observations, seasonal gaps: 516 days avg (N=16) | 48.7% flagged (backwater: 3381, estimated: 326, partial day: 62)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 607.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>7,746 daily observations, seasonal gaps: 516 days avg (N=16) | 48.7% flagged (backwater: 3381, estimated: 326, partial day: 62) | Record: 43.8 years</td></tr>
...
show(plot_station_timeseries("10KA006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10KA006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10KA006/10KA006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10KA006/10KA006_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10KA006/10KA006_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Created with historic mmnts under the assumption there was no signifcant control change until 2020 w...</td>
    </tr>
    <tr>
      <td>5.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>2022 over shifting as it is believed the beaver dam control to be stable enough to do so.  Previousl...</td>
    </tr>
    <tr>
      <td>4.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Provisional/Provisoire</td>
      <td>New station location 2km downstream. Best fit representing poor relationship between stage-discharge...</td>
    </tr>
    <tr>
      <td>2.0</td>
      <td>LinearTable</td>
      <td>Provisional/Provisoire</td>
      <td>HQFIT1.0 for 2008 Q measurements only</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("10KA006"))
:::
...
<div class="download-section">
  <a href="../../10KA006/10KA006_field_visits.csv" download class="download-btn">
