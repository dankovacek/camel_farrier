...
# 08GA027: EASTCAP CREEK NEAR THE MOUTH
...
result = plot_station_polygon("08GA027")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA027">stations/08GA027 folder on GitHub</a>.
:::
...
<tr><td>08GA027</td><td>EASTCAP CREEK NEAR THE MOUTH</td><td>49.450</td><td>-123.103</td><td>41.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 77.7 years
<br><strong>Timeseries Summary:</strong> 2,194 daily observations, seasonal gaps: 4368 days avg (N=6) | 12.3% flagged (estimated: 224, backwater: 38, partial day: 7)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 96.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,194 daily observations, seasonal gaps: 4368 days avg (N=6) | 12.3% flagged (estimated: 224, backwater: 38, partial day: 7) | Record: 77.7 years</td></tr>
...
show(plot_station_timeseries("08GA027"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA027")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA027/08GA027_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA027/08GA027_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA027"))
:::
...
<div class="download-section">
  <a href="../../08GA027/08GA027_field_visits.csv" download class="download-btn">
