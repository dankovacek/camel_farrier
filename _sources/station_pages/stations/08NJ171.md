...
# 08NJ171: KITTO CREEK ABOVE DIVERSIONS
...
result = plot_station_polygon("08NJ171")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ171">stations/08NJ171 folder on GitHub</a>.
:::
...
<tr><td>08NJ171</td><td>KITTO CREEK ABOVE DIVERSIONS</td><td>49.615</td><td>-117.105</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.94, ΔArea: +5.9%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 397 daily observations, seasonal gaps: 122 days avg (N=1) | 15.6% flagged (estimated: 62)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>397 daily observations, seasonal gaps: 122 days avg (N=1) | 15.6% flagged (estimated: 62) | Record: 1.4 years</td></tr>
...
show(plot_station_timeseries("08NJ171"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ171")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ171/08NJ171_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ171/08NJ171_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ171"))
:::
...
<div class="download-section">
  <a href="../../08NJ171/08NJ171_field_visits.csv" download class="download-btn">
