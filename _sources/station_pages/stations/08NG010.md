...
# 08NG010: SAND CREEK NEAR GALLOWAY
...
result = plot_station_polygon("08NG010")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG010">stations/08NG010 folder on GitHub</a>.
:::
...
<tr><td>08NG010</td><td>SAND CREEK NEAR GALLOWAY</td><td>49.369</td><td>-115.245</td><td>135.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 40.9 years
<br><strong>Timeseries Summary:</strong> 3,541 daily observations, seasonal gaps: 760 days avg (N=15) | 3.7% flagged (backwater: 88, estimated: 44)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 323.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,541 daily observations, seasonal gaps: 760 days avg (N=15) | 3.7% flagged (backwater: 88, estimated: 44) | Record: 40.9 years</td></tr>
...
show(plot_station_timeseries("08NG010"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG010")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG010/08NG010_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG010/08NG010_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG010"))
:::
...
<div class="download-section">
  <a href="../../08NG010/08NG010_field_visits.csv" download class="download-btn">
