...
# 08NM125: B.X. CREEK ABOVE SWAN LAKE CONTROL DAM
...
result = plot_station_polygon("08NM125")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM125">stations/08NM125 folder on GitHub</a>.
:::
...
<tr><td>08NM125</td><td>B.X. CREEK ABOVE SWAN LAKE CONTROL DAM</td><td>50.293</td><td>-119.262</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 289.5 km²</td></tr>
...
show(plot_station_timeseries("08NM125"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM125")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM125/08NM125_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM125/08NM125_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM125"))
:::
...
<div class="download-section">
  <a href="../../08NM125/08NM125_field_visits.csv" download class="download-btn">
