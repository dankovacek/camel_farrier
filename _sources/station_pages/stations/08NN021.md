...
result = plot_station_polygon("08NN021")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NN021">stations/08NN021 folder on GitHub</a>.
:::
...
<tr><td>08NN021</td><td>MOODY CREEK NEAR CHRISTINA</td><td>49.051</td><td>-118.273</td><td>13.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 13.5 years
<br><strong>Timeseries Summary:</strong> 4,933 daily observations, continuous record | 39.5% flagged (estimated: 1927, backwater: 24)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 28.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>4,933 daily observations, continuous record | 39.5% flagged (estimated: 1927, backwater: 24) | Record: 13.5 years</td></tr>
...
show(plot_station_timeseries("08NN021"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NN021")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NN021/08NN021_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NN021/08NN021_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NN021"))
:::
