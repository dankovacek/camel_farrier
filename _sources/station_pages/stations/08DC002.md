...
# 08DC002: GEORGIE RIVER (WEST BRANCH) NEAR STEWART
...
result = plot_station_polygon("08DC002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08DC002">stations/08DC002 folder on GitHub</a>.
:::
...
<tr><td>08DC002</td><td>GEORGIE RIVER (WEST BRANCH) NEAR STEWART</td><td>55.782</td><td>-130.033</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 184 daily observations, minor gaps: 59 days avg (N=1)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 83.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>184 daily observations, minor gaps: 59 days avg (N=1) | Record: 0.7 years</td></tr>
...
show(plot_station_timeseries("08DC002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08DC002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08DC002/08DC002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08DC002/08DC002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08DC002"))
:::
