...
The data used in generating the tables on this page can be downloaded from the <a href="../../stations/09FC001/">stations/09FC001</a> folder (<a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09FC001">view on GitHub</a>).
...
<div class="download-section">
  ...
  <a href="/stations/09FC001/09FC001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="/stations/09FC001/09FC001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="/stations/09FC001/09FC001_annual_instant_peaks.csv" download class="download-btn">
