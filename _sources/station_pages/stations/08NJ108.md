...
# 08NJ108: TROZZO CREEK NEAR APPLEDALE
...
result = plot_station_polygon("08NJ108")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ108">stations/08NJ108 folder on GitHub</a>.
:::
...
<tr><td>08NJ108</td><td>TROZZO CREEK NEAR APPLEDALE</td><td>49.639</td><td>-117.529</td><td>27.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 35.2 years
<br><strong>Timeseries Summary:</strong> 306 daily observations, seasonal gaps: 6285 days avg (N=2) | 42.5% flagged (estimated: 130)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>306 daily observations, seasonal gaps: 6285 days avg (N=2) | 42.5% flagged (estimated: 130) | Record: 35.2 years</td></tr>
...
show(plot_station_timeseries("08NJ108"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ108")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ108/08NJ108_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ108/08NJ108_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ108"))
:::
...
<div class="download-section">
  <a href="../../08NJ108/08NJ108_field_visits.csv" download class="download-btn">
