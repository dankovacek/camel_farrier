...
# 07AC003: EAST CABIN CREEK NEAR MUSKEG
...
result = plot_station_polygon("07AC003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07AC003">stations/07AC003 folder on GitHub</a>.
:::
...
<tr><td>07AC003</td><td>EAST CABIN CREEK NEAR MUSKEG</td><td>53.767</td><td>-118.367</td><td>12.4 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 398 daily observations, seasonal gaps: 212 days avg (N=2) | 8.5% flagged (backwater: 27, estimated: 5, partial day: 2)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 35.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>398 daily observations, seasonal gaps: 212 days avg (N=2) | 8.5% flagged (backwater: 27, estimated: 5, partial day: 2) | Record: 2.2 years</td></tr>
...
show(plot_station_timeseries("07AC003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07AC003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07AC003/07AC003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07AC003/07AC003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07AC003"))
:::
