...
# 08JA019: CHEDAKUZ CREEK AT THE MOUTH
...
result = plot_station_polygon("08JA019")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08JA019">stations/08JA019 folder on GitHub</a>.
:::
...
<tr><td>08JA019</td><td>CHEDAKUZ CREEK AT THE MOUTH</td><td>53.400</td><td>-124.971</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,370 daily observations, continuous record | 44.6% flagged (backwater: 543, estimated: 61, partial day: 7)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2482.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,370 daily observations, continuous record | 44.6% flagged (backwater: 543, estimated: 61, partial day: 7) | Record: 3.7 years</td></tr>
...
show(plot_station_timeseries("08JA019"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08JA019")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08JA019/08JA019_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08JA019/08JA019_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08JA019"))
:::
...
<div class="download-section">
  <a href="../../08JA019/08JA019_field_visits.csv" download class="download-btn">
