...
# 08OB002: PALLANT CREEK NEAR DAAJING GIIDS
...
result = plot_station_polygon("08OB002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08OB002">stations/08OB002 folder on GitHub</a>.
:::
...
<tr><td>08OB002</td><td>PALLANT CREEK NEAR DAAJING GIIDS</td><td>53.057</td><td>-132.051</td><td>76.7 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 62.6 years
<br><strong>Timeseries Summary:</strong> 20,698 daily observations, seasonal gaps: 120 days avg (N=18) | 3.8% flagged (estimated: 689, partial day: 64, backwater: 24)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 224.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>20,698 daily observations, seasonal gaps: 120 days avg (N=18) | 3.8% flagged (estimated: 689, partial day: 64, backwater: 24) | Record: 62.6 years</td></tr>
...
show(plot_station_timeseries("08OB002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08OB002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08OB002/08OB002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08OB002/08OB002_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08OB002/08OB002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08OB002"))
:::
...
<div class="download-section">
  <a href="../../08OB002/08OB002_field_visits.csv" download class="download-btn">
