...
result = plot_station_polygon("08EE010")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EE010">stations/08EE010 folder on GitHub</a>.
:::
...
<tr><td>08EE010</td><td>KATHLYN CREEK ABOVE SIMPSON CREEK</td><td>54.812</td><td>-127.201</td><td>24.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 4,415 daily observations, minor gaps: 36 days avg (N=6) | 17.7% flagged (backwater: 660, estimated: 123)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 57.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>4,415 daily observations, minor gaps: 36 days avg (N=6) | 17.7% flagged (backwater: 660, estimated: 123) | Record: 12.7 years</td></tr>
...
show(plot_station_timeseries("08EE010"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EE010")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EE010/08EE010_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08EE010/08EE010_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08EE010"))
:::
...
<div class="download-section">
  <a href="../../08EE010/08EE010_field_visits.csv" download class="download-btn">
