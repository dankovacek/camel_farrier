...
# 08NJ003: CARPENTER CREEK NEAR NEW DENVER
...
result = plot_station_polygon("08NJ003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ003">stations/08NJ003 folder on GitHub</a>.
:::
...
<tr><td>08NJ003</td><td>CARPENTER CREEK NEAR NEW DENVER</td><td>49.992</td><td>-117.351</td><td>168.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 16.1 years
<br><strong>Timeseries Summary:</strong> 974 daily observations, seasonal gaps: 4900 days avg (N=1) | 9.4% flagged (backwater: 47, estimated: 45)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 496.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>974 daily observations, seasonal gaps: 4900 days avg (N=1) | 9.4% flagged (backwater: 47, estimated: 45) | Record: 16.1 years</td></tr>
...
show(plot_station_timeseries("08NJ003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ003/08NJ003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ003/08NJ003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ003"))
:::
...
<div class="download-section">
  <a href="../../08NJ003/08NJ003_field_visits.csv" download class="download-btn">
