...
# 08GA067: MILLAR CREEK NEAR OUTLET OF ALPHA LAKE
...
result = plot_station_polygon("08GA067")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA067">stations/08GA067 folder on GitHub</a>.
:::
...
<tr><td>08GA067</td><td>MILLAR CREEK NEAR OUTLET OF ALPHA LAKE</td><td>50.095</td><td>-123.042</td><td>14.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,283 daily observations, seasonal gaps: 121 days avg (N=6) | 3.4% flagged (estimated: 44)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 80.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,283 daily observations, seasonal gaps: 121 days avg (N=6) | 3.4% flagged (estimated: 44) | Record: 5.5 years</td></tr>
...
show(plot_station_timeseries("08GA067"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA067")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA067/08GA067_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA067/08GA067_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA067"))
:::
