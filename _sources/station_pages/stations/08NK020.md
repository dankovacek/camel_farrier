...
result = plot_station_polygon("08NK020")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NK020">stations/08NK020 folder on GitHub</a>.
:::
...
<tr><td>08NK020</td><td>MICHEL CREEK BELOW NATAL</td><td>49.730</td><td>-114.857</td><td>637.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 26.5 years
<br><strong>Timeseries Summary:</strong> 9,494 daily observations, seasonal gaps: 184 days avg (N=1) | 33.3% flagged (backwater: 2814, estimated: 184, partial day: 168)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1518.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>9,494 daily observations, seasonal gaps: 184 days avg (N=1) | 33.3% flagged (backwater: 2814, estimated: 184, partial day: 168) | Record: 26.5 years</td></tr>
...
show(plot_station_timeseries("08NK020"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NK020")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NK020/08NK020_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NK020/08NK020_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NK020"))
:::
...
<div class="download-section">
  <a href="../../08NK020/08NK020_field_visits.csv" download class="download-btn">
