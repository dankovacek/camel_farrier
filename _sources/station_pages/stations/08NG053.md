...
# 08NG053: KOOTENAY RIVER NEAR SKOOKUMCHUCK
...
result = plot_station_polygon("08NG053")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG053">stations/08NG053 folder on GitHub</a>.
:::
...
<tr><td>08NG053</td><td>KOOTENAY RIVER NEAR SKOOKUMCHUCK</td><td>49.911</td><td>-115.736</td><td>7120.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 46.2 years
<br><strong>Timeseries Summary:</strong> 16,861 daily observations, continuous record | 7.6% flagged (estimated: 463, backwater: 427, partial day: 399)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 17788.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>16,861 daily observations, continuous record | 7.6% flagged (estimated: 463, backwater: 427, partial day: 399) | Record: 46.2 years</td></tr>
...
show(plot_station_timeseries("08NG053"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG053")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG053/08NG053_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG053/08NG053_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG053"))
:::
...
<div class="download-section">
  <a href="../../08NG053/08NG053_field_visits.csv" download class="download-btn">
