...
result = plot_station_polygon("07QD006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07QD006">stations/07QD006 folder on GitHub</a>.
:::
...
<tr><td>07QD006</td><td>PORTER LAKE OUTFLOW</td><td>61.816</td><td>-107.870</td><td>2050.0 (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,922 daily observations, continuous record | 50.2% flagged (backwater: 1379, estimated: 83, partial day: 5)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 8573.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,922 daily observations, continuous record | 50.2% flagged (backwater: 1379, estimated: 83, partial day: 5) | Record: 8.0 years</td></tr>
...
show(plot_station_timeseries("07QD006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07QD006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07QD006/07QD006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07QD006/07QD006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07QD006"))
:::
...
<div class="download-section">
  <a href="../../07QD006/07QD006_field_visits.csv" download class="download-btn">
