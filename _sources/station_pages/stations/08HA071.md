...
# 08HA071: GRAHAM CREEK AT STELLY'S CROSS ROAD
...
result = plot_station_polygon("08HA071")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HA071">stations/08HA071 folder on GitHub</a>.
:::
...
<tr><td>08HA071</td><td>GRAHAM CREEK AT STELLY'S CROSS ROAD</td><td>48.582</td><td>-123.432</td><td>5.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.91, ΔArea: -8.6%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,826 daily observations, continuous record | 9.5% flagged (estimated: 151, partial day: 20, backwater: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 15.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,826 daily observations, continuous record | 9.5% flagged (estimated: 151, partial day: 20, backwater: 3) | Record: 5.0 years</td></tr>
...
show(plot_station_timeseries("08HA071"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HA071")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HA071/08HA071_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HA071/08HA071_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HA071"))
:::
...
<div class="download-section">
  <a href="../../08HA071/08HA071_field_visits.csv" download class="download-btn">
