...
result = plot_station_polygon("08LB017")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB017">stations/08LB017 folder on GitHub</a>.
:::
...
<tr><td>08LB017</td><td>RAFT RIVER NEAR CLEARWATER</td><td>51.639</td><td>-119.967</td><td>764.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 3,626 daily observations, seasonal gaps: 1769 days avg (N=7) | 17.4% flagged (backwater: 495, estimated: 135)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1988.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,626 daily observations, seasonal gaps: 1769 days avg (N=7) | 17.4% flagged (backwater: 495, estimated: 135) | Record: 43.8 years</td></tr>
...
show(plot_station_timeseries("08LB017"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB017")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB017/08LB017_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LB017/08LB017_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB017"))
:::
...
<div class="download-section">
  <a href="../../08LB017/08LB017_field_visits.csv" download class="download-btn">
