...
# 08NG027: LAKIT CREEK AT THE UPPER FORKS
...
result = plot_station_polygon("08NG027")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG027">stations/08NG027 folder on GitHub</a>.
:::
...
<tr><td>08NG027</td><td>LAKIT CREEK AT THE UPPER FORKS</td><td>49.678</td><td>-115.639</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 519 daily observations, seasonal gaps: 182 days avg (N=2) | 10.6% flagged (estimated: 55)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 56.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>519 daily observations, seasonal gaps: 182 days avg (N=2) | 10.6% flagged (estimated: 55) | Record: 2.4 years</td></tr>
...
show(plot_station_timeseries("08NG027"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG027")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG027/08NG027_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG027/08NG027_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG027"))
:::
...
<div class="download-section">
  <a href="../../08NG027/08NG027_field_visits.csv" download class="download-btn">
