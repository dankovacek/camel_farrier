...
The data representing the above plots can be downloaded from the [stations/05DB005](https://dankovacek.github.io/camel_farrier/stations/05DB005) folder in the Github repository.
