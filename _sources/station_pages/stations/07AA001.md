...
result = plot_station_polygon("07AA001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07AA001">stations/07AA001 folder on GitHub</a>.
:::
...
<tr><td>07AA001</td><td>MIETTE RIVER NEAR JASPER</td><td>52.864</td><td>-118.107</td><td>629.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 21,067 daily observations, seasonal gaps: 6452 days avg (N=3) | 45.8% flagged (backwater: 9165, estimated: 369, partial day: 111)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1799.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>21,067 daily observations, seasonal gaps: 6452 days avg (N=3) | 45.8% flagged (backwater: 9165, estimated: 369, partial day: 111) | Record: 110.7 years</td></tr>
...
show(plot_station_timeseries("07AA001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07AA001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07AA001/07AA001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07AA001/07AA001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07AA001/07AA001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>New rating curve developed to modernize imported Compumod curve.</td>
    </tr>
    <tr>
      <td>8.0</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Curve 8 same as Curve 7 above 2.550 m.</td>
    </tr>
    <tr>
      <td>7.0</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Same as #5 Ext: 2007: 2.7m - 3.2m</td>
    </tr>
    <tr>
      <td>6.0</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07AA001"))
:::
