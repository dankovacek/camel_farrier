...
# 07CA901: PINE CREEK NEAR COLINTON
...
result = plot_station_polygon("07CA901")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07CA901">stations/07CA901 folder on GitHub</a>.
:::
...
<tr><td>07CA901</td><td>PINE CREEK NEAR COLINTON</td><td>54.617</td><td>-113.013</td><td>255.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 2.7 years
<br><strong>Timeseries Summary:</strong> 765 daily observations, seasonal gaps: 120 days avg (N=2) | 18.0% flagged (backwater: 87, estimated: 43, partial day: 8)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 609.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>765 daily observations, seasonal gaps: 120 days avg (N=2) | 18.0% flagged (backwater: 87, estimated: 43, partial day: 8) | Record: 2.7 years</td></tr>
...
show(plot_station_timeseries("07CA901"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07CA901")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07CA901/07CA901_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07CA901/07CA901_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07CA901"))
:::
...
<div class="download-section">
  <a href="../../07CA901/07CA901_field_visits.csv" download class="download-btn">
