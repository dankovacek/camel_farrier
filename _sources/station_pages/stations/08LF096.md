...
# 08LF096: LOON CREEK ABOVE LOON LAKE
...
result = plot_station_polygon("08LF096")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF096">stations/08LF096 folder on GitHub</a>.
:::
...
<tr><td>08LF096</td><td>LOON CREEK ABOVE LOON LAKE</td><td>51.164</td><td>-121.136</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 823 daily observations, continuous record | 17.3% flagged (backwater: 108, estimated: 29, partial day: 5)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 222.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>823 daily observations, continuous record | 17.3% flagged (backwater: 108, estimated: 29, partial day: 5) | Record: 2.3 years</td></tr>
...
show(plot_station_timeseries("08LF096"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF096")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF096/08LF096_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF096/08LF096_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF096"))
:::
...
<div class="download-section">
  <a href="../../08LF096/08LF096_field_visits.csv" download class="download-btn">
