...
result = plot_station_polygon("08DC006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08DC006">stations/08DC006 folder on GitHub</a>.
:::
...
<tr><td>08DC006</td><td>BEAR RIVER ABOVE BITTER CREEK</td><td>56.043</td><td>-129.925</td><td>350.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 32.0 years
<br><strong>Timeseries Summary:</strong> 11,688 daily observations, continuous record | 21.5% flagged (backwater: 1847, estimated: 634, partial day: 30)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1020.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>11,688 daily observations, continuous record | 21.5% flagged (backwater: 1847, estimated: 634, partial day: 30) | Record: 32.0 years</td></tr>
...
show(plot_station_timeseries("08DC006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08DC006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08DC006/08DC006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08DC006/08DC006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08DC006"))
:::
...
<div class="download-section">
  <a href="../../08DC006/08DC006_field_visits.csv" download class="download-btn">
