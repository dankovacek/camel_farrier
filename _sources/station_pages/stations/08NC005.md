...
# 08NC005: CAMP CREEK AT HIGHWAY NO. 5
...
result = plot_station_polygon("08NC005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NC005">stations/08NC005 folder on GitHub</a>.
:::
...
<tr><td>08NC005</td><td>CAMP CREEK AT HIGHWAY NO. 5</td><td>52.734</td><td>-119.267</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 276 daily observations, minor gaps: 30 days avg (N=1) | 37.3% flagged (partial day: 102, estimated: 1)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 461.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>276 daily observations, minor gaps: 30 days avg (N=1) | 37.3% flagged (partial day: 102, estimated: 1) | Record: 0.8 years</td></tr>
...
show(plot_station_timeseries("08NC005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NC005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NC005/08NC005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NC005/08NC005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NC005"))
:::
...
<div class="download-section">
  <a href="../../08NC005/08NC005_field_visits.csv" download class="download-btn">
