...
# 08NB009: HOSPITAL CREEK NORTH FORK NEAR GOLDEN
...
result = plot_station_polygon("08NB009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NB009">stations/08NB009 folder on GitHub</a>.
:::
...
<tr><td>08NB009</td><td>HOSPITAL CREEK NORTH FORK NEAR GOLDEN</td><td>51.341</td><td>-116.950</td><td>25.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,078 daily observations, seasonal gaps: 206 days avg (N=10) | 40.0% flagged (estimated: 832)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 65.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,078 daily observations, seasonal gaps: 206 days avg (N=10) | 40.0% flagged (estimated: 832) | Record: 11.3 years</td></tr>
...
show(plot_station_timeseries("08NB009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NB009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NB009/08NB009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NB009/08NB009_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NB009"))
:::
