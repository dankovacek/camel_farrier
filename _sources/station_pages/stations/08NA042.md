...
# 08NA042: MCCREADY CREEK NEAR BRISCO
...
result = plot_station_polygon("08NA042")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA042">stations/08NA042 folder on GitHub</a>.
:::
...
<tr><td>08NA042</td><td>MCCREADY CREEK NEAR BRISCO</td><td>50.790</td><td>-116.213</td><td>2.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 122 daily observations, continuous record</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 13.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>122 daily observations, continuous record | Record: 0.3 years</td></tr>
...
show(plot_station_timeseries("08NA042"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA042")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA042/08NA042_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA042/08NA042_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA042"))
:::
