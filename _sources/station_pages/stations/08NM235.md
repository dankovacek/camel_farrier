...
# 08NM235: RIBBLEWORTH CREEK NEAR OYAMA
...
result = plot_station_polygon("08NM235")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM235">stations/08NM235 folder on GitHub</a>.
:::
...
<tr><td>08NM235</td><td>RIBBLEWORTH CREEK NEAR OYAMA</td><td>50.075</td><td>-119.379</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.97, ΔArea: +2.5%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,436 daily observations, continuous record | 7.1% flagged (estimated: 134, partial day: 40)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 33.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,436 daily observations, continuous record | 7.1% flagged (estimated: 134, partial day: 40) | Record: 6.7 years</td></tr>
...
show(plot_station_timeseries("08NM235"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM235")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM235/08NM235_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM235/08NM235_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM235"))
:::
...
<div class="download-section">
  <a href="../../08NM235/08NM235_field_visits.csv" download class="download-btn">
