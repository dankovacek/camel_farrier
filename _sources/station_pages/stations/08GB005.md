...
# 08GB005: SLIAMMON CREEK NEAR POWELL RIVER
...
result = plot_station_polygon("08GB005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GB005">stations/08GB005 folder on GitHub</a>.
:::
...
<tr><td>08GB005</td><td>SLIAMMON CREEK NEAR POWELL RIVER</td><td>49.898</td><td>-124.602</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 730 daily observations, continuous record | 50.0% flagged (estimated: 351, backwater: 14)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 140.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>730 daily observations, continuous record | 50.0% flagged (estimated: 351, backwater: 14) | Record: 2.0 years</td></tr>
...
show(plot_station_timeseries("08GB005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GB005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GB005/08GB005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GB005/08GB005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GB005"))
:::
