...
result = plot_station_polygon("08LE102")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE102">stations/08LE102 folder on GitHub</a>.
:::
...
<tr><td>08LE102</td><td>PETERSON CREEK ABOVE JACKO CREEK</td><td>50.588</td><td>-120.446</td><td>21.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 5.4 years
<br><strong>Timeseries Summary:</strong> 1,192 daily observations, seasonal gaps: 157 days avg (N=5) | 9.7% flagged (estimated: 84, partial day: 19, backwater: 13)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 51.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,192 daily observations, seasonal gaps: 157 days avg (N=5) | 9.7% flagged (estimated: 84, partial day: 19, backwater: 13) | Record: 5.4 years</td></tr>
...
show(plot_station_timeseries("08LE102"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE102")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE102/08LE102_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE102/08LE102_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE102"))
:::
...
<div class="download-section">
  <a href="../../08LE102/08LE102_field_visits.csv" download class="download-btn">
