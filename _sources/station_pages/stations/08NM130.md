...
# 08NM130: TESTALINDEN CREEK NEAR OLIVER
...
result = plot_station_polygon("08NM130")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM130">stations/08NM130 folder on GitHub</a>.
:::
...
<tr><td>08NM130</td><td>TESTALINDEN CREEK NEAR OLIVER</td><td>49.120</td><td>-119.590</td><td>13.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,372 daily observations, minor gaps: 30 days avg (N=1) | 17.1% flagged (estimated: 190, backwater: 44)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 30.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,372 daily observations, minor gaps: 30 days avg (N=1) | 17.1% flagged (estimated: 190, backwater: 44) | Record: 3.8 years</td></tr>
...
show(plot_station_timeseries("08NM130"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM130")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM130/08NM130_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM130/08NM130_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM130"))
:::
...
<div class="download-section">
  <a href="../../08NM130/08NM130_field_visits.csv" download class="download-btn">
