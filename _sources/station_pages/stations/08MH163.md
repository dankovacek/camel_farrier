...
# 08MH163: FOLEY CREEK ABOVE FOLEY LAKE
...
result = plot_station_polygon("08MH163")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH163">stations/08MH163 folder on GitHub</a>.
:::
...
<tr><td>08MH163</td><td>FOLEY CREEK ABOVE FOLEY LAKE</td><td>49.153</td><td>-121.539</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 4.8 years
<br><strong>Timeseries Summary:</strong> 1,705 daily observations, minor gaps: 31 days avg (N=1) | 19.5% flagged (partial day: 153, estimated: 134, backwater: 46)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 60.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,705 daily observations, minor gaps: 31 days avg (N=1) | 19.5% flagged (partial day: 153, estimated: 134, backwater: 46) | Record: 4.8 years</td></tr>
...
show(plot_station_timeseries("08MH163"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH163")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH163/08MH163_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH163/08MH163_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH163"))
:::
...
<div class="download-section">
  <a href="../../08MH163/08MH163_field_visits.csv" download class="download-btn">
