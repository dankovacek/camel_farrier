...
result = plot_station_polygon("08NH007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH007">stations/08NH007 folder on GitHub</a>.
:::
...
<tr><td>08NH007</td><td>LARDEAU RIVER AT MARBLEHEAD</td><td>50.263</td><td>-116.968</td><td>1640.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 107.8 years
<br><strong>Timeseries Summary:</strong> 27,732 daily observations, seasonal gaps: 3875 days avg (N=3) | 11.8% flagged (backwater: 1992, estimated: 1205, partial day: 86)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4028.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>27,732 daily observations, seasonal gaps: 3875 days avg (N=3) | 11.8% flagged (backwater: 1992, estimated: 1205, partial day: 86) | Record: 107.8 years</td></tr>
...
show(plot_station_timeseries("08NH007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH007/08NH007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NH007/08NH007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NH007/08NH007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH007"))
:::
...
<div class="download-section">
  <a href="../../08NH007/08NH007_field_visits.csv" download class="download-btn">
