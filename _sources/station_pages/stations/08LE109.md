...
result = plot_station_polygon("08LE109")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE109">stations/08LE109 folder on GitHub</a>.
:::
...
<tr><td>08LE109</td><td>SHUSWAP LAKE AT CANOE</td><td>50.755</td><td>-119.229</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 38618.2 km²</td></tr>
...
show(plot_station_timeseries("08LE109"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE109")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE109/08LE109_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LE109/08LE109_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE109"))
:::
...
<div class="download-section">
  <a href="../../08LE109/08LE109_field_visits.csv" download class="download-btn">
