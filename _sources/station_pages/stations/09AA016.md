...
# 09AA016: FANTAIL LAKE NEAR ATLIN
...
result = plot_station_polygon("09AA016")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09AA016">stations/09AA016 folder on GitHub</a>.
:::
...
<tr><td>09AA016</td><td>FANTAIL LAKE NEAR ATLIN</td><td>59.594</td><td>-134.391</td><td>nan (0.0)</td><td>YT</td><td>D</td></tr>
</table>
...
show(plot_station_timeseries("09AA016"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09AA016")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09AA016/09AA016_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../09AA016/09AA016_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("09AA016"))
:::
...
<div class="download-section">
  <a href="../../09AA016/09AA016_field_visits.csv" download class="download-btn">
