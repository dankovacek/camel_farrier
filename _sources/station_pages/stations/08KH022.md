...
result = plot_station_polygon("08KH022")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KH022">stations/08KH022 folder on GitHub</a>.
:::
...
<tr><td>08KH022</td><td>MACKAY RIVER AT THE MOUTH</td><td>52.374</td><td>-120.722</td><td>144.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 14.5 years
<br><strong>Timeseries Summary:</strong> 5,146 daily observations, minor gaps: 76 days avg (N=2) | 44.7% flagged (backwater: 2064, estimated: 215, partial day: 23)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 375.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>5,146 daily observations, minor gaps: 76 days avg (N=2) | 44.7% flagged (backwater: 2064, estimated: 215, partial day: 23) | Record: 14.5 years</td></tr>
...
show(plot_station_timeseries("08KH022"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KH022")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KH022/08KH022_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KH022/08KH022_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KH022"))
:::
...
<div class="download-section">
  <a href="../../08KH022/08KH022_field_visits.csv" download class="download-btn">
