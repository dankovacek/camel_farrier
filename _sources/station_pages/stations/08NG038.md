...
# 08NG038: ANGUS CREEK NEAR CRANBROOK
...
result = plot_station_polygon("08NG038")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG038">stations/08NG038 folder on GitHub</a>.
:::
...
<tr><td>08NG038</td><td>ANGUS CREEK NEAR CRANBROOK</td><td>49.486</td><td>-115.848</td><td>6.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 92 daily observations, continuous record | 55.4% flagged (estimated: 51)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 14.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>92 daily observations, continuous record | 55.4% flagged (estimated: 51) | Record: 0.2 years</td></tr>
...
show(plot_station_timeseries("08NG038"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG038")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG038/08NG038_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG038/08NG038_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG038"))
:::
...
<div class="download-section">
  <a href="../../08NG038/08NG038_field_visits.csv" download class="download-btn">
