...
result = plot_station_polygon("08AC002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08AC002">stations/08AC002 folder on GitHub</a>.
:::
...
<tr><td>08AC002</td><td>TATSHENSHINI RIVER NEAR DALTON POST</td><td>60.119</td><td>-137.085</td><td>1750.0 (0.0)</td><td>YT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 35.0 years
<br><strong>Timeseries Summary:</strong> 12,753 daily observations, minor gaps: 30 days avg (N=1) | 51.8% flagged (backwater: 6385, estimated: 176, partial day: 42)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 6945.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>12,753 daily observations, minor gaps: 30 days avg (N=1) | 51.8% flagged (backwater: 6385, estimated: 176, partial day: 42) | Record: 35.0 years</td></tr>
...
show(plot_station_timeseries("08AC002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08AC002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08AC002/08AC002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08AC002/08AC002_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08AC002/08AC002_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>See 08AC002_20220101_22.0_RMD in sharepoint 08AC002_2022 for details on curve development</td>
    </tr>
    <tr>
      <td>21.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Trying to better define curve at site, assuming gravel bar directly across from gauge on RL is the b...</td>
    </tr>
    <tr>
      <td>19.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Required to reduce complexity from previous Curve 18.2, and to reflect most recent ADCP results.</td>
    </tr>
    <tr>
      <td>18.2</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08AC002"))
:::
