...
result = plot_station_polygon("07AH001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07AH001">stations/07AH001 folder on GitHub</a>.
:::
...
<tr><td>07AH001</td><td>FREEMAN RIVER NEAR FORT ASSINIBOINE</td><td>54.365</td><td>-114.905</td><td>1660.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 1.00, ΔArea: +0.5%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 59.5 years
<br><strong>Timeseries Summary:</strong> 15,929 daily observations, seasonal gaps: 98 days avg (N=59) | 27.5% flagged (backwater: 3208, partial day: 675, estimated: 505)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4920.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>15,929 daily observations, seasonal gaps: 98 days avg (N=59) | 27.5% flagged (backwater: 3208, partial day: 675, estimated: 505) | Record: 59.5 years</td></tr>
...
show(plot_station_timeseries("07AH001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07AH001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07AH001/07AH001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07AH001/07AH001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07AH001/07AH001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Discharge measurements were collected in 2024 to collect enough information to build a preliminary c...</td>
    </tr>
    <tr>
      <td>23.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New rating curve developed following highwater even in June/July-2023 resulting in significant chann...</td>
    </tr>
    <tr>
      <td>22.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Control Change. New Curve Includes Historic High Water Measuements and Measurements Taken Since the ...</td>
    </tr>
    <tr>
      <td>21.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>NEW CURVE DRAWN IN AQUARIUS</td>
    </tr>
    <tr>
      <td>20.1</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Same as curve # 20.0 below 2.69 Changed number  from C20.1 to 20.1</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("07AH001"))
:::
...
<div class="download-section">
  <a href="../../07AH001/07AH001_field_visits.csv" download class="download-btn">
