...
# 08NJ066: SMOKY CREEK NEAR SOUTH SLOCAN
...
result = plot_station_polygon("08NJ066")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ066">stations/08NJ066 folder on GitHub</a>.
:::
...
<tr><td>08NJ066</td><td>SMOKY CREEK NEAR SOUTH SLOCAN</td><td>49.460</td><td>-117.512</td><td>4.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 458 daily observations, seasonal gaps: 486 days avg (N=3) | 52.2% flagged (estimated: 239)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 12.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>458 daily observations, seasonal gaps: 486 days avg (N=3) | 52.2% flagged (estimated: 239) | Record: 5.2 years</td></tr>
...
show(plot_station_timeseries("08NJ066"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ066")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ066/08NJ066_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ066/08NJ066_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ066"))
:::
...
<div class="download-section">
  <a href="../../08NJ066/08NJ066_field_visits.csv" download class="download-btn">
