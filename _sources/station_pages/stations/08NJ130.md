...
result = plot_station_polygon("08NJ130")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ130">stations/08NJ130 folder on GitHub</a>.
:::
...
<tr><td>08NJ130</td><td>ANDERSON CREEK NEAR NELSON</td><td>49.502</td><td>-117.261</td><td>9.1 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 79.7 years
<br><strong>Timeseries Summary:</strong> 22,406 daily observations, seasonal gaps: 1116 days avg (N=6) | 8.0% flagged (estimated: 1604, partial day: 134, backwater: 53)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 19.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>22,406 daily observations, seasonal gaps: 1116 days avg (N=6) | 8.0% flagged (estimated: 1604, partial day: 134, backwater: 53) | Record: 79.7 years</td></tr>
...
show(plot_station_timeseries("08NJ130"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ130")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ130/08NJ130_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NJ130/08NJ130_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NJ130/08NJ130_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ130"))
:::
...
<div class="download-section">
  <a href="../../08NJ130/08NJ130_field_visits.csv" download class="download-btn">
