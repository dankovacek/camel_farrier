...
# 08NA036: BEARD CREEK NEAR PARSON
...
result = plot_station_polygon("08NA036")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA036">stations/08NA036 folder on GitHub</a>.
:::
...
<tr><td>08NA036</td><td>BEARD CREEK NEAR PARSON</td><td>51.065</td><td>-116.577</td><td>9.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 39.4 years
<br><strong>Timeseries Summary:</strong> 763 daily observations, seasonal gaps: 3408 days avg (N=4) | 65.1% flagged (estimated: 497)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 18.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>763 daily observations, seasonal gaps: 3408 days avg (N=4) | 65.1% flagged (estimated: 497) | Record: 39.4 years</td></tr>
...
show(plot_station_timeseries("08NA036"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA036")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA036/08NA036_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA036/08NA036_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA036"))
:::
...
<div class="download-section">
  <a href="../../08NA036/08NA036_field_visits.csv" download class="download-btn">
