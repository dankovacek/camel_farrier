...
result = plot_station_polygon("08EF004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EF004">stations/08EF004 folder on GitHub</a>.
:::
...
<tr><td>08EF004</td><td>KITSEGUECLA RIVER NEAR SKEENA CROSSING</td><td>55.090</td><td>-127.811</td><td>728.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 11.3 years
<br><strong>Timeseries Summary:</strong> 3,958 daily observations, seasonal gaps: 90 days avg (N=2) | 33.0% flagged (backwater: 1067, estimated: 221, partial day: 17)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2127.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,958 daily observations, seasonal gaps: 90 days avg (N=2) | 33.0% flagged (backwater: 1067, estimated: 221, partial day: 17) | Record: 11.3 years</td></tr>
...
show(plot_station_timeseries("08EF004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EF004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EF004/08EF004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08EF004/08EF004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08EF004"))
:::
...
<div class="download-section">
  <a href="../../08EF004/08EF004_field_visits.csv" download class="download-btn">
