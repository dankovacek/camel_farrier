...
# 09DC003: STEWART RIVER ABOVE FRASER FALLS
...
result = plot_station_polygon("09DC003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09DC003">stations/09DC003 folder on GitHub</a>.
:::
...
<tr><td>09DC003</td><td>STEWART RIVER ABOVE FRASER FALLS</td><td>63.488</td><td>-135.135</td><td>30600.0 (0.0)</td><td>YT</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 5,844 daily observations, continuous record | 64.8% flagged (backwater: 3243, estimated: 511, partial day: 34)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 155763.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>5,844 daily observations, continuous record | 64.8% flagged (backwater: 3243, estimated: 511, partial day: 34) | Record: 16.0 years</td></tr>
...
show(plot_station_timeseries("09DC003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09DC003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09DC003/09DC003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../09DC003/09DC003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../09DC003/09DC003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("09DC003"))
:::
...
<div class="download-section">
  <a href="../../09DC003/09DC003_field_visits.csv" download class="download-btn">
