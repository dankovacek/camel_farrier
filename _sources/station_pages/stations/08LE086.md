...
# 08LE086: RATCHFORD CREEK AT 600 M CONTOUR
...
result = plot_station_polygon("08LE086")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE086">stations/08LE086 folder on GitHub</a>.
:::
...
<tr><td>08LE086</td><td>RATCHFORD CREEK AT 600 M CONTOUR</td><td>51.365</td><td>-118.806</td><td>253.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 4,230 daily observations, continuous record | 32.3% flagged (backwater: 863, estimated: 478, partial day: 25)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 630.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>4,230 daily observations, continuous record | 32.3% flagged (backwater: 863, estimated: 478, partial day: 25) | Record: 11.6 years</td></tr>
...
show(plot_station_timeseries("08LE086"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE086")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE086/08LE086_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE086/08LE086_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE086"))
:::
...
<div class="download-section">
  <a href="../../08LE086/08LE086_field_visits.csv" download class="download-btn">
