...
# 08LC027: SICAMOUS CREEK NEAR SICAMOUS
...
result = plot_station_polygon("08LC027")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LC027">stations/08LC027 folder on GitHub</a>.
:::
...
<tr><td>08LC027</td><td>SICAMOUS CREEK NEAR SICAMOUS</td><td>50.810</td><td>-118.968</td><td>64.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 549 daily observations, seasonal gaps: 182 days avg (N=2) | 0.9% flagged (estimated: 5)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 162.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>549 daily observations, seasonal gaps: 182 days avg (N=2) | 0.9% flagged (estimated: 5) | Record: 2.5 years</td></tr>
...
show(plot_station_timeseries("08LC027"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LC027")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LC027/08LC027_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LC027/08LC027_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LC027"))
:::
