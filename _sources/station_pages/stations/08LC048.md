...
result = plot_station_polygon("08LC048")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LC048">stations/08LC048 folder on GitHub</a>.
:::
...
<tr><td>08LC048</td><td>TRINITY CREEK ABOVE DIVERSION</td><td>50.414</td><td>-118.933</td><td>42.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 732 daily observations, seasonal gaps: 182 days avg (N=3) | 0.8% flagged (estimated: 6)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 176.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>732 daily observations, seasonal gaps: 182 days avg (N=3) | 0.8% flagged (estimated: 6) | Record: 3.5 years</td></tr>
...
show(plot_station_timeseries("08LC048"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LC048")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LC048/08LC048_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LC048/08LC048_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LC048"))
:::
