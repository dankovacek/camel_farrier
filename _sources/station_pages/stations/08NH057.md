...
# 08NH057: BJERKNESS CREEK AT MIRROR LAKE
...
result = plot_station_polygon("08NH057")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH057">stations/08NH057 folder on GitHub</a>.
:::
...
<tr><td>08NH057</td><td>BJERKNESS CREEK AT MIRROR LAKE</td><td>49.872</td><td>-116.911</td><td>25.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 38.8 years
<br><strong>Timeseries Summary:</strong> 2,010 daily observations, seasonal gaps: 4048 days avg (N=3) | 24.7% flagged (estimated: 474, backwater: 23)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 64.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,010 daily observations, seasonal gaps: 4048 days avg (N=3) | 24.7% flagged (estimated: 474, backwater: 23) | Record: 38.8 years</td></tr>
...
show(plot_station_timeseries("08NH057"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH057")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH057/08NH057_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH057/08NH057_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH057"))
:::
...
<div class="download-section">
  <a href="../../08NH057/08NH057_field_visits.csv" download class="download-btn">
