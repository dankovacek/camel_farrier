...
# 08MF067: KOPP CREEK ABOVE MENZ CREEK
...
result = plot_station_polygon("08MF067")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MF067">stations/08MF067 folder on GitHub</a>.
:::
...
<tr><td>08MF067</td><td>KOPP CREEK ABOVE MENZ CREEK</td><td>49.384</td><td>-121.391</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 856 daily observations, seasonal gaps: 141 days avg (N=3) | 77.0% flagged (estimated: 659)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>856 daily observations, seasonal gaps: 141 days avg (N=3) | 77.0% flagged (estimated: 659) | Record: 3.5 years</td></tr>
...
show(plot_station_timeseries("08MF067"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MF067")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MF067/08MF067_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MF067/08MF067_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MF067"))
:::
...
<div class="download-section">
  <a href="../../08MF067/08MF067_field_visits.csv" download class="download-btn">
