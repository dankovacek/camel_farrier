...
# 07DA021: NAMUR LAKE AT BIRCH MOUNTAINS LODGE
...
result = plot_station_polygon("07DA021")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DA021">stations/07DA021 folder on GitHub</a>.
:::
...
<tr><td>07DA021</td><td>NAMUR LAKE AT BIRCH MOUNTAINS LODGE</td><td>57.369</td><td>-112.758</td><td>172.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 604.5 km²</td></tr>
...
show(plot_station_timeseries("07DA021"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07DA021")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07DA021/07DA021_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07DA021/07DA021_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07DA021"))
:::
...
<div class="download-section">
  <a href="../../07DA021/07DA021_field_visits.csv" download class="download-btn">
