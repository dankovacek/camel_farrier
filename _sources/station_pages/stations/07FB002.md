...
result = plot_station_polygon("07FB002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07FB002">stations/07FB002 folder on GitHub</a>.
:::
...
<tr><td>07FB002</td><td>MURRAY RIVER NEAR THE MOUTH</td><td>55.552</td><td>-121.203</td><td>5550.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 47.4 years
<br><strong>Timeseries Summary:</strong> 17,290 daily observations, minor gaps: 30 days avg (N=1) | 48.1% flagged (backwater: 7651, estimated: 609, partial day: 63)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 16836.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>17,290 daily observations, minor gaps: 30 days avg (N=1) | 48.1% flagged (backwater: 7651, estimated: 609, partial day: 63) | Record: 47.4 years</td></tr>
...
show(plot_station_timeseries("07FB002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07FB002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07FB002/07FB002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07FB002/07FB002_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07FB002/07FB002_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Curve created using 2023 open water measurements. All measurements since the cableway was restored p...</td>
    </tr>
    <tr>
      <td>29.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve created using 2021 and 2022 open water measurements since cableway restoration, and record hig...</td>
    </tr>
    <tr>
      <td>28.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extended the upper end of curve 28 to plot 2017 data, and added the grading at the low end.</td>
    </tr>
    <tr>
      <td>28.00</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("07FB002"))
:::
...
<div class="download-section">
  <a href="../../07FB002/07FB002_field_visits.csv" download class="download-btn">
