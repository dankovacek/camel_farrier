...
result = plot_station_polygon("07CE005")
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4037.8 km²</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07CE005")
show(show_with_notes(result))
:::
