...
# 08MH070: DEROCHE CREEK AT DEROCHE
...
result = plot_station_polygon("08MH070")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH070">stations/08MH070 folder on GitHub</a>.
:::
...
<tr><td>08MH070</td><td>DEROCHE CREEK AT DEROCHE</td><td>49.186</td><td>-122.075</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,090 daily observations, seasonal gaps: 123 days avg (N=4) | 8.7% flagged (estimated: 95)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,090 daily observations, seasonal gaps: 123 days avg (N=4) | 8.7% flagged (estimated: 95) | Record: 4.3 years</td></tr>
...
show(plot_station_timeseries("08MH070"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH070")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH070/08MH070_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH070/08MH070_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH070"))
:::
...
<div class="download-section">
  <a href="../../08MH070/08MH070_field_visits.csv" download class="download-btn">
