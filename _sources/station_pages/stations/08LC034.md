...
result = plot_station_polygon("08LC034")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LC034">stations/08LC034 folder on GitHub</a>.
:::
...
<tr><td>08LC034</td><td>FERRY CREEK NEAR LUMBY</td><td>50.242</td><td>-118.647</td><td>145.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 18.5 years
<br><strong>Timeseries Summary:</strong> 5,309 daily observations, seasonal gaps: 121 days avg (N=12) | 7.5% flagged (backwater: 256, estimated: 143)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 360.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>5,309 daily observations, seasonal gaps: 121 days avg (N=12) | 7.5% flagged (backwater: 256, estimated: 143) | Record: 18.5 years</td></tr>
...
show(plot_station_timeseries("08LC034"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LC034")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LC034/08LC034_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LC034/08LC034_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LC034"))
:::
...
<div class="download-section">
  <a href="../../08LC034/08LC034_field_visits.csv" download class="download-btn">
