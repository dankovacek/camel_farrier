...
# 08NH096: KOOTENAY RIVER AT GOAT SLOUGH (OUTSIDE DYKE)
...
result = plot_station_polygon("08NH096")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH096">stations/08NH096 folder on GitHub</a>.
:::
...
<tr><td>08NH096</td><td>KOOTENAY RIVER AT GOAT SLOUGH (OUTSIDE DYKE)</td><td>49.156</td><td>-116.588</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 40.1 km²</td></tr>
...
show(plot_station_timeseries("08NH096"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH096")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH096/08NH096_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NH096/08NH096_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH096"))
:::
...
<div class="download-section">
  <a href="../../08NH096/08NH096_field_visits.csv" download class="download-btn">
