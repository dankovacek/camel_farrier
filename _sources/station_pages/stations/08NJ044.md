...
# 08NJ044: CARSON CREEK NEAR PROCTER
...
result = plot_station_polygon("08NJ044")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ044">stations/08NJ044 folder on GitHub</a>.
:::
...
<tr><td>08NJ044</td><td>CARSON CREEK NEAR PROCTER</td><td>49.621</td><td>-116.947</td><td>2.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.98, ΔArea: +2.3%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 18.2 years
<br><strong>Timeseries Summary:</strong> 1,008 daily observations, seasonal gaps: 938 days avg (N=6) | 46.9% flagged (estimated: 473)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,008 daily observations, seasonal gaps: 938 days avg (N=6) | 46.9% flagged (estimated: 473) | Record: 18.2 years</td></tr>
...
show(plot_station_timeseries("08NJ044"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ044")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ044/08NJ044_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ044/08NJ044_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ044"))
:::
...
<div class="download-section">
  <a href="../../08NJ044/08NJ044_field_visits.csv" download class="download-btn">
