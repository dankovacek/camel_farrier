...
# 08HD009: STOWE CREEK NEAR SAYWARD
...
result = plot_station_polygon("08HD009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HD009">stations/08HD009 folder on GitHub</a>.
:::
...
<tr><td>08HD009</td><td>STOWE CREEK NEAR SAYWARD</td><td>50.299</td><td>-125.885</td><td>17.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 183 daily observations, continuous record | 1.1% flagged (estimated: 2)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 41.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>183 daily observations, continuous record | 1.1% flagged (estimated: 2) | Record: 0.5 years</td></tr>
...
show(plot_station_timeseries("08HD009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HD009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HD009/08HD009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HD009/08HD009_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HD009"))
:::
...
<div class="download-section">
  <a href="../../08HD009/08HD009_field_visits.csv" download class="download-btn">
