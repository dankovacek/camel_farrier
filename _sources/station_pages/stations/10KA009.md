...
# 10KA009: CANYON CREEK AT PIPELINE CROSSING
...
result = plot_station_polygon("10KA009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10KA009">stations/10KA009 folder on GitHub</a>.
:::
...
<tr><td>10KA009</td><td>CANYON CREEK AT PIPELINE CROSSING</td><td>65.232</td><td>-126.518</td><td>nan (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 14.6 years
<br><strong>Timeseries Summary:</strong> 3,149 daily observations, seasonal gaps: 198 days avg (N=11) | 38.8% flagged (backwater: 705, estimated: 485, partial day: 31)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 376.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,149 daily observations, seasonal gaps: 198 days avg (N=11) | 38.8% flagged (backwater: 705, estimated: 485, partial day: 31) | Record: 14.6 years</td></tr>
...
show(plot_station_timeseries("10KA009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10KA009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10KA009/10KA009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10KA009/10KA009_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10KA009/10KA009_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>New rating for the control change on the low end from 2023 onward.</td>
    </tr>
    <tr>
      <td>9.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>A new curve #9.000 was drawn as some minor adjustments were required.  Top end moved slightly to the...</td>
    </tr>
    <tr>
      <td>8.000</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Provisional/Provisoire</td>
      <td>Developed using 2013-2014 Open water measurements</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("10KA009"))
:::
...
<div class="download-section">
  <a href="../../10KA009/10KA009_field_visits.csv" download class="download-btn">
