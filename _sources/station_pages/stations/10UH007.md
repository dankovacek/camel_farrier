...
# 10UH007: BURTON RIVER AT BURTON LAKE
...
result = plot_station_polygon("10UH007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10UH007">stations/10UH007 folder on GitHub</a>.
:::
...
<tr><td>10UH007</td><td>BURTON RIVER AT BURTON LAKE</td><td>63.789</td><td>-68.322</td><td>nan (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1743.1 km²</td></tr>
...
show(plot_station_timeseries("10UH007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10UH007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10UH007/10UH007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10UH007/10UH007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10UH007"))
:::
