...
The data representing the above plots can be downloaded from the [stations/05FE002](https://dankovacek.github.io/camel_farrier/stations/05FE002) folder in the Github repository.
