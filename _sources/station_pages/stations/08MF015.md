...
# 08MF015: TEXAS CREEK NEAR LILLOOET
...
result = plot_station_polygon("08MF015")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MF015">stations/08MF015 folder on GitHub</a>.
:::
...
<tr><td>08MF015</td><td>TEXAS CREEK NEAR LILLOOET</td><td>50.561</td><td>-121.829</td><td>163.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,220 daily observations, seasonal gaps: 238 days avg (N=6) | 13.4% flagged (estimated: 164)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 419.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,220 daily observations, seasonal gaps: 238 days avg (N=6) | 13.4% flagged (estimated: 164) | Record: 7.2 years</td></tr>
...
show(plot_station_timeseries("08MF015"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MF015")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MF015/08MF015_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MF015/08MF015_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MF015"))
:::
...
<div class="download-section">
  <a href="../../08MF015/08MF015_field_visits.csv" download class="download-btn">
