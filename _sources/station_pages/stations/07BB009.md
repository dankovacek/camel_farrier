...
result = plot_station_polygon("07BB009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07BB009">stations/07BB009 folder on GitHub</a>.
:::
...
<tr><td>07BB009</td><td>CONNOR CREEK NEAR SANGUDO</td><td>54.023</td><td>-114.944</td><td>165.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,782 daily observations, seasonal gaps: 318 days avg (N=10) | 17.9% flagged (backwater: 403, estimated: 87, partial day: 9)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 471.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,782 daily observations, seasonal gaps: 318 days avg (N=10) | 17.9% flagged (backwater: 403, estimated: 87, partial day: 9) | Record: 16.3 years</td></tr>
...
show(plot_station_timeseries("07BB009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07BB009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07BB009/07BB009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07BB009/07BB009_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07BB009"))
:::
