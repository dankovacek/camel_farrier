...
result = plot_station_polygon("10BC001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10BC001">stations/10BC001 folder on GitHub</a>.
:::
...
<tr><td>10BC001</td><td>COAL RIVER AT THE MOUTH</td><td>59.691</td><td>-126.951</td><td>9190.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 33.7 years
<br><strong>Timeseries Summary:</strong> 12,176 daily observations, minor gaps: 60 days avg (N=2) | 53.9% flagged (backwater: 6062, estimated: 459, partial day: 36)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 38828.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>12,176 daily observations, minor gaps: 60 days avg (N=2) | 53.9% flagged (backwater: 6062, estimated: 459, partial day: 36) | Record: 33.7 years</td></tr>
...
show(plot_station_timeseries("10BC001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10BC001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10BC001/10BC001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10BC001/10BC001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10BC001"))
:::
...
<div class="download-section">
  <a href="../../10BC001/10BC001_field_visits.csv" download class="download-btn">
