...
result = plot_station_polygon("07BB002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07BB002">stations/07BB002 folder on GitHub</a>.
:::
...
<tr><td>07BB002</td><td>PEMBINA RIVER NEAR ENTWISTLE</td><td>53.600</td><td>-115.004</td><td>4400.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 28,855 daily observations, seasonal gaps: 11568 days avg (N=1) | 49.5% flagged (backwater: 13430, estimated: 578, partial day: 263)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 12231.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>28,855 daily observations, seasonal gaps: 11568 days avg (N=1) | 49.5% flagged (backwater: 13430, estimated: 578, partial day: 263) | Record: 110.7 years</td></tr>
...
show(plot_station_timeseries("07BB002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07BB002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07BB002/07BB002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07BB002/07BB002_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07BB002/07BB002_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Extension of high end for June 2023 high water. New rating curve required as gauge location moved up...</td>
    </tr>
    <tr>
      <td>26.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New rating curve required as gauge location moved upstream in 2022</td>
    </tr>
    <tr>
      <td>25.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New curve developed in Aquarius to modernize imported Compumod curve</td>
    </tr>
    <tr>
      <td>24.00</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07BB002"))
:::
...
<div class="download-section">
  <a href="../../07BB002/07BB002_field_visits.csv" download class="download-btn">
