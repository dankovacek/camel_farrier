...
# 08NA031: WARM SPRINGS CREEK NEAR FAIRMONT
...
result = plot_station_polygon("08NA031")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA031">stations/08NA031 folder on GitHub</a>.
:::
...
<tr><td>08NA031</td><td>WARM SPRINGS CREEK NEAR FAIRMONT</td><td>50.329</td><td>-115.838</td><td>10.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 183 daily observations, continuous record | 41.0% flagged (estimated: 75)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 25.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>183 daily observations, continuous record | 41.0% flagged (estimated: 75) | Record: 0.5 years</td></tr>
...
show(plot_station_timeseries("08NA031"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA031")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA031/08NA031_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA031/08NA031_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA031"))
:::
...
<div class="download-section">
  <a href="../../08NA031/08NA031_field_visits.csv" download class="download-btn">
