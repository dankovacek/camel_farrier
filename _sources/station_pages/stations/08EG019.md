...
# 08EG019: KITSUMKALUM RIVER BELOW ALICE CREEK
...
result = plot_station_polygon("08EG019")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EG019">stations/08EG019 folder on GitHub</a>.
:::
...
<tr><td>08EG019</td><td>KITSUMKALUM RIVER BELOW ALICE CREEK</td><td>54.679</td><td>-128.744</td><td>2070.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 6.3 years
<br><strong>Timeseries Summary:</strong> 2,314 daily observations, continuous record | 1.0% flagged (estimated: 21, partial day: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 6216.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,314 daily observations, continuous record | 1.0% flagged (estimated: 21, partial day: 3) | Record: 6.3 years</td></tr>
...
show(plot_station_timeseries("08EG019"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EG019")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EG019/08EG019_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08EG019/08EG019_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08EG019/08EG019_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08EG019"))
:::
...
<div class="download-section">
  <a href="../../08EG019/08EG019_field_visits.csv" download class="download-btn">
