...
# 08NL011: OLALLA CREEK AT OLALLA
...
result = plot_station_polygon("08NL011")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL011">stations/08NL011 folder on GitHub</a>.
:::
...
<tr><td>08NL011</td><td>OLALLA CREEK AT OLALLA</td><td>49.264</td><td>-119.833</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 549 daily observations, seasonal gaps: 182 days avg (N=2) | 57.2% flagged (estimated: 314)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>549 daily observations, seasonal gaps: 182 days avg (N=2) | 57.2% flagged (estimated: 314) | Record: 2.5 years</td></tr>
...
show(plot_station_timeseries("08NL011"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL011")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL011/08NL011_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NL011/08NL011_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL011"))
:::
...
<div class="download-section">
  <a href="../../08NL011/08NL011_field_visits.csv" download class="download-btn">
