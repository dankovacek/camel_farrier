...
# 08NG079: LAKE KOOCANUSA AT INTERNATIONAL BOUNDARY
...
result = plot_station_polygon("08NG079")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG079">stations/08NG079 folder on GitHub</a>.
:::
...
<tr><td>08NG079</td><td>LAKE KOOCANUSA AT INTERNATIONAL BOUNDARY</td><td>49.000</td><td>-115.170</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 55890.6 km²</td></tr>
...
show(plot_station_timeseries("08NG079"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG079")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG079/08NG079_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NG079/08NG079_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG079"))
:::
