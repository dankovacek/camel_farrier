...
# 08LF042: RUSH CREEK NEAR KAMLOOPS
...
result = plot_station_polygon("08LF042")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF042">stations/08LF042 folder on GitHub</a>.
:::
...
<tr><td>08LF042</td><td>RUSH CREEK NEAR KAMLOOPS</td><td>50.594</td><td>-120.471</td><td>1.3 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 183 daily observations, continuous record</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>183 daily observations, continuous record | Record: 0.5 years</td></tr>
...
show(plot_station_timeseries("08LF042"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF042")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF042/08LF042_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF042/08LF042_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF042"))
:::
