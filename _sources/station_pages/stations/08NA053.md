...
result = plot_station_polygon("08NA053")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA053">stations/08NA053 folder on GitHub</a>.
:::
...
<tr><td>08NA053</td><td>KICKING HORSE RIVER BELOW SHERBROOKE CREEK</td><td>51.437</td><td>-116.374</td><td>119.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,160 daily observations, seasonal gaps: 6925 days avg (N=2) | 24.8% flagged (estimated: 316, backwater: 216, partial day: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 304.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,160 daily observations, seasonal gaps: 6925 days avg (N=2) | 24.8% flagged (estimated: 316, backwater: 216, partial day: 3) | Record: 43.8 years</td></tr>
...
show(plot_station_timeseries("08NA053"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA053")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA053/08NA053_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA053/08NA053_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA053"))
:::
...
<div class="download-section">
  <a href="../../08NA053/08NA053_field_visits.csv" download class="download-btn">
