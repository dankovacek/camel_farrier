...
result = plot_station_polygon("07GD002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07GD002">stations/07GD002 folder on GitHub</a>.
:::
...
<tr><td>07GD002</td><td>BEAVERTAIL CREEK NEAR HYTHE</td><td>55.316</td><td>-119.643</td><td>666.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 26.6 years
<br><strong>Timeseries Summary:</strong> 7,307 daily observations, seasonal gaps: 92 days avg (N=26) | 22.2% flagged (backwater: 1459, estimated: 116, partial day: 50)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2111.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>7,307 daily observations, seasonal gaps: 92 days avg (N=26) | 22.2% flagged (backwater: 1459, estimated: 116, partial day: 50) | Record: 26.6 years</td></tr>
...
show(plot_station_timeseries("07GD002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07GD002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07GD002/07GD002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07GD002/07GD002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07GD002"))
:::
...
<div class="download-section">
  <a href="../../07GD002/07GD002_field_visits.csv" download class="download-btn">
