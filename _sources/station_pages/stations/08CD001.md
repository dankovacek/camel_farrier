...
result = plot_station_polygon("08CD001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08CD001">stations/08CD001 folder on GitHub</a>.
:::
...
<tr><td>08CD001</td><td>TUYA RIVER NEAR TELEGRAPH CREEK</td><td>58.072</td><td>-130.826</td><td>3550.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 62.9 years
<br><strong>Timeseries Summary:</strong> 22,617 daily observations, minor gaps: 60 days avg (N=6) | 50.1% flagged (backwater: 11125, estimated: 175, partial day: 25)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 13082.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>22,617 daily observations, minor gaps: 60 days avg (N=6) | 50.1% flagged (backwater: 11125, estimated: 175, partial day: 25) | Record: 62.9 years</td></tr>
...
show(plot_station_timeseries("08CD001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08CD001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08CD001/08CD001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08CD001/08CD001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08CD001/08CD001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Curve 19.00 created in consideration of new 2023 and 2024 data which suggests rating is consistent w...</td>
    </tr>
    <tr>
      <td>18.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extension of rating 18.00</td>
    </tr>
    <tr>
      <td>18.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New Curve for 2016-2018 data which indicates scour of control relative to Curve 17.000. New curve ap...</td>
    </tr>
    <tr>
      <td>17.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve 17.000 replaces compumod curve; change to new curve occurs under ice conditions.</td>
    </tr>
    <tr>
      <td>16.00</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("08CD001"))
:::
...
<div class="download-section">
  <a href="../../08CD001/08CD001_field_visits.csv" download class="download-btn">
