...
# 08NE073: BLUEBERRY CREEK NEAR BLUEBERRY CREEK
...
result = plot_station_polygon("08NE073")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE073">stations/08NE073 folder on GitHub</a>.
:::
...
<tr><td>08NE073</td><td>BLUEBERRY CREEK NEAR BLUEBERRY CREEK</td><td>49.256</td><td>-117.681</td><td>145.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 3,867 daily observations, seasonal gaps: 510 days avg (N=8) | 56.7% flagged (estimated: 1912, backwater: 280)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 344.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,867 daily observations, seasonal gaps: 510 days avg (N=8) | 56.7% flagged (estimated: 1912, backwater: 280) | Record: 21.7 years</td></tr>
...
show(plot_station_timeseries("08NE073"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE073")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE073/08NE073_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE073/08NE073_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE073"))
:::
