...
# 07GE005: BEAR RIVER NEAR GRANDE PRAIRIE
...
result = plot_station_polygon("07GE005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07GE005">stations/07GE005 folder on GitHub</a>.
:::
...
<tr><td>07GE005</td><td>BEAR RIVER NEAR GRANDE PRAIRIE</td><td>55.200</td><td>-118.836</td><td>1510.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 4.1 years
<br><strong>Timeseries Summary:</strong> 1,492 daily observations, continuous record | 50.7% flagged (backwater: 694, estimated: 53, partial day: 9)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4945.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,492 daily observations, continuous record | 50.7% flagged (backwater: 694, estimated: 53, partial day: 9) | Record: 4.1 years</td></tr>
...
show(plot_station_timeseries("07GE005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07GE005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07GE005/07GE005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07GE005/07GE005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07GE005"))
:::
...
<div class="download-section">
  <a href="../../07GE005/07GE005_field_visits.csv" download class="download-btn">
