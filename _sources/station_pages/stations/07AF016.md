...
# 07AF016: ERITH RIVER BELOW HANLAN CREEK
...
result = plot_station_polygon("07AF016")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07AF016">stations/07AF016 folder on GitHub</a>.
:::
...
<tr><td>07AF016</td><td>ERITH RIVER BELOW HANLAN CREEK</td><td>53.236</td><td>-116.566</td><td>nan (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 4.9 years
<br><strong>Timeseries Summary:</strong> 1,250 daily observations, seasonal gaps: 136 days avg (N=4) | 17.6% flagged (backwater: 165, partial day: 34, estimated: 21)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1631.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,250 daily observations, seasonal gaps: 136 days avg (N=4) | 17.6% flagged (backwater: 165, partial day: 34, estimated: 21) | Record: 4.9 years</td></tr>
...
show(plot_station_timeseries("07AF016"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07AF016")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07AF016/07AF016_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07AF016/07AF016_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07AF016"))
:::
