...
# 08NL014: KEREMEOS CREEK ABOVE MARSEL CREEK
...
result = plot_station_polygon("08NL014")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL014">stations/08NL014 folder on GitHub</a>.
:::
...
<tr><td>08NL014</td><td>KEREMEOS CREEK ABOVE MARSEL CREEK</td><td>49.333</td><td>-119.817</td><td>68.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 7.5 years
<br><strong>Timeseries Summary:</strong> 1,434 daily observations, seasonal gaps: 186 days avg (N=7) | 41.4% flagged (estimated: 594)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 159.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,434 daily observations, seasonal gaps: 186 days avg (N=7) | 41.4% flagged (estimated: 594) | Record: 7.5 years</td></tr>
...
show(plot_station_timeseries("08NL014"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL014")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL014/08NL014_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NL014/08NL014_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL014"))
:::
...
<div class="download-section">
  <a href="../../08NL014/08NL014_field_visits.csv" download class="download-btn">
