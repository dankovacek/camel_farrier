...
# 08NA057: WILMER CREEK NEAR WILMER
...
result = plot_station_polygon("08NA057")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA057">stations/08NA057 folder on GitHub</a>.
:::
...
<tr><td>08NA057</td><td>WILMER CREEK NEAR WILMER</td><td>50.546</td><td>-116.098</td><td>6.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,829 daily observations, minor gaps: 60 days avg (N=2) | 61.4% flagged (estimated: 931, backwater: 192)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 34.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,829 daily observations, minor gaps: 60 days avg (N=2) | 61.4% flagged (estimated: 931, backwater: 192) | Record: 5.3 years</td></tr>
...
show(plot_station_timeseries("08NA057"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA057")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA057/08NA057_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA057/08NA057_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA057"))
:::
