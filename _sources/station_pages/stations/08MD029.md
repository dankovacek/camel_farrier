...
# 08MD029: BLACKHILL CREEK NEAR PAVILION
...
result = plot_station_polygon("08MD029")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MD029">stations/08MD029 folder on GitHub</a>.
:::
...
<tr><td>08MD029</td><td>BLACKHILL CREEK NEAR PAVILION</td><td>50.802</td><td>-121.895</td><td>13.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 4.6 years
<br><strong>Timeseries Summary:</strong> 1,163 daily observations, seasonal gaps: 128 days avg (N=4) | 10.2% flagged (estimated: 104, partial day: 15)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 33.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,163 daily observations, seasonal gaps: 128 days avg (N=4) | 10.2% flagged (estimated: 104, partial day: 15) | Record: 4.6 years</td></tr>
...
show(plot_station_timeseries("08MD029"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MD029")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MD029/08MD029_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MD029/08MD029_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MD029"))
:::
...
<div class="download-section">
  <a href="../../08MD029/08MD029_field_visits.csv" download class="download-btn">
