...
# 08MH008: GURNEY CREEK NEAR PORT COQUITLAM
...
result = plot_station_polygon("08MH008")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH008">stations/08MH008 folder on GitHub</a>.
:::
...
<tr><td>08MH008</td><td>GURNEY CREEK NEAR PORT COQUITLAM</td><td>49.483</td><td>-122.534</td><td>38.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 426 daily observations, minor gaps: 61 days avg (N=1) | 78.2% flagged (estimated: 333)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 91.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>426 daily observations, minor gaps: 61 days avg (N=1) | 78.2% flagged (estimated: 333) | Record: 1.3 years</td></tr>
...
show(plot_station_timeseries("08MH008"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH008")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH008/08MH008_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH008/08MH008_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH008"))
:::
...
<div class="download-section">
  <a href="../../08MH008/08MH008_field_visits.csv" download class="download-btn">
