...
# 08AA001: AISHIHIK RIVER NEAR WHITEHORSE
...
result = plot_station_polygon("08AA001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08AA001">stations/08AA001 folder on GitHub</a>.
:::
...
<tr><td>08AA001</td><td>AISHIHIK RIVER NEAR WHITEHORSE</td><td>60.861</td><td>-137.061</td><td>4300.0 (0.0)</td><td>YT</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 36.7 years
<br><strong>Timeseries Summary:</strong> 13,180 daily observations, minor gaps: 71 days avg (N=3) | 54.0% flagged (backwater: 6735, estimated: 331, partial day: 46)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 18920.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>13,180 daily observations, minor gaps: 71 days avg (N=3) | 54.0% flagged (backwater: 6735, estimated: 331, partial day: 46) | Record: 36.7 years</td></tr>
...
show(plot_station_timeseries("08AA001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08AA001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08AA001/08AA001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08AA001/08AA001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08AA001"))
:::
