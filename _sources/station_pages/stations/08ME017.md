...
# 08ME017: SETON LAKE NEAR SHALALTH
...
result = plot_station_polygon("08ME017")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08ME017">stations/08ME017 folder on GitHub</a>.
:::
...
<tr><td>08ME017</td><td>SETON LAKE NEAR SHALALTH</td><td>50.728</td><td>-122.233</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2479.7 km²</td></tr>
...
show(plot_station_timeseries("08ME017"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08ME017")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08ME017/08ME017_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08ME017/08ME017_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08ME017"))
:::
...
<div class="download-section">
  <a href="../../08ME017/08ME017_field_visits.csv" download class="download-btn">
