...
# 08LC044: HADDO LAKE AT THE OUTLET
...
result = plot_station_polygon("08LC044")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LC044">stations/08LC044 folder on GitHub</a>.
:::
...
<tr><td>08LC044</td><td>HADDO LAKE AT THE OUTLET</td><td>50.094</td><td>-119.084</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 247.8 km²</td></tr>
...
show(plot_station_timeseries("08LC044"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LC044")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LC044/08LC044_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LC044/08LC044_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LC044"))
:::
