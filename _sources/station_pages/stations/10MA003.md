...
The data representing the above plots can be downloaded from the [stations/10MA003](https://dankovacek.github.io/camel_farrier/stations/10MA003) folder in the Github repository.
