...
# 08LF067: BARNARD CREEK NEAR ASHCROFT
...
result = plot_station_polygon("08LF067")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF067">stations/08LF067 folder on GitHub</a>.
:::
...
<tr><td>08LF067</td><td>BARNARD CREEK NEAR ASHCROFT</td><td>50.669</td><td>-121.278</td><td>29.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 123 daily observations, minor gaps: 30 days avg (N=1) | 25.2% flagged (estimated: 31)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 65.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>123 daily observations, minor gaps: 30 days avg (N=1) | 25.2% flagged (estimated: 31) | Record: 0.4 years</td></tr>
...
show(plot_station_timeseries("08LF067"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF067")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF067/08LF067_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF067/08LF067_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF067"))
:::
...
<div class="download-section">
  <a href="../../08LF067/08LF067_field_visits.csv" download class="download-btn">
