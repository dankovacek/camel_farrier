...
result = plot_station_polygon("07GE003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07GE003">stations/07GE003 folder on GitHub</a>.
:::
...
<tr><td>07GE003</td><td>GRANDE PRAIRIE CREEK NEAR SEXSMITH</td><td>55.375</td><td>-118.916</td><td>140.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 55.2 years
<br><strong>Timeseries Summary:</strong> 14,662 daily observations, seasonal gaps: 100 days avg (N=55) | 26.9% flagged (backwater: 2866, estimated: 916, partial day: 161)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 427.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>14,662 daily observations, seasonal gaps: 100 days avg (N=55) | 26.9% flagged (backwater: 2866, estimated: 916, partial day: 161) | Record: 55.2 years</td></tr>
...
show(plot_station_timeseries("07GE003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07GE003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07GE003/07GE003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07GE003/07GE003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07GE003/07GE003_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Three segment curve representing section (low flow in culvert), channel (culvert filling), and overb...</td>
    </tr>
    <tr>
      <td>10.0</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07GE003"))
:::
...
<div class="download-section">
  <a href="../../07GE003/07GE003_field_visits.csv" download class="download-btn">
