...
result = plot_station_polygon("08HB069")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB069">stations/08HB069 folder on GitHub</a>.
:::
...
<tr><td>08HB069</td><td>CARNATION CREEK AT 150 M CONTOUR</td><td>48.929</td><td>-124.941</td><td>2.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.95, ΔArea: +5.1%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 18.6 years
<br><strong>Timeseries Summary:</strong> 6,786 daily observations, continuous record | 5.1% flagged (estimated: 312, partial day: 28, backwater: 7)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>6,786 daily observations, continuous record | 5.1% flagged (estimated: 312, partial day: 28, backwater: 7) | Record: 18.6 years</td></tr>
...
show(plot_station_timeseries("08HB069"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB069")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB069/08HB069_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HB069/08HB069_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HB069"))
:::
...
<div class="download-section">
  <a href="../../08HB069/08HB069_field_visits.csv" download class="download-btn">
