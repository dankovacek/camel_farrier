...
The data representing the above plots can be downloaded from the [stations/08FE003](https://dankovacek.github.io/camel_farrier/stations/08FE003) folder in the Github repository.
