...
# 08LE017: PEMBERTON CREEK NEAR PRITCHARD
...
result = plot_station_polygon("08LE017")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE017">stations/08LE017 folder on GitHub</a>.
:::
...
<tr><td>08LE017</td><td>PEMBERTON CREEK NEAR PRITCHARD</td><td>50.702</td><td>-119.863</td><td>20.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 1.1 years
<br><strong>Timeseries Summary:</strong> 244 daily observations, seasonal gaps: 152 days avg (N=1) | 6.1% flagged (estimated: 15)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 41.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>244 daily observations, seasonal gaps: 152 days avg (N=1) | 6.1% flagged (estimated: 15) | Record: 1.1 years</td></tr>
...
show(plot_station_timeseries("08LE017"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE017")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE017/08LE017_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE017/08LE017_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE017"))
:::
...
<div class="download-section">
  <a href="../../08LE017/08LE017_field_visits.csv" download class="download-btn">
