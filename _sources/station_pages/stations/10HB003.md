...
# 10HB003: WRIGLEY RIVER NEAR THE MOUTH
...
result = plot_station_polygon("10HB003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10HB003">stations/10HB003 folder on GitHub</a>.
:::
...
<tr><td>10HB003</td><td>WRIGLEY RIVER NEAR THE MOUTH</td><td>63.176</td><td>-123.690</td><td>1230.0 (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 11.1 years
<br><strong>Timeseries Summary:</strong> 4,018 daily observations, minor gaps: 31 days avg (N=1) | 61.5% flagged (backwater: 2348, estimated: 101, partial day: 21)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 6076.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>4,018 daily observations, minor gaps: 31 days avg (N=1) | 61.5% flagged (backwater: 2348, estimated: 101, partial day: 21) | Record: 11.1 years</td></tr>
...
show(plot_station_timeseries("10HB003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10HB003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10HB003/10HB003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10HB003/10HB003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10HB003"))
:::
...
<div class="download-section">
  <a href="../../10HB003/10HB003_field_visits.csv" download class="download-btn">
