...
result = plot_station_polygon("09AA010")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09AA010">stations/09AA010 folder on GitHub</a>.
:::
...
<tr><td>09AA010</td><td>LINDEMAN CREEK NEAR BENNETT</td><td>59.838</td><td>-135.014</td><td>240.0 (0.0)</td><td>YT</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 14,094 daily observations, minor gaps: 81 days avg (N=3) | 47.8% flagged (estimated: 4738, backwater: 1866, partial day: 134)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 890.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>14,094 daily observations, minor gaps: 81 days avg (N=3) | 47.8% flagged (estimated: 4738, backwater: 1866, partial day: 134) | Record: 39.2 years</td></tr>
...
show(plot_station_timeseries("09AA010"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09AA010")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09AA010/09AA010_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../09AA010/09AA010_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("09AA010"))
:::
...
<div class="download-section">
  <a href="../../09AA010/09AA010_field_visits.csv" download class="download-btn">
