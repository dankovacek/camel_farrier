...
# 08NM122: ELLIS CREEK NORTH MAIN DIVERSION
...
result = plot_station_polygon("08NM122")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM122">stations/08NM122 folder on GitHub</a>.
:::
...
<tr><td>08NM122</td><td>ELLIS CREEK NORTH MAIN DIVERSION</td><td>49.481</td><td>-119.562</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 275 daily observations, seasonal gaps: 578 days avg (N=1) | 10.5% flagged (estimated: 29)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 372.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>275 daily observations, seasonal gaps: 578 days avg (N=1) | 10.5% flagged (estimated: 29) | Record: 2.3 years</td></tr>
...
show(plot_station_timeseries("08NM122"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM122")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM122/08NM122_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM122/08NM122_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM122"))
:::
...
<div class="download-section">
  <a href="../../08NM122/08NM122_field_visits.csv" download class="download-btn">
