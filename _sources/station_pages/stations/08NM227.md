...
# 08NM227: GARNET LAKE NEAR SUMMERLAND
...
result = plot_station_polygon("08NM227")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM227">stations/08NM227 folder on GitHub</a>.
:::
...
<tr><td>08NM227</td><td>GARNET LAKE NEAR SUMMERLAND</td><td>49.686</td><td>-119.775</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 137.7 km²</td></tr>
...
show(plot_station_timeseries("08NM227"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM227")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM227/08NM227_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM227/08NM227_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM227"))
:::
...
<div class="download-section">
  <a href="../../08NM227/08NM227_field_visits.csv" download class="download-btn">
