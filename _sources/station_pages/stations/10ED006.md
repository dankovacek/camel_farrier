...
# 10ED006: RABBIT CREEK AT HIGHWAY NO. 7
...
result = plot_station_polygon("10ED006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10ED006">stations/10ED006 folder on GitHub</a>.
:::
...
<tr><td>10ED006</td><td>RABBIT CREEK AT HIGHWAY NO. 7</td><td>60.464</td><td>-123.365</td><td>92.7 (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.93, ΔArea: -1.4%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 7.0 years
<br><strong>Timeseries Summary:</strong> 2,557 daily observations, continuous record | 63.7% flagged (backwater: 1391, estimated: 224, partial day: 13)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 441.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,557 daily observations, continuous record | 63.7% flagged (backwater: 1391, estimated: 224, partial day: 13) | Record: 7.0 years</td></tr>
...
show(plot_station_timeseries("10ED006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10ED006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10ED006/10ED006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10ED006/10ED006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10ED006"))
:::
...
<div class="download-section">
  <a href="../../10ED006/10ED006_field_visits.csv" download class="download-btn">
