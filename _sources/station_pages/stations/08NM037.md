...
# 08NM037: SHATFORD CREEK NEAR PENTICTON
...
result = plot_station_polygon("08NM037")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM037">stations/08NM037 folder on GitHub</a>.
:::
...
<tr><td>08NM037</td><td>SHATFORD CREEK NEAR PENTICTON</td><td>49.427</td><td>-119.752</td><td>101.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 104.8 years
<br><strong>Timeseries Summary:</strong> 23,139 daily observations, seasonal gaps: 1260 days avg (N=12) | 23.1% flagged (backwater: 2596, estimated: 2564, partial day: 184)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 238.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>23,139 daily observations, seasonal gaps: 1260 days avg (N=12) | 23.1% flagged (backwater: 2596, estimated: 2564, partial day: 184) | Record: 104.8 years</td></tr>
...
show(plot_station_timeseries("08NM037"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM037")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM037/08NM037_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NM037/08NM037_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM037/08NM037_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM037"))
:::
...
<div class="download-section">
  <a href="../../08NM037/08NM037_field_visits.csv" download class="download-btn">
