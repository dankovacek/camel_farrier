...
result = plot_station_polygon("08NL067")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL067">stations/08NL067 folder on GitHub</a>.
:::
...
<tr><td>08NL067</td><td>TULAMEEN RIVER NEAR TULAMEEN</td><td>49.541</td><td>-120.800</td><td>619.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 6.6 years
<br><strong>Timeseries Summary:</strong> 2,225 daily observations, minor gaps: 45 days avg (N=4) | 18.6% flagged (backwater: 314, estimated: 100)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1451.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,225 daily observations, minor gaps: 45 days avg (N=4) | 18.6% flagged (backwater: 314, estimated: 100) | Record: 6.6 years</td></tr>
...
show(plot_station_timeseries("08NL067"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL067")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL067/08NL067_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NL067/08NL067_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL067"))
:::
...
<div class="download-section">
  <a href="../../08NL067/08NL067_field_visits.csv" download class="download-btn">
