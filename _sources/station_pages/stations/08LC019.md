...
# 08LC019: SHUSWAP RIVER AT OUTLET OF MABEL LAKE
...
result = plot_station_polygon("08LC019")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LC019">stations/08LC019 folder on GitHub</a>.
:::
...
<tr><td>08LC019</td><td>SHUSWAP RIVER AT OUTLET OF MABEL LAKE</td><td>50.603</td><td>-118.738</td><td>4040.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 13,333 daily observations, seasonal gaps: 5752 days avg (N=1) | 6.6% flagged (estimated: 838, backwater: 31, partial day: 7)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 9995.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>13,333 daily observations, seasonal gaps: 5752 days avg (N=1) | 6.6% flagged (estimated: 838, backwater: 31, partial day: 7) | Record: 52.2 years</td></tr>
...
show(plot_station_timeseries("08LC019"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LC019")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LC019/08LC019_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LC019/08LC019_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LC019"))
:::
...
<div class="download-section">
  <a href="../../08LC019/08LC019_field_visits.csv" download class="download-btn">
