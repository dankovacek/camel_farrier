...
# 08HB019: CAMERON RIVER NEAR ALBERNI
...
result = plot_station_polygon("08HB019")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB019">stations/08HB019 folder on GitHub</a>.
:::
...
<tr><td>08HB019</td><td>CAMERON RIVER NEAR ALBERNI</td><td>49.246</td><td>-124.657</td><td>83.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 396 daily observations, minor gaps: 30 days avg (N=1) | 40.2% flagged (estimated: 159)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 192.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>396 daily observations, minor gaps: 30 days avg (N=1) | 40.2% flagged (estimated: 159) | Record: 1.2 years</td></tr>
...
show(plot_station_timeseries("08HB019"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB019")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB019/08HB019_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HB019/08HB019_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HB019"))
:::
...
<div class="download-section">
  <a href="../../08HB019/08HB019_field_visits.csv" download class="download-btn">
