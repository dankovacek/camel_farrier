...
# 08NK011: HARTLEY CREEK NEAR FERNIE
...
result = plot_station_polygon("08NK011")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NK011">stations/08NK011 folder on GitHub</a>.
:::
...
<tr><td>08NK011</td><td>HARTLEY CREEK NEAR FERNIE</td><td>49.567</td><td>-115.017</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 550 daily observations, seasonal gaps: 700 days avg (N=3) | 61.6% flagged (estimated: 339)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 41.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>550 daily observations, seasonal gaps: 700 days avg (N=3) | 61.6% flagged (estimated: 339) | Record: 7.2 years</td></tr>
...
show(plot_station_timeseries("08NK011"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NK011")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NK011/08NK011_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NK011/08NK011_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NK011"))
:::
...
<div class="download-section">
  <a href="../../08NK011/08NK011_field_visits.csv" download class="download-btn">
