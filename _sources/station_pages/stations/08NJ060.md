...
# 08NJ060: FOSTER CREEK NEAR NELSON
...
result = plot_station_polygon("08NJ060")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ060">stations/08NJ060 folder on GitHub</a>.
:::
...
<tr><td>08NJ060</td><td>FOSTER CREEK NEAR NELSON</td><td>49.520</td><td>-117.280</td><td>1.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 397 daily observations, seasonal gaps: 593 days avg (N=2) | 54.4% flagged (estimated: 216)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>397 daily observations, seasonal gaps: 593 days avg (N=2) | 54.4% flagged (estimated: 216) | Record: 4.3 years</td></tr>
...
show(plot_station_timeseries("08NJ060"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ060")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ060/08NJ060_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ060/08NJ060_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ060"))
:::
...
<div class="download-section">
  <a href="../../08NJ060/08NJ060_field_visits.csv" download class="download-btn">
