...
# 08KE008: CUISSON CREEK (SOUTH FORK) NEAR MARGUERITE
...
result = plot_station_polygon("08KE008")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KE008">stations/08KE008 folder on GitHub</a>.
:::
...
<tr><td>08KE008</td><td>CUISSON CREEK (SOUTH FORK) NEAR MARGUERITE</td><td>52.518</td><td>-122.328</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 672 daily observations, seasonal gaps: 494 days avg (N=4) | 48.7% flagged (estimated: 327)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 126.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>672 daily observations, seasonal gaps: 494 days avg (N=4) | 48.7% flagged (estimated: 327) | Record: 7.2 years</td></tr>
...
show(plot_station_timeseries("08KE008"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KE008")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KE008/08KE008_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KE008/08KE008_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KE008"))
:::
...
<div class="download-section">
  <a href="../../08KE008/08KE008_field_visits.csv" download class="download-btn">
