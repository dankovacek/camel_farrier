...
# 07FD014: WAINSCOTT COULEE NEAR BROWNVALE
...
result = plot_station_polygon("07FD014")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07FD014">stations/07FD014 folder on GitHub</a>.
:::
...
<tr><td>07FD014</td><td>WAINSCOTT COULEE NEAR BROWNVALE</td><td>56.027</td><td>-117.936</td><td>149.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 16.2 years
<br><strong>Timeseries Summary:</strong> 4,530 daily observations, minor gaps: 88 days avg (N=16) | 27.5% flagged (backwater: 763, estimated: 430, partial day: 52)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 527.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>4,530 daily observations, minor gaps: 88 days avg (N=16) | 27.5% flagged (backwater: 763, estimated: 430, partial day: 52) | Record: 16.2 years</td></tr>
...
show(plot_station_timeseries("07FD014"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07FD014")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07FD014/07FD014_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07FD014/07FD014_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07FD014"))
:::
...
<div class="download-section">
  <a href="../../07FD014/07FD014_field_visits.csv" download class="download-btn">
