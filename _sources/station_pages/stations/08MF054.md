...
# 08MF054: MOUNTAIN SLOUGH NEAR AGASSIZ
...
result = plot_station_polygon("08MF054")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MF054">stations/08MF054 folder on GitHub</a>.
:::
...
<tr><td>08MF054</td><td>MOUNTAIN SLOUGH NEAR AGASSIZ</td><td>49.254</td><td>-121.847</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 664 daily observations, seasonal gaps: 110 days avg (N=5) | 3.3% flagged (estimated: 22)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 14.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>664 daily observations, seasonal gaps: 110 days avg (N=5) | 3.3% flagged (estimated: 22) | Record: 3.3 years</td></tr>
...
show(plot_station_timeseries("08MF054"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MF054")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MF054/08MF054_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MF054/08MF054_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MF054"))
:::
...
<div class="download-section">
  <a href="../../08MF054/08MF054_field_visits.csv" download class="download-btn">
