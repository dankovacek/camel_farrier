...
# 08GA051: LANGDALE CREEK AT HIGHWAY NO. 101 NEAR GIBSONS
...
result = plot_station_polygon("08GA051")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA051">stations/08GA051 folder on GitHub</a>.
:::
...
<tr><td>08GA051</td><td>LANGDALE CREEK AT HIGHWAY NO. 101 NEAR GIBSONS</td><td>49.433</td><td>-123.479</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 3.4 years
<br><strong>Timeseries Summary:</strong> 489 daily observations, seasonal gaps: 380 days avg (N=2) | 2.0% flagged (estimated: 10)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 16.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>489 daily observations, seasonal gaps: 380 days avg (N=2) | 2.0% flagged (estimated: 10) | Record: 3.4 years</td></tr>
...
show(plot_station_timeseries("08GA051"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA051")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA051/08GA051_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA051/08GA051_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA051"))
:::
...
<div class="download-section">
  <a href="../../08GA051/08GA051_field_visits.csv" download class="download-btn">
