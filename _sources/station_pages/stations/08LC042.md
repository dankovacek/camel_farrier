...
# 08LC042: BESSETTE CREEK ABOVE LUMBY LAGOON OUTFALL
...
result = plot_station_polygon("08LC042")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LC042">stations/08LC042 folder on GitHub</a>.
:::
...
<tr><td>08LC042</td><td>BESSETTE CREEK ABOVE LUMBY LAGOON OUTFALL</td><td>50.252</td><td>-118.961</td><td>632.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 18,903 daily observations, continuous record | 20.5% flagged (backwater: 2947, estimated: 601, partial day: 318)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1541.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>18,903 daily observations, continuous record | 20.5% flagged (backwater: 2947, estimated: 601, partial day: 318) | Record: 51.8 years</td></tr>
...
show(plot_station_timeseries("08LC042"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LC042")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LC042/08LC042_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08LC042/08LC042_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LC042/08LC042_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LC042"))
:::
...
<div class="download-section">
  <a href="../../08LC042/08LC042_field_visits.csv" download class="download-btn">
