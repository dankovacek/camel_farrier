...
result = plot_station_polygon("07AG008")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07AG008">stations/07AG008 folder on GitHub</a>.
:::
...
<tr><td>07AG008</td><td>GROAT CREEK NEAR WHITECOURT</td><td>54.033</td><td>-115.842</td><td>133.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 40.3 years
<br><strong>Timeseries Summary:</strong> 10,679 daily observations, seasonal gaps: 99 days avg (N=41) | 29.8% flagged (backwater: 2466, partial day: 375, estimated: 339)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 377.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>10,679 daily observations, seasonal gaps: 99 days avg (N=41) | 29.8% flagged (backwater: 2466, partial day: 375, estimated: 339) | Record: 40.3 years</td></tr>
...
show(plot_station_timeseries("07AG008"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07AG008")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07AG008/07AG008_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07AG008/07AG008_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07AG008/07AG008_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>New rating curve following channel modification and new pool for sensor (lower). Measurements are pl...</td>
    </tr>
    <tr>
      <td>15.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New rating curve to reflect orifice being relocated to an upstream gauge pool in August 2018.</td>
    </tr>
    <tr>
      <td>14.00</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Same as curve No. 12 below 1.526m</td>
    </tr>
    <tr>
      <td>12.000</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07AG008"))
:::
...
<div class="download-section">
  <a href="../../07AG008/07AG008_field_visits.csv" download class="download-btn">
