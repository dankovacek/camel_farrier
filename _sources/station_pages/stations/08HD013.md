...
# 08HD013: BARRON CREEK NEAR BLOEDEL
...
result = plot_station_polygon("08HD013")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HD013">stations/08HD013 folder on GitHub</a>.
:::
...
<tr><td>08HD013</td><td>BARRON CREEK NEAR BLOEDEL</td><td>50.112</td><td>-125.337</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 643 daily observations, seasonal gaps: 101 days avg (N=3) | 1.9% flagged (estimated: 12)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 0.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>643 daily observations, seasonal gaps: 101 days avg (N=3) | 1.9% flagged (estimated: 12) | Record: 2.6 years</td></tr>
...
show(plot_station_timeseries("08HD013"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HD013")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HD013/08HD013_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HD013/08HD013_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HD013"))
:::
