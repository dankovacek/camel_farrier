...
# 08NJ147: THOMPSON CREEK NEAR WILLOW POINT
...
result = plot_station_polygon("08NJ147")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ147">stations/08NJ147 folder on GitHub</a>.
:::
...
<tr><td>08NJ147</td><td>THOMPSON CREEK NEAR WILLOW POINT</td><td>49.571</td><td>-117.248</td><td>0.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.97, ΔArea: +1.8%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 581 daily observations, seasonal gaps: 250 days avg (N=4) | 51.1% flagged (estimated: 297)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>581 daily observations, seasonal gaps: 250 days avg (N=4) | 51.1% flagged (estimated: 297) | Record: 4.3 years</td></tr>
...
show(plot_station_timeseries("08NJ147"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ147")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ147/08NJ147_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ147/08NJ147_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ147"))
:::
...
<div class="download-section">
  <a href="../../08NJ147/08NJ147_field_visits.csv" download class="download-btn">
