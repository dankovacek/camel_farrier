...
# 08KE006: AUSTRALIAN CREEK AT AUSTRALIAN
...
result = plot_station_polygon("08KE006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KE006">stations/08KE006 folder on GitHub</a>.
:::
...
<tr><td>08KE006</td><td>AUSTRALIAN CREEK AT AUSTRALIAN</td><td>52.721</td><td>-122.443</td><td>164.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 42.5 years
<br><strong>Timeseries Summary:</strong> 1,528 daily observations, seasonal gaps: 1999 days avg (N=7) | 36.9% flagged (estimated: 557, backwater: 7)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 455.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,528 daily observations, seasonal gaps: 1999 days avg (N=7) | 36.9% flagged (estimated: 557, backwater: 7) | Record: 42.5 years</td></tr>
...
show(plot_station_timeseries("08KE006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KE006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KE006/08KE006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KE006/08KE006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KE006"))
:::
...
<div class="download-section">
  <a href="../../08KE006/08KE006_field_visits.csv" download class="download-btn">
