...
result = plot_station_polygon("08GA054")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA054">stations/08GA054 folder on GitHub</a>.
:::
...
<tr><td>08GA054</td><td>MAMQUAM RIVER ABOVE MASHITER CREEK</td><td>49.729</td><td>-123.106</td><td>334.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 6,939 daily observations, seasonal gaps: 130 days avg (N=4) | 8.7% flagged (backwater: 298, estimated: 266, partial day: 42)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 783.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>6,939 daily observations, seasonal gaps: 130 days avg (N=4) | 8.7% flagged (backwater: 298, estimated: 266, partial day: 42) | Record: 20.4 years</td></tr>
...
show(plot_station_timeseries("08GA054"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA054")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA054/08GA054_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA054/08GA054_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA054"))
:::
...
<div class="download-section">
  <a href="../../08GA054/08GA054_field_visits.csv" download class="download-btn">
