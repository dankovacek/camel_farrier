...
# 08MC009: LAC LA HACHE NEAR LAC LA HACHE
...
result = plot_station_polygon("08MC009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MC009">stations/08MC009 folder on GitHub</a>.
:::
...
<tr><td>08MC009</td><td>LAC LA HACHE NEAR LAC LA HACHE</td><td>51.848</td><td>-121.587</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3225.8 km²</td></tr>
...
show(plot_station_timeseries("08MC009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MC009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MC009/08MC009_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08MC009/08MC009_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MC009"))
:::
...
<div class="download-section">
  <a href="../../08MC009/08MC009_field_visits.csv" download class="download-btn">
