...
# 08NH010: HUGGARD CREEK NEAR WYNNDEL
...
result = plot_station_polygon("08NH010")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH010">stations/08NH010 folder on GitHub</a>.
:::
...
<tr><td>08NH010</td><td>HUGGARD CREEK NEAR WYNNDEL</td><td>49.201</td><td>-116.530</td><td>2.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 45.2 years
<br><strong>Timeseries Summary:</strong> 917 daily observations, seasonal gaps: 2602 days avg (N=6) | 60.5% flagged (estimated: 555)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>917 daily observations, seasonal gaps: 2602 days avg (N=6) | 60.5% flagged (estimated: 555) | Record: 45.2 years</td></tr>
...
show(plot_station_timeseries("08NH010"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH010")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH010/08NH010_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH010/08NH010_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH010"))
:::
...
<div class="download-section">
  <a href="../../08NH010/08NH010_field_visits.csv" download class="download-btn">
