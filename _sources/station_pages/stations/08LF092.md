...
# 08LF092: HAT CREEK ABOVE ANDERSON CREEK
...
result = plot_station_polygon("08LF092")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF092">stations/08LF092 folder on GitHub</a>.
:::
...
<tr><td>08LF092</td><td>HAT CREEK ABOVE ANDERSON CREEK</td><td>50.727</td><td>-121.599</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 945 daily observations, continuous record | 48.8% flagged (backwater: 291, estimated: 156, partial day: 14)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 526.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>945 daily observations, continuous record | 48.8% flagged (backwater: 291, estimated: 156, partial day: 14) | Record: 2.6 years</td></tr>
...
show(plot_station_timeseries("08LF092"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF092")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF092/08LF092_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF092/08LF092_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF092"))
:::
...
<div class="download-section">
  <a href="../../08LF092/08LF092_field_visits.csv" download class="download-btn">
