...
# 09FD003: PORCUPINE RIVER BELOW OLD CROW RIVER
...
result = plot_station_polygon("09FD003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09FD003">stations/09FD003 folder on GitHub</a>.
:::
...
<tr><td>09FD003</td><td>PORCUPINE RIVER BELOW OLD CROW RIVER</td><td>67.568</td><td>-139.834</td><td>nan (0.0)</td><td>YT</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 360390.6 km²</td></tr>
...
show(plot_station_timeseries("09FD003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09FD003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09FD003/09FD003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../09FD003/09FD003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("09FD003"))
:::
...
<div class="download-section">
  <a href="../../09FD003/09FD003_field_visits.csv" download class="download-btn">
