...
# 08NG056: HOULE CREEK NEAR KIMBERLEY
...
result = plot_station_polygon("08NG056")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG056">stations/08NG056 folder on GitHub</a>.
:::
...
<tr><td>08NG056</td><td>HOULE CREEK NEAR KIMBERLEY</td><td>49.733</td><td>-115.931</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 153 daily observations, continuous record | 62.1% flagged (estimated: 95)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 47.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>153 daily observations, continuous record | 62.1% flagged (estimated: 95) | Record: 0.4 years</td></tr>
...
show(plot_station_timeseries("08NG056"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG056")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG056/08NG056_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG056/08NG056_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG056"))
:::
...
<div class="download-section">
  <a href="../../08NG056/08NG056_field_visits.csv" download class="download-btn">
