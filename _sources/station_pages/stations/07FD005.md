...
# 07FD005: ALCES RIVER AT SECTION 20
...
result = plot_station_polygon("07FD005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07FD005">stations/07FD005 folder on GitHub</a>.
:::
...
<tr><td>07FD005</td><td>ALCES RIVER AT SECTION 20</td><td>56.386</td><td>-120.176</td><td>229.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 183 daily observations, continuous record | 32.8% flagged (estimated: 60)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 795.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>183 daily observations, continuous record | 32.8% flagged (estimated: 60) | Record: 0.5 years</td></tr>
...
show(plot_station_timeseries("07FD005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07FD005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07FD005/07FD005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07FD005/07FD005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07FD005"))
:::
...
<div class="download-section">
  <a href="../../07FD005/07FD005_field_visits.csv" download class="download-btn">
