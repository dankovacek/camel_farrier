...
# 08NE086: GIBSON CREEK NEAR BRILLIANT
...
result = plot_station_polygon("08NE086")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE086">stations/08NE086 folder on GitHub</a>.
:::
...
<tr><td>08NE086</td><td>GIBSON CREEK NEAR BRILLIANT</td><td>49.365</td><td>-117.658</td><td>2.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 275 daily observations, seasonal gaps: 243 days avg (N=1) | 39.3% flagged (estimated: 108)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 6.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>275 daily observations, seasonal gaps: 243 days avg (N=1) | 39.3% flagged (estimated: 108) | Record: 1.4 years</td></tr>
...
show(plot_station_timeseries("08NE086"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE086")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE086/08NE086_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE086/08NE086_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE086"))
:::
...
<div class="download-section">
  <a href="../../08NE086/08NE086_field_visits.csv" download class="download-btn">
