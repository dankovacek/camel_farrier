...
# 08NJ068: FORTY-NINE CREEK NEAR BLEWETT
...
result = plot_station_polygon("08NJ068")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ068">stations/08NJ068 folder on GitHub</a>.
:::
...
<tr><td>08NJ068</td><td>FORTY-NINE CREEK NEAR BLEWETT</td><td>49.461</td><td>-117.425</td><td>25.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 32.5 years
<br><strong>Timeseries Summary:</strong> 611 daily observations, seasonal gaps: 2815 days avg (N=4) | 47.3% flagged (estimated: 289)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 61.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>611 daily observations, seasonal gaps: 2815 days avg (N=4) | 47.3% flagged (estimated: 289) | Record: 32.5 years</td></tr>
...
show(plot_station_timeseries("08NJ068"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ068")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ068/08NJ068_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ068/08NJ068_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ068"))
:::
...
<div class="download-section">
  <a href="../../08NJ068/08NJ068_field_visits.csv" download class="download-btn">
