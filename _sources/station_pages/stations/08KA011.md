...
result = plot_station_polygon("08KA011")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KA011">stations/08KA011 folder on GitHub</a>.
:::
...
<tr><td>08KA011</td><td>MCLENNAN RIVER NEAR THE MOUTH</td><td>52.961</td><td>-119.458</td><td>534.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,100 daily observations, seasonal gaps: 159 days avg (N=4) | 20.1% flagged (estimated: 221)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1436.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,100 daily observations, seasonal gaps: 159 days avg (N=4) | 20.1% flagged (estimated: 221) | Record: 4.8 years</td></tr>
...
show(plot_station_timeseries("08KA011"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KA011")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KA011/08KA011_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KA011/08KA011_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KA011"))
:::
...
<div class="download-section">
  <a href="../../08KA011/08KA011_field_visits.csv" download class="download-btn">
