...
result = plot_station_polygon("07OB003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07OB003">stations/07OB003 folder on GitHub</a>.
:::
...
<tr><td>07OB003</td><td>HAY RIVER NEAR MEANDER RIVER</td><td>59.149</td><td>-117.636</td><td>36900.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 50.2 years
<br><strong>Timeseries Summary:</strong> 12,942 daily observations, seasonal gaps: 108 days avg (N=50) | 29.9% flagged (backwater: 3323, estimated: 388, partial day: 156)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 135188.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>12,942 daily observations, seasonal gaps: 108 days avg (N=50) | 29.9% flagged (backwater: 3323, estimated: 388, partial day: 156) | Record: 50.2 years</td></tr>
...
show(plot_station_timeseries("07OB003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07OB003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07OB003/07OB003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07OB003/07OB003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07OB003/07OB003_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Two segment curve with transition from section control to channel control between 4.3 m and 4.8 m.</td>
    </tr>
    <tr>
      <td>6.001</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Clone of 6.0 to circumvent locked shift . Renamed to 6.001</td>
    </tr>
    <tr>
      <td>6.000</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07OB003"))
:::
...
<div class="download-section">
  <a href="../../07OB003/07OB003_field_visits.csv" download class="download-btn">
