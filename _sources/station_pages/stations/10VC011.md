...
# 10VC011: ABBOTT RIVER ABOVE MIDSHIPMAN BAY
...
result = plot_station_polygon("10VC011")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10VC011">stations/10VC011 folder on GitHub</a>.
:::
...
<tr><td>10VC011</td><td>ABBOTT RIVER ABOVE MIDSHIPMAN BAY</td><td>75.233</td><td>-95.683</td><td>191.0 (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3028.7 km²</td></tr>
...
show(plot_station_timeseries("10VC011"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10VC011")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10VC011/10VC011_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10VC011"))
:::
...
<div class="download-section">
  <a href="../../10VC011/10VC011_field_visits.csv" download class="download-btn">
