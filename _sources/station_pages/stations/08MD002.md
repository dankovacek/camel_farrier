...
# 08MD002: PAVILION CREEK NEAR PAVILION (LOWER STATION)
...
result = plot_station_polygon("08MD002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MD002">stations/08MD002 folder on GitHub</a>.
:::
...
<tr><td>08MD002</td><td>PAVILION CREEK NEAR PAVILION (LOWER STATION)</td><td>50.893</td><td>-121.797</td><td>207.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 28.3 years
<br><strong>Timeseries Summary:</strong> 3,448 daily observations, seasonal gaps: 363 days avg (N=19) | 11.2% flagged (estimated: 386)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 411.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,448 daily observations, seasonal gaps: 363 days avg (N=19) | 11.2% flagged (estimated: 386) | Record: 28.3 years</td></tr>
...
show(plot_station_timeseries("08MD002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MD002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MD002/08MD002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MD002/08MD002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MD002"))
:::
...
<div class="download-section">
  <a href="../../08MD002/08MD002_field_visits.csv" download class="download-btn">
