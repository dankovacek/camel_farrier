...
result = plot_station_polygon("08HA031")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HA031">stations/08HA031 folder on GitHub</a>.
:::
...
<tr><td>08HA031</td><td>TUGWELL CREEK AT THE MOUTH</td><td>48.376</td><td>-123.849</td><td>26.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,071 daily observations, seasonal gaps: 121 days avg (N=5) | 7.1% flagged (estimated: 76)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 44.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,071 daily observations, seasonal gaps: 121 days avg (N=5) | 7.1% flagged (estimated: 76) | Record: 4.6 years</td></tr>
...
show(plot_station_timeseries("08HA031"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HA031")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HA031/08HA031_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HA031/08HA031_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HA031"))
:::
...
<div class="download-section">
  <a href="../../08HA031/08HA031_field_visits.csv" download class="download-btn">
