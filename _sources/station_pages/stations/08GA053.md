...
# 08GA053: SQUAMISH RIVER BELOW MAMQUAM RIVER
...
result = plot_station_polygon("08GA053")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA053">stations/08GA053 folder on GitHub</a>.
:::
...
<tr><td>08GA053</td><td>SQUAMISH RIVER BELOW MAMQUAM RIVER</td><td>49.722</td><td>-123.165</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 9310.7 km²</td></tr>
...
show(plot_station_timeseries("08GA053"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA053")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA053/08GA053_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08GA053/08GA053_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA053"))
:::
...
<div class="download-section">
  <a href="../../08GA053/08GA053_field_visits.csv" download class="download-btn">
