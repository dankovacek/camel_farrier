...
The data representing the above plots can be downloaded from the [stations/05NG020](https://dankovacek.github.io/camel_farrier/stations/05NG020) folder in the Github repository.
