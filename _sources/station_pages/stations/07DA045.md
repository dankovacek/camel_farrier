...
# 07DA045: TAR RIVER NEAR THE MOUTH
...
result = plot_station_polygon("07DA045")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DA045">stations/07DA045 folder on GitHub</a>.
:::
...
<tr><td>07DA045</td><td>TAR RIVER NEAR THE MOUTH</td><td>57.322</td><td>-111.691</td><td>320.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.98, ΔArea: -1.2%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 7.6 years
<br><strong>Timeseries Summary:</strong> 2,771 daily observations, continuous record | 55.8% flagged (backwater: 1385, estimated: 119, partial day: 42)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1105.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,771 daily observations, continuous record | 55.8% flagged (backwater: 1385, estimated: 119, partial day: 42) | Record: 7.6 years</td></tr>
...
show(plot_station_timeseries("07DA045"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07DA045")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07DA045/07DA045_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07DA045/07DA045_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07DA045/07DA045_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07DA045"))
:::
...
<div class="download-section">
  <a href="../../07DA045/07DA045_field_visits.csv" download class="download-btn">
