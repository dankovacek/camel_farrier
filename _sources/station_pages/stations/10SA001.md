...
# 10SA001: UNNAMED RIVER AT OUTLET OF LAKE JEKYL
...
result = plot_station_polygon("10SA001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10SA001">stations/10SA001 folder on GitHub</a>.
:::
...
<tr><td>10SA001</td><td>UNNAMED RIVER AT OUTLET OF LAKE JEKYL</td><td>69.783</td><td>-93.500</td><td>502.0 (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4190.6 km²</td></tr>
...
show(plot_station_timeseries("10SA001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10SA001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10SA001/10SA001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10SA001"))
:::
...
<div class="download-section">
  <a href="../../10SA001/10SA001_field_visits.csv" download class="download-btn">
