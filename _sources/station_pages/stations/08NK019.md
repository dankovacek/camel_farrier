...
result = plot_station_polygon("08NK019")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NK019">stations/08NK019 folder on GitHub</a>.
:::
...
<tr><td>08NK019</td><td>GRAVE CREEK AT THE MOUTH</td><td>49.843</td><td>-114.860</td><td>83.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 29.3 years
<br><strong>Timeseries Summary:</strong> 10,712 daily observations, continuous record | 44.4% flagged (backwater: 2816, estimated: 1850, partial day: 87)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 198.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>10,712 daily observations, continuous record | 44.4% flagged (backwater: 2816, estimated: 1850, partial day: 87) | Record: 29.3 years</td></tr>
...
show(plot_station_timeseries("08NK019"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NK019")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NK019/08NK019_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NK019/08NK019_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NK019"))
:::
...
<div class="download-section">
  <a href="../../08NK019/08NK019_field_visits.csv" download class="download-btn">
