...
result = plot_station_polygon("08LB047")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB047">stations/08LB047 folder on GitHub</a>.
:::
...
<tr><td>08LB047</td><td>NORTH THOMPSON RIVER AT BIRCH ISLAND</td><td>51.602</td><td>-119.914</td><td>4490.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 64.7 years
<br><strong>Timeseries Summary:</strong> 23,621 daily observations, continuous record | 33.9% flagged (backwater: 6763, estimated: 823, partial day: 419)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 11925.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>23,621 daily observations, continuous record | 33.9% flagged (backwater: 6763, estimated: 823, partial day: 419) | Record: 64.7 years</td></tr>
...
show(plot_station_timeseries("08LB047"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB047")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB047/08LB047_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08LB047/08LB047_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LB047/08LB047_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Bottom end of curve is graded as 'estimate'</td>
    </tr>
    <tr>
      <td>22.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Slight change to bottom end of curve</td>
    </tr>
    <tr>
      <td>21.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>First curve developed with RDT.</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08LB047"))
:::
...
<div class="download-section">
  <a href="../../08LB047/08LB047_field_visits.csv" download class="download-btn">
