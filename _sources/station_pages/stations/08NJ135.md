...
# 08NJ135: GOOSE CREEK ABOVE GANDER CREEK
...
result = plot_station_polygon("08NJ135")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ135">stations/08NJ135 folder on GitHub</a>.
:::
...
<tr><td>08NJ135</td><td>GOOSE CREEK ABOVE GANDER CREEK</td><td>49.424</td><td>-117.614</td><td>52.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 275 daily observations, seasonal gaps: 122 days avg (N=2) | 22.5% flagged (estimated: 62)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 122.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>275 daily observations, seasonal gaps: 122 days avg (N=2) | 22.5% flagged (estimated: 62) | Record: 1.4 years</td></tr>
...
show(plot_station_timeseries("08NJ135"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ135")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ135/08NJ135_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ135/08NJ135_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ135"))
:::
...
<div class="download-section">
  <a href="../../08NJ135/08NJ135_field_visits.csv" download class="download-btn">
