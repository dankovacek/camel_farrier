...
# 08NH101: COFFEE CREEK NEAR AINSWORTH
...
result = plot_station_polygon("08NH101")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH101">stations/08NH101 folder on GitHub</a>.
:::
...
<tr><td>08NH101</td><td>COFFEE CREEK NEAR AINSWORTH</td><td>49.697</td><td>-116.918</td><td>87.3 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,834 daily observations, seasonal gaps: 2298 days avg (N=6) | 6.2% flagged (backwater: 110, estimated: 63, partial day: 4)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 202.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,834 daily observations, seasonal gaps: 2298 days avg (N=6) | 6.2% flagged (backwater: 110, estimated: 63, partial day: 4) | Record: 45.5 years</td></tr>
...
show(plot_station_timeseries("08NH101"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH101")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH101/08NH101_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH101/08NH101_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH101"))
:::
...
<div class="download-section">
  <a href="../../08NH101/08NH101_field_visits.csv" download class="download-btn">
