...
result = plot_station_polygon("08LE024")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE024">stations/08LE024 folder on GitHub</a>.
:::
...
<tr><td>08LE024</td><td>EAGLE RIVER NEAR MALAKWA</td><td>50.936</td><td>-118.802</td><td>932.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 111.7 years
<br><strong>Timeseries Summary:</strong> 23,592 daily observations, seasonal gaps: 4299 days avg (N=4) | 17.7% flagged (backwater: 2127, partial day: 1521, estimated: 535)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2367.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>23,592 daily observations, seasonal gaps: 4299 days avg (N=4) | 17.7% flagged (backwater: 2127, partial day: 1521, estimated: 535) | Record: 111.7 years</td></tr>
...
show(plot_station_timeseries("08LE024"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE024")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE024/08LE024_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08LE024/08LE024_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LE024/08LE024_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Rating to capture deposition on control causing a shift of mmnts to the left of the rating</td>
    </tr>
    <tr>
      <td>44.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Cloned Rating 44.00 - adjusted grading</td>
    </tr>
    <tr>
      <td>44.00</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08LE024"))
:::
...
<div class="download-section">
  <a href="../../08LE024/08LE024_field_visits.csv" download class="download-btn">
