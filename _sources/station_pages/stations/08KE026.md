...
# 08KE026: GENERAL CREEK IN ALEXANDRIA I.R. NO. 3
...
result = plot_station_polygon("08KE026")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KE026">stations/08KE026 folder on GitHub</a>.
:::
...
<tr><td>08KE026</td><td>GENERAL CREEK IN ALEXANDRIA I.R. NO. 3</td><td>52.591</td><td>-122.495</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 549 daily observations, seasonal gaps: 182 days avg (N=2) | 2.7% flagged (estimated: 15)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 47.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>549 daily observations, seasonal gaps: 182 days avg (N=2) | 2.7% flagged (estimated: 15) | Record: 2.5 years</td></tr>
...
show(plot_station_timeseries("08KE026"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KE026")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KE026/08KE026_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KE026/08KE026_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KE026"))
:::
...
<div class="download-section">
  <a href="../../08KE026/08KE026_field_visits.csv" download class="download-btn">
