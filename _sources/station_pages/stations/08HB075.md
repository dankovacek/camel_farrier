...
result = plot_station_polygon("08HB075")
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB075")
show(show_with_notes(result))
:::
...
show(generate_field_visits_table("08HB075"))
:::
...
<div class="download-section">
  <a href="../../08HB075/08HB075_field_visits.csv" download class="download-btn">
