...
# 10VB004: UNNAMED RIVER ABOVE WARREN POINT
...
result = plot_station_polygon("10VB004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10VB004">stations/10VB004 folder on GitHub</a>.
:::
...
<tr><td>10VB004</td><td>UNNAMED RIVER ABOVE WARREN POINT</td><td>76.200</td><td>-108.450</td><td>193.0 (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3421.4 km²</td></tr>
...
show(plot_station_timeseries("10VB004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10VB004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10VB004/10VB004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10VB004"))
:::
...
<div class="download-section">
  <a href="../../10VB004/10VB004_field_visits.csv" download class="download-btn">
