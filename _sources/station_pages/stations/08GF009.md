...
# 08GF009: KINGCOME RIVER BELOW ATLATZI RIVER
...
result = plot_station_polygon("08GF009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GF009">stations/08GF009 folder on GitHub</a>.
:::
...
<tr><td>08GF009</td><td>KINGCOME RIVER BELOW ATLATZI RIVER</td><td>51.002</td><td>-126.118</td><td>nan (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3079.6 km²</td></tr>
...
show(plot_station_timeseries("08GF009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GF009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GF009/08GF009_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08GF009/08GF009_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GF009"))
:::
...
<div class="download-section">
  <a href="../../08GF009/08GF009_field_visits.csv" download class="download-btn">
