...
# 10VH001: FALLS RIVER NEAR D'IBERVILLE FIORD
...
result = plot_station_polygon("10VH001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10VH001">stations/10VH001 folder on GitHub</a>.
:::
...
<tr><td>10VH001</td><td>FALLS RIVER NEAR D'IBERVILLE FIORD</td><td>80.602</td><td>-79.411</td><td>32.6 (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 2.3 years
<br><strong>Timeseries Summary:</strong> 306 daily observations, seasonal gaps: 273 days avg (N=2) | 13.1% flagged (backwater: 32, estimated: 8)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 782.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>306 daily observations, seasonal gaps: 273 days avg (N=2) | 13.1% flagged (backwater: 32, estimated: 8) | Record: 2.3 years</td></tr>
...
show(plot_station_timeseries("10VH001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10VH001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10VH001/10VH001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10VH001/10VH001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10VH001"))
:::
...
<div class="download-section">
  <a href="../../10VH001/10VH001_field_visits.csv" download class="download-btn">
