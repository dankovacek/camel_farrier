...
# 10FA001: TROUT RIVER NEAR OUTLET OF TROUT LAKE
...
result = plot_station_polygon("10FA001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10FA001">stations/10FA001 folder on GitHub</a>.
:::
...
<tr><td>10FA001</td><td>TROUT RIVER NEAR OUTLET OF TROUT LAKE</td><td>60.767</td><td>-121.108</td><td>nan (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 729 daily observations, seasonal gaps: 110 days avg (N=5) | 34.2% flagged (backwater: 213, estimated: 31, partial day: 5)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 23933.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>729 daily observations, seasonal gaps: 110 days avg (N=5) | 34.2% flagged (backwater: 213, estimated: 31, partial day: 5) | Record: 3.5 years</td></tr>
...
show(plot_station_timeseries("10FA001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10FA001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10FA001/10FA001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10FA001/10FA001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10FA001"))
:::
