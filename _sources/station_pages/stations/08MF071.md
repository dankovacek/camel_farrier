...
# 08MF071: BOULDER CREEK NEAR THE MOUTH
...
result = plot_station_polygon("08MF071")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MF071">stations/08MF071 folder on GitHub</a>.
:::
...
<tr><td>08MF071</td><td>BOULDER CREEK NEAR THE MOUTH</td><td>49.249</td><td>-121.600</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 517 daily observations, minor gaps: 36 days avg (N=5) | 11.6% flagged (partial day: 40, estimated: 20)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>517 daily observations, minor gaps: 36 days avg (N=5) | 11.6% flagged (partial day: 40, estimated: 20) | Record: 1.9 years</td></tr>
...
show(plot_station_timeseries("08MF071"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MF071")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MF071/08MF071_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MF071/08MF071_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MF071"))
:::
