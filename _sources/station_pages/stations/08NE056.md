...
# 08NE056: KELLY CREEK NEAR FRUITVALE (UPPER STATION)
...
result = plot_station_polygon("08NE056")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE056">stations/08NE056 folder on GitHub</a>.
:::
...
<tr><td>08NE056</td><td>KELLY CREEK NEAR FRUITVALE (UPPER STATION)</td><td>49.113</td><td>-117.491</td><td>19.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 0.2 years
<br><strong>Timeseries Summary:</strong> 92 daily observations, continuous record | 53.3% flagged (estimated: 49)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 46.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>92 daily observations, continuous record | 53.3% flagged (estimated: 49) | Record: 0.2 years</td></tr>
...
show(plot_station_timeseries("08NE056"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE056")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE056/08NE056_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE056/08NE056_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE056"))
:::
...
<div class="download-section">
  <a href="../../08NE056/08NE056_field_visits.csv" download class="download-btn">
