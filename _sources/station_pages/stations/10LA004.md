...
# 10LA004: WELDON CREEK NEAR THE MOUTH
...
result = plot_station_polygon("10LA004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10LA004">stations/10LA004 folder on GitHub</a>.
:::
...
<tr><td>10LA004</td><td>WELDON CREEK NEAR THE MOUTH</td><td>66.412</td><td>-132.694</td><td>852.0 (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.98, ΔArea: -0.1%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 13.0 years
<br><strong>Timeseries Summary:</strong> 4,748 daily observations, continuous record | 69.5% flagged (backwater: 3033, estimated: 251, partial day: 15)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5007.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>4,748 daily observations, continuous record | 69.5% flagged (backwater: 3033, estimated: 251, partial day: 15) | Record: 13.0 years</td></tr>
...
show(plot_station_timeseries("10LA004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10LA004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10LA004/10LA004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10LA004/10LA004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10LA004"))
:::
...
<div class="download-section">
  <a href="../../10LA004/10LA004_field_visits.csv" download class="download-btn">
