...
# 08NB011: COLUMBIA RIVER AT BIG BEND HIGHWAY CROSSING
...
result = plot_station_polygon("08NB011")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NB011">stations/08NB011 folder on GitHub</a>.
:::
...
<tr><td>08NB011</td><td>COLUMBIA RIVER AT BIG BEND HIGHWAY CROSSING</td><td>52.115</td><td>-118.424</td><td>16800.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 5.0 years
<br><strong>Timeseries Summary:</strong> 1,796 daily observations, minor gaps: 30 days avg (N=1) | 13.8% flagged (backwater: 206, estimated: 41)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 42257.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,796 daily observations, minor gaps: 30 days avg (N=1) | 13.8% flagged (backwater: 206, estimated: 41) | Record: 5.0 years</td></tr>
...
show(plot_station_timeseries("08NB011"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NB011")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NB011/08NB011_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NB011/08NB011_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NB011"))
:::
...
<div class="download-section">
  <a href="../../08NB011/08NB011_field_visits.csv" download class="download-btn">
