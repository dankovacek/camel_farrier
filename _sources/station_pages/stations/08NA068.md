...
# 08NA068: PAGLIARO CREEK NEAR GOLDEN
...
result = plot_station_polygon("08NA068")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA068">stations/08NA068 folder on GitHub</a>.
:::
...
<tr><td>08NA068</td><td>PAGLIARO CREEK NEAR GOLDEN</td><td>51.198</td><td>-116.853</td><td>4.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,436 daily observations, continuous record | 62.6% flagged (estimated: 1525)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 11.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,436 daily observations, continuous record | 62.6% flagged (estimated: 1525) | Record: 6.7 years</td></tr>
...
show(plot_station_timeseries("08NA068"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA068")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA068/08NA068_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA068/08NA068_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA068"))
:::
...
<div class="download-section">
  <a href="../../08NA068/08NA068_field_visits.csv" download class="download-btn">
