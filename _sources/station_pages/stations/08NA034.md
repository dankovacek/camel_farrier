...
# 08NA034: WARM SPRINGS CREEK NEAR FAIRMONT (UPPER STATION)
...
result = plot_station_polygon("08NA034")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA034">stations/08NA034 folder on GitHub</a>.
:::
...
<tr><td>08NA034</td><td>WARM SPRINGS CREEK NEAR FAIRMONT (UPPER STATION)</td><td>50.329</td><td>-115.838</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 61 daily observations, continuous record | 32.8% flagged (estimated: 20)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 25.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>61 daily observations, continuous record | 32.8% flagged (estimated: 20) | Record: 0.2 years</td></tr>
...
show(plot_station_timeseries("08NA034"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA034")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA034/08NA034_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA034/08NA034_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA034"))
:::
