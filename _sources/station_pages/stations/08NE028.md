...
# 08NE028: RENATA CREEK NEAR RENATA
...
result = plot_station_polygon("08NE028")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE028">stations/08NE028 folder on GitHub</a>.
:::
...
<tr><td>08NE028</td><td>RENATA CREEK NEAR RENATA</td><td>49.421</td><td>-118.109</td><td>195.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 92 daily observations, continuous record | 44.6% flagged (estimated: 41)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 459.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>92 daily observations, continuous record | 44.6% flagged (estimated: 41) | Record: 0.2 years</td></tr>
...
show(plot_station_timeseries("08NE028"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE028")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE028/08NE028_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE028/08NE028_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE028"))
:::
...
<div class="download-section">
  <a href="../../08NE028/08NE028_field_visits.csv" download class="download-btn">
