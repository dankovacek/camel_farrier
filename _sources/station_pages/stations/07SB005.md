...
# 07SB005: YELLOWKNIFE RIVER AT OUTLET BLUEFISH LAKE DAM
...
result = plot_station_polygon("07SB005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07SB005">stations/07SB005 folder on GitHub</a>.
:::
...
<tr><td>07SB005</td><td>YELLOWKNIFE RIVER AT OUTLET BLUEFISH LAKE DAM</td><td>62.683</td><td>-114.267</td><td>nan (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 16.7 years
<br><strong>Timeseries Summary:</strong> 6,117 daily observations, continuous record | 5.8% flagged (backwater: 355)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 55436.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>6,117 daily observations, continuous record | 5.8% flagged (backwater: 355) | Record: 16.7 years</td></tr>
...
show(plot_station_timeseries("07SB005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07SB005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07SB005/07SB005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07SB005/07SB005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07SB005"))
:::
