...
# 07EE008: WILLISTON LAKE NEAR MACKENZIE
...
result = plot_station_polygon("07EE008")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07EE008">stations/07EE008 folder on GitHub</a>.
:::
...
<tr><td>07EE008</td><td>WILLISTON LAKE NEAR MACKENZIE</td><td>55.339</td><td>-123.188</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 31942.9 km²</td></tr>
...
show(plot_station_timeseries("07EE008"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07EE008")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07EE008/07EE008_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07EE008/07EE008_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07EE008"))
:::
...
<div class="download-section">
  <a href="../../07EE008/07EE008_field_visits.csv" download class="download-btn">
