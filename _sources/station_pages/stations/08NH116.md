...
# 08NH116: GLASER CREEK NEAR CRESTON
...
result = plot_station_polygon("08NH116")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH116">stations/08NH116 folder on GitHub</a>.
:::
...
<tr><td>08NH116</td><td>GLASER CREEK NEAR CRESTON</td><td>49.107</td><td>-116.515</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.97, ΔArea: +3.0%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 245 daily observations, seasonal gaps: 273 days avg (N=1) | 1.6% flagged (estimated: 4)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>245 daily observations, seasonal gaps: 273 days avg (N=1) | 1.6% flagged (estimated: 4) | Record: 1.4 years</td></tr>
...
show(plot_station_timeseries("08NH116"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH116")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH116/08NH116_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH116/08NH116_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH116"))
:::
...
<div class="download-section">
  <a href="../../08NH116/08NH116_field_visits.csv" download class="download-btn">
