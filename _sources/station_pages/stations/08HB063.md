...
result = plot_station_polygon("08HB063")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB063">stations/08HB063 folder on GitHub</a>.
:::
...
<tr><td>08HB063</td><td>KITSUCKSUS CREEK ABOVE CHERRY CREEK</td><td>49.284</td><td>-124.799</td><td>21.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 887 daily observations, seasonal gaps: 141 days avg (N=3) | 7.1% flagged (estimated: 63)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 46.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>887 daily observations, seasonal gaps: 141 days avg (N=3) | 7.1% flagged (estimated: 63) | Record: 3.6 years</td></tr>
...
show(plot_station_timeseries("08HB063"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB063")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB063/08HB063_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HB063/08HB063_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HB063"))
:::
