...
# 08LE032: NISKONLITH CREEK ABOVE NISKONLITH LAKE
...
result = plot_station_polygon("08LE032")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE032">stations/08LE032 folder on GitHub</a>.
:::
...
<tr><td>08LE032</td><td>NISKONLITH CREEK ABOVE NISKONLITH LAKE</td><td>50.768</td><td>-119.800</td><td>31.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 9.4 years
<br><strong>Timeseries Summary:</strong> 1,619 daily observations, seasonal gaps: 202 days avg (N=9) | 3.0% flagged (estimated: 49)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,619 daily observations, seasonal gaps: 202 days avg (N=9) | 3.0% flagged (estimated: 49) | Record: 9.4 years</td></tr>
...
show(plot_station_timeseries("08LE032"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE032")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE032/08LE032_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE032/08LE032_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE032"))
:::
...
<div class="download-section">
  <a href="../../08LE032/08LE032_field_visits.csv" download class="download-btn">
