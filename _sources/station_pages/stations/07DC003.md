...
# 07DC003: FIREBAG RIVER UPSTREAM OF SUNCOR FIREBAG
...
result = plot_station_polygon("07DC003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DC003">stations/07DC003 folder on GitHub</a>.
:::
...
<tr><td>07DC003</td><td>FIREBAG RIVER UPSTREAM OF SUNCOR FIREBAG</td><td>57.335</td><td>-110.474</td><td>2420.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,922 daily observations, continuous record | 57.8% flagged (backwater: 1505, estimated: 168, partial day: 16)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 8267.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,922 daily observations, continuous record | 57.8% flagged (backwater: 1505, estimated: 168, partial day: 16) | Record: 8.0 years</td></tr>
...
show(plot_station_timeseries("07DC003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07DC003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07DC003/07DC003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07DC003/07DC003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07DC003/07DC003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07DC003"))
:::
...
<div class="download-section">
  <a href="../../07DC003/07DC003_field_visits.csv" download class="download-btn">
