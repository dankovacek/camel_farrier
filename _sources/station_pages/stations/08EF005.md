...
result = plot_station_polygon("08EF005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EF005">stations/08EF005 folder on GitHub</a>.
:::
...
<tr><td>08EF005</td><td>ZYMOETZ RIVER ABOVE O.K. CREEK</td><td>54.494</td><td>-128.325</td><td>2850.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 60.3 years
<br><strong>Timeseries Summary:</strong> 22,037 daily observations, continuous record | 25.6% flagged (backwater: 3897, estimated: 1665, partial day: 84)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 8648.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>22,037 daily observations, continuous record | 25.6% flagged (backwater: 3897, estimated: 1665, partial day: 84) | Record: 60.3 years</td></tr>
...
show(plot_station_timeseries("08EF005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EF005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EF005/08EF005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08EF005/08EF005_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08EF005/08EF005_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>New curve developed using 2023 data and respecting historic high flow measurements.</td>
    </tr>
    <tr>
      <td>33.03</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Clone of Curve 33.02 with revised grades for improved discharge measurement coverage beginning after...</td>
    </tr>
    <tr>
      <td>33.020</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Shift at highwater significantly trending to the left, supported by observations. Otherwisw the curv...</td>
    </tr>
    <tr>
      <td>33.010</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08EF005"))
:::
...
<div class="download-section">
  <a href="../../08EF005/08EF005_field_visits.csv" download class="download-btn">
