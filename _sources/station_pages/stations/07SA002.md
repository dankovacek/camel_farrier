...
result = plot_station_polygon("07SA002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07SA002">stations/07SA002 folder on GitHub</a>.
:::
...
<tr><td>07SA002</td><td>SNARE RIVER BELOW GHOST RIVER</td><td>63.974</td><td>-115.433</td><td>13300.0 (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 77.3 years
<br><strong>Timeseries Summary:</strong> 15,555 daily observations, seasonal gaps: 12662 days avg (N=1) | 11.1% flagged (estimated: 1258, partial day: 467, backwater: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 72408.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>15,555 daily observations, seasonal gaps: 12662 days avg (N=1) | 11.1% flagged (estimated: 1258, partial day: 467, backwater: 3) | Record: 77.3 years</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07SA002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07SA002/07SA002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07SA002/07SA002_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07SA002/07SA002_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Final/Finales</td>
      <td>A single segment curve created to refine the low end of curve 5.0000. Although curve 5.000 is a good...</td>
    </tr>
    <tr>
      <td>5.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>High end determined by mmnts. and log plot.</td>
    </tr>
    <tr>
      <td>3.0</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07SA002"))
:::
...
<div class="download-section">
  <a href="../../07SA002/07SA002_field_visits.csv" download class="download-btn">
