...
# 09EA005: LITTLE SOUTH KLONDIKE RIVER BELOW ROSS CREEK
...
show(plot_station_polygon("09EA005"))
:::

## Station metadata

The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09EA005">stations/09EA005 folder on GitHub</a>.
...
<tr><td>09EA005</td><td>LITTLE SOUTH KLONDIKE RIVER BELOW ROSS CREEK</td><td>63.997</td><td>-137.579</td><td>860.0 (0.0)</td><td>YT</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-06</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.9999, ΔArea: +0.01%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 7,824 daily observations, seasonal gaps: 3758 days avg (N=2) | 62.0% flagged (backwater: 4503, estimated: 334, partial day: 13)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4189.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>7,824 daily observations, seasonal gaps: 3758 days avg (N=2) | 62.0% flagged (backwater: 4503, estimated: 334, partial day: 13) | Record: 42.0 years</td></tr>
...
show(plot_station_timeseries("09EA005"))
:::
...
show(plot_distributions("09EA005"))
:::
...
<div class="download-section">
  ...
  <a href="camel_farrier/09EA005/09EA005/09EA005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="camel_farrier/09EA005/09EA005/09EA005_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="camel_farrier/09EA005/09EA005/09EA005_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe dataframe table">
  ...
  <tbody>
    <tr>
      ...
      <td>Newly created curve made to more accurately model upper end. Based on discharge measurements obtaine...</td>
    </tr>
    <tr>
      <td>10.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>See documentation at SHAREPOINT/09EA005/2023/09EA005_20230101_10.00_RMD.</td>
    </tr>
    <tr>
      <td>9.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>This curve is an segimented equation with multiple rating points. Although it has been used for 2019...</td>
    </tr>
    <tr>
      <td>8.0</td>
      <td>LinearTable</td>
