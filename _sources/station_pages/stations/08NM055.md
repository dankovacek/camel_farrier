...
# 08NM055: TROUT CREEK SUMMERLAND DIVERSION
...
result = plot_station_polygon("08NM055")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM055">stations/08NM055 folder on GitHub</a>.
:::
...
<tr><td>08NM055</td><td>TROUT CREEK SUMMERLAND DIVERSION</td><td>49.599</td><td>-119.764</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,650 daily observations, seasonal gaps: 199 days avg (N=9) | 3.3% flagged (estimated: 54)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1622.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,650 daily observations, seasonal gaps: 199 days avg (N=9) | 3.3% flagged (estimated: 54) | Record: 9.4 years</td></tr>
...
show(plot_station_timeseries("08NM055"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM055")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM055/08NM055_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM055/08NM055_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM055"))
:::
...
<div class="download-section">
  <a href="../../08NM055/08NM055_field_visits.csv" download class="download-btn">
