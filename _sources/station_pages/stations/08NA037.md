...
result = plot_station_polygon("08NA037")
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.98, ΔArea: +1.5%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 74.4 years
<br><strong>Timeseries Summary:</strong> 5,504 daily observations, seasonal gaps: 803 days avg (N=27) | 7.5% flagged (estimated: 393, partial day: 21)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>5,504 daily observations, seasonal gaps: 803 days avg (N=27) | 7.5% flagged (estimated: 393, partial day: 21) | Record: 74.4 years</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA037")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA037/08NA037_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA037/08NA037_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA037"))
:::
