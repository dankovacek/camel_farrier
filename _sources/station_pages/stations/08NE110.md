...
result = plot_station_polygon("08NE110")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE110">stations/08NE110 folder on GitHub</a>.
:::
...
<tr><td>08NE110</td><td>INONOAKLIN CREEK ABOVE VALLEY CREEK</td><td>49.897</td><td>-118.190</td><td>298.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 18,114 daily observations, seasonal gaps: 1520 days avg (N=1) | 13.9% flagged (estimated: 1885, backwater: 401, partial day: 223)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 692.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>18,114 daily observations, seasonal gaps: 1520 days avg (N=1) | 13.9% flagged (estimated: 1885, backwater: 401, partial day: 223) | Record: 53.8 years</td></tr>
...
show(plot_station_timeseries("08NE110"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE110")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE110/08NE110_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NE110/08NE110_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NE110/08NE110_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>strong trend to the left for 2023, extended bottom end for low flows</td>
    </tr>
    <tr>
      <td>40.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>clone of 40.00 with changes to low end curve confidence estimates</td>
    </tr>
    <tr>
      <td>40.00</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>changing 'E' grade on lower end</td>
    </tr>
    <tr>
      <td>39.00</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08NE110"))
:::
