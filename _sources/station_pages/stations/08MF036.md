...
# 08MF036: HOPE SLOUGH NEAR ROSEDALE
...
result = plot_station_polygon("08MF036")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MF036">stations/08MF036 folder on GitHub</a>.
:::
...
<tr><td>08MF036</td><td>HOPE SLOUGH NEAR ROSEDALE</td><td>49.175</td><td>-121.854</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,098 daily observations, seasonal gaps: 182 days avg (N=5) | 3.2% flagged (estimated: 35)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 124.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,098 daily observations, seasonal gaps: 182 days avg (N=5) | 3.2% flagged (estimated: 35) | Record: 5.5 years</td></tr>
...
show(plot_station_timeseries("08MF036"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MF036")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MF036/08MF036_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MF036/08MF036_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MF036"))
:::
