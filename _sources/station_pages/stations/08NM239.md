...
# 08NM239: MISSION CREEK BELOW B.M.I.D. INTAKE
...
result = plot_station_polygon("08NM239")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM239">stations/08NM239 folder on GitHub</a>.
:::
...
<tr><td>08NM239</td><td>MISSION CREEK BELOW B.M.I.D. INTAKE</td><td>49.850</td><td>-119.283</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 0.8 years
<br><strong>Timeseries Summary:</strong> 275 daily observations, continuous record | 20.0% flagged (backwater: 29, estimated: 23, partial day: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1457.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>275 daily observations, continuous record | 20.0% flagged (backwater: 29, estimated: 23, partial day: 3) | Record: 0.8 years</td></tr>
...
show(plot_station_timeseries("08NM239"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM239")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM239/08NM239_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM239/08NM239_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM239"))
:::
...
<div class="download-section">
  <a href="../../08NM239/08NM239_field_visits.csv" download class="download-btn">
