...
# 08EG004: THULME RIVER NEAR PORT SIMPSON
...
result = plot_station_polygon("08EG004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EG004">stations/08EG004 folder on GitHub</a>.
:::
...
<tr><td>08EG004</td><td>THULME RIVER NEAR PORT SIMPSON</td><td>54.492</td><td>-129.996</td><td>73.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,004 daily observations, minor gaps: 30 days avg (N=3) | 9.0% flagged (estimated: 59, backwater: 31)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 218.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,004 daily observations, minor gaps: 30 days avg (N=3) | 9.0% flagged (estimated: 59, backwater: 31) | Record: 3.0 years</td></tr>
...
show(plot_station_timeseries("08EG004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EG004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EG004/08EG004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08EG004/08EG004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08EG004"))
:::
...
<div class="download-section">
  <a href="../../08EG004/08EG004_field_visits.csv" download class="download-btn">
