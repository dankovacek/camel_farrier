...
result = plot_station_polygon("07BA003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07BA003">stations/07BA003 folder on GitHub</a>.
:::
...
<tr><td>07BA003</td><td>LOVETT RIVER NEAR THE MOUTH</td><td>53.000</td><td>-116.656</td><td>103.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 49.6 years
<br><strong>Timeseries Summary:</strong> 10,310 daily observations, seasonal gaps: 159 days avg (N=49) | 13.6% flagged (backwater: 1033, estimated: 326, partial day: 48)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 287.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>10,310 daily observations, seasonal gaps: 159 days avg (N=49) | 13.6% flagged (backwater: 1033, estimated: 326, partial day: 48) | Record: 49.6 years</td></tr>
...
show(plot_station_timeseries("07BA003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07BA003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07BA003/07BA003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07BA003/07BA003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07BA003/07BA003_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Scour at mid-range.  New curve needed for technologic upgrade from compumod import.</td>
    </tr>
    <tr>
      <td>5.0</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Same As Curve #4 Above 0.970 m.</td>
    </tr>
    <tr>
      <td>4.0</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07BA003"))
:::
