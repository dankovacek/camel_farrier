...
# 10VC012: UNNAMED RIVER NEAR CAPE GELL
...
result = plot_station_polygon("10VC012")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10VC012">stations/10VC012 folder on GitHub</a>.
:::
...
<tr><td>10VC012</td><td>UNNAMED RIVER NEAR CAPE GELL</td><td>75.583</td><td>-94.833</td><td>94.3 (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1525.0 km²</td></tr>
...
show(plot_station_timeseries("10VC012"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10VC012")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10VC012/10VC012_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10VC012"))
:::
...
<div class="download-section">
  <a href="../../10VC012/10VC012_field_visits.csv" download class="download-btn">
