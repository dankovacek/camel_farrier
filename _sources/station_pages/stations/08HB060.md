...
# 08HB060: NAHMINT LAKE NEAR PORT ALBERNI
...
result = plot_station_polygon("08HB060")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB060">stations/08HB060 folder on GitHub</a>.
:::
...
<tr><td>08HB060</td><td>NAHMINT LAKE NEAR PORT ALBERNI</td><td>49.123</td><td>-124.990</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 332.4 km²</td></tr>
...
show(plot_station_timeseries("08HB060"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB060")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB060/08HB060_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HB060/08HB060_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HB060"))
:::
...
<div class="download-section">
  <a href="../../08HB060/08HB060_field_visits.csv" download class="download-btn">
