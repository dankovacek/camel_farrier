...
result = plot_station_polygon("07DA006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DA006">stations/07DA006 folder on GitHub</a>.
:::
...
<tr><td>07DA006</td><td>STEEPBANK RIVER NEAR FORT MCMURRAY</td><td>56.999</td><td>-111.407</td><td>1320.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 52.3 years
<br><strong>Timeseries Summary:</strong> 16,076 daily observations, seasonal gaps: 108 days avg (N=28) | 46.6% flagged (backwater: 6592, estimated: 515, partial day: 389)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4398.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>16,076 daily observations, seasonal gaps: 108 days avg (N=28) | 46.6% flagged (backwater: 6592, estimated: 515, partial day: 389) | Record: 52.3 years</td></tr>
...
show(plot_station_timeseries("07DA006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07DA006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07DA006/07DA006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07DA006/07DA006_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07DA006/07DA006_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Same as Curve#7 below 98.1m. Extension of high end</td>
    </tr>
    <tr>
      <td>7.0</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>HQFIT1.0 Same 0 flow as curve 6, extended curve.</td>
    </tr>
    <tr>
      <td>6.0</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07DA006"))
:::
...
<div class="download-section">
  <a href="../../07DA006/07DA006_field_visits.csv" download class="download-btn">
