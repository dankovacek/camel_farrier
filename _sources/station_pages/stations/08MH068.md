...
# 08MH068: CLAYBURN CREEK AT CLAYBURN ROAD, MATSQUI
...
result = plot_station_polygon("08MH068")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH068">stations/08MH068 folder on GitHub</a>.
:::
...
<tr><td>08MH068</td><td>CLAYBURN CREEK AT CLAYBURN ROAD, MATSQUI</td><td>49.082</td><td>-122.277</td><td>37.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 10.4 years
<br><strong>Timeseries Summary:</strong> 1,270 daily observations, seasonal gaps: 506 days avg (N=5) | 1.9% flagged (estimated: 23, partial day: 1)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 93.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,270 daily observations, seasonal gaps: 506 days avg (N=5) | 1.9% flagged (estimated: 23, partial day: 1) | Record: 10.4 years</td></tr>
...
show(plot_station_timeseries("08MH068"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH068")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH068/08MH068_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08MH068/08MH068_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08MH068/08MH068_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH068"))
:::
...
<div class="download-section">
  <a href="../../08MH068/08MH068_field_visits.csv" download class="download-btn">
