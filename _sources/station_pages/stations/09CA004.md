...
result = plot_station_polygon("09CA004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09CA004">stations/09CA004 folder on GitHub</a>.
:::
...
<tr><td>09CA004</td><td>DUKE RIVER NEAR THE MOUTH</td><td>61.346</td><td>-139.168</td><td>654.0 (0.0)</td><td>YT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 41.0 years
<br><strong>Timeseries Summary:</strong> 14,853 daily observations, minor gaps: 61 days avg (N=2) | 64.9% flagged (backwater: 8305, estimated: 1249, partial day: 93)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2790.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>14,853 daily observations, minor gaps: 61 days avg (N=2) | 64.9% flagged (backwater: 8305, estimated: 1249, partial day: 93) | Record: 41.0 years</td></tr>
...
show(plot_station_timeseries("09CA004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09CA004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09CA004/09CA004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../09CA004/09CA004_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../09CA004/09CA004_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>New curve for 2022 to account for continuous scour in channel after large deposition event in 2013. ...</td>
    </tr>
    <tr>
      <td>33.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve 33.0 is a logarithmic curve created on 2023-04-19 and active as of 2021-01-01.  High uncertain...</td>
    </tr>
    <tr>
      <td>32.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New curve created to reflect major channel shift at end of July 2019. Assuming there is a break poin...</td>
    </tr>
    <tr>
      <td>31.0</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("09CA004"))
:::
