...
The data representing the above plots can be downloaded from the [stations/08FF001](https://dankovacek.github.io/camel_farrier/stations/08FF001) folder in the Github repository.
