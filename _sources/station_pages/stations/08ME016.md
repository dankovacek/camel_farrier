...
# 08ME016: PETERS CREEK NEAR SHALALTH
...
result = plot_station_polygon("08ME016")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08ME016">stations/08ME016 folder on GitHub</a>.
:::
...
<tr><td>08ME016</td><td>PETERS CREEK NEAR SHALALTH</td><td>50.724</td><td>-122.244</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.77, ΔArea: +28.4%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 242 daily observations, minor gaps: 31 days avg (N=1) | 65.7% flagged (estimated: 159)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>242 daily observations, minor gaps: 31 days avg (N=1) | 65.7% flagged (estimated: 159) | Record: 0.7 years</td></tr>
...
show(plot_station_timeseries("08ME016"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08ME016")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08ME016/08ME016_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08ME016/08ME016_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08ME016"))
:::
