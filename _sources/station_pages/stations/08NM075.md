...
# 08NM075: DEEP CREEK NEAR VERNON (STATION NO. 3)
...
result = plot_station_polygon("08NM075")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM075">stations/08NM075 folder on GitHub</a>.
:::
...
<tr><td>08NM075</td><td>DEEP CREEK NEAR VERNON (STATION NO. 3)</td><td>50.364</td><td>-119.282</td><td>207.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,898 daily observations, seasonal gaps: 178 days avg (N=15) | 5.6% flagged (estimated: 161)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 494.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,898 daily observations, seasonal gaps: 178 days avg (N=15) | 5.6% flagged (estimated: 161) | Record: 15.2 years</td></tr>
...
show(plot_station_timeseries("08NM075"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM075")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM075/08NM075_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM075/08NM075_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM075"))
:::
