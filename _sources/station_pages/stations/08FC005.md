...
result = plot_station_polygon("08FC005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08FC005">stations/08FC005 folder on GitHub</a>.
:::
...
<tr><td>08FC005</td><td>DEAN RIVER NEAR ANAHIM LAKE</td><td>52.460</td><td>-125.264</td><td>1060.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 10.3 years
<br><strong>Timeseries Summary:</strong> 3,775 daily observations, continuous record | 50.3% flagged (backwater: 1724, estimated: 108, partial day: 68)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2845.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>3,775 daily observations, continuous record | 50.3% flagged (backwater: 1724, estimated: 108, partial day: 68) | Record: 10.3 years</td></tr>
...
show(plot_station_timeseries("08FC005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08FC005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08FC005/08FC005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08FC005/08FC005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08FC005"))
:::
...
<div class="download-section">
  <a href="../../08FC005/08FC005_field_visits.csv" download class="download-btn">
