...
# 08NJ151: MCPHEE CREEK NEAR BRILLIANT
...
result = plot_station_polygon("08NJ151")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ151">stations/08NJ151 folder on GitHub</a>.
:::
...
<tr><td>08NJ151</td><td>MCPHEE CREEK NEAR BRILLIANT</td><td>49.334</td><td>-117.574</td><td>35.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 337 daily observations, seasonal gaps: 242 days avg (N=2) | 62.0% flagged (estimated: 209)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 81.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>337 daily observations, seasonal gaps: 242 days avg (N=2) | 62.0% flagged (estimated: 209) | Record: 2.2 years</td></tr>
...
show(plot_station_timeseries("08NJ151"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ151")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ151/08NJ151_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ151/08NJ151_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ151"))
:::
...
<div class="download-section">
  <a href="../../08NJ151/08NJ151_field_visits.csv" download class="download-btn">
