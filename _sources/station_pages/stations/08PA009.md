...
# 08PA009: ROSS RESERVOIR NEAR NEWHALEM
...
result = plot_station_polygon("08PA009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08PA009">stations/08PA009 folder on GitHub</a>.
:::
...
<tr><td>08PA009</td><td>ROSS RESERVOIR NEAR NEWHALEM</td><td>48.733</td><td>-121.067</td><td>nan (0.0)</td><td>WA</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 6064.3 km²</td></tr>
...
show(plot_station_timeseries("08PA009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08PA009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08PA009/08PA009_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08PA009/08PA009_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08PA009"))
:::
...
<div class="download-section">
  <a href="../../08PA009/08PA009_field_visits.csv" download class="download-btn">
