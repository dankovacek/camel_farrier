...
result = plot_station_polygon("08CG005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08CG005">stations/08CG005 folder on GitHub</a>.
:::
...
<tr><td>08CG005</td><td>MORE CREEK NEAR THE MOUTH</td><td>57.041</td><td>-130.401</td><td>844.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 23.3 years
<br><strong>Timeseries Summary:</strong> 8,459 daily observations, minor gaps: 31 days avg (N=2) | 46.7% flagged (backwater: 3187, estimated: 713, partial day: 50)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2989.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>8,459 daily observations, minor gaps: 31 days avg (N=2) | 46.7% flagged (backwater: 3187, estimated: 713, partial day: 50) | Record: 23.3 years</td></tr>
...
show(plot_station_timeseries("08CG005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08CG005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08CG005/08CG005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08CG005/08CG005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08CG005"))
:::
...
<div class="download-section">
  <a href="../../08CG005/08CG005_field_visits.csv" download class="download-btn">
