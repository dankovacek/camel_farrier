...
# 08NM030: PEACHLAND CREEK MUNICIPAL IRRIGATION DIVERSION
...
result = plot_station_polygon("08NM030")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM030">stations/08NM030 folder on GitHub</a>.
:::
...
<tr><td>08NM030</td><td>PEACHLAND CREEK MUNICIPAL IRRIGATION DIVERSION</td><td>49.758</td><td>-119.816</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 5.3 years
<br><strong>Timeseries Summary:</strong> 1,008 daily observations, seasonal gaps: 188 days avg (N=5) | 46.0% flagged (estimated: 464)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 301.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,008 daily observations, seasonal gaps: 188 days avg (N=5) | 46.0% flagged (estimated: 464) | Record: 5.3 years</td></tr>
...
show(plot_station_timeseries("08NM030"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM030")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM030/08NM030_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM030/08NM030_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM030"))
:::
...
<div class="download-section">
  <a href="../../08NM030/08NM030_field_visits.csv" download class="download-btn">
