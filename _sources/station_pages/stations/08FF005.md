...
# 08FF005: KILOMETRE 18.9 CREEK NEAR KITIMAT
...
result = plot_station_polygon("08FF005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08FF005">stations/08FF005 folder on GitHub</a>.
:::
...
<tr><td>08FF005</td><td>KILOMETRE 18.9 CREEK NEAR KITIMAT</td><td>54.216</td><td>-128.222</td><td>12.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 12.8 years
<br><strong>Timeseries Summary:</strong> 3,204 daily observations, seasonal gaps: 148 days avg (N=10) | 10.1% flagged (estimated: 173, backwater: 137, partial day: 14)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 36.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,204 daily observations, seasonal gaps: 148 days avg (N=10) | 10.1% flagged (estimated: 173, backwater: 137, partial day: 14) | Record: 12.8 years</td></tr>
...
show(plot_station_timeseries("08FF005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08FF005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08FF005/08FF005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08FF005/08FF005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08FF005"))
:::
...
<div class="download-section">
  <a href="../../08FF005/08FF005_field_visits.csv" download class="download-btn">
