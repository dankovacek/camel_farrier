...
# 08NE123: CRANBERRY CREEK ABOVE B.C. HYDRO INTAKE
...
result = plot_station_polygon("08NE123")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE123">stations/08NE123 folder on GitHub</a>.
:::
...
<tr><td>08NE123</td><td>CRANBERRY CREEK ABOVE B.C. HYDRO INTAKE</td><td>50.795</td><td>-118.078</td><td>99.6 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 7,336 daily observations, seasonal gaps: 8827 days avg (N=1) | 28.5% flagged (estimated: 1028, backwater: 1028, partial day: 37)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 251.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>7,336 daily observations, seasonal gaps: 8827 days avg (N=1) | 28.5% flagged (estimated: 1028, backwater: 1028, partial day: 37) | Record: 44.2 years</td></tr>
...
show(plot_station_timeseries("08NE123"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE123")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE123/08NE123_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NE123/08NE123_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NE123/08NE123_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE123"))
:::
...
<div class="download-section">
  <a href="../../08NE123/08NE123_field_visits.csv" download class="download-btn">
