...
# 08LG029: MOORE CREEK AT THE MOUTH
...
result = plot_station_polygon("08LG029")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG029">stations/08LG029 folder on GitHub</a>.
:::
...
<tr><td>08LG029</td><td>MOORE CREEK AT THE MOUTH</td><td>50.256</td><td>-120.453</td><td>181.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 245 daily observations, continuous record | 1.6% flagged (estimated: 4)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 499.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>245 daily observations, continuous record | 1.6% flagged (estimated: 4) | Record: 0.7 years</td></tr>
...
show(plot_station_timeseries("08LG029"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG029")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG029/08LG029_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LG029/08LG029_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LG029"))
:::
...
<div class="download-section">
  <a href="../../08LG029/08LG029_field_visits.csv" download class="download-btn">
