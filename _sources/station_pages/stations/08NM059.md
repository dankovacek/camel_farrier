...
# 08NM059: POWERS CREEK BELOW WESTBANK DIVERSION
...
result = plot_station_polygon("08NM059")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM059">stations/08NM059 folder on GitHub</a>.
:::
...
<tr><td>08NM059</td><td>POWERS CREEK BELOW WESTBANK DIVERSION</td><td>49.841</td><td>-119.651</td><td>139.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 63.2 years
<br><strong>Timeseries Summary:</strong> 8,432 daily observations, seasonal gaps: 2096 days avg (N=7) | 21.1% flagged (backwater: 1111, estimated: 662, partial day: 4)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 330.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>8,432 daily observations, seasonal gaps: 2096 days avg (N=7) | 21.1% flagged (backwater: 1111, estimated: 662, partial day: 4) | Record: 63.2 years</td></tr>
...
show(plot_station_timeseries("08NM059"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM059")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM059/08NM059_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM059/08NM059_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM059"))
:::
...
<div class="download-section">
  <a href="../../08NM059/08NM059_field_visits.csv" download class="download-btn">
