...
# 08GA058: HOP RANCH CREEK ABOVE DRYDEN CREEK
...
result = plot_station_polygon("08GA058")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA058">stations/08GA058 folder on GitHub</a>.
:::
...
<tr><td>08GA058</td><td>HOP RANCH CREEK ABOVE DRYDEN CREEK</td><td>49.759</td><td>-123.127</td><td>2.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 336 daily observations, continuous record | 11.0% flagged (estimated: 25, partial day: 12)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 9.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>336 daily observations, continuous record | 11.0% flagged (estimated: 25, partial day: 12) | Record: 0.9 years</td></tr>
...
show(plot_station_timeseries("08GA058"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA058")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA058/08GA058_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA058/08GA058_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA058"))
:::
