...
# 08MH026: BRUNETTE RIVER AT SAPPERTON
...
result = plot_station_polygon("08MH026")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH026">stations/08MH026 folder on GitHub</a>.
:::
...
<tr><td>08MH026</td><td>BRUNETTE RIVER AT SAPPERTON</td><td>49.244</td><td>-122.899</td><td>68.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.96, ΔArea: +4.0%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 9,815 daily observations, seasonal gaps: 131 days avg (N=29) | 3.0% flagged (estimated: 277, partial day: 17)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 150.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>9,815 daily observations, seasonal gaps: 131 days avg (N=29) | 3.0% flagged (estimated: 277, partial day: 17) | Record: 37.2 years</td></tr>
...
show(plot_station_timeseries("08MH026"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH026")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH026/08MH026_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH026/08MH026_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH026"))
:::
...
<div class="download-section">
  <a href="../../08MH026/08MH026_field_visits.csv" download class="download-btn">
