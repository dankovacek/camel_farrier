...
# 08MH107: MURRAY CREEK NEAR MURRAYVILLE
...
result = plot_station_polygon("08MH107")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH107">stations/08MH107 folder on GitHub</a>.
:::
...
<tr><td>08MH107</td><td>MURRAY CREEK NEAR MURRAYVILLE</td><td>49.090</td><td>-122.636</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,371 daily observations, continuous record | 12.1% flagged (estimated: 163, backwater: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 62.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,371 daily observations, continuous record | 12.1% flagged (estimated: 163, backwater: 3) | Record: 3.8 years</td></tr>
...
show(plot_station_timeseries("08MH107"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH107")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH107/08MH107_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH107/08MH107_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH107"))
:::
...
<div class="download-section">
  <a href="../../08MH107/08MH107_field_visits.csv" download class="download-btn">
