...
# 08LG015: CLAPPERTON CREEK NEAR NICOLA
...
result = plot_station_polygon("08LG015")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG015">stations/08LG015 folder on GitHub</a>.
:::
...
<tr><td>08LG015</td><td>CLAPPERTON CREEK NEAR NICOLA</td><td>50.164</td><td>-120.669</td><td>181.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 336 daily observations, seasonal gaps: 182 days avg (N=1) | 58.3% flagged (estimated: 196)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 559.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>336 daily observations, seasonal gaps: 182 days avg (N=1) | 58.3% flagged (estimated: 196) | Record: 1.4 years</td></tr>
...
show(plot_station_timeseries("08LG015"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG015")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG015/08LG015_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LG015/08LG015_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LG015"))
:::
