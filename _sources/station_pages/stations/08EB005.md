...
result = plot_station_polygon("08EB005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EB005">stations/08EB005 folder on GitHub</a>.
:::
...
<tr><td>08EB005</td><td>SKEENA RIVER ABOVE BABINE RIVER</td><td>55.717</td><td>-127.687</td><td>12400.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 15,188 daily observations, seasonal gaps: 1553 days avg (N=3) | 45.4% flagged (backwater: 5784, estimated: 1016, partial day: 97)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 41149.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>15,188 daily observations, seasonal gaps: 1553 days avg (N=3) | 45.4% flagged (backwater: 5784, estimated: 1016, partial day: 97) | Record: 54.3 years</td></tr>
...
show(plot_station_timeseries("08EB005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EB005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EB005/08EB005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08EB005/08EB005_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08EB005/08EB005_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Historically, the upper end of the rating curve should be quite stable, as such, any shifts applied ...</td>
    </tr>
    <tr>
      <td>15.02</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Clone of curve 15.01 - revised lower grade for 2022 data. Curve 15.000 includes a breakpoint to acco...</td>
    </tr>
    <tr>
      <td>15.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve 15.000 includes a breakpoint to account for the effect of bedrock features on control. Shift d...</td>
    </tr>
    <tr>
      <td>15.00</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve 14.010 is coincidental to Curve 14.000. Created due to need for 'E' grade designation using gr...</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08EB005"))
:::
...
<div class="download-section">
  <a href="../../08EB005/08EB005_field_visits.csv" download class="download-btn">
