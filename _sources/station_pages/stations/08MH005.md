...
# 08MH005: ALOUETTE RIVER NEAR HANEY
...
result = plot_station_polygon("08MH005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH005">stations/08MH005 folder on GitHub</a>.
:::
...
<tr><td>08MH005</td><td>ALOUETTE RIVER NEAR HANEY</td><td>49.239</td><td>-122.580</td><td>233.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 113.3 years
<br><strong>Timeseries Summary:</strong> 22,223 daily observations, seasonal gaps: 2735 days avg (N=7) | 6.2% flagged (partial day: 753, estimated: 493, backwater: 122)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 558.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>22,223 daily observations, seasonal gaps: 2735 days avg (N=7) | 6.2% flagged (partial day: 753, estimated: 493, backwater: 122) | Record: 113.3 years</td></tr>
...
show(plot_station_timeseries("08MH005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH005/08MH005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08MH005/08MH005_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08MH005/08MH005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH005"))
:::
...
<div class="download-section">
  <a href="../../08MH005/08MH005_field_visits.csv" download class="download-btn">
