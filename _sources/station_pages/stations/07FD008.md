...
# 07FD008: HINES CREEK NEAR FAIRVIEW
...
result = plot_station_polygon("07FD008")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07FD008">stations/07FD008 folder on GitHub</a>.
:::
...
<tr><td>07FD008</td><td>HINES CREEK NEAR FAIRVIEW</td><td>56.068</td><td>-118.660</td><td>1240.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 20.2 years
<br><strong>Timeseries Summary:</strong> 5,333 daily observations, seasonal gaps: 98 days avg (N=21) | 32.6% flagged (backwater: 1064, estimated: 665, partial day: 9)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3942.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>5,333 daily observations, seasonal gaps: 98 days avg (N=21) | 32.6% flagged (backwater: 1064, estimated: 665, partial day: 9) | Record: 20.2 years</td></tr>
...
show(plot_station_timeseries("07FD008"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07FD008")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07FD008/07FD008_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07FD008/07FD008_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07FD008"))
:::
