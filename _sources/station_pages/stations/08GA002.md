...
# 08GA002: BRANDT CREEK NEAR VANCOUVER (LOWER STATION)
...
result = plot_station_polygon("08GA002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA002">stations/08GA002 folder on GitHub</a>.
:::
...
<tr><td>08GA002</td><td>BRANDT CREEK NEAR VANCOUVER (LOWER STATION)</td><td>49.527</td><td>-122.897</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 730 daily observations, continuous record | 24.8% flagged (estimated: 181)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 43.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>730 daily observations, continuous record | 24.8% flagged (estimated: 181) | Record: 2.0 years</td></tr>
...
show(plot_station_timeseries("08GA002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA002/08GA002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA002/08GA002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA002"))
:::
...
<div class="download-section">
  <a href="../../08GA002/08GA002_field_visits.csv" download class="download-btn">
