...
# 07DA042: RED CLAY CREEK NEAR THE MOUTH
...
result = plot_station_polygon("07DA042")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DA042">stations/07DA042 folder on GitHub</a>.
:::
...
<tr><td>07DA042</td><td>RED CLAY CREEK NEAR THE MOUTH</td><td>57.743</td><td>-111.421</td><td>176.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 6.7 years
<br><strong>Timeseries Summary:</strong> 2,437 daily observations, continuous record | 51.7% flagged (backwater: 1155, estimated: 82, partial day: 24)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 623.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,437 daily observations, continuous record | 51.7% flagged (backwater: 1155, estimated: 82, partial day: 24) | Record: 6.7 years</td></tr>
...
show(plot_station_timeseries("07DA042"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07DA042")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07DA042/07DA042_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07DA042/07DA042_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07DA042/07DA042_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07DA042"))
:::
...
<div class="download-section">
  <a href="../../07DA042/07DA042_field_visits.csv" download class="download-btn">
