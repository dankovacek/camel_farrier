...
result = plot_station_polygon("08HB011")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB011">stations/08HB011 folder on GitHub</a>.
:::
...
<tr><td>08HB011</td><td>TSOLUM RIVER NEAR COURTENAY</td><td>49.706</td><td>-125.011</td><td>251.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 24,019 daily observations, seasonal gaps: 2343 days avg (N=7) | 4.6% flagged (estimated: 656, backwater: 334, partial day: 109)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 631.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>24,019 daily observations, seasonal gaps: 2343 days avg (N=7) | 4.6% flagged (estimated: 656, backwater: 334, partial day: 109) | Record: 110.7 years</td></tr>
...
show(plot_station_timeseries("08HB011"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB011")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB011/08HB011_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08HB011/08HB011_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HB011/08HB011_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HB011"))
:::
...
<div class="download-section">
  <a href="../../08HB011/08HB011_field_visits.csv" download class="download-btn">
