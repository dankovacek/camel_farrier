...
result = plot_station_polygon("08HB068")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB068">stations/08HB068 folder on GitHub</a>.
:::
...
<tr><td>08HB068</td><td>MCCOY CREEK NEAR ALBERNI</td><td>49.265</td><td>-124.866</td><td>15.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,284 daily observations, seasonal gaps: 145 days avg (N=5) | 5.1% flagged (estimated: 65)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 35.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,284 daily observations, seasonal gaps: 145 days avg (N=5) | 5.1% flagged (estimated: 65) | Record: 5.5 years</td></tr>
...
show(plot_station_timeseries("08HB068"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB068")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB068/08HB068_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HB068/08HB068_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HB068"))
:::
...
<div class="download-section">
  <a href="../../08HB068/08HB068_field_visits.csv" download class="download-btn">
