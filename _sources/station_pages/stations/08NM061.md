...
# 08NM061: KELOWNA CREEK NEAR RUTLAND
...
result = plot_station_polygon("08NM061")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM061">stations/08NM061 folder on GitHub</a>.
:::
...
<tr><td>08NM061</td><td>KELOWNA CREEK NEAR RUTLAND</td><td>49.979</td><td>-119.353</td><td>77.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 7.4 years
<br><strong>Timeseries Summary:</strong> 1,284 daily observations, seasonal gaps: 204 days avg (N=7) | 11.1% flagged (estimated: 143)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 185.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,284 daily observations, seasonal gaps: 204 days avg (N=7) | 11.1% flagged (estimated: 143) | Record: 7.4 years</td></tr>
...
show(plot_station_timeseries("08NM061"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM061")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM061/08NM061_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM061/08NM061_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM061"))
:::
...
<div class="download-section">
  <a href="../../08NM061/08NM061_field_visits.csv" download class="download-btn">
