...
result = plot_station_polygon("08ME023")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08ME023">stations/08ME023 folder on GitHub</a>.
:::
...
<tr><td>08ME023</td><td>BRIDGE RIVER (SOUTH BRANCH) BELOW BRIDGE GLACIER</td><td>50.856</td><td>-123.453</td><td>144.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 46.5 years
<br><strong>Timeseries Summary:</strong> 16,776 daily observations, minor gaps: 70 days avg (N=3) | 51.8% flagged (backwater: 8299, estimated: 333, partial day: 51)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 366.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>16,776 daily observations, minor gaps: 70 days avg (N=3) | 51.8% flagged (backwater: 8299, estimated: 333, partial day: 51) | Record: 46.5 years</td></tr>
...
show(plot_station_timeseries("08ME023"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08ME023")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08ME023/08ME023_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08ME023/08ME023_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08ME023/08ME023_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>2 Eqn Rating - Section control to Channel Control</td>
    </tr>
    <tr>
      <td>23.0</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08ME023"))
:::
