...
result = plot_station_polygon("08KH014")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KH014">stations/08KH014 folder on GitHub</a>.
:::
...
<tr><td>08KH014</td><td>MITCHELL RIVER AT OUTLET OF MITCHELL LAKE</td><td>52.843</td><td>-120.742</td><td>245.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 21.6 years
<br><strong>Timeseries Summary:</strong> 7,336 daily observations, seasonal gaps: 137 days avg (N=4) | 26.5% flagged (backwater: 1127, estimated: 775, partial day: 40)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 687.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>7,336 daily observations, seasonal gaps: 137 days avg (N=4) | 26.5% flagged (backwater: 1127, estimated: 775, partial day: 40) | Record: 21.6 years</td></tr>
...
show(plot_station_timeseries("08KH014"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KH014")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KH014/08KH014_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KH014/08KH014_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KH014"))
:::
...
<div class="download-section">
  <a href="../../08KH014/08KH014_field_visits.csv" download class="download-btn">
