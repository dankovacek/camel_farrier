...
result = plot_station_polygon("07GD004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07GD004">stations/07GD004 folder on GitHub</a>.
:::
...
<tr><td>07GD004</td><td>REDWILLOW RIVER NEAR RIO GRANDE</td><td>55.079</td><td>-119.702</td><td>1250.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 31.5 years
<br><strong>Timeseries Summary:</strong> 11,476 daily observations, minor gaps: 31 days avg (N=1) | 51.1% flagged (backwater: 5471, estimated: 315, partial day: 82)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3767.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>11,476 daily observations, minor gaps: 31 days avg (N=1) | 51.1% flagged (backwater: 5471, estimated: 315, partial day: 82) | Record: 31.5 years</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07GD004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07GD004/07GD004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07GD004/07GD004_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07GD004/07GD004_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Extension of curve 8.00 to populate 0 flow conditions in Aquarius. A two segment curve representing ...</td>
    </tr>
    <tr>
      <td>8.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve 7 plotting right on low end</td>
    </tr>
    <tr>
      <td>7.00</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Same a Curve#5 below 2.980m and above 5.299m</td>
    </tr>
    <tr>
      <td>6.000-SC3</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07GD004"))
:::
...
<div class="download-section">
  <a href="../../07GD004/07GD004_field_visits.csv" download class="download-btn">
