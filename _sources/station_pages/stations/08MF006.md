...
# 08MF006: WAHLEACH CREEK NEAR LAIDLAW (UPPER STATION)
...
result = plot_station_polygon("08MF006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MF006">stations/08MF006 folder on GitHub</a>.
:::
...
<tr><td>08MF006</td><td>WAHLEACH CREEK NEAR LAIDLAW (UPPER STATION)</td><td>49.251</td><td>-121.604</td><td>64.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 40.6 years
<br><strong>Timeseries Summary:</strong> 5,999 daily observations, seasonal gaps: 2942 days avg (N=3) | 0.2% flagged (estimated: 13)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 209.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>5,999 daily observations, seasonal gaps: 2942 days avg (N=3) | 0.2% flagged (estimated: 13) | Record: 40.6 years</td></tr>
...
show(plot_station_timeseries("08MF006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MF006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MF006/08MF006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MF006/08MF006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MF006"))
:::
...
<div class="download-section">
  <a href="../../08MF006/08MF006_field_visits.csv" download class="download-btn">
