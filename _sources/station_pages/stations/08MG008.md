...
result = plot_station_polygon("08MG008")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MG008">stations/08MG008 folder on GitHub</a>.
:::
...
<tr><td>08MG008</td><td>BIRKENHEAD RIVER AT MOUNT CURRIE</td><td>50.339</td><td>-122.728</td><td>596.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 26.1 years
<br><strong>Timeseries Summary:</strong> 9,407 daily observations, minor gaps: 40 days avg (N=3) | 30.8% flagged (estimated: 2666, backwater: 234)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1588.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>9,407 daily observations, minor gaps: 40 days avg (N=3) | 30.8% flagged (estimated: 2666, backwater: 234) | Record: 26.1 years</td></tr>
...
show(plot_station_timeseries("08MG008"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MG008")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MG008/08MG008_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MG008/08MG008_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MG008"))
:::
...
<div class="download-section">
  <a href="../../08MG008/08MG008_field_visits.csv" download class="download-btn">
