...
The data representing the above plots can be downloaded from the [stations/10LC003](https://dankovacek.github.io/camel_farrier/stations/10LC003) folder in the Github repository.
