...
# 08MH105: NICOMEKL RIVER BELOW MURRAY CREEK
...
result = plot_station_polygon("08MH105")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH105">stations/08MH105 folder on GitHub</a>.
:::
...
<tr><td>08MH105</td><td>NICOMEKL RIVER BELOW MURRAY CREEK</td><td>49.101</td><td>-122.646</td><td>64.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 19.7 years
<br><strong>Timeseries Summary:</strong> 7,184 daily observations, continuous record | 6.8% flagged (backwater: 218, partial day: 161, estimated: 109)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 153.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>7,184 daily observations, continuous record | 6.8% flagged (backwater: 218, partial day: 161, estimated: 109) | Record: 19.7 years</td></tr>
...
show(plot_station_timeseries("08MH105"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH105")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH105/08MH105_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH105/08MH105_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH105"))
:::
