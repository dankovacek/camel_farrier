...
# 07JA001: UTIKUMA LAKE NEAR NIPISI
...
result = plot_station_polygon("07JA001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07JA001">stations/07JA001 folder on GitHub</a>.
:::
...
<tr><td>07JA001</td><td>UTIKUMA LAKE NEAR NIPISI</td><td>55.914</td><td>-115.171</td><td>2478.8 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 7921.8 km²</td></tr>
...
show(plot_station_timeseries("07JA001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07JA001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07JA001/07JA001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07JA001/07JA001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07JA001"))
:::
...
<div class="download-section">
  <a href="../../07JA001/07JA001_field_visits.csv" download class="download-btn">
