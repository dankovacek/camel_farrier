...
result = plot_station_polygon("08NE113")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE113">stations/08NE113 folder on GitHub</a>.
:::
...
<tr><td>08NE113</td><td>KELLY CREEK AT 850 M CONTOUR</td><td>49.109</td><td>-117.502</td><td>23.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 11.8 years
<br><strong>Timeseries Summary:</strong> 4,324 daily observations, continuous record | 66.1% flagged (estimated: 2458, backwater: 402)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 53.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>4,324 daily observations, continuous record | 66.1% flagged (estimated: 2458, backwater: 402) | Record: 11.8 years</td></tr>
...
show(plot_station_timeseries("08NE113"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE113")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE113/08NE113_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE113/08NE113_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE113"))
:::
