...
result = plot_station_polygon("08LF002")
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 13490.4 km²</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF002/08LF002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08LF002/08LF002_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LF002/08LF002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF002"))
:::
