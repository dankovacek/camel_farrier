...
result = plot_station_polygon("08LC025")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LC025">stations/08LC025 folder on GitHub</a>.
:::
...
<tr><td>08LC025</td><td>BLURTON CREEK NEAR MARA</td><td>50.679</td><td>-119.046</td><td>19.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,068 daily observations, seasonal gaps: 334 days avg (N=5) | 33.1% flagged (estimated: 354)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 46.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,068 daily observations, seasonal gaps: 334 days avg (N=5) | 33.1% flagged (estimated: 354) | Record: 7.5 years</td></tr>
...
show(plot_station_timeseries("08LC025"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LC025")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LC025/08LC025_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LC025/08LC025_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LC025"))
:::
...
<div class="download-section">
  <a href="../../08LC025/08LC025_field_visits.csv" download class="download-btn">
