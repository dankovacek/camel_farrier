...
# 10TN001: LANG RIVER ABOVE PRINCE REGENT INLET
...
result = plot_station_polygon("10TN001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10TN001">stations/10TN001 folder on GitHub</a>.
:::
...
<tr><td>10TN001</td><td>LANG RIVER ABOVE PRINCE REGENT INLET</td><td>72.283</td><td>-94.200</td><td>134.0 (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1480.2 km²</td></tr>
...
show(plot_station_timeseries("10TN001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10TN001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10TN001/10TN001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10TN001"))
:::
...
<div class="download-section">
  <a href="../../10TN001/10TN001_field_visits.csv" download class="download-btn">
