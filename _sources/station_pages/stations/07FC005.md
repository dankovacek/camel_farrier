...
# 07FC005: CHARLIE LAKE NEAR FORT ST. JOHN
...
result = plot_station_polygon("07FC005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07FC005">stations/07FC005 folder on GitHub</a>.
:::
...
<tr><td>07FC005</td><td>CHARLIE LAKE NEAR FORT ST. JOHN</td><td>56.281</td><td>-120.957</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 971.0 km²</td></tr>
...
show(plot_station_timeseries("07FC005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07FC005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07FC005/07FC005_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07FC005/07FC005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07FC005"))
:::
