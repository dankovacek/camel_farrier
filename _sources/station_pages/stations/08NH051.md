...
result = plot_station_polygon("08NH051")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH051">stations/08NH051 folder on GitHub</a>.
:::
...
<tr><td>08NH051</td><td>ARGENTA CREEK NEAR ARGENTA</td><td>50.164</td><td>-116.900</td><td>5.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 58.2 years
<br><strong>Timeseries Summary:</strong> 5,269 daily observations, seasonal gaps: 2668 days avg (N=6) | 26.2% flagged (estimated: 1220, partial day: 138, backwater: 20)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 15.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>5,269 daily observations, seasonal gaps: 2668 days avg (N=6) | 26.2% flagged (estimated: 1220, partial day: 138, backwater: 20) | Record: 58.2 years</td></tr>
...
show(plot_station_timeseries("08NH051"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH051")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH051/08NH051_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH051/08NH051_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH051"))
:::
...
<div class="download-section">
  <a href="../../08NH051/08NH051_field_visits.csv" download class="download-btn">
