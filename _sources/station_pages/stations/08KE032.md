...
# 08KE032: TABOR CREEK ABOVE SWEDE CREEK
...
result = plot_station_polygon("08KE032")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KE032">stations/08KE032 folder on GitHub</a>.
:::
...
<tr><td>08KE032</td><td>TABOR CREEK ABOVE SWEDE CREEK</td><td>53.862</td><td>-122.571</td><td>60.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 18.1 years
<br><strong>Timeseries Summary:</strong> 5,874 daily observations, seasonal gaps: 91 days avg (N=8) | 48.1% flagged (backwater: 2126, estimated: 684, partial day: 15)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 187.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>5,874 daily observations, seasonal gaps: 91 days avg (N=8) | 48.1% flagged (backwater: 2126, estimated: 684, partial day: 15) | Record: 18.1 years</td></tr>
...
show(plot_station_timeseries("08KE032"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KE032")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KE032/08KE032_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KE032/08KE032_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KE032"))
:::
