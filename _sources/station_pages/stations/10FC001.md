...
# 10FC001: PLATEAU CREEK NEAR WILLOW LAKE
...
result = plot_station_polygon("10FC001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10FC001">stations/10FC001 folder on GitHub</a>.
:::
...
<tr><td>10FC001</td><td>PLATEAU CREEK NEAR WILLOW LAKE</td><td>62.304</td><td>-118.233</td><td>69.9 (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.94, ΔArea: +3.8%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 9.7 years
<br><strong>Timeseries Summary:</strong> 3,351 daily observations, minor gaps: 60 days avg (N=3) | 57.4% flagged (backwater: 1746, estimated: 154, partial day: 23)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 202.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>3,351 daily observations, minor gaps: 60 days avg (N=3) | 57.4% flagged (backwater: 1746, estimated: 154, partial day: 23) | Record: 9.7 years</td></tr>
...
show(plot_station_timeseries("10FC001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10FC001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10FC001/10FC001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10FC001/10FC001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10FC001"))
:::
...
<div class="download-section">
  <a href="../../10FC001/10FC001_field_visits.csv" download class="download-btn">
