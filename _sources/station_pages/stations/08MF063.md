...
# 08MF063: LYTTON CREEK AT LYTTON
...
result = plot_station_polygon("08MF063")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MF063">stations/08MF063 folder on GitHub</a>.
:::
...
<tr><td>08MF063</td><td>LYTTON CREEK AT LYTTON</td><td>50.217</td><td>-121.551</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 489 daily observations, seasonal gaps: 106 days avg (N=4) | 38.2% flagged (estimated: 187)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 21.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>489 daily observations, seasonal gaps: 106 days avg (N=4) | 38.2% flagged (estimated: 187) | Record: 2.5 years</td></tr>
...
show(plot_station_timeseries("08MF063"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MF063")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MF063/08MF063_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MF063/08MF063_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MF063"))
:::
...
<div class="download-section">
  <a href="../../08MF063/08MF063_field_visits.csv" download class="download-btn">
