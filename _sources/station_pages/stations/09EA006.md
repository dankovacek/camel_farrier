...
# 09EA006: KLONDIKE RIVER AT ROCK CREEK
...
result = plot_station_polygon("09EA006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09EA006">stations/09EA006 folder on GitHub</a>.
:::
...
<tr><td>09EA006</td><td>KLONDIKE RIVER AT ROCK CREEK</td><td>64.062</td><td>-139.084</td><td>nan (0.0)</td><td>YT</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 36281.2 km²</td></tr>
...
show(plot_station_timeseries("09EA006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09EA006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09EA006/09EA006_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../09EA006/09EA006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("09EA006"))
:::
...
<div class="download-section">
  <a href="../../09EA006/09EA006_field_visits.csv" download class="download-btn">
