...
result = plot_station_polygon("08KE033")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KE033">stations/08KE033 folder on GitHub</a>.
:::
...
<tr><td>08KE033</td><td>ALIX CREEK ABOVE ALIX LAKES</td><td>52.637</td><td>-122.406</td><td>37.3 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,344 daily observations, seasonal gaps: 294 days avg (N=6) | 34.8% flagged (estimated: 461, partial day: 7)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 104.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,344 daily observations, seasonal gaps: 294 days avg (N=6) | 34.8% flagged (estimated: 461, partial day: 7) | Record: 8.5 years</td></tr>
...
show(plot_station_timeseries("08KE033"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KE033")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KE033/08KE033_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KE033/08KE033_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KE033"))
:::
