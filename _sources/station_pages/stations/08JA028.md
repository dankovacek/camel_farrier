...
# 08JA028: EUTSUK RIVER AT OUTLET OF EUTSUK LAKE
...
result = plot_station_polygon("08JA028")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08JA028">stations/08JA028 folder on GitHub</a>.
:::
...
<tr><td>08JA028</td><td>EUTSUK RIVER AT OUTLET OF EUTSUK LAKE</td><td>53.234</td><td>-126.112</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 20.4 years
<br><strong>Timeseries Summary:</strong> 4,534 daily observations, seasonal gaps: 2922 days avg (N=1) | 4.5% flagged (estimated: 95, partial day: 77, backwater: 32)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 7121.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>4,534 daily observations, seasonal gaps: 2922 days avg (N=1) | 4.5% flagged (estimated: 95, partial day: 77, backwater: 32) | Record: 20.4 years</td></tr>
...
show(plot_station_timeseries("08JA028"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08JA028")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08JA028/08JA028_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08JA028/08JA028_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08JA028/08JA028_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08JA028"))
:::
...
<div class="download-section">
  <a href="../../08JA028/08JA028_field_visits.csv" download class="download-btn">
