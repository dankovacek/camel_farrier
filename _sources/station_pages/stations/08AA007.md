...
# 08AA007: SEKULMUN LAKE NEAR WHITEHORSE
...
result = plot_station_polygon("08AA007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08AA007">stations/08AA007 folder on GitHub</a>.
:::
...
<tr><td>08AA007</td><td>SEKULMUN LAKE NEAR WHITEHORSE</td><td>61.536</td><td>-137.590</td><td>nan (0.0)</td><td>YT</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5326.4 km²</td></tr>
...
show(plot_station_timeseries("08AA007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08AA007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08AA007/08AA007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08AA007/08AA007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08AA007"))
:::
...
<div class="download-section">
  <a href="../../08AA007/08AA007_field_visits.csv" download class="download-btn">
