...
# 08NM066: WOOD LAKE AT INLET TO OYAMA CANAL
...
result = plot_station_polygon("08NM066")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM066">stations/08NM066 folder on GitHub</a>.
:::
...
<tr><td>08NM066</td><td>WOOD LAKE AT INLET TO OYAMA CANAL</td><td>50.110</td><td>-119.382</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
show(plot_station_timeseries("08NM066"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM066")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM066/08NM066_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM066/08NM066_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM066"))
:::
...
<div class="download-section">
  <a href="../../08NM066/08NM066_field_visits.csv" download class="download-btn">
