...
# 08NE106: BEAVER CREEK AT THE MOUTH
...
result = plot_station_polygon("08NE106")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE106">stations/08NE106 folder on GitHub</a>.
:::
...
<tr><td>08NE106</td><td>BEAVER CREEK AT THE MOUTH</td><td>49.069</td><td>-117.601</td><td>267.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 8.9 years
<br><strong>Timeseries Summary:</strong> 3,256 daily observations, continuous record | 61.5% flagged (estimated: 1902, backwater: 99)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 616.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>3,256 daily observations, continuous record | 61.5% flagged (estimated: 1902, backwater: 99) | Record: 8.9 years</td></tr>
...
show(plot_station_timeseries("08NE106"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE106")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE106/08NE106_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE106/08NE106_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE106"))
:::
...
<div class="download-section">
  <a href="../../08NE106/08NE106_field_visits.csv" download class="download-btn">
