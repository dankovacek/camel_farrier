...
# 08LE068: MONTE LAKE NEAR MONTE LAKE
...
result = plot_station_polygon("08LE068")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE068">stations/08LE068 folder on GitHub</a>.
:::
...
<tr><td>08LE068</td><td>MONTE LAKE NEAR MONTE LAKE</td><td>50.492</td><td>-119.833</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 41.8 km²</td></tr>
...
show(plot_station_timeseries("08LE068"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE068")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE068/08LE068_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LE068/08LE068_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE068"))
:::
...
<div class="download-section">
  <a href="../../08LE068/08LE068_field_visits.csv" download class="download-btn">
