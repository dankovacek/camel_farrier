...
# 08LG021: REY CREEK NEAR MAMETTE LAKE
...
result = plot_station_polygon("08LG021")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG021">stations/08LG021 folder on GitHub</a>.
:::
...
<tr><td>08LG021</td><td>REY CREEK NEAR MAMETTE LAKE</td><td>50.360</td><td>-120.796</td><td>64.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 122 daily observations, minor gaps: 61 days avg (N=1)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 152.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>122 daily observations, minor gaps: 61 days avg (N=1) | Record: 0.5 years</td></tr>
...
show(plot_station_timeseries("08LG021"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG021")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG021/08LG021_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LG021/08LG021_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LG021"))
:::
...
<div class="download-section">
  <a href="../../08LG021/08LG021_field_visits.csv" download class="download-btn">
