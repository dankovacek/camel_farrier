...
# 08NM231: IDEAL LAKE NEAR THE OUTLET
...
result = plot_station_polygon("08NM231")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM231">stations/08NM231 folder on GitHub</a>.
:::
...
<tr><td>08NM231</td><td>IDEAL LAKE NEAR THE OUTLET</td><td>50.011</td><td>-119.096</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 84.7 km²</td></tr>
...
show(plot_station_timeseries("08NM231"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM231")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM231/08NM231_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM231/08NM231_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM231"))
:::
...
<div class="download-section">
  <a href="../../08NM231/08NM231_field_visits.csv" download class="download-btn">
