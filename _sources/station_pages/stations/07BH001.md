...
# 07BH001: ARCADIA CREEK NEAR ARCADIA
...
result = plot_station_polygon("07BH001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07BH001">stations/07BH001 folder on GitHub</a>.
:::
...
<tr><td>07BH001</td><td>ARCADIA CREEK NEAR ARCADIA</td><td>55.399</td><td>-116.128</td><td>177.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 183 daily observations, continuous record | 38.3% flagged (estimated: 64, backwater: 6)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 559.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>183 daily observations, continuous record | 38.3% flagged (estimated: 64, backwater: 6) | Record: 0.5 years</td></tr>
...
show(plot_station_timeseries("07BH001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07BH001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07BH001/07BH001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07BH001/07BH001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07BH001"))
:::
