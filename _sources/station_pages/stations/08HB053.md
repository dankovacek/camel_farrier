...
# 08HB053: HOGGAN LAKE ON GABRIOLA ISLAND
...
result = plot_station_polygon("08HB053")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB053">stations/08HB053 folder on GitHub</a>.
:::
...
<tr><td>08HB053</td><td>HOGGAN LAKE ON GABRIOLA ISLAND</td><td>49.153</td><td>-123.826</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
show(plot_station_timeseries("08HB053"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB053")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB053/08HB053_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HB053/08HB053_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HB053"))
:::
...
<div class="download-section">
  <a href="../../08HB053/08HB053_field_visits.csv" download class="download-btn">
