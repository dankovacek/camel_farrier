...
# 08KC002: WRIGHT CREEK AT THE MOUTH
...
result = plot_station_polygon("08KC002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KC002">stations/08KC002 folder on GitHub</a>.
:::
...
<tr><td>08KC002</td><td>WRIGHT CREEK AT THE MOUTH</td><td>54.094</td><td>-122.686</td><td>181.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 9.6 years
<br><strong>Timeseries Summary:</strong> 3,470 daily observations, minor gaps: 31 days avg (N=1) | 51.2% flagged (backwater: 1260, estimated: 515)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 518.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>3,470 daily observations, minor gaps: 31 days avg (N=1) | 51.2% flagged (backwater: 1260, estimated: 515) | Record: 9.6 years</td></tr>
...
show(plot_station_timeseries("08KC002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KC002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KC002/08KC002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KC002/08KC002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KC002"))
:::
...
<div class="download-section">
  <a href="../../08KC002/08KC002_field_visits.csv" download class="download-btn">
