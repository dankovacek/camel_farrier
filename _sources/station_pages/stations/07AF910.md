...
# 07AF910: WHITEHORSE CREEK NEAR CADOMIN
...
result = plot_station_polygon("07AF910")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07AF910">stations/07AF910 folder on GitHub</a>.
:::
...
<tr><td>07AF910</td><td>WHITEHORSE CREEK NEAR CADOMIN</td><td>52.983</td><td>-117.344</td><td>115.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 642 daily observations, seasonal gaps: 151 days avg (N=2) | 17.6% flagged (backwater: 74, estimated: 38, partial day: 1)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 319.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>642 daily observations, seasonal gaps: 151 days avg (N=2) | 17.6% flagged (backwater: 74, estimated: 38, partial day: 1) | Record: 2.6 years</td></tr>
...
show(plot_station_timeseries("07AF910"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07AF910")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07AF910/07AF910_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07AF910/07AF910_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07AF910"))
:::
