...
result = plot_station_polygon("08NK022")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NK022">stations/08NK022 folder on GitHub</a>.
:::
...
<tr><td>08NK022</td><td>LINE CREEK AT THE MOUTH</td><td>49.891</td><td>-114.833</td><td>138.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 19,634 daily observations, continuous record | 34.6% flagged (backwater: 4612, estimated: 2030, partial day: 159)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 329.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>19,634 daily observations, continuous record | 34.6% flagged (backwater: 4612, estimated: 2030, partial day: 159) | Record: 53.8 years</td></tr>
...
show(plot_station_timeseries("08NK022"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NK022")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NK022/08NK022_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NK022/08NK022_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NK022/08NK022_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Curve 57.00 was created based on 11 measurements post 2020 high water and pre 2022 high water, all b...</td>
    </tr>
    <tr>
      <td>56.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>CLONE 56.0 WITH NAMING CONVENTION & CC ESTIMATES</td>
    </tr>
    <tr>
      <td>56.00</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>clone curve to add curve conf limits</td>
    </tr>
    <tr>
      <td>55.00</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08NK022"))
:::
...
<div class="download-section">
  <a href="../../08NK022/08NK022_field_visits.csv" download class="download-btn">
