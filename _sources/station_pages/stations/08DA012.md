...
result = plot_station_polygon("08DA012")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08DA012">stations/08DA012 folder on GitHub</a>.
:::
...
<tr><td>08DA012</td><td>KELLY CREEK NEAR STEWART</td><td>56.293</td><td>-129.230</td><td>8.6 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-03-10</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.96, ΔArea: -1.4%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 26.9 years
<br><strong>Timeseries Summary:</strong> 6,505 daily observations, seasonal gaps: 133 days avg (N=25) | 22.5% flagged (estimated: 784, backwater: 653, partial day: 26)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 20.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>6,505 daily observations, seasonal gaps: 133 days avg (N=25) | 22.5% flagged (estimated: 784, backwater: 653, partial day: 26) | Record: 26.9 years</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08DA012")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08DA012/08DA012_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08DA012/08DA012_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08DA012/08DA012_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>New rating grades required. 2025-09-22 measurement indicates that Curve 27.00 is once again applicab...</td>
    </tr>
    <tr>
      <td>29.00</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extension at lower end.</td>
    </tr>
    <tr>
      <td>28.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New curve for 2022 and 2023 data based on control changed in fall of 2021</td>
    </tr>
    <tr>
      <td>27.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve defined using late 2020 and 2021 data which indicates scour of channel.</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08DA012"))
:::
...
<div class="download-section">
  <a href="../../08DA012/08DA012_field_visits.csv" download class="download-btn">
