...
result = plot_station_polygon("09DC002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09DC002">stations/09DC002 folder on GitHub</a>.
:::
...
<tr><td>09DC002</td><td>STEWART RIVER AT MAYO</td><td>63.591</td><td>-135.897</td><td>31600.0 (0.0)</td><td>YT</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 31.0 years
<br><strong>Timeseries Summary:</strong> 10,959 daily observations, seasonal gaps: 91 days avg (N=4) | 54.7% flagged (backwater: 5688, estimated: 296, partial day: 10)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 161151.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>10,959 daily observations, seasonal gaps: 91 days avg (N=4) | 54.7% flagged (backwater: 5688, estimated: 296, partial day: 10) | Record: 31.0 years</td></tr>
...
show(plot_station_timeseries("09DC002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09DC002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09DC002/09DC002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../09DC002/09DC002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("09DC002"))
:::
...
<div class="download-section">
  <a href="../../09DC002/09DC002_field_visits.csv" download class="download-btn">
