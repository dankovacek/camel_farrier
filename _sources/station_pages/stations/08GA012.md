...
# 08GA012: LYNN CREEK NEAR NORTH VANCOUVER
...
result = plot_station_polygon("08GA012")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA012">stations/08GA012 folder on GitHub</a>.
:::
...
<tr><td>08GA012</td><td>LYNN CREEK NEAR NORTH VANCOUVER</td><td>49.360</td><td>-123.026</td><td>36.3 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,948 daily observations, continuous record</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 93.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,948 daily observations, continuous record | Record: 5.3 years</td></tr>
...
show(plot_station_timeseries("08GA012"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA012")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA012/08GA012_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA012/08GA012_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA012"))
:::
...
<div class="download-section">
  <a href="../../08GA012/08GA012_field_visits.csv" download class="download-btn">
