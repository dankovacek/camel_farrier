...
# 08NM023: DARKE CREEK NORTHWEST FORK
...
result = plot_station_polygon("08NM023")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM023">stations/08NM023 folder on GitHub</a>.
:::
...
<tr><td>08NM023</td><td>DARKE CREEK NORTHWEST FORK</td><td>49.711</td><td>-119.867</td><td>13.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 153 daily observations, seasonal gaps: 273 days avg (N=1) | 24.2% flagged (estimated: 37)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 31.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>153 daily observations, seasonal gaps: 273 days avg (N=1) | 24.2% flagged (estimated: 37) | Record: 1.2 years</td></tr>
...
show(plot_station_timeseries("08NM023"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM023")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM023/08NM023_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM023/08NM023_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM023"))
:::
