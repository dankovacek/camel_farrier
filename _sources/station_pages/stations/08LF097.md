...
# 08LF097: BONAPARTE RIVER BELOW BONAPARTE LAKE
...
result = plot_station_polygon("08LF097")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF097">stations/08LF097 folder on GitHub</a>.
:::
...
<tr><td>08LF097</td><td>BONAPARTE RIVER BELOW BONAPARTE LAKE</td><td>51.281</td><td>-120.678</td><td>325.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 1.6 years
<br><strong>Timeseries Summary:</strong> 428 daily observations, minor gaps: 76 days avg (N=2) | 14.0% flagged (estimated: 60)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 795.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>428 daily observations, minor gaps: 76 days avg (N=2) | 14.0% flagged (estimated: 60) | Record: 1.6 years</td></tr>
...
show(plot_station_timeseries("08LF097"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF097")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF097/08LF097_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF097/08LF097_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF097"))
:::
...
<div class="download-section">
  <a href="../../08LF097/08LF097_field_visits.csv" download class="download-btn">
