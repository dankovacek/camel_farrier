...
# 08LA029: JUDSON CREEK NEAR THE MOUTH
...
result = plot_station_polygon("08LA029")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LA029">stations/08LA029 folder on GitHub</a>.
:::
...
<tr><td>08LA029</td><td>JUDSON CREEK NEAR THE MOUTH</td><td>51.570</td><td>-120.799</td><td>20.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 3.8 years
<br><strong>Timeseries Summary:</strong> 1,341 daily observations, minor gaps: 30 days avg (N=2) | 50.1% flagged (backwater: 525, estimated: 135, partial day: 12)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 56.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,341 daily observations, minor gaps: 30 days avg (N=2) | 50.1% flagged (backwater: 525, estimated: 135, partial day: 12) | Record: 3.8 years</td></tr>
...
show(plot_station_timeseries("08LA029"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LA029")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LA029/08LA029_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LA029/08LA029_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LA029"))
:::
...
<div class="download-section">
  <a href="../../08LA029/08LA029_field_visits.csv" download class="download-btn">
