...
# 08NM238: THIRSK LAKE NEAR THE OUTLET
...
result = plot_station_polygon("08NM238")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM238">stations/08NM238 folder on GitHub</a>.
:::
...
<tr><td>08NM238</td><td>THIRSK LAKE NEAR THE OUTLET</td><td>49.733</td><td>-120.092</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 585.0 km²</td></tr>
...
show(plot_station_timeseries("08NM238"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM238")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM238/08NM238_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM238/08NM238_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM238"))
:::
