...
# 08KE027: TWAN CREEK BELOW STORAGE DAM
...
result = plot_station_polygon("08KE027")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KE027">stations/08KE027 folder on GitHub</a>.
:::
...
<tr><td>08KE027</td><td>TWAN CREEK BELOW STORAGE DAM</td><td>52.531</td><td>-122.606</td><td>218.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 154 daily observations, minor gaps: 30 days avg (N=1)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1374.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>154 daily observations, minor gaps: 30 days avg (N=1) | Record: 0.5 years</td></tr>
...
show(plot_station_timeseries("08KE027"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KE027")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KE027/08KE027_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KE027/08KE027_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KE027"))
:::
...
<div class="download-section">
  <a href="../../08KE027/08KE027_field_visits.csv" download class="download-btn">
