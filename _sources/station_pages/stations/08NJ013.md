...
result = plot_station_polygon("08NJ013")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ013">stations/08NJ013 folder on GitHub</a>.
:::
...
<tr><td>08NJ013</td><td>SLOCAN RIVER NEAR CRESCENT VALLEY</td><td>49.460</td><td>-117.565</td><td>3330.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 111.0 years
<br><strong>Timeseries Summary:</strong> 36,984 daily observations, seasonal gaps: 1186 days avg (N=3) | 6.2% flagged (backwater: 1723, estimated: 301, partial day: 266)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 8006.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>36,984 daily observations, seasonal gaps: 1186 days avg (N=3) | 6.2% flagged (backwater: 1723, estimated: 301, partial day: 266) | Record: 111.0 years</td></tr>
...
show(plot_station_timeseries("08NJ013"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ013")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ013/08NJ013_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NJ013/08NJ013_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NJ013/08NJ013_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>coincident with no.8 at and above 1.200 m.</td>
    </tr>
    <tr>
      <td>8.00</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>REDEFINITION OF CURVE, FOR TREND TO THE RIGHT.</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08NJ013"))
:::
