...
# 08LG007: NICOLA RIVER NEAR MERRITT
...
result = plot_station_polygon("08LG007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG007">stations/08LG007 folder on GitHub</a>.
:::
...
<tr><td>08LG007</td><td>NICOLA RIVER NEAR MERRITT</td><td>50.144</td><td>-120.885</td><td>4300.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 96.6 years
<br><strong>Timeseries Summary:</strong> 19,360 daily observations, seasonal gaps: 5306 days avg (N=3) | 15.6% flagged (backwater: 2079, estimated: 850, partial day: 85)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 10492.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>19,360 daily observations, seasonal gaps: 5306 days avg (N=3) | 15.6% flagged (backwater: 2079, estimated: 850, partial day: 85) | Record: 96.6 years</td></tr>
...
show(plot_station_timeseries("08LG007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG007/08LG007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LG007/08LG007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LG007"))
:::
...
<div class="download-section">
  <a href="../../08LG007/08LG007_field_visits.csv" download class="download-btn">
