...
result = plot_station_polygon("08HA069")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HA069">stations/08HA069 folder on GitHub</a>.
:::
...
<tr><td>08HA069</td><td>RENFREW CREEK NEAR PORT RENFREW</td><td>48.637</td><td>-124.292</td><td>8.1 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 10,196 daily observations, minor gaps: 31 days avg (N=1) | 3.9% flagged (estimated: 330, partial day: 62, backwater: 5)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>10,196 daily observations, minor gaps: 31 days avg (N=1) | 3.9% flagged (estimated: 330, partial day: 62, backwater: 5) | Record: 28.0 years</td></tr>
...
show(plot_station_timeseries("08HA069"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HA069")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HA069/08HA069_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08HA069/08HA069_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HA069/08HA069_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Mean curve using the most recent MMTs to account for the scouring at the low end</td>
    </tr>
    <tr>
      <td>29.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve is an attempt to create a statistical mean while working with the constraints of offset max = ...</td>
    </tr>
    <tr>
      <td>28.000</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve improvement based on best fit.</td>
    </tr>
    <tr>
      <td>26.000</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08HA069"))
:::
...
<div class="download-section">
  <a href="../../08HA069/08HA069_field_visits.csv" download class="download-btn">
