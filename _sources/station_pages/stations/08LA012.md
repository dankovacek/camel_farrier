...
# 08LA012: CLEARWATER LAKE NEAR CLEARWATER STATION
...
result = plot_station_polygon("08LA012")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LA012">stations/08LA012 folder on GitHub</a>.
:::
...
<tr><td>08LA012</td><td>CLEARWATER LAKE NEAR CLEARWATER STATION</td><td>52.143</td><td>-120.192</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 7920.7 km²</td></tr>
...
show(plot_station_timeseries("08LA012"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LA012")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LA012/08LA012_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LA012/08LA012_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LA012"))
:::
...
<div class="download-section">
  <a href="../../08LA012/08LA012_field_visits.csv" download class="download-btn">
