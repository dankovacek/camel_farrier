...
# 08NH049: BIRKBECK CREEK NEAR GRAY CREEK
...
result = plot_station_polygon("08NH049")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH049">stations/08NH049 folder on GitHub</a>.
:::
...
<tr><td>08NH049</td><td>BIRKBECK CREEK NEAR GRAY CREEK</td><td>49.610</td><td>-116.770</td><td>1.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.95, ΔArea: +4.6%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 366 daily observations, seasonal gaps: 182 days avg (N=1) | 55.2% flagged (estimated: 202)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>366 daily observations, seasonal gaps: 182 days avg (N=1) | 55.2% flagged (estimated: 202) | Record: 1.5 years</td></tr>
...
show(plot_station_timeseries("08NH049"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH049")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH049/08NH049_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH049/08NH049_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH049"))
:::
