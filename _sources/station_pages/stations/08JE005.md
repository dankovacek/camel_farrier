...
result = plot_station_polygon("08JE005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08JE005">stations/08JE005 folder on GitHub</a>.
:::
...
<tr><td>08JE005</td><td>KAZCHEK CREEK NEAR THE MOUTH</td><td>54.900</td><td>-125.138</td><td>881.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 10.0 years
<br><strong>Timeseries Summary:</strong> 2,467 daily observations, seasonal gaps: 593 days avg (N=2) | 44.5% flagged (backwater: 942, estimated: 150, partial day: 5)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2580.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,467 daily observations, seasonal gaps: 593 days avg (N=2) | 44.5% flagged (backwater: 942, estimated: 150, partial day: 5) | Record: 10.0 years</td></tr>
...
show(plot_station_timeseries("08JE005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08JE005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08JE005/08JE005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08JE005/08JE005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08JE005"))
:::
