...
# 08OB003: MATHERS CREEK NEAR SANDSPIT
...
result = plot_station_polygon("08OB003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08OB003">stations/08OB003 folder on GitHub</a>.
:::
...
<tr><td>08OB003</td><td>MATHERS CREEK NEAR SANDSPIT</td><td>53.017</td><td>-131.778</td><td>79.3 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 364 daily observations, minor gaps: 71 days avg (N=6) | 3.3% flagged (estimated: 12)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 212.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>364 daily observations, minor gaps: 71 days avg (N=6) | 3.3% flagged (estimated: 12) | Record: 2.2 years</td></tr>
...
show(plot_station_timeseries("08OB003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08OB003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08OB003/08OB003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08OB003/08OB003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08OB003"))
:::
