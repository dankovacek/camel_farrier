...
result = plot_station_polygon("10GC002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10GC002">stations/10GC002 folder on GitHub</a>.
:::
...
<tr><td>10GC002</td><td>HARRIS RIVER NEAR THE MOUTH</td><td>61.877</td><td>-121.296</td><td>701.0 (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 8,584 daily observations, minor gaps: 30 days avg (N=1) | 59.1% flagged (backwater: 4554, estimated: 467, partial day: 48)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3058.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>8,584 daily observations, minor gaps: 30 days avg (N=1) | 59.1% flagged (backwater: 4554, estimated: 467, partial day: 48) | Record: 23.6 years</td></tr>
...
show(plot_station_timeseries("10GC002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10GC002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10GC002/10GC002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10GC002/10GC002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10GC002"))
:::
