...
# 07FA007: CYPRESS CREEK NEAR THE MOUTH
...
result = plot_station_polygon("07FA007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07FA007">stations/07FA007 folder on GitHub</a>.
:::
...
<tr><td>07FA007</td><td>CYPRESS CREEK NEAR THE MOUTH</td><td>56.823</td><td>-122.625</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,277 daily observations, continuous record | 55.2% flagged (backwater: 593, estimated: 71, partial day: 41)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2071.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,277 daily observations, continuous record | 55.2% flagged (backwater: 593, estimated: 71, partial day: 41) | Record: 3.5 years</td></tr>
...
show(plot_station_timeseries("07FA007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07FA007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07FA007/07FA007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07FA007/07FA007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07FA007"))
:::
...
<div class="download-section">
  <a href="../../07FA007/07FA007_field_visits.csv" download class="download-btn">
