...
# 10VK001: RUGGLES RIVER AT OUTLET LAKE HAZEN
...
result = plot_station_polygon("10VK001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10VK001">stations/10VK001 folder on GitHub</a>.
:::
...
<tr><td>10VK001</td><td>RUGGLES RIVER AT OUTLET LAKE HAZEN</td><td>81.794</td><td>-70.440</td><td>nan (0.0)</td><td>NU</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 28.6 years
<br><strong>Timeseries Summary:</strong> 3,354 daily observations, seasonal gaps: 1181 days avg (N=6) | 86.3% flagged (estimated: 1618, backwater: 1255, partial day: 22)</p>

<table class="dataframe table">
<tr><th>Check Category</th><th>Status</th><th>Notes</th></tr>
<tr><td><strong>Data Completeness</strong></td><td>⚠️ Warning</td><td>Missing: corrections</td></tr>
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 354692.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,354 daily observations, seasonal gaps: 1181 days avg (N=6) | 86.3% flagged (estimated: 1618, backwater: 1255, partial day: 22) | Record: 28.6 years</td></tr>
...
show(plot_station_timeseries("10VK001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10VK001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10VK001/10VK001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10VK001/10VK001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10VK001/10VK001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Rating of best fit for most recent open water measurements and high water measurements.  Good expone...</td>
    </tr>
    <tr>
      <td>5.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>revising on the assumption all June mmts since scour event (2013) are B</td>
    </tr>
    <tr>
      <td>4.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Provisional/Provisoire</td>
      <td>Made with HQfit, smoothed manually</td>
    </tr>
    <tr>
      <td>1.0</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("10VK001"))
:::
...
<div class="download-section">
  <a href="../../10VK001/10VK001_field_visits.csv" download class="download-btn">
