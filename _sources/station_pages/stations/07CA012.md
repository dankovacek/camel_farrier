...
result = plot_station_polygon("07CA012")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07CA012">stations/07CA012 folder on GitHub</a>.
:::
...
<tr><td>07CA012</td><td>LOGAN RIVER NEAR THE MOUTH</td><td>55.172</td><td>-111.725</td><td>425.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 40.7 years
<br><strong>Timeseries Summary:</strong> 10,518 daily observations, seasonal gaps: 108 days avg (N=40) | 28.7% flagged (backwater: 2579, estimated: 248, partial day: 196)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1295.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>10,518 daily observations, seasonal gaps: 108 days avg (N=40) | 28.7% flagged (backwater: 2579, estimated: 248, partial day: 196) | Record: 40.7 years</td></tr>
...
show(plot_station_timeseries("07CA012"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07CA012")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07CA012/07CA012_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07CA012/07CA012_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07CA012/07CA012_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Extending rating 8.01 to model low stage heights reached in 2025.</td>
    </tr>
    <tr>
      <td>8.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>8.00 extended and estimated region added at 2x highest measurement.</td>
    </tr>
    <tr>
      <td>8.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>NEW curve.  Scour evident curve 7 on low end.</td>
    </tr>
    <tr>
      <td>7.00</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07CA012"))
:::
...
<div class="download-section">
  <a href="../../07CA012/07CA012_field_visits.csv" download class="download-btn">
