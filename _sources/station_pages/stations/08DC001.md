...
# 08DC001: AMERICAN CREEK NEAR STEWART
...
result = plot_station_polygon("08DC001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08DC001">stations/08DC001 folder on GitHub</a>.
:::
...
<tr><td>08DC001</td><td>AMERICAN CREEK NEAR STEWART</td><td>56.107</td><td>-129.882</td><td>166.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 457 daily observations, continuous record | 2.4% flagged (estimated: 7, backwater: 4)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 380.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>457 daily observations, continuous record | 2.4% flagged (estimated: 7, backwater: 4) | Record: 1.2 years</td></tr>
...
show(plot_station_timeseries("08DC001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08DC001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08DC001/08DC001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08DC001/08DC001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08DC001"))
:::
...
<div class="download-section">
  <a href="../../08DC001/08DC001_field_visits.csv" download class="download-btn">
