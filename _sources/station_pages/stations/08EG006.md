...
result = plot_station_polygon("08EG006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EG006">stations/08EG006 folder on GitHub</a>.
:::
...
<tr><td>08EG006</td><td>KITSUMKALUM RIVER NEAR TERRACE</td><td>54.582</td><td>-128.660</td><td>2180.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 22.7 years
<br><strong>Timeseries Summary:</strong> 7,346 daily observations, minor gaps: 55 days avg (N=17) | 14.5% flagged (estimated: 715, backwater: 344, partial day: 9)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 6585.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>7,346 daily observations, minor gaps: 55 days avg (N=17) | 14.5% flagged (estimated: 715, backwater: 344, partial day: 9) | Record: 22.7 years</td></tr>
...
show(plot_station_timeseries("08EG006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EG006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EG006/08EG006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08EG006/08EG006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08EG006"))
:::
...
<div class="download-section">
  <a href="../../08EG006/08EG006_field_visits.csv" download class="download-btn">
