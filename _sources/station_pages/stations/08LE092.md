...
# 08LE092: GORDON CREEK ABOVE DIVERSIONS
...
result = plot_station_polygon("08LE092")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE092">stations/08LE092 folder on GitHub</a>.
:::
...
<tr><td>08LE092</td><td>GORDON CREEK ABOVE DIVERSIONS</td><td>50.661</td><td>-119.383</td><td>17.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 6.0 years
<br><strong>Timeseries Summary:</strong> 2,191 daily observations, continuous record | 25.2% flagged (estimated: 309, backwater: 202, partial day: 41)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 50.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,191 daily observations, continuous record | 25.2% flagged (estimated: 309, backwater: 202, partial day: 41) | Record: 6.0 years</td></tr>
...
show(plot_station_timeseries("08LE092"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE092")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE092/08LE092_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE092/08LE092_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE092"))
:::
