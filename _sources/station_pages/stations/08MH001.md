...
result = plot_station_polygon("08MH001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH001">stations/08MH001 folder on GitHub</a>.
:::
...
<tr><td>08MH001</td><td>CHILLIWACK RIVER AT VEDDER CROSSING</td><td>49.097</td><td>-121.967</td><td>1230.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 113.2 years
<br><strong>Timeseries Summary:</strong> 33,424 daily observations, seasonal gaps: 1582 days avg (N=5) | 5.2% flagged (estimated: 1093, partial day: 541, backwater: 94)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2864.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>33,424 daily observations, seasonal gaps: 1582 days avg (N=5) | 5.2% flagged (estimated: 1093, partial day: 541, backwater: 94) | Record: 113.2 years</td></tr>
...
show(plot_station_timeseries("08MH001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH001/08MH001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08MH001/08MH001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08MH001/08MH001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH001"))
:::
...
<div class="download-section">
  <a href="../../08MH001/08MH001_field_visits.csv" download class="download-btn">
