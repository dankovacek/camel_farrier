...
result = plot_station_polygon("08LG051")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG051">stations/08LG051 folder on GitHub</a>.
:::
...
<tr><td>08LG051</td><td>AXE CREEK AT LOT 781</td><td>50.534</td><td>-120.868</td><td>26.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 9.2 years
<br><strong>Timeseries Summary:</strong> 3,164 daily observations, minor gaps: 46 days avg (N=4) | 29.5% flagged (backwater: 653, estimated: 266, partial day: 14)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 89.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>3,164 daily observations, minor gaps: 46 days avg (N=4) | 29.5% flagged (backwater: 653, estimated: 266, partial day: 14) | Record: 9.2 years</td></tr>
...
show(plot_station_timeseries("08LG051"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG051")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG051/08LG051_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LG051/08LG051_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LG051"))
:::
...
<div class="download-section">
  <a href="../../08LG051/08LG051_field_visits.csv" download class="download-btn">
