...
# 08LB023: EDWARDS CREEK (LYON'S DIVERSION) NEAR HEFFLEY CREEK
...
result = plot_station_polygon("08LB023")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB023">stations/08LB023 folder on GitHub</a>.
:::
...
<tr><td>08LB023</td><td>EDWARDS CREEK (LYON'S DIVERSION) NEAR HEFFLEY CREEK</td><td>50.901</td><td>-120.149</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,863 daily observations, seasonal gaps: 197 days avg (N=10) | 3.0% flagged (estimated: 55)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 81.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,863 daily observations, seasonal gaps: 197 days avg (N=10) | 3.0% flagged (estimated: 55) | Record: 10.5 years</td></tr>
...
show(plot_station_timeseries("08LB023"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB023")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB023/08LB023_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LB023/08LB023_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB023"))
:::
