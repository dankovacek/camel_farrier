...
# 08NG063: NORBURY CREEK AT OUTLET OF NORBURY LAKES
...
result = plot_station_polygon("08NG063")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG063">stations/08NG063 folder on GitHub</a>.
:::
...
<tr><td>08NG063</td><td>NORBURY CREEK AT OUTLET OF NORBURY LAKES</td><td>49.530</td><td>-115.479</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,006 daily observations, seasonal gaps: 197 days avg (N=2) | 28.6% flagged (estimated: 288)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 212.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,006 daily observations, seasonal gaps: 197 days avg (N=2) | 28.6% flagged (estimated: 288) | Record: 3.8 years</td></tr>
...
show(plot_station_timeseries("08NG063"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG063")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG063/08NG063_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG063/08NG063_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG063"))
:::
