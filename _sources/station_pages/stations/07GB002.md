...
result = plot_station_polygon("07GB002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07GB002">stations/07GB002 folder on GitHub</a>.
:::
...
<tr><td>07GB002</td><td>KAKWA RIVER NEAR GRANDE PRAIRIE</td><td>54.372</td><td>-118.594</td><td>3300.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 18.9 years
<br><strong>Timeseries Summary:</strong> 4,687 daily observations, seasonal gaps: 117 days avg (N=19) | 23.7% flagged (backwater: 777, estimated: 251, partial day: 85)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 9622.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>4,687 daily observations, seasonal gaps: 117 days avg (N=19) | 23.7% flagged (backwater: 777, estimated: 251, partial day: 85) | Record: 18.9 years</td></tr>
...
show(plot_station_timeseries("07GB002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07GB002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07GB002/07GB002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07GB002/07GB002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07GB002"))
:::
...
<div class="download-section">
  <a href="../../07GB002/07GB002_field_visits.csv" download class="download-btn">
