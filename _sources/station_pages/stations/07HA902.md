...
# 07HA902: KRAWCHUK DRAINAGE NEAR MCLENNAN
...
result = plot_station_polygon("07HA902")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07HA902">stations/07HA902 folder on GitHub</a>.
:::
...
<tr><td>07HA902</td><td>KRAWCHUK DRAINAGE NEAR MCLENNAN</td><td>55.950</td><td>-117.033</td><td>13.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.84, ΔArea: +6.2%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 11.7 years
<br><strong>Timeseries Summary:</strong> 2,995 daily observations, seasonal gaps: 106 days avg (N=12) | 8.5% flagged (backwater: 234, estimated: 21, partial day: 1)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 63.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,995 daily observations, seasonal gaps: 106 days avg (N=12) | 8.5% flagged (backwater: 234, estimated: 21, partial day: 1) | Record: 11.7 years</td></tr>
...
show(plot_station_timeseries("07HA902"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07HA902")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07HA902/07HA902_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07HA902/07HA902_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07HA902"))
:::
