...
# 10PB003: POINT LAKE NEAR THE OUTLET
...
result = plot_station_polygon("10PB003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10PB003">stations/10PB003 folder on GitHub</a>.
:::
...
<tr><td>10PB003</td><td>POINT LAKE NEAR THE OUTLET</td><td>65.404</td><td>-113.995</td><td>19300.0 (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 113248.6 km²</td></tr>
...
show(plot_station_timeseries("10PB003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10PB003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10PB003/10PB003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10PB003/10PB003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10PB003"))
:::
...
<div class="download-section">
  <a href="../../10PB003/10PB003_field_visits.csv" download class="download-btn">
