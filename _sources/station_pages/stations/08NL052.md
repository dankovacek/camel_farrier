...
# 08NL052: CHAIN LAKE AT THE OUTLET
...
result = plot_station_polygon("08NL052")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL052">stations/08NL052 folder on GitHub</a>.
:::
...
<tr><td>08NL052</td><td>CHAIN LAKE AT THE OUTLET</td><td>49.691</td><td>-120.280</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 99.5 km²</td></tr>
...
show(plot_station_timeseries("08NL052"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL052")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL052/08NL052_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NL052/08NL052_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL052"))
:::
...
<div class="download-section">
  <a href="../../08NL052/08NL052_field_visits.csv" download class="download-btn">
