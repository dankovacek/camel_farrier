...
# 08GA008: BRANDT CREEK NEAR VANCOUVER (UPPER STATION)
...
result = plot_station_polygon("08GA008")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA008">stations/08GA008 folder on GitHub</a>.
:::
...
<tr><td>08GA008</td><td>BRANDT CREEK NEAR VANCOUVER (UPPER STATION)</td><td>49.555</td><td>-122.867</td><td>3.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.97, ΔArea: +2.7%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,740 daily observations, seasonal gaps: 152 days avg (N=2) | 75.6% flagged (estimated: 2024, backwater: 48)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 9.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,740 daily observations, seasonal gaps: 152 days avg (N=2) | 75.6% flagged (estimated: 2024, backwater: 48) | Record: 8.3 years</td></tr>
...
show(plot_station_timeseries("08GA008"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA008")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA008/08GA008_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA008/08GA008_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA008"))
:::
...
<div class="download-section">
  <a href="../../08GA008/08GA008_field_visits.csv" download class="download-btn">
