...
# 08LE048: NISKONLITH CREEK (INDIAN DIVERSION) NEAR SHUSWAP
...
result = plot_station_polygon("08LE048")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE048">stations/08LE048 folder on GitHub</a>.
:::
...
<tr><td>08LE048</td><td>NISKONLITH CREEK (INDIAN DIVERSION) NEAR SHUSWAP</td><td>50.764</td><td>-119.774</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 17.5 years
<br><strong>Timeseries Summary:</strong> 2,993 daily observations, seasonal gaps: 200 days avg (N=17) | 8.7% flagged (estimated: 261)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 253.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,993 daily observations, seasonal gaps: 200 days avg (N=17) | 8.7% flagged (estimated: 261) | Record: 17.5 years</td></tr>
...
show(plot_station_timeseries("08LE048"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE048")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE048/08LE048_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE048/08LE048_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE048"))
:::
