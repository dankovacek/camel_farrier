...
result = plot_station_polygon("08NJ143")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ143">stations/08NJ143 folder on GitHub</a>.
:::
...
<tr><td>08NJ143</td><td>EAGLE CREEK (WEST FORK) NEAR BLEWETT</td><td>49.460</td><td>-117.379</td><td>2.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.97, ΔArea: +3.2%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 3.3 years
<br><strong>Timeseries Summary:</strong> 489 daily observations, seasonal gaps: 243 days avg (N=3) | 60.1% flagged (estimated: 294)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 6.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>489 daily observations, seasonal gaps: 243 days avg (N=3) | 60.1% flagged (estimated: 294) | Record: 3.3 years</td></tr>
...
show(plot_station_timeseries("08NJ143"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ143")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ143/08NJ143_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ143/08NJ143_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ143"))
:::
...
<div class="download-section">
  <a href="../../08NJ143/08NJ143_field_visits.csv" download class="download-btn">
