...
# 08NN017: CHRISTINA LAKE NEAR GRAND FORKS
...
result = plot_station_polygon("08NN017")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NN017">stations/08NN017 folder on GitHub</a>.
:::
...
<tr><td>08NN017</td><td>CHRISTINA LAKE NEAR GRAND FORKS</td><td>49.044</td><td>-118.208</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1152.8 km²</td></tr>
...
show(plot_station_timeseries("08NN017"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NN017")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NN017/08NN017_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NN017/08NN017_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NN017"))
:::
