...
result = plot_station_polygon("08HF007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HF007">stations/08HF007 folder on GitHub</a>.
:::
...
<tr><td>08HF007</td><td>RUSSELL CREEK NEAR THE MOUTH</td><td>50.325</td><td>-126.419</td><td>32.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.98, ΔArea: -2.0%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,557 daily observations, continuous record | 11.5% flagged (estimated: 133, partial day: 110, backwater: 50)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 79.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,557 daily observations, continuous record | 11.5% flagged (estimated: 133, partial day: 110, backwater: 50) | Record: 7.0 years</td></tr>
...
show(plot_station_timeseries("08HF007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HF007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HF007/08HF007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HF007/08HF007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HF007"))
:::
...
<div class="download-section">
  <a href="../../08HF007/08HF007_field_visits.csv" download class="download-btn">
