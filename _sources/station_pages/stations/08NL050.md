...
result = plot_station_polygon("08NL050")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL050">stations/08NL050 folder on GitHub</a>.
:::
...
<tr><td>08NL050</td><td>HEDLEY CREEK NEAR THE MOUTH</td><td>49.359</td><td>-120.073</td><td>388.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 51.7 years
<br><strong>Timeseries Summary:</strong> 18,720 daily observations, seasonal gaps: 153 days avg (N=1) | 21.4% flagged (backwater: 3301, estimated: 463, partial day: 236)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 932.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>18,720 daily observations, seasonal gaps: 153 days avg (N=1) | 21.4% flagged (backwater: 3301, estimated: 463, partial day: 236) | Record: 51.7 years</td></tr>
...
show(plot_station_timeseries("08NL050"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL050")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL050/08NL050_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NL050/08NL050_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NL050/08NL050_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Clone of Rating #46.000, Estimated range on low end adjusted to estimated below 1.30 m3/s</td>
    </tr>
    <tr>
      <td>46.000</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extended the bottom rating point to capture the 2018-08-15 measurement</td>
    </tr>
    <tr>
      <td>44.000</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08NL050"))
:::
