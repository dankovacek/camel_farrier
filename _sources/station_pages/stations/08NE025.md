...
result = plot_station_polygon("08NE025")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE025">stations/08NE025 folder on GitHub</a>.
:::
...
<tr><td>08NE025</td><td>BATH CREEK NEAR FRUITVALE</td><td>49.094</td><td>-117.579</td><td>3.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.91, ΔArea: +5.8%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 794 daily observations, seasonal gaps: 2788 days avg (N=5) | 30.5% flagged (estimated: 242)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>794 daily observations, seasonal gaps: 2788 days avg (N=5) | 30.5% flagged (estimated: 242) | Record: 40.3 years</td></tr>
...
show(plot_station_timeseries("08NE025"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE025")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE025/08NE025_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE025/08NE025_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE025"))
:::
...
<div class="download-section">
  <a href="../../08NE025/08NE025_field_visits.csv" download class="download-btn">
