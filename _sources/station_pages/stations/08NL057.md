...
# 08NL057: ALLISON CREEK AT OUTLET OF ALLISON LAKE
...
result = plot_station_polygon("08NL057")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL057">stations/08NL057 folder on GitHub</a>.
:::
...
<tr><td>08NL057</td><td>ALLISON CREEK AT OUTLET OF ALLISON LAKE</td><td>49.681</td><td>-120.605</td><td>76.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,375 daily observations, seasonal gaps: 273 days avg (N=5) | 18.0% flagged (estimated: 247)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 170.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,375 daily observations, seasonal gaps: 273 days avg (N=5) | 18.0% flagged (estimated: 247) | Record: 7.5 years</td></tr>
...
show(plot_station_timeseries("08NL057"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL057")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL057/08NL057_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NL057/08NL057_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL057"))
:::
