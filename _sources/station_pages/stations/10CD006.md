...
result = plot_station_polygon("10CD006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10CD006">stations/10CD006 folder on GitHub</a>.
:::
...
<tr><td>10CD006</td><td>PROPHET RIVER ABOVE CHEVES CREEK</td><td>58.484</td><td>-122.830</td><td>7320.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,647 daily observations, continuous record | 55.9% flagged (backwater: 1356, estimated: 116, partial day: 8)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 25596.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,647 daily observations, continuous record | 55.9% flagged (backwater: 1356, estimated: 116, partial day: 8) | Record: 7.2 years</td></tr>
...
show(plot_station_timeseries("10CD006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10CD006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10CD006/10CD006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10CD006/10CD006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10CD006"))
:::
