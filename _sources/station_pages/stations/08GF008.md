...
# 08GF008: KINGCOME RIVER ABOVE ATLATZI RIVER
...
result = plot_station_polygon("08GF008")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GF008">stations/08GF008 folder on GitHub</a>.
:::
...
<tr><td>08GF008</td><td>KINGCOME RIVER ABOVE ATLATZI RIVER</td><td>51.015</td><td>-126.122</td><td>1040.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,675 daily observations, continuous record | 8.5% flagged (estimated: 72, backwater: 67, partial day: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2663.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,675 daily observations, continuous record | 8.5% flagged (estimated: 72, backwater: 67, partial day: 3) | Record: 4.6 years</td></tr>
...
show(plot_station_timeseries("08GF008"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GF008")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GF008/08GF008_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GF008/08GF008_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GF008"))
:::
