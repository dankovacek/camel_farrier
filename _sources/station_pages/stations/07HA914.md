...
# 07HA914: NAMPA (SOUTH) DRAINAGE NEAR NAMPA
...
result = plot_station_polygon("07HA914")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07HA914">stations/07HA914 folder on GitHub</a>.
:::
...
<tr><td>07HA914</td><td>NAMPA (SOUTH) DRAINAGE NEAR NAMPA</td><td>56.014</td><td>-117.146</td><td>22.1 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.72, ΔArea: +38.2%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 20.7 years
<br><strong>Timeseries Summary:</strong> 5,080 daily observations, seasonal gaps: 124 days avg (N=20) | 12.7% flagged (backwater: 566, estimated: 69, partial day: 8)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 107.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>5,080 daily observations, seasonal gaps: 124 days avg (N=20) | 12.7% flagged (backwater: 566, estimated: 69, partial day: 8) | Record: 20.7 years</td></tr>
...
show(plot_station_timeseries("07HA914"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07HA914")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07HA914/07HA914_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07HA914/07HA914_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07HA914"))
:::
...
<div class="download-section">
  <a href="../../07HA914/07HA914_field_visits.csv" download class="download-btn">
