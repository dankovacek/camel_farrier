...
# 08GA050: CHASTER CREEK ABOVE HIGHWAY NO. 101
...
result = plot_station_polygon("08GA050")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA050">stations/08GA050 folder on GitHub</a>.
:::
...
<tr><td>08GA050</td><td>CHASTER CREEK ABOVE HIGHWAY NO. 101</td><td>49.407</td><td>-123.541</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 153 daily observations, continuous record</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 10.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>153 daily observations, continuous record | Record: 0.4 years</td></tr>
...
show(plot_station_timeseries("08GA050"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA050")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA050/08GA050_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA050/08GA050_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA050"))
:::
...
<div class="download-section">
  <a href="../../08GA050/08GA050_field_visits.csv" download class="download-btn">
