...
result = plot_station_polygon("08NE001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE001">stations/08NE001 folder on GitHub</a>.
:::
...
<tr><td>08NE001</td><td>INCOMAPPLEUX RIVER NEAR BEATON</td><td>50.774</td><td>-117.677</td><td>1020.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 82.1 years
<br><strong>Timeseries Summary:</strong> 16,651 daily observations, seasonal gaps: 6665 days avg (N=2) | 15.4% flagged (backwater: 1934, partial day: 349, estimated: 280)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2523.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>16,651 daily observations, seasonal gaps: 6665 days avg (N=2) | 15.4% flagged (backwater: 1934, partial day: 349, estimated: 280) | Record: 82.1 years</td></tr>
...
show(plot_station_timeseries("08NE001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE001/08NE001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE001/08NE001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE001"))
:::
...
<div class="download-section">
  <a href="../../08NE001/08NE001_field_visits.csv" download class="download-btn">
