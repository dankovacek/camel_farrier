...
# 08NE064: BARCLAY CREEK NEAR FRUITVALE
...
result = plot_station_polygon("08NE064")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE064">stations/08NE064 folder on GitHub</a>.
:::
...
<tr><td>08NE064</td><td>BARCLAY CREEK NEAR FRUITVALE</td><td>49.089</td><td>-117.556</td><td>2.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 702 daily observations, seasonal gaps: 182 days avg (N=3) | 46.4% flagged (estimated: 326)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>702 daily observations, seasonal gaps: 182 days avg (N=3) | 46.4% flagged (estimated: 326) | Record: 3.4 years</td></tr>
...
show(plot_station_timeseries("08NE064"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE064")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE064/08NE064_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE064/08NE064_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE064"))
:::
...
<div class="download-section">
  <a href="../../08NE064/08NE064_field_visits.csv" download class="download-btn">
