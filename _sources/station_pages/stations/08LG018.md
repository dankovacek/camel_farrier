...
# 08LG018: SPAHOMIN CREEK NEAR DOUGLAS LAKE
...
result = plot_station_polygon("08LG018")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG018">stations/08LG018 folder on GitHub</a>.
:::
...
<tr><td>08LG018</td><td>SPAHOMIN CREEK NEAR DOUGLAS LAKE</td><td>50.115</td><td>-120.286</td><td>233.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,893 daily observations, seasonal gaps: 1402 days avg (N=11) | 24.0% flagged (estimated: 454)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 445.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,893 daily observations, seasonal gaps: 1402 days avg (N=11) | 24.0% flagged (estimated: 454) | Record: 47.4 years</td></tr>
...
show(plot_station_timeseries("08LG018"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG018")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG018/08LG018_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LG018/08LG018_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LG018"))
:::
...
<div class="download-section">
  <a href="../../08LG018/08LG018_field_visits.csv" download class="download-btn">
