...
result = plot_station_polygon("08MH103")
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH103")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH103/08MH103_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08MH103/08MH103_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08MH103/08MH103_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Extended bottom of curve to capture trend in lower end</td>
    </tr>
    <tr>
      <td>30.020</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extended top of curve to capture max discharge</td>
    </tr>
    <tr>
      <td>30.010</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New curve with a lower offset as measurements below 0.700m since May, 2014 have been plotting to the...</td>
    </tr>
    <tr>
      <td>30.000</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08MH103"))
:::
