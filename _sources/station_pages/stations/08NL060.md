...
# 08NL060: OTTER CREEK BELOW SPEARING CREEK
...
result = plot_station_polygon("08NL060")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL060">stations/08NL060 folder on GitHub</a>.
:::
...
<tr><td>08NL060</td><td>OTTER CREEK BELOW SPEARING CREEK</td><td>49.768</td><td>-120.771</td><td>409.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,922 daily observations, continuous record | 26.4% flagged (backwater: 492, estimated: 228, partial day: 51)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 978.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,922 daily observations, continuous record | 26.4% flagged (backwater: 492, estimated: 228, partial day: 51) | Record: 8.0 years</td></tr>
...
show(plot_station_timeseries("08NL060"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL060")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL060/08NL060_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NL060/08NL060_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL060"))
:::
