...
# 08NA063: MARION CREEK (WEST FORK) NEAR CANAL FLATS
...
result = plot_station_polygon("08NA063")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA063">stations/08NA063 folder on GitHub</a>.
:::
...
<tr><td>08NA063</td><td>MARION CREEK (WEST FORK) NEAR CANAL FLATS</td><td>50.212</td><td>-115.886</td><td>9.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 4.4 years
<br><strong>Timeseries Summary:</strong> 917 daily observations, seasonal gaps: 174 days avg (N=4) | 63.0% flagged (estimated: 578)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 21.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>917 daily observations, seasonal gaps: 174 days avg (N=4) | 63.0% flagged (estimated: 578) | Record: 4.4 years</td></tr>
...
show(plot_station_timeseries("08NA063"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA063")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA063/08NA063_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA063/08NA063_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA063"))
:::
...
<div class="download-section">
  <a href="../../08NA063/08NA063_field_visits.csv" download class="download-btn">
