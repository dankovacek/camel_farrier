...
# 08LB046: LINDQUIST CREEK NEAR CHINOOK COVE
...
result = plot_station_polygon("08LB046")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB046">stations/08LB046 folder on GitHub</a>.
:::
...
<tr><td>08LB046</td><td>LINDQUIST CREEK NEAR CHINOOK COVE</td><td>51.314</td><td>-120.182</td><td>77.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 549 daily observations, seasonal gaps: 182 days avg (N=2) | 3.5% flagged (estimated: 19)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 174.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>549 daily observations, seasonal gaps: 182 days avg (N=2) | 3.5% flagged (estimated: 19) | Record: 2.5 years</td></tr>
...
show(plot_station_timeseries("08LB046"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB046")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB046/08LB046_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LB046/08LB046_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB046"))
:::
...
<div class="download-section">
  <a href="../../08LB046/08LB046_field_visits.csv" download class="download-btn">
