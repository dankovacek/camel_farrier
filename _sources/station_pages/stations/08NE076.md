...
# 08NE076: MERRY CREEK NEAR KINNAIRD
...
result = plot_station_polygon("08NE076")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE076">stations/08NE076 folder on GitHub</a>.
:::
...
<tr><td>08NE076</td><td>MERRY CREEK NEAR KINNAIRD</td><td>49.294</td><td>-117.660</td><td>3.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 885 daily observations, seasonal gaps: 201 days avg (N=5) | 7.6% flagged (estimated: 67)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 12.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>885 daily observations, seasonal gaps: 201 days avg (N=5) | 7.6% flagged (estimated: 67) | Record: 5.2 years</td></tr>
...
show(plot_station_timeseries("08NE076"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE076")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE076/08NE076_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE076/08NE076_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE076"))
:::
