...
result = plot_station_polygon("08FB005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08FB005">stations/08FB005 folder on GitHub</a>.
:::
...
<tr><td>08FB005</td><td>NUSATSUM RIVER NEAR HAGENSBORG</td><td>52.389</td><td>-126.460</td><td>269.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 31.3 years
<br><strong>Timeseries Summary:</strong> 10,867 daily observations, minor gaps: 58 days avg (N=10) | 14.5% flagged (backwater: 931, estimated: 586, partial day: 58)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 724.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>10,867 daily observations, minor gaps: 58 days avg (N=10) | 14.5% flagged (backwater: 931, estimated: 586, partial day: 58) | Record: 31.3 years</td></tr>
...
show(plot_station_timeseries("08FB005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08FB005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08FB005/08FB005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08FB005/08FB005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08FB005"))
:::
