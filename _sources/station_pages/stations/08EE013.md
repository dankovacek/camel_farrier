...
result = plot_station_polygon("08EE013")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EE013">stations/08EE013 folder on GitHub</a>.
:::
...
<tr><td>08EE013</td><td>BUCK CREEK AT THE MOUTH</td><td>54.396</td><td>-126.650</td><td>565.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 18,231 daily observations, seasonal gaps: 198 days avg (N=2) | 47.3% flagged (backwater: 7885, estimated: 605, partial day: 142)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1661.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>18,231 daily observations, seasonal gaps: 198 days avg (N=2) | 47.3% flagged (backwater: 7885, estimated: 605, partial day: 142) | Record: 51.0 years</td></tr>
...
show(plot_station_timeseries("08EE013"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EE013")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EE013/08EE013_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08EE013/08EE013_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08EE013/08EE013_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>clone of curve 42.000 and slightly adjusted rating points for 2018 data which indicated filling of c...</td>
    </tr>
    <tr>
      <td>42.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>clone of curve 41.000, with extended range and slightly adjusted rating points for 2017 and 2018 dat...</td>
    </tr>
    <tr>
      <td>41.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Shift to left during ice period.</td>
    </tr>
    <tr>
      <td>40.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New curve created during ice period - lower end adjusted for low flow observed in 2014 - removed rat...</td>
    </tr>
    <tr>
      <td>39.00</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08EE013"))
:::
...
<div class="download-section">
  <a href="../../08EE013/08EE013_field_visits.csv" download class="download-btn">
