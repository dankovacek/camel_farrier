...
result = plot_station_polygon("08NE117")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE117">stations/08NE117 folder on GitHub</a>.
:::
...
<tr><td>08NE117</td><td>KUSKANAX CREEK AT 1040 M CONTOUR</td><td>50.343</td><td>-117.518</td><td>113.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 8,309 daily observations, continuous record | 17.7% flagged (backwater: 1375, estimated: 83, partial day: 11)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 272.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>8,309 daily observations, continuous record | 17.7% flagged (backwater: 1375, estimated: 83, partial day: 11) | Record: 22.7 years</td></tr>
...
show(plot_station_timeseries("08NE117"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE117")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE117/08NE117_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE117/08NE117_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE117"))
:::
...
<div class="download-section">
  <a href="../../08NE117/08NE117_field_visits.csv" download class="download-btn">
