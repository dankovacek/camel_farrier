...
# 08LC005: BESSETTE CREEK NEAR LUMBY
...
result = plot_station_polygon("08LC005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LC005">stations/08LC005 folder on GitHub</a>.
:::
...
<tr><td>08LC005</td><td>BESSETTE CREEK NEAR LUMBY</td><td>50.235</td><td>-118.968</td><td>253.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 4,672 daily observations, seasonal gaps: 726 days avg (N=26) | 12.5% flagged (estimated: 583)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 616.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>4,672 daily observations, seasonal gaps: 726 days avg (N=26) | 12.5% flagged (estimated: 583) | Record: 64.5 years</td></tr>
...
show(plot_station_timeseries("08LC005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LC005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LC005/08LC005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LC005/08LC005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LC005"))
:::
...
<div class="download-section">
  <a href="../../08LC005/08LC005_field_visits.csv" download class="download-btn">
