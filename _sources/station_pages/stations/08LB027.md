...
# 08LB027: PAUL CREEK NEAR KAMLOOPS (STATION F)
...
result = plot_station_polygon("08LB027")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB027">stations/08LB027 folder on GitHub</a>.
:::
...
<tr><td>08LB027</td><td>PAUL CREEK NEAR KAMLOOPS (STATION F)</td><td>50.708</td><td>-120.320</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 17.6 years
<br><strong>Timeseries Summary:</strong> 2,534 daily observations, seasonal gaps: 389 days avg (N=10) | 1.5% flagged (estimated: 37)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 691.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,534 daily observations, seasonal gaps: 389 days avg (N=10) | 1.5% flagged (estimated: 37) | Record: 17.6 years</td></tr>
...
show(plot_station_timeseries("08LB027"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB027")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB027/08LB027_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LB027/08LB027_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB027"))
:::
