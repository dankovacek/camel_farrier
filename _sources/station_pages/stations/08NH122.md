...
# 08NH122: PEAVINE CREEK NEAR CRANBROOK
...
result = plot_station_polygon("08NH122")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH122">stations/08NH122 folder on GitHub</a>.
:::
...
<tr><td>08NH122</td><td>PEAVINE CREEK NEAR CRANBROOK</td><td>49.451</td><td>-115.739</td><td>13.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 366 daily observations, seasonal gaps: 243 days avg (N=2) | 12.8% flagged (estimated: 47)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 29.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>366 daily observations, seasonal gaps: 243 days avg (N=2) | 12.8% flagged (estimated: 47) | Record: 2.3 years</td></tr>
...
show(plot_station_timeseries("08NH122"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH122")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH122/08NH122_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH122/08NH122_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH122"))
:::
