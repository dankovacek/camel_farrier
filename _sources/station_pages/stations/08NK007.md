...
# 08NK007: QUAIL CREEK NEAR HOSMER
...
result = plot_station_polygon("08NK007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NK007">stations/08NK007 folder on GitHub</a>.
:::
...
<tr><td>08NK007</td><td>QUAIL CREEK NEAR HOSMER</td><td>49.571</td><td>-114.990</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.97, ΔArea: +1.7%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 519 daily observations, seasonal gaps: 182 days avg (N=2) | 53.6% flagged (estimated: 278)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>519 daily observations, seasonal gaps: 182 days avg (N=2) | 53.6% flagged (estimated: 278) | Record: 2.4 years</td></tr>
...
show(plot_station_timeseries("08NK007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NK007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NK007/08NK007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NK007/08NK007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NK007"))
:::
...
<div class="download-section">
  <a href="../../08NK007/08NK007_field_visits.csv" download class="download-btn">
