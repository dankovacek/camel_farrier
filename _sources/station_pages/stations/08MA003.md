...
result = plot_station_polygon("08MA003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MA003">stations/08MA003 folder on GitHub</a>.
:::
...
<tr><td>08MA003</td><td>TASEKO RIVER AT OUTLET OF TASEKO LAKES</td><td>51.379</td><td>-123.631</td><td>1520.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 95.7 years
<br><strong>Timeseries Summary:</strong> 15,768 daily observations, seasonal gaps: 3835 days avg (N=5) | 12.8% flagged (estimated: 1065, backwater: 811, partial day: 142)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3874.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>15,768 daily observations, seasonal gaps: 3835 days avg (N=5) | 12.8% flagged (estimated: 1065, backwater: 811, partial day: 142) | Record: 95.7 years</td></tr>
...
show(plot_station_timeseries("08MA003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MA003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MA003/08MA003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08MA003/08MA003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08MA003/08MA003_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Created using open water measurements from 2017 -2021.  Not including ADCP measurements which show a...</td>
    </tr>
    <tr>
      <td>13.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve created using open water measurements from Jan 2017-May 2019.  Upper end was defined using his...</td>
    </tr>
    <tr>
      <td>11.1</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>coincident with table 12 & 10 at and above 1.40</td>
    </tr>
    <tr>
      <td>12.0</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("08MA003"))
:::
