...
# 08NH071: MCGREGOR CREEK NEAR BOSWELL
...
result = plot_station_polygon("08NH071")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH071">stations/08NH071 folder on GitHub</a>.
:::
...
<tr><td>08NH071</td><td>MCGREGOR CREEK NEAR BOSWELL</td><td>49.457</td><td>-116.752</td><td>3.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 92 daily observations, continuous record | 42.4% flagged (estimated: 39)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 8.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>92 daily observations, continuous record | 42.4% flagged (estimated: 39) | Record: 0.2 years</td></tr>
...
show(plot_station_timeseries("08NH071"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH071")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH071/08NH071_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH071/08NH071_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH071"))
:::
...
<div class="download-section">
  <a href="../../08NH071/08NH071_field_visits.csv" download class="download-btn">
