...
# 08NG031: CASSIMAYOOK CREEK NEAR BAKER
...
result = plot_station_polygon("08NG031")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG031">stations/08NG031 folder on GitHub</a>.
:::
...
<tr><td>08NG031</td><td>CASSIMAYOOK CREEK NEAR BAKER</td><td>49.507</td><td>-115.602</td><td>23.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 702 daily observations, seasonal gaps: 192 days avg (N=3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 53.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>702 daily observations, seasonal gaps: 192 days avg (N=3) | Record: 3.5 years</td></tr>
...
show(plot_station_timeseries("08NG031"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG031")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG031/08NG031_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG031/08NG031_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG031"))
:::
