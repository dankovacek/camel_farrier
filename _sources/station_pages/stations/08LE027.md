...
result = plot_station_polygon("08LE027")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE027">stations/08LE027 folder on GitHub</a>.
:::
...
<tr><td>08LE027</td><td>SEYMOUR RIVER NEAR SEYMOUR ARM</td><td>51.262</td><td>-118.946</td><td>805.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 110.4 years
<br><strong>Timeseries Summary:</strong> 24,905 daily observations, seasonal gaps: 1286 days avg (N=12) | 20.6% flagged (backwater: 4407, estimated: 680, partial day: 44)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2060.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>24,905 daily observations, seasonal gaps: 1286 days avg (N=12) | 20.6% flagged (backwater: 4407, estimated: 680, partial day: 44) | Record: 110.4 years</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE027")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE027/08LE027_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08LE027/08LE027_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LE027/08LE027_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Lower curve extension with lower confidence interval change.</td>
    </tr>
    <tr>
      <td>32.00</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08LE027"))
:::
...
<div class="download-section">
  <a href="../../08LE027/08LE027_field_visits.csv" download class="download-btn">
