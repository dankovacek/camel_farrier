...
# 08MF049: ANNIS DITCH NEAR ROSEDALE
...
result = plot_station_polygon("08MF049")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MF049">stations/08MF049 folder on GitHub</a>.
:::
...
<tr><td>08MF049</td><td>ANNIS DITCH NEAR ROSEDALE</td><td>49.159</td><td>-121.826</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,675 daily observations, continuous record | 2.0% flagged (estimated: 30, backwater: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,675 daily observations, continuous record | 2.0% flagged (estimated: 30, backwater: 3) | Record: 4.6 years</td></tr>
...
show(plot_station_timeseries("08MF049"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MF049")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MF049/08MF049_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MF049/08MF049_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MF049"))
:::
...
<div class="download-section">
  <a href="../../08MF049/08MF049_field_visits.csv" download class="download-btn">
