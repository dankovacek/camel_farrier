...
# 08NN008: PASS CREEK NEAR GRAND FORKS
...
result = plot_station_polygon("08NN008")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NN008">stations/08NN008 folder on GitHub</a>.
:::
...
<tr><td>08NN008</td><td>PASS CREEK NEAR GRAND FORKS</td><td>49.190</td><td>-118.466</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 179.6 km²</td></tr>
...
show(plot_station_timeseries("08NN008"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NN008")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NN008/08NN008_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NN008/08NN008_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NN008"))
:::
...
<div class="download-section">
  <a href="../../08NN008/08NN008_field_visits.csv" download class="download-btn">
