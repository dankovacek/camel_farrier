...
# 08HA034: CRAIGFLOWER CREEK BELOW BURNSIDE ROAD, VICTORIA
...
result = plot_station_polygon("08HA034")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HA034">stations/08HA034 folder on GitHub</a>.
:::
...
<tr><td>08HA034</td><td>CRAIGFLOWER CREEK BELOW BURNSIDE ROAD, VICTORIA</td><td>48.463</td><td>-123.439</td><td>13.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,679 daily observations, minor gaps: 46 days avg (N=2) | 5.3% flagged (estimated: 130, backwater: 11)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 44.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,679 daily observations, minor gaps: 46 days avg (N=2) | 5.3% flagged (estimated: 130, backwater: 11) | Record: 7.6 years</td></tr>
...
show(plot_station_timeseries("08HA034"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HA034")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HA034/08HA034_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HA034/08HA034_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HA034"))
:::
...
<div class="download-section">
  <a href="../../08HA034/08HA034_field_visits.csv" download class="download-btn">
