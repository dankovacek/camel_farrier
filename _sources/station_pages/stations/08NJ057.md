...
# 08NJ057: PERRY CREEK NEAR PERRY SIDING
...
result = plot_station_polygon("08NJ057")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ057">stations/08NJ057 folder on GitHub</a>.
:::
...
<tr><td>08NJ057</td><td>PERRY CREEK NEAR PERRY SIDING</td><td>49.669</td><td>-117.499</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 153 daily observations, continuous record | 64.7% flagged (estimated: 99)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 6.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>153 daily observations, continuous record | 64.7% flagged (estimated: 99) | Record: 0.4 years</td></tr>
...
show(plot_station_timeseries("08NJ057"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ057")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ057/08NJ057_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ057/08NJ057_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ057"))
:::
...
<div class="download-section">
  <a href="../../08NJ057/08NJ057_field_visits.csv" download class="download-btn">
