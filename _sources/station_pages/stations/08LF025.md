...
# 08LF025: TWAAL CREEK NEAR SPENCES BRIDGE
...
result = plot_station_polygon("08LF025")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF025">stations/08LF025 folder on GitHub</a>.
:::
...
<tr><td>08LF025</td><td>TWAAL CREEK NEAR SPENCES BRIDGE</td><td>50.467</td><td>-121.338</td><td>84.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 0.3 years
<br><strong>Timeseries Summary:</strong> 122 daily observations, continuous record | 62.3% flagged (estimated: 76)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 224.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>122 daily observations, continuous record | 62.3% flagged (estimated: 76) | Record: 0.3 years</td></tr>
...
show(plot_station_timeseries("08LF025"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF025")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF025/08LF025_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF025/08LF025_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF025"))
:::
...
<div class="download-section">
  <a href="../../08LF025/08LF025_field_visits.csv" download class="download-btn">
