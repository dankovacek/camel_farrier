...
The data representing the above plots can be downloaded from the [stations/05HD036](https://dankovacek.github.io/camel_farrier/stations/05HD036) folder in the Github repository.
