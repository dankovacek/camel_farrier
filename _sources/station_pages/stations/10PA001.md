...
result = plot_station_polygon("10PA001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10PA001">stations/10PA001 folder on GitHub</a>.
:::
...
<tr><td>10PA001</td><td>COPPERMINE RIVER BELOW DESTEFFANY LAKE</td><td>64.616</td><td>-111.955</td><td>6116.0 (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 30.5 years
<br><strong>Timeseries Summary:</strong> 9,961 daily observations, seasonal gaps: 98 days avg (N=12) | 47.4% flagged (backwater: 4590, partial day: 79, estimated: 51)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 33053.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>9,961 daily observations, seasonal gaps: 98 days avg (N=12) | 47.4% flagged (backwater: 4590, partial day: 79, estimated: 51) | Record: 30.5 years</td></tr>
...
show(plot_station_timeseries("10PA001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10PA001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10PA001/10PA001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10PA001/10PA001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10PA001/10PA001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Rating based off of new measurements in 2021 and 2022. Suspect control has changed with high water. ...</td>
    </tr>
    <tr>
      <td>3.0</td>
      <td>LinearTable</td>
      <td>Provisional/Provisoire</td>
      <td>REVISED AND EXTENDED TO 7.8 M.</td>
    </tr>
    <tr>
      <td>2.0</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Significant revision above 6.70 meters</td>
    </tr>
    <tr>
      <td>1.0</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Was originally used up to Dec. 31, 1999</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("10PA001"))
:::
