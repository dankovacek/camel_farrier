...
# 07EE004: CHICHOUYENILY CREEK NEAR MACKENZIE
...
result = plot_station_polygon("07EE004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07EE004">stations/07EE004 folder on GitHub</a>.
:::
...
<tr><td>07EE004</td><td>CHICHOUYENILY CREEK NEAR MACKENZIE</td><td>55.319</td><td>-123.097</td><td>72.3 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 943 daily observations, minor gaps: 30 days avg (N=2) | 62.5% flagged (backwater: 327, estimated: 262)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 216.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>943 daily observations, minor gaps: 30 days avg (N=2) | 62.5% flagged (backwater: 327, estimated: 262) | Record: 2.7 years</td></tr>
...
show(plot_station_timeseries("07EE004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07EE004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07EE004/07EE004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07EE004/07EE004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07EE004"))
:::
...
<div class="download-section">
  <a href="../../07EE004/07EE004_field_visits.csv" download class="download-btn">
