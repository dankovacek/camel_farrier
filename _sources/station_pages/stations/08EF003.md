...
result = plot_station_polygon("08EF003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EF003">stations/08EF003 folder on GitHub</a>.
:::
...
<tr><td>08EF003</td><td>ZYMOETZ RIVER NEAR TERRACE</td><td>54.536</td><td>-128.454</td><td>3080.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 12.7 years
<br><strong>Timeseries Summary:</strong> 4,536 daily observations, seasonal gaps: 90 days avg (N=1) | 52.5% flagged (estimated: 1968, backwater: 412)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 8948.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>4,536 daily observations, seasonal gaps: 90 days avg (N=1) | 52.5% flagged (estimated: 1968, backwater: 412) | Record: 12.7 years</td></tr>
...
show(plot_station_timeseries("08EF003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EF003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EF003/08EF003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08EF003/08EF003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08EF003"))
:::
...
<div class="download-section">
  <a href="../../08EF003/08EF003_field_visits.csv" download class="download-btn">
