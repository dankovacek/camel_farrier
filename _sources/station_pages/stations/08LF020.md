...
# 08LF020: PENDLETON CREEK NEAR CHERRY CREEK
...
result = plot_station_polygon("08LF020")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF020">stations/08LF020 folder on GitHub</a>.
:::
...
<tr><td>08LF020</td><td>PENDLETON CREEK NEAR CHERRY CREEK</td><td>50.675</td><td>-120.575</td><td>10.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 183 daily observations, continuous record | 44.8% flagged (estimated: 82)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 23.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>183 daily observations, continuous record | 44.8% flagged (estimated: 82) | Record: 0.5 years</td></tr>
...
show(plot_station_timeseries("08LF020"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF020")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF020/08LF020_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF020/08LF020_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF020"))
:::
...
<div class="download-section">
  <a href="../../08LF020/08LF020_field_visits.csv" download class="download-btn">
