...
# 08JE002: PINCHI CREEK AT PINCHI LAKE
...
result = plot_station_polygon("08JE002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08JE002">stations/08JE002 folder on GitHub</a>.
:::
...
<tr><td>08JE002</td><td>PINCHI CREEK AT PINCHI LAKE</td><td>54.592</td><td>-124.490</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 1.2 years
<br><strong>Timeseries Summary:</strong> 424 daily observations, continuous record | 74.1% flagged (estimated: 270, backwater: 44)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3285.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>424 daily observations, continuous record | 74.1% flagged (estimated: 270, backwater: 44) | Record: 1.2 years</td></tr>
...
show(plot_station_timeseries("08JE002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08JE002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08JE002/08JE002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08JE002/08JE002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08JE002"))
:::
...
<div class="download-section">
  <a href="../../08JE002/08JE002_field_visits.csv" download class="download-btn">
