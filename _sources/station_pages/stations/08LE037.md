...
# 08LE037: CAMPBELL CREEK NEAR BARNHART VALE (UPPER STATION)
...
result = plot_station_polygon("08LE037")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE037">stations/08LE037 folder on GitHub</a>.
:::
...
<tr><td>08LE037</td><td>CAMPBELL CREEK NEAR BARNHART VALE (UPPER STATION)</td><td>50.571</td><td>-120.211</td><td>285.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,625 daily observations, seasonal gaps: 710 days avg (N=14)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 912.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,625 daily observations, seasonal gaps: 710 days avg (N=14) | Record: 34.4 years</td></tr>
...
show(plot_station_timeseries("08LE037"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE037")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE037/08LE037_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE037/08LE037_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE037"))
:::
...
<div class="download-section">
  <a href="../../08LE037/08LE037_field_visits.csv" download class="download-btn">
