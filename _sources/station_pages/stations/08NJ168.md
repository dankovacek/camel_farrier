...
result = plot_station_polygon("08NJ168")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ168">stations/08NJ168 folder on GitHub</a>.
:::
...
<tr><td>08NJ168</td><td>FIVE MILE CREEK ABOVE CITY INTAKE</td><td>49.519</td><td>-117.212</td><td>47.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 32.2 years
<br><strong>Timeseries Summary:</strong> 11,780 daily observations, continuous record | 20.7% flagged (backwater: 1731, estimated: 591, partial day: 113)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 108.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>11,780 daily observations, continuous record | 20.7% flagged (backwater: 1731, estimated: 591, partial day: 113) | Record: 32.2 years</td></tr>
...
show(plot_station_timeseries("08NJ168"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ168")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ168/08NJ168_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NJ168/08NJ168_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NJ168/08NJ168_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ168"))
:::
...
<div class="download-section">
  <a href="../../08NJ168/08NJ168_field_visits.csv" download class="download-btn">
