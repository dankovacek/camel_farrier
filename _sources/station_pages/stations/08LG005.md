...
# 08LG005: MEADOW CREEK NEAR THE MOUTH
...
result = plot_station_polygon("08LG005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG005">stations/08LG005 folder on GitHub</a>.
:::
...
<tr><td>08LG005</td><td>MEADOW CREEK NEAR THE MOUTH</td><td>50.472</td><td>-120.810</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 57.3 years
<br><strong>Timeseries Summary:</strong> 1,526 daily observations, seasonal gaps: 2427 days avg (N=8) | 38.4% flagged (estimated: 586)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 757.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,526 daily observations, seasonal gaps: 2427 days avg (N=8) | 38.4% flagged (estimated: 586) | Record: 57.3 years</td></tr>
...
show(plot_station_timeseries("08LG005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG005/08LG005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LG005/08LG005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LG005"))
:::
