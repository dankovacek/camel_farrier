...
result = plot_station_polygon("10LC007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10LC007">stations/10LC007 folder on GitHub</a>.
:::
...
<tr><td>10LC007</td><td>CARIBOU CREEK ABOVE HIGHWAY NO. 8 (DEMPSTER HIGHWAY)</td><td>68.087</td><td>-133.492</td><td>590.0 (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 15,285 daily observations, seasonal gaps: 105 days avg (N=4) | 66.8% flagged (backwater: 9722, partial day: 260, estimated: 222)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4318.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>15,285 daily observations, seasonal gaps: 105 days avg (N=4) | 66.8% flagged (backwater: 9722, partial day: 260, estimated: 222) | Record: 43.0 years</td></tr>
...
show(plot_station_timeseries("10LC007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10LC007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10LC007/10LC007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10LC007/10LC007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10LC007/10LC007_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>curve for 2023, clone of 13</td>
    </tr>
    <tr>
      <td>13.00</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("10LC007"))
:::
...
<div class="download-section">
  <a href="../../10LC007/10LC007_field_visits.csv" download class="download-btn">
