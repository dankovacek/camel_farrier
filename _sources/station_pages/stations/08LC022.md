...
# 08LC022: MONASHEE CREEK NEAR CHERRYVILLE
...
result = plot_station_polygon("08LC022")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LC022">stations/08LC022 folder on GitHub</a>.
:::
...
<tr><td>08LC022</td><td>MONASHEE CREEK NEAR CHERRYVILLE</td><td>50.219</td><td>-118.548</td><td>311.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 274 daily observations, minor gaps: 76 days avg (N=2) | 13.9% flagged (estimated: 38)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 649.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>274 daily observations, minor gaps: 76 days avg (N=2) | 13.9% flagged (estimated: 38) | Record: 1.2 years</td></tr>
...
show(plot_station_timeseries("08LC022"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LC022")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LC022/08LC022_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LC022/08LC022_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LC022"))
:::
...
<div class="download-section">
  <a href="../../08LC022/08LC022_field_visits.csv" download class="download-btn">
