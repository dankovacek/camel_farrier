...
# 08MC043: MELDRUM CREEK BELOW MCTAGGART LAKE
...
result = plot_station_polygon("08MC043")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MC043">stations/08MC043 folder on GitHub</a>.
:::
...
<tr><td>08MC043</td><td>MELDRUM CREEK BELOW MCTAGGART LAKE</td><td>52.153</td><td>-122.556</td><td>82.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,988 daily observations, seasonal gaps: 140 days avg (N=8) | 13.6% flagged (estimated: 211, partial day: 30, backwater: 29)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 158.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,988 daily observations, seasonal gaps: 140 days avg (N=8) | 13.6% flagged (estimated: 211, partial day: 30, backwater: 29) | Record: 8.5 years</td></tr>
...
show(plot_station_timeseries("08MC043"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MC043")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MC043/08MC043_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MC043/08MC043_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MC043"))
:::
...
<div class="download-section">
  <a href="../../08MC043/08MC043_field_visits.csv" download class="download-btn">
