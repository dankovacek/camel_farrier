...
# 08NL006: SIMILKAMEEN RIVER NEAR KEREMEOS
...
result = plot_station_polygon("08NL006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL006">stations/08NL006 folder on GitHub</a>.
:::
...
<tr><td>08NL006</td><td>SIMILKAMEEN RIVER NEAR KEREMEOS</td><td>49.221</td><td>-119.958</td><td>5960.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 18.0 years
<br><strong>Timeseries Summary:</strong> 6,485 daily observations, minor gaps: 45 days avg (N=2) | 1.6% flagged (estimated: 102, backwater: 1)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 17625.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>6,485 daily observations, minor gaps: 45 days avg (N=2) | 1.6% flagged (estimated: 102, backwater: 1) | Record: 18.0 years</td></tr>
...
show(plot_station_timeseries("08NL006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL006/08NL006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NL006/08NL006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL006"))
:::
...
<div class="download-section">
  <a href="../../08NL006/08NL006_field_visits.csv" download class="download-btn">
