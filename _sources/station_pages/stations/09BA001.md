...
result = plot_station_polygon("09BA001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09BA001">stations/09BA001 folder on GitHub</a>.
:::
...
<tr><td>09BA001</td><td>ROSS RIVER AT ROSS RIVER</td><td>61.989</td><td>-132.407</td><td>7310.0 (0.0)</td><td>YT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 64.1 years
<br><strong>Timeseries Summary:</strong> 23,102 daily observations, minor gaps: 61 days avg (N=5) | 59.4% flagged (backwater: 12570, estimated: 1049, partial day: 112)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 33374.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>23,102 daily observations, minor gaps: 61 days avg (N=5) | 59.4% flagged (backwater: 12570, estimated: 1049, partial day: 112) | Record: 64.1 years</td></tr>
...
show(plot_station_timeseries("09BA001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09BA001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09BA001/09BA001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../09BA001/09BA001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../09BA001/09BA001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Provisional/Provisoire</td>
      <td>APPROVED Coincides with#17 <9.26m & >10.1m</td>
    </tr>
    <tr>
      <td>17.000</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Coincides with#16 <9.71m & >10.9m</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("09BA001"))
:::
...
<div class="download-section">
  <a href="../../09BA001/09BA001_field_visits.csv" download class="download-btn">
