...
result = plot_station_polygon("07FB001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07FB001">stations/07FB001 folder on GitHub</a>.
:::
...
<tr><td>07FB001</td><td>PINE RIVER AT EAST PINE</td><td>55.718</td><td>-121.212</td><td>12100.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 64.0 years
<br><strong>Timeseries Summary:</strong> 23,133 daily observations, minor gaps: 49 days avg (N=5) | 48.8% flagged (backwater: 10067, estimated: 1060, partial day: 160)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 37256.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>23,133 daily observations, minor gaps: 49 days avg (N=5) | 48.8% flagged (backwater: 10067, estimated: 1060, partial day: 160) | Record: 64.0 years</td></tr>
...
show(plot_station_timeseries("07FB001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07FB001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07FB001/07FB001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07FB001/07FB001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07FB001/07FB001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Curve created using open water measurements from 2022 and the historic high measurements from 1972, ...</td>
    </tr>
    <tr>
      <td>22.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extend lower end of curve 22.00. created using open water measurements from 2017 and the historic ma...</td>
    </tr>
    <tr>
      <td>22.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>created using open water measurements from 2017 and the historic maximum from 1972</td>
    </tr>
    <tr>
      <td>21.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>built using open water measurements from 2013-2016 and historic high measurement from 1972</td>
    </tr>
    <tr>
      <td>20.00</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>coincident to Table #19 at and above 4.000 m.</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("07FB001"))
:::
