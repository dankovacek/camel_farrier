...
# 08LB070: HASCHEAK CREEK BELOW RUSSELL CREEK
...
result = plot_station_polygon("08LB070")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB070">stations/08LB070 folder on GitHub</a>.
:::
...
<tr><td>08LB070</td><td>HASCHEAK CREEK BELOW RUSSELL CREEK</td><td>51.632</td><td>-120.026</td><td>24.3 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,374 daily observations, continuous record | 66.9% flagged (estimated: 1473, backwater: 115)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 63.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,374 daily observations, continuous record | 66.9% flagged (estimated: 1473, backwater: 115) | Record: 6.5 years</td></tr>
...
show(plot_station_timeseries("08LB070"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB070")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB070/08LB070_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LB070/08LB070_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB070"))
:::
...
<div class="download-section">
  <a href="../../08LB070/08LB070_field_visits.csv" download class="download-btn">
