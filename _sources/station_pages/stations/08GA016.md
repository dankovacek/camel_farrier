...
# 08GA016: BRANDYWINE CREEK NEAR BREW
...
result = plot_station_polygon("08GA016")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA016">stations/08GA016 folder on GitHub</a>.
:::
...
<tr><td>08GA016</td><td>BRANDYWINE CREEK NEAR BREW</td><td>50.037</td><td>-123.120</td><td>46.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,920 daily observations, seasonal gaps: 142 days avg (N=3) | 2.3% flagged (estimated: 45)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 123.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,920 daily observations, seasonal gaps: 142 days avg (N=3) | 2.3% flagged (estimated: 45) | Record: 6.4 years</td></tr>
...
show(plot_station_timeseries("08GA016"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA016")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA016/08GA016_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA016/08GA016_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA016"))
:::
