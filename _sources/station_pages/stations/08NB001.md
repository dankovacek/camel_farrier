...
result = plot_station_polygon("08NB001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NB001">stations/08NB001 folder on GitHub</a>.
:::
...
<tr><td>08NB001</td><td>BLAEBERRY RIVER NEAR GOLDEN</td><td>51.424</td><td>-117.041</td><td>738.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 58.3 years
<br><strong>Timeseries Summary:</strong> 2,407 daily observations, seasonal gaps: 3145 days avg (N=6) | 28.6% flagged (backwater: 349, estimated: 339)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1915.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,407 daily observations, seasonal gaps: 3145 days avg (N=6) | 28.6% flagged (backwater: 349, estimated: 339) | Record: 58.3 years</td></tr>
...
show(plot_station_timeseries("08NB001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NB001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NB001/08NB001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NB001/08NB001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NB001"))
:::
...
<div class="download-section">
  <a href="../../08NB001/08NB001_field_visits.csv" download class="download-btn">
