...
# 10VC010: ELEANOR RIVER ABOVE ELEANOR LAKE
...
result = plot_station_polygon("10VC010")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10VC010">stations/10VC010 folder on GitHub</a>.
:::
...
<tr><td>10VC010</td><td>ELEANOR RIVER ABOVE ELEANOR LAKE</td><td>75.333</td><td>-94.217</td><td>666.0 (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 10336.5 km²</td></tr>
...
show(plot_station_timeseries("10VC010"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10VC010")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10VC010/10VC010_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10VC010"))
:::
