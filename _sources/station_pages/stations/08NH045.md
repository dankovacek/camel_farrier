...
# 08NH045: SIRDAR CREEK AT SIRDAR
...
result = plot_station_polygon("08NH045")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH045">stations/08NH045 folder on GitHub</a>.
:::
...
<tr><td>08NH045</td><td>SIRDAR CREEK AT SIRDAR</td><td>49.244</td><td>-116.619</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.84, ΔArea: +17.2%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 549 daily observations, seasonal gaps: 182 days avg (N=2) | 1.8% flagged (estimated: 10)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>549 daily observations, seasonal gaps: 182 days avg (N=2) | 1.8% flagged (estimated: 10) | Record: 2.5 years</td></tr>
...
show(plot_station_timeseries("08NH045"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH045")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH045/08NH045_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH045/08NH045_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH045"))
:::
...
<div class="download-section">
  <a href="../../08NH045/08NH045_field_visits.csv" download class="download-btn">
