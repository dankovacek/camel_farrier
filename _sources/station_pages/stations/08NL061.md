...
# 08NL061: DAVIS LAKE NEAR THALIA
...
result = plot_station_polygon("08NL061")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL061">stations/08NL061 folder on GitHub</a>.
:::
...
<tr><td>08NL061</td><td>DAVIS LAKE NEAR THALIA</td><td>49.858</td><td>-120.726</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.98, ΔArea: +1.4%</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 62.0 km²</td></tr>
...
show(plot_station_timeseries("08NL061"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL061")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL061/08NL061_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NL061/08NL061_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL061"))
:::
...
<div class="download-section">
  <a href="../../08NL061/08NL061_field_visits.csv" download class="download-btn">
