...
result = plot_station_polygon("07JA003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07JA003">stations/07JA003 folder on GitHub</a>.
:::
...
<tr><td>07JA003</td><td>WILLOW RIVER NEAR WABASCA</td><td>55.917</td><td>-113.921</td><td>1030.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 39.7 years
<br><strong>Timeseries Summary:</strong> 10,385 daily observations, seasonal gaps: 105 days avg (N=39) | 32.2% flagged (backwater: 2330, estimated: 576, partial day: 439)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3210.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>10,385 daily observations, seasonal gaps: 105 days avg (N=39) | 32.2% flagged (backwater: 2330, estimated: 576, partial day: 439) | Record: 39.7 years</td></tr>
...
show(plot_station_timeseries("07JA003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07JA003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07JA003/07JA003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07JA003/07JA003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07JA003/07JA003_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>In 2024, a new rating model was implemented at the site to address a general trend of positive (scou...</td>
    </tr>
    <tr>
      <td>14.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Work Objective and Rationale: In both 2022 and 2023 most open water measurements plotted as scour wh...</td>
    </tr>
    <tr>
      <td>13.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>The gauge pool was noticeably lower after the June 2018 high water event and has remained lower in 2...</td>
    </tr>
    <tr>
      <td>12.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>NEW CURVE PRODUCED IN RDT</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("07JA003"))
:::
...
<div class="download-section">
  <a href="../../07JA003/07JA003_field_visits.csv" download class="download-btn">
