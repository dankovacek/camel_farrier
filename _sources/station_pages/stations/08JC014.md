...
# 08JC014: BEAVERLEY CREEK NEAR THE MOUTH
...
result = plot_station_polygon("08JC014")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08JC014">stations/08JC014 folder on GitHub</a>.
:::
...
<tr><td>08JC014</td><td>BEAVERLEY CREEK NEAR THE MOUTH</td><td>53.812</td><td>-122.968</td><td>145.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 0.5 years
<br><strong>Timeseries Summary:</strong> 183 daily observations, continuous record | 28.4% flagged (estimated: 29, backwater: 23)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 614.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>183 daily observations, continuous record | 28.4% flagged (estimated: 29, backwater: 23) | Record: 0.5 years</td></tr>
...
show(plot_station_timeseries("08JC014"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08JC014")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08JC014/08JC014_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08JC014/08JC014_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08JC014"))
:::
...
<div class="download-section">
  <a href="../../08JC014/08JC014_field_visits.csv" download class="download-btn">
