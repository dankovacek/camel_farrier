...
# 08GA070: KILLARNEY LAKE ON BOWEN ISLAND
...
result = plot_station_polygon("08GA070")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA070">stations/08GA070 folder on GitHub</a>.
:::
...
<tr><td>08GA070</td><td>KILLARNEY LAKE ON BOWEN ISLAND</td><td>49.389</td><td>-123.351</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 10.2 km²</td></tr>
...
show(plot_station_timeseries("08GA070"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA070")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA070/08GA070_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08GA070/08GA070_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA070"))
:::
...
<div class="download-section">
  <a href="../../08GA070/08GA070_field_visits.csv" download class="download-btn">
