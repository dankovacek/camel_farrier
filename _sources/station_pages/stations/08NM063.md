...
# 08NM063: PENTICTON CREEK LOT 19 DIVERSION
...
result = plot_station_polygon("08NM063")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM063">stations/08NM063 folder on GitHub</a>.
:::
...
<tr><td>08NM063</td><td>PENTICTON CREEK LOT 19 DIVERSION</td><td>49.507</td><td>-119.561</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.73, ΔArea: +37.6%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 28.4 years
<br><strong>Timeseries Summary:</strong> 4,915 daily observations, seasonal gaps: 195 days avg (N=28) | 0.7% flagged (estimated: 34)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 0.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>4,915 daily observations, seasonal gaps: 195 days avg (N=28) | 0.7% flagged (estimated: 34) | Record: 28.4 years</td></tr>
...
show(plot_station_timeseries("08NM063"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM063")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM063/08NM063_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM063/08NM063_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM063"))
:::
