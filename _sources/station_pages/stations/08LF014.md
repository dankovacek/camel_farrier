...
# 08LF014: HAT CREEK - HAMMOND DIVERSION TO OREGON JACK CREEK
...
result = plot_station_polygon("08LF014")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF014">stations/08LF014 folder on GitHub</a>.
:::
...
<tr><td>08LF014</td><td>HAT CREEK - HAMMOND DIVERSION TO OREGON JACK CREEK</td><td>50.621</td><td>-121.569</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,437 daily observations, seasonal gaps: 296 days avg (N=8) | 0.1% flagged (estimated: 2)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 220.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,437 daily observations, seasonal gaps: 296 days avg (N=8) | 0.1% flagged (estimated: 2) | Record: 10.4 years</td></tr>
...
show(plot_station_timeseries("08LF014"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF014")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF014/08LF014_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF014/08LF014_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF014"))
:::
...
<div class="download-section">
  <a href="../../08LF014/08LF014_field_visits.csv" download class="download-btn">
