...
# 08LB071: HASCHEAK CREEK ABOVE RUSSELL CREEK
...
result = plot_station_polygon("08LB071")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB071">stations/08LB071 folder on GitHub</a>.
:::
...
<tr><td>08LB071</td><td>HASCHEAK CREEK ABOVE RUSSELL CREEK</td><td>51.629</td><td>-120.022</td><td>8.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 6.4 years
<br><strong>Timeseries Summary:</strong> 2,344 daily observations, continuous record | 75.6% flagged (estimated: 1668, backwater: 105)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 17.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,344 daily observations, continuous record | 75.6% flagged (estimated: 1668, backwater: 105) | Record: 6.4 years</td></tr>
...
show(plot_station_timeseries("08LB071"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB071")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB071/08LB071_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LB071/08LB071_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB071"))
:::
