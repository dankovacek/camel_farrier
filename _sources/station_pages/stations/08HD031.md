...
# 08HD031: UPPER CAMPBELL LAKE AT STRATHCONA DAM
...
result = plot_station_polygon("08HD031")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HD031">stations/08HD031 folder on GitHub</a>.
:::
...
<tr><td>08HD031</td><td>UPPER CAMPBELL LAKE AT STRATHCONA DAM</td><td>49.997</td><td>-125.587</td><td>nan (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2852.4 km²</td></tr>
...
show(plot_station_timeseries("08HD031"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HD031")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HD031/08HD031_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HD031/08HD031_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HD031"))
:::
...
<div class="download-section">
  <a href="../../08HD031/08HD031_field_visits.csv" download class="download-btn">
