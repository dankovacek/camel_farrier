...
result = plot_station_polygon("09AC004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09AC004">stations/09AC004 folder on GitHub</a>.
:::
...
<tr><td>09AC004</td><td>TAKHINI RIVER AT OUTLET OF KUSAWA LAKE</td><td>60.613</td><td>-136.124</td><td>4070.0 (0.0)</td><td>YT</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 34.4 years
<br><strong>Timeseries Summary:</strong> 11,323 daily observations, seasonal gaps: 139 days avg (N=9) | 39.2% flagged (backwater: 3713, estimated: 676, partial day: 53)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 16516.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>11,323 daily observations, seasonal gaps: 139 days avg (N=9) | 39.2% flagged (backwater: 3713, estimated: 676, partial day: 53) | Record: 34.4 years</td></tr>
...
show(plot_station_timeseries("09AC004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09AC004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09AC004/09AC004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../09AC004/09AC004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("09AC004"))
:::
...
<div class="download-section">
  <a href="../../09AC004/09AC004_field_visits.csv" download class="download-btn">
