...
# 08HE004: RAGING RIVER NEAR PORT ALICE
...
result = plot_station_polygon("08HE004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HE004">stations/08HE004 folder on GitHub</a>.
:::
...
<tr><td>08HE004</td><td>RAGING RIVER NEAR PORT ALICE</td><td>50.389</td><td>-127.231</td><td>117.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 0.9 years
<br><strong>Timeseries Summary:</strong> 334 daily observations, continuous record | 29.0% flagged (estimated: 97)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 277.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>334 daily observations, continuous record | 29.0% flagged (estimated: 97) | Record: 0.9 years</td></tr>
...
show(plot_station_timeseries("08HE004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HE004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HE004/08HE004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HE004/08HE004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HE004"))
:::
...
<div class="download-section">
  <a href="../../08HE004/08HE004_field_visits.csv" download class="download-btn">
