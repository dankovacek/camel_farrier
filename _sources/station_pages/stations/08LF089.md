...
# 08LF089: SCOTTIE CREEK ABOVE CHROME CREEK
...
result = plot_station_polygon("08LF089")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF089">stations/08LF089 folder on GitHub</a>.
:::
...
<tr><td>08LF089</td><td>SCOTTIE CREEK ABOVE CHROME CREEK</td><td>50.984</td><td>-121.398</td><td>141.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 13.6 years
<br><strong>Timeseries Summary:</strong> 3,336 daily observations, seasonal gaps: 125 days avg (N=13) | 2.8% flagged (estimated: 57, partial day: 30, backwater: 5)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 353.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,336 daily observations, seasonal gaps: 125 days avg (N=13) | 2.8% flagged (estimated: 57, partial day: 30, backwater: 5) | Record: 13.6 years</td></tr>
...
show(plot_station_timeseries("08LF089"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF089")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF089/08LF089_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF089/08LF089_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF089"))
:::
...
<div class="download-section">
  <a href="../../08LF089/08LF089_field_visits.csv" download class="download-btn">
