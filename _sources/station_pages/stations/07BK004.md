...
# 07BK004: OTAUWAU RIVER NEAR SLAVE LAKE
...
result = plot_station_polygon("07BK004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07BK004">stations/07BK004 folder on GitHub</a>.
:::
...
<tr><td>07BK004</td><td>OTAUWAU RIVER NEAR SLAVE LAKE</td><td>55.275</td><td>-114.410</td><td>515.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 91 daily observations, continuous record</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1763.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>91 daily observations, continuous record | Record: 0.2 years</td></tr>
...
show(plot_station_timeseries("07BK004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07BK004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07BK004/07BK004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07BK004/07BK004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07BK004"))
:::
...
<div class="download-section">
  <a href="../../07BK004/07BK004_field_visits.csv" download class="download-btn">
