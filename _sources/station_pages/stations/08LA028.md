...
result = plot_station_polygon("08LA028")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LA028">stations/08LA028 folder on GitHub</a>.
:::
...
<tr><td>08LA028</td><td>WINDY CREEK ABOVE JIM CREEK</td><td>51.623</td><td>-120.672</td><td>79.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 15.2 years
<br><strong>Timeseries Summary:</strong> 5,571 daily observations, continuous record | 39.0% flagged (backwater: 2058, estimated: 60, partial day: 55)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 207.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>5,571 daily observations, continuous record | 39.0% flagged (backwater: 2058, estimated: 60, partial day: 55) | Record: 15.2 years</td></tr>
...
show(plot_station_timeseries("08LA028"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LA028")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LA028/08LA028_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08LA028/08LA028_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LA028/08LA028_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LA028"))
:::
...
<div class="download-section">
  <a href="../../08LA028/08LA028_field_visits.csv" download class="download-btn">
