...
# 08FB009: CLAYTON FALLS CREEK NEAR THE MOUTH
...
result = plot_station_polygon("08FB009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08FB009">stations/08FB009 folder on GitHub</a>.
:::
...
<tr><td>08FB009</td><td>CLAYTON FALLS CREEK NEAR THE MOUTH</td><td>52.364</td><td>-126.808</td><td>92.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 5,996 daily observations, continuous record | 15.3% flagged (estimated: 452, backwater: 432, partial day: 34)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 246.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>5,996 daily observations, continuous record | 15.3% flagged (estimated: 452, backwater: 432, partial day: 34) | Record: 16.4 years</td></tr>
...
show(plot_station_timeseries("08FB009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08FB009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08FB009/08FB009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08FB009/08FB009_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08FB009"))
:::
