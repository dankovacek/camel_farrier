...
result = plot_station_polygon("08NJ027")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ027">stations/08NJ027 folder on GitHub</a>.
:::
...
<tr><td>08NJ027</td><td>HARROP CREEK NEAR HARROP</td><td>49.595</td><td>-117.059</td><td>42.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 72.3 years
<br><strong>Timeseries Summary:</strong> 4,547 daily observations, seasonal gaps: 810 days avg (N=27) | 26.1% flagged (estimated: 1188)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 100.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>4,547 daily observations, seasonal gaps: 810 days avg (N=27) | 26.1% flagged (estimated: 1188) | Record: 72.3 years</td></tr>
...
show(plot_station_timeseries("08NJ027"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ027")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ027/08NJ027_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ027/08NJ027_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ027"))
:::
...
<div class="download-section">
  <a href="../../08NJ027/08NJ027_field_visits.csv" download class="download-btn">
