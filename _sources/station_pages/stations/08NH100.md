...
result = plot_station_polygon("08NH100")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH100">stations/08NH100 folder on GitHub</a>.
:::
...
<tr><td>08NH100</td><td>SUMMIT CREEK NEAR CRESTON</td><td>49.143</td><td>-116.654</td><td>293.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,560 daily observations, seasonal gaps: 158 days avg (N=5) | 17.1% flagged (backwater: 340, estimated: 94, partial day: 4)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 692.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,560 daily observations, seasonal gaps: 158 days avg (N=5) | 17.1% flagged (backwater: 340, estimated: 94, partial day: 4) | Record: 9.2 years</td></tr>
...
show(plot_station_timeseries("08NH100"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH100")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH100/08NH100_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH100/08NH100_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH100"))
:::
