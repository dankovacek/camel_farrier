...
# 08NM131: OKANOGAN RIVER AT BRIDGE STREET AT OROVILLE
...
result = plot_station_polygon("08NM131")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM131">stations/08NM131 folder on GitHub</a>.
:::
...
<tr><td>08NM131</td><td>OKANOGAN RIVER AT BRIDGE STREET AT OROVILLE</td><td>48.939</td><td>-119.427</td><td>8110.0 (0.0)</td><td>WA</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 19198.5 km²</td></tr>
...
show(plot_station_timeseries("08NM131"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM131")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM131/08NM131_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM131/08NM131_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM131"))
:::
