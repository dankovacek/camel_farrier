...
# 08NL046: MISSEZULA LAKE NEAR PRINCETON
...
result = plot_station_polygon("08NL046")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL046">stations/08NL046 folder on GitHub</a>.
:::
...
<tr><td>08NL046</td><td>MISSEZULA LAKE NEAR PRINCETON</td><td>49.767</td><td>-120.500</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
show(plot_station_timeseries("08NL046"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL046")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL046/08NL046_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NL046/08NL046_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL046"))
:::
...
<div class="download-section">
  <a href="../../08NL046/08NL046_field_visits.csv" download class="download-btn">
