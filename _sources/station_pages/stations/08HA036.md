...
# 08HA036: COWAN BROOK NEAR YOUBOU
...
result = plot_station_polygon("08HA036")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HA036">stations/08HA036 folder on GitHub</a>.
:::
...
<tr><td>08HA036</td><td>COWAN BROOK NEAR YOUBOU</td><td>48.896</td><td>-124.278</td><td>0.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.95, ΔArea: +3.4%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,097 daily observations, seasonal gaps: 137 days avg (N=4) | 20.1% flagged (estimated: 221)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,097 daily observations, seasonal gaps: 137 days avg (N=4) | 20.1% flagged (estimated: 221) | Record: 4.5 years</td></tr>
...
show(plot_station_timeseries("08HA036"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HA036")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HA036/08HA036_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HA036/08HA036_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HA036"))
:::
...
<div class="download-section">
  <a href="../../08HA036/08HA036_field_visits.csv" download class="download-btn">
