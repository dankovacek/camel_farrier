...
# 08LE079: NISKONLITH LAKE NEAR SHUSWAP
...
result = plot_station_polygon("08LE079")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE079">stations/08LE079 folder on GitHub</a>.
:::
...
<tr><td>08LE079</td><td>NISKONLITH LAKE NEAR SHUSWAP</td><td>50.764</td><td>-119.783</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 250.4 km²</td></tr>
...
show(plot_station_timeseries("08LE079"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE079")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE079/08LE079_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LE079/08LE079_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE079"))
:::
