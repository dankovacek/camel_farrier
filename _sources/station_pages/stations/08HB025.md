...
result = plot_station_polygon("08HB025")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB025">stations/08HB025 folder on GitHub</a>.
:::
...
<tr><td>08HB025</td><td>BROWNS RIVER NEAR COURTENAY</td><td>49.693</td><td>-125.069</td><td>87.9 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 64.9 years
<br><strong>Timeseries Summary:</strong> 18,595 daily observations, seasonal gaps: 640 days avg (N=8) | 15.3% flagged (estimated: 2387, backwater: 339, partial day: 123)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 210.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>18,595 daily observations, seasonal gaps: 640 days avg (N=8) | 15.3% flagged (estimated: 2387, backwater: 339, partial day: 123) | Record: 64.9 years</td></tr>
...
show(plot_station_timeseries("08HB025"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB025")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB025/08HB025_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08HB025/08HB025_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HB025/08HB025_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HB025"))
:::
...
<div class="download-section">
  <a href="../../08HB025/08HB025_field_visits.csv" download class="download-btn">
