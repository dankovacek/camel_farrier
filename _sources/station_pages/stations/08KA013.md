...
result = plot_station_polygon("08KA013")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KA013">stations/08KA013 folder on GitHub</a>.
:::
...
<tr><td>08KA013</td><td>MORKILL RIVER BELOW HELLROARING CREEK</td><td>53.682</td><td>-120.591</td><td>1260.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 27.0 years
<br><strong>Timeseries Summary:</strong> 9,862 daily observations, continuous record | 37.0% flagged (backwater: 3636, partial day: 14, estimated: 2)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3591.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>9,862 daily observations, continuous record | 37.0% flagged (backwater: 3636, partial day: 14, estimated: 2) | Record: 27.0 years</td></tr>
...
show(plot_station_timeseries("08KA013"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KA013")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KA013/08KA013_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08KA013/08KA013_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08KA013/08KA013_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>New curve for 2022 using 2019-22 measurements. Top end of the curve is defined by 2012 max measureme...</td>
    </tr>
    <tr>
      <td>12.02</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Revised grades due to recent measurements/shifts</td>
    </tr>
    <tr>
      <td>12.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extended bottom end to accmodate water levels on 20180331</td>
    </tr>
    <tr>
      <td>12.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New curve with no BP shift during ice period</td>
    </tr>
    <tr>
      <td>11</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>First Curve on HWS</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08KA013"))
:::
