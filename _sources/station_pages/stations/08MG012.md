...
result = plot_station_polygon("08MG012")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MG012">stations/08MG012 folder on GitHub</a>.
:::
...
<tr><td>08MG012</td><td>HARRISON LAKE NEAR HARRISON HOT SPRINGS</td><td>49.309</td><td>-121.774</td><td>nan (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 19146.5 km²</td></tr>
...
show(plot_station_timeseries("08MG012"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MG012")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MG012/08MG012_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08MG012/08MG012_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MG012"))
:::
...
<div class="download-section">
  <a href="../../08MG012/08MG012_field_visits.csv" download class="download-btn">
