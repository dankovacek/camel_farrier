...
result = plot_station_polygon("09AC007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09AC007">stations/09AC007 folder on GitHub</a>.
:::
...
<tr><td>09AC007</td><td>IBEX RIVER NEAR WHITEHORSE</td><td>60.726</td><td>-135.486</td><td>648.0 (0.0)</td><td>YT</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 12,296 daily observations, seasonal gaps: 162 days avg (N=3) | 60.8% flagged (backwater: 6434, estimated: 976, partial day: 61)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1792.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>12,296 daily observations, seasonal gaps: 162 days avg (N=3) | 60.8% flagged (backwater: 6434, estimated: 976, partial day: 61) | Record: 35.0 years</td></tr>
...
show(plot_station_timeseries("09AC007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09AC007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09AC007/09AC007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../09AC007/09AC007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../09AC007/09AC007_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Developing new curve to produce higher and lower flow data than Curve 15.0</td>
    </tr>
    <tr>
      <td>15.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Developing new curv</td>
    </tr>
    <tr>
      <td>14.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Move orifice, left shift 3.500-4.700 m</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("09AC007"))
:::
...
<div class="download-section">
  <a href="../../09AC007/09AC007_field_visits.csv" download class="download-btn">
