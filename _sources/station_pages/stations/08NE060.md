...
# 08NE060: BANGOR BROOK NEAR ROSSLAND
...
result = plot_station_polygon("08NE060")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE060">stations/08NE060 folder on GitHub</a>.
:::
...
<tr><td>08NE060</td><td>BANGOR BROOK NEAR ROSSLAND</td><td>49.073</td><td>-117.776</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.95, ΔArea: +4.7%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 153 daily observations, continuous record | 48.4% flagged (estimated: 74)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>153 daily observations, continuous record | 48.4% flagged (estimated: 74) | Record: 0.4 years</td></tr>
...
show(plot_station_timeseries("08NE060"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE060")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE060/08NE060_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE060/08NE060_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE060"))
:::
...
<div class="download-section">
  <a href="../../08NE060/08NE060_field_visits.csv" download class="download-btn">
