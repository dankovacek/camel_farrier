...
# 08MH088: SAAR CREEK NEAR UPPER SUMAS
...
result = plot_station_polygon("08MH088")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH088">stations/08MH088 folder on GitHub</a>.
:::
...
<tr><td>08MH088</td><td>SAAR CREEK NEAR UPPER SUMAS</td><td>49.017</td><td>-122.188</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,460 daily observations, minor gaps: 31 days avg (N=1) | 12.3% flagged (estimated: 166, partial day: 14)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,460 daily observations, minor gaps: 31 days avg (N=1) | 12.3% flagged (estimated: 166, partial day: 14) | Record: 4.1 years</td></tr>
...
show(plot_station_timeseries("08MH088"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH088")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH088/08MH088_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH088/08MH088_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH088"))
:::
...
<div class="download-section">
  <a href="../../08MH088/08MH088_field_visits.csv" download class="download-btn">
