...
result = plot_station_polygon("07FB003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07FB003">stations/07FB003 folder on GitHub</a>.
:::
...
<tr><td>07FB003</td><td>SUKUNKA RIVER NEAR THE MOUTH</td><td>55.542</td><td>-121.628</td><td>2590.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 17,320 daily observations, continuous record | 55.3% flagged (backwater: 7474, estimated: 1941, partial day: 162)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 7932.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>17,320 daily observations, continuous record | 55.3% flagged (backwater: 7474, estimated: 1941, partial day: 162) | Record: 47.4 years</td></tr>
...
show(plot_station_timeseries("07FB003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07FB003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07FB003/07FB003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07FB003/07FB003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07FB003/07FB003_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Curve 30.00 implemented due to continued deposition affecting the low-mid range combined with the ga...</td>
    </tr>
    <tr>
      <td>29.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve 29.01 is a clone of 29.00 with high end estimated region extended to reflect 2024 data.</td>
    </tr>
    <tr>
      <td>29.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>created using open water measurements from 2020-2022.  The historical max measurement from 2002 was ...</td>
    </tr>
    <tr>
      <td>28.00</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("07FB003"))
:::
...
<div class="download-section">
  <a href="../../07FB003/07FB003_field_visits.csv" download class="download-btn">
