...
# 08MH080: LONZO CREEK NEAR ABBOTSFORD
...
result = plot_station_polygon("08MH080")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH080">stations/08MH080 folder on GitHub</a>.
:::
...
<tr><td>08MH080</td><td>LONZO CREEK NEAR ABBOTSFORD</td><td>49.029</td><td>-122.262</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.94, ΔArea: +5.8%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,001 daily observations, seasonal gaps: 102 days avg (N=3) | 3.7% flagged (estimated: 37)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,001 daily observations, seasonal gaps: 102 days avg (N=3) | 3.7% flagged (estimated: 37) | Record: 3.6 years</td></tr>
...
show(plot_station_timeseries("08MH080"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH080")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH080/08MH080_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH080/08MH080_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH080"))
:::
...
<div class="download-section">
  <a href="../../08MH080/08MH080_field_visits.csv" download class="download-btn">
