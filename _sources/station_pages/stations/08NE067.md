...
# 08NE067: WALKER CREEK NEAR ROBSON
...
result = plot_station_polygon("08NE067")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE067">stations/08NE067 folder on GitHub</a>.
:::
...
<tr><td>08NE067</td><td>WALKER CREEK NEAR ROBSON</td><td>49.347</td><td>-117.748</td><td>0.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.96, ΔArea: +0.4%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 885 daily observations, seasonal gaps: 182 days avg (N=4) | 48.7% flagged (estimated: 431)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>885 daily observations, seasonal gaps: 182 days avg (N=4) | 48.7% flagged (estimated: 431) | Record: 4.4 years</td></tr>
...
show(plot_station_timeseries("08NE067"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE067")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE067/08NE067_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE067/08NE067_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE067"))
:::
...
<div class="download-section">
  <a href="../../08NE067/08NE067_field_visits.csv" download class="download-btn">
