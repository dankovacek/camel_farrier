...
# 08NH102: AKOKLI CREEK NEAR BOSWELL
...
result = plot_station_polygon("08NH102")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH102">stations/08NH102 folder on GitHub</a>.
:::
...
<tr><td>08NH102</td><td>AKOKLI CREEK NEAR BOSWELL</td><td>49.428</td><td>-116.744</td><td>50.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,007 daily observations, seasonal gaps: 182 days avg (N=5) | 57.3% flagged (estimated: 577)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 120.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,007 daily observations, seasonal gaps: 182 days avg (N=5) | 57.3% flagged (estimated: 577) | Record: 5.3 years</td></tr>
...
show(plot_station_timeseries("08NH102"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH102")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH102/08NH102_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH102/08NH102_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH102"))
:::
