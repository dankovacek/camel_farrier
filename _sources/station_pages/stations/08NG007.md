...
# 08NG007: MARK CREEK NEAR MARYSVILLE
...
result = plot_station_polygon("08NG007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG007">stations/08NG007 folder on GitHub</a>.
:::
...
<tr><td>08NG007</td><td>MARK CREEK NEAR MARYSVILLE</td><td>49.638</td><td>-115.961</td><td>233.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,159 daily observations, seasonal gaps: 90 days avg (N=1) | 6.7% flagged (backwater: 76, estimated: 2)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 371.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,159 daily observations, seasonal gaps: 90 days avg (N=1) | 6.7% flagged (backwater: 76, estimated: 2) | Record: 3.4 years</td></tr>
...
show(plot_station_timeseries("08NG007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG007/08NG007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG007/08NG007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG007"))
:::
...
<div class="download-section">
  <a href="../../08NG007/08NG007_field_visits.csv" download class="download-btn">
