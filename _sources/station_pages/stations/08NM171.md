...
result = plot_station_polygon("08NM171")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM171">stations/08NM171 folder on GitHub</a>.
:::
...
<tr><td>08NM171</td><td>VASEUX CREEK ABOVE SOLCO CREEK</td><td>49.249</td><td>-119.321</td><td>117.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 19,816 daily observations, continuous record | 37.1% flagged (backwater: 6360, estimated: 943, partial day: 53)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 276.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>19,816 daily observations, continuous record | 37.1% flagged (backwater: 6360, estimated: 943, partial day: 53) | Record: 54.3 years</td></tr>
...
show(plot_station_timeseries("08NM171"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM171")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM171/08NM171_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NM171/08NM171_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM171/08NM171_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>New rating based on all open water mmnts from 2022 and 2023</td>
    </tr>
    <tr>
      <td>49.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extension of Curve #49.01</td>
    </tr>
    <tr>
      <td>49.00</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08NM171"))
:::
