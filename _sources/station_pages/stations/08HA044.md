...
# 08HA044: ST.MARY LAKE AT THE PUMPHOUSE
...
result = plot_station_polygon("08HA044")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HA044">stations/08HA044 folder on GitHub</a>.
:::
...
<tr><td>08HA044</td><td>ST.MARY LAKE AT THE PUMPHOUSE</td><td>48.893</td><td>-123.549</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 18.1 km²</td></tr>
...
show(plot_station_timeseries("08HA044"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HA044")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HA044/08HA044_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HA044/08HA044_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HA044"))
:::
...
<div class="download-section">
  <a href="../../08HA044/08HA044_field_visits.csv" download class="download-btn">
