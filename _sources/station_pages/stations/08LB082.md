...
# 08LB082: MCQUEEN LAKE AT THE OUTLET
...
result = plot_station_polygon("08LB082")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB082">stations/08LB082 folder on GitHub</a>.
:::
...
<tr><td>08LB082</td><td>MCQUEEN LAKE AT THE OUTLET</td><td>50.830</td><td>-120.438</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 13.7 km²</td></tr>
...
show(plot_station_timeseries("08LB082"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB082")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB082/08LB082_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LB082/08LB082_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB082"))
:::
...
<div class="download-section">
  <a href="../../08LB082/08LB082_field_visits.csv" download class="download-btn">
