...
result = plot_station_polygon("08CC003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08CC003">stations/08CC003 folder on GitHub</a>.
:::
...
<tr><td>08CC003</td><td>KLAPPAN RIVER AT HEADWATERS PLATEAU</td><td>57.250</td><td>-129.053</td><td>16.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 3,319 daily observations, minor gaps: 30 days avg (N=1) | 64.1% flagged (backwater: 1988, estimated: 134, partial day: 5)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 57.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>3,319 daily observations, minor gaps: 30 days avg (N=1) | 64.1% flagged (backwater: 1988, estimated: 134, partial day: 5) | Record: 9.2 years</td></tr>
...
show(plot_station_timeseries("08CC003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08CC003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08CC003/08CC003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08CC003/08CC003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08CC003"))
:::
...
<div class="download-section">
  <a href="../../08CC003/08CC003_field_visits.csv" download class="download-btn">
