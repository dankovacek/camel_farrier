...
# 08MF007: NAHATLATCH RIVER AT OUTLET OF FRANCES LAKE
...
result = plot_station_polygon("08MF007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MF007">stations/08MF007 folder on GitHub</a>.
:::
...
<tr><td>08MF007</td><td>NAHATLATCH RIVER AT OUTLET OF FRANCES LAKE</td><td>50.009</td><td>-121.646</td><td>777.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 9.5 years
<br><strong>Timeseries Summary:</strong> 3,471 daily observations, continuous record</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2201.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>3,471 daily observations, continuous record | Record: 9.5 years</td></tr>
...
show(plot_station_timeseries("08MF007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MF007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MF007/08MF007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MF007/08MF007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MF007"))
:::
...
<div class="download-section">
  <a href="../../08MF007/08MF007_field_visits.csv" download class="download-btn">
