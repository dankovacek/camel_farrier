...
# 08MF001: ANDERSON RIVER NEAR BOSTON BAR
...
result = plot_station_polygon("08MF001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MF001">stations/08MF001 folder on GitHub</a>.
:::
...
<tr><td>08MF001</td><td>ANDERSON RIVER NEAR BOSTON BAR</td><td>49.840</td><td>-121.428</td><td>492.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 70.7 years
<br><strong>Timeseries Summary:</strong> 2,099 daily observations, seasonal gaps: 2635 days avg (N=9) | 3.5% flagged (backwater: 54, estimated: 16, partial day: 4)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1199.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,099 daily observations, seasonal gaps: 2635 days avg (N=9) | 3.5% flagged (backwater: 54, estimated: 16, partial day: 4) | Record: 70.7 years</td></tr>
...
show(plot_station_timeseries("08MF001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MF001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MF001/08MF001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MF001/08MF001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MF001"))
:::
