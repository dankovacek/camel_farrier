...
result = plot_station_polygon("08EC005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EC005">stations/08EC005 folder on GitHub</a>.
:::
...
<tr><td>08EC005</td><td>FULTON RIVER AT FULTON LAKE NARROWS</td><td>54.807</td><td>-126.300</td><td>1340.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,216 daily observations, minor gaps: 76 days avg (N=2) | 6.7% flagged (partial day: 69, estimated: 12)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4211.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,216 daily observations, minor gaps: 76 days avg (N=2) | 6.7% flagged (partial day: 69, estimated: 12) | Record: 3.7 years</td></tr>
...
show(plot_station_timeseries("08EC005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EC005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EC005/08EC005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08EC005/08EC005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08EC005"))
:::
...
<div class="download-section">
  <a href="../../08EC005/08EC005_field_visits.csv" download class="download-btn">
