...
# 08LC038: MABEL LAKE AT THE OUTLET
...
result = plot_station_polygon("08LC038")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LC038">stations/08LC038 folder on GitHub</a>.
:::
...
<tr><td>08LC038</td><td>MABEL LAKE AT THE OUTLET</td><td>50.603</td><td>-118.738</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 9994.7 km²</td></tr>
...
show(plot_station_timeseries("08LC038"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LC038")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LC038/08LC038_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LC038/08LC038_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LC038"))
:::
