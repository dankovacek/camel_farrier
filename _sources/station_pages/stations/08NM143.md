...
# 08NM143: KALAMALKA LAKE AT VERNON PUMPHOUSE
...
result = plot_station_polygon("08NM143")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM143">stations/08NM143 folder on GitHub</a>.
:::
...
<tr><td>08NM143</td><td>KALAMALKA LAKE AT VERNON PUMPHOUSE</td><td>50.230</td><td>-119.274</td><td>nan (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1395.7 km²</td></tr>
...
show(plot_station_timeseries("08NM143"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM143")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM143/08NM143_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM143/08NM143_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM143"))
:::
