...
result = plot_station_polygon("10BA001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10BA001">stations/10BA001 folder on GitHub</a>.
:::
...
<tr><td>10BA001</td><td>TURNAGAIN RIVER ABOVE SANDPILE CREEK</td><td>59.064</td><td>-127.845</td><td>6580.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 26.7 years
<br><strong>Timeseries Summary:</strong> 9,681 daily observations, minor gaps: 61 days avg (N=1) | 51.8% flagged (backwater: 4740, estimated: 250, partial day: 20)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 24336.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>9,681 daily observations, minor gaps: 61 days avg (N=1) | 51.8% flagged (backwater: 4740, estimated: 250, partial day: 20) | Record: 26.7 years</td></tr>
...
show(plot_station_timeseries("10BA001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10BA001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10BA001/10BA001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10BA001/10BA001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10BA001"))
:::
