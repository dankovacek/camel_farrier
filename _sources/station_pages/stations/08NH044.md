...
# 08NH044: WILDS CREEK (NORTH FORK) NEAR WYNNDEL
...
result = plot_station_polygon("08NH044")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH044">stations/08NH044 folder on GitHub</a>.
:::
...
<tr><td>08NH044</td><td>WILDS CREEK (NORTH FORK) NEAR WYNNDEL</td><td>49.208</td><td>-116.567</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 366 daily observations, seasonal gaps: 182 days avg (N=1) | 83.9% flagged (estimated: 307)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>366 daily observations, seasonal gaps: 182 days avg (N=1) | 83.9% flagged (estimated: 307) | Record: 1.5 years</td></tr>
...
show(plot_station_timeseries("08NH044"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH044")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH044/08NH044_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH044/08NH044_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH044"))
:::
...
<div class="download-section">
  <a href="../../08NH044/08NH044_field_visits.csv" download class="download-btn">
