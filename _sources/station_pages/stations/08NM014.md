...
# 08NM014: MCDOUGALL CREEK NEAR WESTBANK
...
result = plot_station_polygon("08NM014")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM014">stations/08NM014 folder on GitHub</a>.
:::
...
<tr><td>08NM014</td><td>MCDOUGALL CREEK NEAR WESTBANK</td><td>49.879</td><td>-119.589</td><td>38.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,160 daily observations, seasonal gaps: 173 days avg (N=7) | 35.3% flagged (estimated: 409)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,160 daily observations, seasonal gaps: 173 days avg (N=7) | 35.3% flagged (estimated: 409) | Record: 6.5 years</td></tr>
...
show(plot_station_timeseries("08NM014"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM014")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM014/08NM014_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM014/08NM014_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM014"))
:::
...
<div class="download-section">
  <a href="../../08NM014/08NM014_field_visits.csv" download class="download-btn">
