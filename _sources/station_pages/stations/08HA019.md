...
# 08HA019: PATROLAS CREEK NEAR COWICHAN STATION
...
result = plot_station_polygon("08HA019")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HA019">stations/08HA019 folder on GitHub</a>.
:::
...
<tr><td>08HA019</td><td>PATROLAS CREEK NEAR COWICHAN STATION</td><td>48.724</td><td>-123.658</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 0.4 years
<br><strong>Timeseries Summary:</strong> 123 daily observations, minor gaps: 30 days avg (N=1) | 3.3% flagged (estimated: 4)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 31.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>123 daily observations, minor gaps: 30 days avg (N=1) | 3.3% flagged (estimated: 4) | Record: 0.4 years</td></tr>
...
show(plot_station_timeseries("08HA019"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HA019")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HA019/08HA019_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HA019/08HA019_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HA019"))
:::
...
<div class="download-section">
  <a href="../../08HA019/08HA019_field_visits.csv" download class="download-btn">
