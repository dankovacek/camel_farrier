...
# 08GA014: CHEAKAMUS RIVER NEAR CHEEKYE
...
result = plot_station_polygon("08GA014")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA014">stations/08GA014 folder on GitHub</a>.
:::
...
<tr><td>08GA014</td><td>CHEAKAMUS RIVER NEAR CHEEKYE</td><td>49.799</td><td>-123.156</td><td>1070.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 855 daily observations, minor gaps: 44 days avg (N=2)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2489.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>855 daily observations, minor gaps: 44 days avg (N=2) | Record: 2.6 years</td></tr>
...
show(plot_station_timeseries("08GA014"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA014")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA014/08GA014_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA014/08GA014_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA014"))
:::
...
<div class="download-section">
  <a href="../../08GA014/08GA014_field_visits.csv" download class="download-btn">
