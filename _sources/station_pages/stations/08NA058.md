...
result = plot_station_polygon("08NA058")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA058">stations/08NA058 folder on GitHub</a>.
:::
...
<tr><td>08NA058</td><td>HOTSPRING CREEK NEAR FAIRMONT HOT SPRINGS</td><td>50.328</td><td>-115.839</td><td>10.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 765 daily observations, seasonal gaps: 237 days avg (N=5) | 2.0% flagged (estimated: 15)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 25.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>765 daily observations, seasonal gaps: 237 days avg (N=5) | 2.0% flagged (estimated: 15) | Record: 5.3 years</td></tr>
...
show(plot_station_timeseries("08NA058"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA058")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA058/08NA058_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA058/08NA058_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA058"))
:::
...
<div class="download-section">
  <a href="../../08NA058/08NA058_field_visits.csv" download class="download-btn">
