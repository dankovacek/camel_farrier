...
# 08MG017: MIAMI CREEK NEAR HARRISON HOT SPRINGS (LOWER STATION)
...
result = plot_station_polygon("08MG017")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MG017">stations/08MG017 folder on GitHub</a>.
:::
...
<tr><td>08MG017</td><td>MIAMI CREEK NEAR HARRISON HOT SPRINGS (LOWER STATION)</td><td>49.281</td><td>-121.783</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,152 daily observations, seasonal gaps: 123 days avg (N=4) | 14.1% flagged (estimated: 163)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,152 daily observations, seasonal gaps: 123 days avg (N=4) | 14.1% flagged (estimated: 163) | Record: 4.5 years</td></tr>
...
show(plot_station_timeseries("08MG017"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MG017")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MG017/08MG017_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MG017/08MG017_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MG017"))
:::
