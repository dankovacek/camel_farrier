...
# 08JA023: NECHAKO RESERVOIR AT SKINS LAKE SPILLWAY
...
result = plot_station_polygon("08JA023")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08JA023">stations/08JA023 folder on GitHub</a>.
:::
...
<tr><td>08JA023</td><td>NECHAKO RESERVOIR AT SKINS LAKE SPILLWAY</td><td>53.772</td><td>-125.997</td><td>nan (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 39363.5 km²</td></tr>
...
show(plot_station_timeseries("08JA023"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08JA023")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08JA023/08JA023_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08JA023/08JA023_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08JA023"))
:::
...
<div class="download-section">
  <a href="../../08JA023/08JA023_field_visits.csv" download class="download-btn">
