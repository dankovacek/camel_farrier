...
result = plot_station_polygon("10CD005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10CD005">stations/10CD005 folder on GitHub</a>.
:::
...
<tr><td>10CD005</td><td>ADSETT CREEK AT KILOMETRE 386.0 ALASKA HIGHWAY</td><td>58.106</td><td>-122.716</td><td>109.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 41.8 years
<br><strong>Timeseries Summary:</strong> 15,251 daily observations, continuous record | 58.2% flagged (backwater: 7925, estimated: 695, partial day: 256)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 395.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>15,251 daily observations, continuous record | 58.2% flagged (backwater: 7925, estimated: 695, partial day: 256) | Record: 41.8 years</td></tr>
...
show(plot_station_timeseries("10CD005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10CD005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10CD005/10CD005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10CD005/10CD005_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10CD005/10CD005_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Based on 2017/2018 mmts.  After a 2016 scour event</td>
    </tr>
    <tr>
      <td>42.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve 42.00 was created for the 2023 review period because all 2023 open water measurements plotted ...</td>
    </tr>
    <tr>
      <td>40.0</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("10CD005"))
:::
...
<div class="download-section">
  <a href="../../10CD005/10CD005_field_visits.csv" download class="download-btn">
