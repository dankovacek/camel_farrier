...
# 08MH077: KENWORTHY CREEK NEAR HATZIC
...
result = plot_station_polygon("08MH077")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH077">stations/08MH077 folder on GitHub</a>.
:::
...
<tr><td>08MH077</td><td>KENWORTHY CREEK NEAR HATZIC</td><td>49.199</td><td>-122.258</td><td>4.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,090 daily observations, seasonal gaps: 123 days avg (N=4) | 16.1% flagged (estimated: 176)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 8.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,090 daily observations, seasonal gaps: 123 days avg (N=4) | 16.1% flagged (estimated: 176) | Record: 4.3 years</td></tr>
...
show(plot_station_timeseries("08MH077"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH077")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH077/08MH077_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH077/08MH077_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH077"))
:::
...
<div class="download-section">
  <a href="../../08MH077/08MH077_field_visits.csv" download class="download-btn">
