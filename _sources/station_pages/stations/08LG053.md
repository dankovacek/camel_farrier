...
result = plot_station_polygon("08LG053")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG053">stations/08LG053 folder on GitHub</a>.
:::
...
<tr><td>08LG053</td><td>WALLOPER CREEK ABOVE WALLOPER LAKE</td><td>50.486</td><td>-120.544</td><td>19.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: -1.5%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 915 daily observations, seasonal gaps: 182 days avg (N=4) | 44.2% flagged (estimated: 389, backwater: 15)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 48.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>915 daily observations, seasonal gaps: 182 days avg (N=4) | 44.2% flagged (estimated: 389, backwater: 15) | Record: 4.5 years</td></tr>
...
show(plot_station_timeseries("08LG053"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG053")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG053/08LG053_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LG053/08LG053_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LG053"))
:::
...
<div class="download-section">
  <a href="../../08LG053/08LG053_field_visits.csv" download class="download-btn">
