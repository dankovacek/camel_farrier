...
# 08NL013: SUMMERS CREEK AT THE MOUTH
...
result = plot_station_polygon("08NL013")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL013">stations/08NL013 folder on GitHub</a>.
:::
...
<tr><td>08NL013</td><td>SUMMERS CREEK AT THE MOUTH</td><td>49.536</td><td>-120.515</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 47.3 years
<br><strong>Timeseries Summary:</strong> 1,434 daily observations, seasonal gaps: 1982 days avg (N=8) | 3.0% flagged (estimated: 43)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 835.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,434 daily observations, seasonal gaps: 1982 days avg (N=8) | 3.0% flagged (estimated: 43) | Record: 47.3 years</td></tr>
...
show(plot_station_timeseries("08NL013"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL013")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL013/08NL013_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NL013/08NL013_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL013"))
:::
...
<div class="download-section">
  <a href="../../08NL013/08NL013_field_visits.csv" download class="download-btn">
