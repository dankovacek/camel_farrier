...
# 08NM183: KALAMALKA LAKE AT OUTLET OF OYAMA CANAL
...
result = plot_station_polygon("08NM183")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM183">stations/08NM183 folder on GitHub</a>.
:::
...
<tr><td>08NM183</td><td>KALAMALKA LAKE AT OUTLET OF OYAMA CANAL</td><td>50.112</td><td>-119.380</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1395.5 km²</td></tr>
...
show(plot_station_timeseries("08NM183"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM183")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM183/08NM183_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM183/08NM183_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM183"))
:::
...
<div class="download-section">
  <a href="../../08NM183/08NM183_field_visits.csv" download class="download-btn">
