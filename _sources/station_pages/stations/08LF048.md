...
# 08LF048: FIFTYNINE CREEK NEAR CHASM
...
result = plot_station_polygon("08LF048")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF048">stations/08LF048 folder on GitHub</a>.
:::
...
<tr><td>08LF048</td><td>FIFTYNINE CREEK NEAR CHASM</td><td>51.219</td><td>-121.507</td><td>203.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,588 daily observations, seasonal gaps: 186 days avg (N=8) | 47.3% flagged (estimated: 751)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 427.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,588 daily observations, seasonal gaps: 186 days avg (N=8) | 47.3% flagged (estimated: 751) | Record: 8.4 years</td></tr>
...
show(plot_station_timeseries("08LF048"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF048")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF048/08LF048_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF048/08LF048_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF048"))
:::
...
<div class="download-section">
  <a href="../../08LF048/08LF048_field_visits.csv" download class="download-btn">
