...
# 08LF082: MEDICINE CREEK NEAR THE MOUTH
...
result = plot_station_polygon("08LF082")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF082">stations/08LF082 folder on GitHub</a>.
:::
...
<tr><td>08LF082</td><td>MEDICINE CREEK NEAR THE MOUTH</td><td>50.759</td><td>-121.556</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,741 daily observations, minor gaps: 30 days avg (N=1) | 45.8% flagged (backwater: 1048, estimated: 187, partial day: 20)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 126.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,741 daily observations, minor gaps: 30 days avg (N=1) | 45.8% flagged (backwater: 1048, estimated: 187, partial day: 20) | Record: 7.6 years</td></tr>
...
show(plot_station_timeseries("08LF082"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF082")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF082/08LF082_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF082/08LF082_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF082"))
:::
...
<div class="download-section">
  <a href="../../08LF082/08LF082_field_visits.csv" download class="download-btn">
