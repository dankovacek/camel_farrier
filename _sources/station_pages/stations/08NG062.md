...
# 08NG062: LITTLE BULL CREEK NEAR BULL RIVER
...
result = plot_station_polygon("08NG062")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG062">stations/08NG062 folder on GitHub</a>.
:::
...
<tr><td>08NG062</td><td>LITTLE BULL CREEK NEAR BULL RIVER</td><td>49.507</td><td>-115.448</td><td>16.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,037 daily observations, seasonal gaps: 182 days avg (N=2) | 51.4% flagged (estimated: 533)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 54.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,037 daily observations, seasonal gaps: 182 days avg (N=2) | 51.4% flagged (estimated: 533) | Record: 3.8 years</td></tr>
...
show(plot_station_timeseries("08NG062"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG062")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG062/08NG062_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG062/08NG062_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG062"))
:::
...
<div class="download-section">
  <a href="../../08NG062/08NG062_field_visits.csv" download class="download-btn">
