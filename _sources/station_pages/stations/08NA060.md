...
# 08NA060: BRUCE CREEK NEAR WILMER
...
result = plot_station_polygon("08NA060")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA060">stations/08NA060 folder on GitHub</a>.
:::
...
<tr><td>08NA060</td><td>BRUCE CREEK NEAR WILMER</td><td>50.562</td><td>-116.241</td><td>80.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 12.4 years
<br><strong>Timeseries Summary:</strong> 1,744 daily observations, seasonal gaps: 279 days avg (N=10) | 34.3% flagged (estimated: 592, partial day: 6)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 197.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,744 daily observations, seasonal gaps: 279 days avg (N=10) | 34.3% flagged (estimated: 592, partial day: 6) | Record: 12.4 years</td></tr>
...
show(plot_station_timeseries("08NA060"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA060")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA060/08NA060_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA060/08NA060_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA060"))
:::
...
<div class="download-section">
  <a href="../../08NA060/08NA060_field_visits.csv" download class="download-btn">
