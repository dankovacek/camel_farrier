...
The data used in generating the plots and tables on this page can be downloaded from the [stations/05ND011](https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/05ND011) folder in the Github repository.
