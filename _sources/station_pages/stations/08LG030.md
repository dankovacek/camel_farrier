...
# 08LG030: STUMPLAKE CREEK NEAR QUILCHENA
...
result = plot_station_polygon("08LG030")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG030">stations/08LG030 folder on GitHub</a>.
:::
...
<tr><td>08LG030</td><td>STUMPLAKE CREEK NEAR QUILCHENA</td><td>50.249</td><td>-120.452</td><td>306.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 749.4 km²</td></tr>
...
show(plot_station_timeseries("08LG030"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG030")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG030/08LG030_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LG030/08LG030_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LG030"))
:::
...
<div class="download-section">
  <a href="../../08LG030/08LG030_field_visits.csv" download class="download-btn">
