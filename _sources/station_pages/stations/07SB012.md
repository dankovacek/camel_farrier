...
# 07SB012: DUNCAN LAKE NEAR YELLOWKNIFE
...
result = plot_station_polygon("07SB012")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07SB012">stations/07SB012 folder on GitHub</a>.
:::
...
<tr><td>07SB012</td><td>DUNCAN LAKE NEAR YELLOWKNIFE</td><td>62.808</td><td>-114.033</td><td>nan (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 17196.1 km²</td></tr>
...
show(plot_station_timeseries("07SB012"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07SB012")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07SB012/07SB012_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07SB012/07SB012_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07SB012"))
:::
...
<div class="download-section">
  <a href="../../07SB012/07SB012_field_visits.csv" download class="download-btn">
