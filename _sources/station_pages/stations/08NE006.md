...
result = plot_station_polygon("08NE006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE006">stations/08NE006 folder on GitHub</a>.
:::
...
<tr><td>08NE006</td><td>KUSKANAX CREEK NEAR NAKUSP</td><td>50.283</td><td>-117.734</td><td>330.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 110.8 years
<br><strong>Timeseries Summary:</strong> 23,013 daily observations, seasonal gaps: 17471 days avg (N=1) | 16.5% flagged (estimated: 1907, backwater: 1451, partial day: 431)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 782.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>23,013 daily observations, seasonal gaps: 17471 days avg (N=1) | 16.5% flagged (estimated: 1907, backwater: 1451, partial day: 431) | Record: 110.8 years</td></tr>
...
show(plot_station_timeseries("08NE006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE006/08NE006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NE006/08NE006_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NE006/08NE006_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>new curve for trend to the right, extend lower end</td>
    </tr>
    <tr>
      <td>60.0</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08NE006"))
:::
...
<div class="download-section">
  <a href="../../08NE006/08NE006_field_visits.csv" download class="download-btn">
