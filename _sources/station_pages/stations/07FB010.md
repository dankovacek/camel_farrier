...
result = plot_station_polygon("07FB010")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07FB010">stations/07FB010 folder on GitHub</a>.
:::
...
<tr><td>07FB010</td><td>PINE RIVER ABOVE MOUNTAIN CREEK</td><td>55.508</td><td>-122.575</td><td>677.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 3.6 years
<br><strong>Timeseries Summary:</strong> 826 daily observations, seasonal gaps: 161 days avg (N=3) | 26.5% flagged (estimated: 219)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2094.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>826 daily observations, seasonal gaps: 161 days avg (N=3) | 26.5% flagged (estimated: 219) | Record: 3.6 years</td></tr>
...
show(plot_station_timeseries("07FB010"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07FB010")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07FB010/07FB010_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07FB010/07FB010_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07FB010"))
:::
...
<div class="download-section">
  <a href="../../07FB010/07FB010_field_visits.csv" download class="download-btn">
