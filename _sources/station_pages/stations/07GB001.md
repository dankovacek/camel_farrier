...
result = plot_station_polygon("07GB001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07GB001">stations/07GB001 folder on GitHub</a>.
:::
...
<tr><td>07GB001</td><td>CUTBANK RIVER NEAR GRANDE PRAIRIE</td><td>54.516</td><td>-118.963</td><td>842.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 54.5 years
<br><strong>Timeseries Summary:</strong> 13,639 daily observations, seasonal gaps: 116 days avg (N=54) | 24.8% flagged (backwater: 2668, estimated: 473, partial day: 247)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2485.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>13,639 daily observations, seasonal gaps: 116 days avg (N=54) | 24.8% flagged (backwater: 2668, estimated: 473, partial day: 247) | Record: 54.5 years</td></tr>
...
show(plot_station_timeseries("07GB001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07GB001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07GB001/07GB001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07GB001/07GB001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07GB001/07GB001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Same as Curve #10. Curve C10 renamed 10.001</td>
    </tr>
    <tr>
      <td>10.000</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Same as Curve #9 below 1.120m and above 2.220 m.</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("07GB001"))
:::
...
<div class="download-section">
  <a href="../../07GB001/07GB001_field_visits.csv" download class="download-btn">
