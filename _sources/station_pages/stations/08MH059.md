...
# 08MH059: CAMPBELL RIVER NEAR WHITE ROCK
...
result = plot_station_polygon("08MH059")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH059">stations/08MH059 folder on GitHub</a>.
:::
...
<tr><td>08MH059</td><td>CAMPBELL RIVER NEAR WHITE ROCK</td><td>49.016</td><td>-122.723</td><td>63.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,279 daily observations, continuous record | 38.7% flagged (estimated: 495)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 120.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,279 daily observations, continuous record | 38.7% flagged (estimated: 495) | Record: 3.5 years</td></tr>
...
show(plot_station_timeseries("08MH059"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH059")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH059/08MH059_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH059/08MH059_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH059"))
:::
...
<div class="download-section">
  <a href="../../08MH059/08MH059_field_visits.csv" download class="download-btn">
