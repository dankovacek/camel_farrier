...
result = plot_station_polygon("08LB039")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB039">stations/08LB039 folder on GitHub</a>.
:::
...
<tr><td>08LB039</td><td>MAD RIVER NEAR IRVINE</td><td>51.676</td><td>-119.604</td><td>280.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 914 daily observations, continuous record</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 586.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>914 daily observations, continuous record | Record: 2.5 years</td></tr>
...
show(plot_station_timeseries("08LB039"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB039")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB039/08LB039_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LB039/08LB039_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB039"))
:::
