...
# 08LF068: VENABLES CREEK ABOVE VENABLES LAKE
...
result = plot_station_polygon("08LF068")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF068">stations/08LF068 folder on GitHub</a>.
:::
...
<tr><td>08LF068</td><td>VENABLES CREEK ABOVE VENABLES LAKE</td><td>50.575</td><td>-121.350</td><td>25.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 123 daily observations, continuous record | 71.5% flagged (estimated: 88)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 54.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>123 daily observations, continuous record | 71.5% flagged (estimated: 88) | Record: 0.3 years</td></tr>
...
show(plot_station_timeseries("08LF068"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF068")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF068/08LF068_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF068/08LF068_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF068"))
:::
