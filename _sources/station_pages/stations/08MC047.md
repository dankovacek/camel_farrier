...
# 08MC047: KNIFE CREEK ABOVE DIVERSIONS
...
result = plot_station_polygon("08MC047")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MC047">stations/08MC047 folder on GitHub</a>.
:::
...
<tr><td>08MC047</td><td>KNIFE CREEK ABOVE DIVERSIONS</td><td>52.000</td><td>-121.663</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 8.2 years
<br><strong>Timeseries Summary:</strong> 2,984 daily observations, minor gaps: 30 days avg (N=1) | 41.5% flagged (backwater: 1055, estimated: 169, partial day: 14)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 315.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,984 daily observations, minor gaps: 30 days avg (N=1) | 41.5% flagged (backwater: 1055, estimated: 169, partial day: 14) | Record: 8.2 years</td></tr>
...
show(plot_station_timeseries("08MC047"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MC047")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MC047/08MC047_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MC047/08MC047_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MC047"))
:::
...
<div class="download-section">
  <a href="../../08MC047/08MC047_field_visits.csv" download class="download-btn">
