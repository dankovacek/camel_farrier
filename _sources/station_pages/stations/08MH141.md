...
result = plot_station_polygon("08MH141")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH141">stations/08MH141 folder on GitHub</a>.
:::
...
<tr><td>08MH141</td><td>COQUITLAM RIVER ABOVE COQUITLAM LAKE</td><td>49.488</td><td>-122.793</td><td>52.5 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 15,676 daily observations, minor gaps: 30 days avg (N=1) | 8.9% flagged (backwater: 569, estimated: 473, partial day: 350)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 116.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>15,676 daily observations, minor gaps: 30 days avg (N=1) | 8.9% flagged (backwater: 569, estimated: 473, partial day: 350) | Record: 43.0 years</td></tr>
...
show(plot_station_timeseries("08MH141"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH141")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH141/08MH141_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08MH141/08MH141_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08MH141/08MH141_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Curve 32.00 created to account for new low water measurements taken during the 2022 and 2023 review ...</td>
    </tr>
    <tr>
      <td>31.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>High water event on Sept 23, 2020 altered control</td>
    </tr>
    <tr>
      <td>30.01</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extension to upper end of RC29.000</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08MH141"))
:::
