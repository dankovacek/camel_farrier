...
# 08MB011: PUNTZI CREEK ABOVE PUNTZI LAKE
...
result = plot_station_polygon("08MB011")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MB011">stations/08MB011 folder on GitHub</a>.
:::
...
<tr><td>08MB011</td><td>PUNTZI CREEK ABOVE PUNTZI LAKE</td><td>52.208</td><td>-124.068</td><td>508.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 3.7 years
<br><strong>Timeseries Summary:</strong> 1,069 daily observations, seasonal gaps: 100 days avg (N=3) | 26.1% flagged (estimated: 260, backwater: 19)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1266.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,069 daily observations, seasonal gaps: 100 days avg (N=3) | 26.1% flagged (estimated: 260, backwater: 19) | Record: 3.7 years</td></tr>
...
show(plot_station_timeseries("08MB011"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MB011")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MB011/08MB011_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MB011/08MB011_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MB011"))
:::
...
<div class="download-section">
  <a href="../../08MB011/08MB011_field_visits.csv" download class="download-btn">
