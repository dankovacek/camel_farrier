...
result = plot_station_polygon("08HC007")
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HC007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HC007/08HC007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08HC007/08HC007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HC007/08HC007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HC007"))
:::
