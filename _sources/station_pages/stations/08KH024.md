...
# 08KH024: MOLYBDENITE CREEK NEAR HENDRIX LAKE
...
result = plot_station_polygon("08KH024")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KH024">stations/08KH024 folder on GitHub</a>.
:::
...
<tr><td>08KH024</td><td>MOLYBDENITE CREEK NEAR HENDRIX LAKE</td><td>52.135</td><td>-120.883</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 245 daily observations, continuous record | 35.1% flagged (backwater: 75, partial day: 11)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 55.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>245 daily observations, continuous record | 35.1% flagged (backwater: 75, partial day: 11) | Record: 0.7 years</td></tr>
...
show(plot_station_timeseries("08KH024"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KH024")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KH024/08KH024_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KH024/08KH024_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KH024"))
:::
