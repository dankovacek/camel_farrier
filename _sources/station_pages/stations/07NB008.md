...
result = plot_station_polygon("07NB008")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07NB008">stations/07NB008 folder on GitHub</a>.
:::
...
<tr><td>07NB008</td><td>DOG RIVER NEAR FITZGERALD</td><td>59.876</td><td>-111.521</td><td>2020.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 22.4 years
<br><strong>Timeseries Summary:</strong> 8,036 daily observations, minor gaps: 51 days avg (N=3) | 51.0% flagged (backwater: 3916, estimated: 165, partial day: 18)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 8442.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>8,036 daily observations, minor gaps: 51 days avg (N=3) | 51.0% flagged (backwater: 3916, estimated: 165, partial day: 18) | Record: 22.4 years</td></tr>
...
show(plot_station_timeseries("07NB008"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07NB008")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07NB008/07NB008_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07NB008/07NB008_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07NB008"))
:::
...
<div class="download-section">
  <a href="../../07NB008/07NB008_field_visits.csv" download class="download-btn">
