...
# 08LF079: CHERRY CREEK NEAR THE MOUTH
...
result = plot_station_polygon("08LF079")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF079">stations/08LF079 folder on GitHub</a>.
:::
...
<tr><td>08LF079</td><td>CHERRY CREEK NEAR THE MOUTH</td><td>50.717</td><td>-120.635</td><td>190.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,309 daily observations, minor gaps: 30 days avg (N=1) | 10.5% flagged (backwater: 71, estimated: 67)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 489.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,309 daily observations, minor gaps: 30 days avg (N=1) | 10.5% flagged (backwater: 71, estimated: 67) | Record: 3.7 years</td></tr>
...
show(plot_station_timeseries("08LF079"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF079")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF079/08LF079_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF079/08LF079_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF079"))
:::
