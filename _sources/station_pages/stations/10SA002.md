...
# 10SA002: LORD LINDSAY RIVER ABOVE SANAGAK LAKE
...
result = plot_station_polygon("10SA002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10SA002">stations/10SA002 folder on GitHub</a>.
:::
...
<tr><td>10SA002</td><td>LORD LINDSAY RIVER ABOVE SANAGAK LAKE</td><td>70.217</td><td>-93.950</td><td>1440.0 (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 12802.3 km²</td></tr>
...
show(plot_station_timeseries("10SA002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10SA002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10SA002/10SA002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10SA002"))
:::
