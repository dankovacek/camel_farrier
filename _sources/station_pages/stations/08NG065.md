...
The data representing the above plots can be downloaded from the [stations/08NG065](https://dankovacek.github.io/camel_farrier/stations/08NG065) folder in the Github repository.
