...
# 08NE032: MERRY CREEK NEAR CASTLEGAR
...
result = plot_station_polygon("08NE032")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE032">stations/08NE032 folder on GitHub</a>.
:::
...
<tr><td>08NE032</td><td>MERRY CREEK NEAR CASTLEGAR</td><td>49.296</td><td>-117.676</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.96, ΔArea: +0.9%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 366 daily observations, seasonal gaps: 182 days avg (N=1) | 56.8% flagged (estimated: 208)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 7.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>366 daily observations, seasonal gaps: 182 days avg (N=1) | 56.8% flagged (estimated: 208) | Record: 1.5 years</td></tr>
...
show(plot_station_timeseries("08NE032"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE032")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE032/08NE032_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE032/08NE032_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE032"))
:::
...
<div class="download-section">
  <a href="../../08NE032/08NE032_field_visits.csv" download class="download-btn">
