...
result = plot_station_polygon("10ED003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10ED003">stations/10ED003 folder on GitHub</a>.
:::
...
<tr><td>10ED003</td><td>BIRCH RIVER AT HIGHWAY NO. 7</td><td>61.334</td><td>-122.094</td><td>542.0 (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-03-10</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.96, ΔArea: +0.5%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 18,355 daily observations, continuous record | 57.0% flagged (backwater: 10064, estimated: 262, partial day: 142)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2357.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>18,355 daily observations, continuous record | 57.0% flagged (backwater: 10064, estimated: 262, partial day: 142) | Record: 50.3 years</td></tr>
...
show(plot_station_timeseries("10ED003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10ED003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10ED003/10ED003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10ED003/10ED003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10ED003/10ED003_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Rating curve 16.00 is a 2-segment model governed by a cobble/boulder section control. The curve appe...</td>
    </tr>
    <tr>
      <td>15.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Mid section shifting right</td>
    </tr>
    <tr>
      <td>14.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Mid section shifting left</td>
    </tr>
    <tr>
      <td>13</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Provisional/Provisoire</td>
      <td>2014 MMNTs btwn 3&4 m3/s plotting off curve 11</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("10ED003"))
:::
...
<div class="download-section">
  <a href="../../10ED003/10ED003_field_visits.csv" download class="download-btn">
