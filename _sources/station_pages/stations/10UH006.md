...
# 10UH006: ARMSHOW NORTH RIVER AT OUTLET ARMSHOW NORTH LAKE
...
result = plot_station_polygon("10UH006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10UH006">stations/10UH006 folder on GitHub</a>.
:::
...
<tr><td>10UH006</td><td>ARMSHOW NORTH RIVER AT OUTLET ARMSHOW NORTH LAKE</td><td>63.631</td><td>-69.039</td><td>nan (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.98, ΔArea: +1.7%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 8.5 years
<br><strong>Timeseries Summary:</strong> 1,675 daily observations, seasonal gaps: 130 days avg (N=11) | 34.3% flagged (backwater: 432, estimated: 113, partial day: 30)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 369.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,675 daily observations, seasonal gaps: 130 days avg (N=11) | 34.3% flagged (backwater: 432, estimated: 113, partial day: 30) | Record: 8.5 years</td></tr>
...
show(plot_station_timeseries("10UH006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10UH006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10UH006/10UH006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10UH006/10UH006_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10UH006/10UH006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10UH006"))
:::
...
<div class="download-section">
  <a href="../../10UH006/10UH006_field_visits.csv" download class="download-btn">
