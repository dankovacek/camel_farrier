...
# 08NM233: MISSION CREEK ABOVE PEARSON CREEK
...
result = plot_station_polygon("08NM233")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM233">stations/08NM233 folder on GitHub</a>.
:::
...
<tr><td>08NM233</td><td>MISSION CREEK ABOVE PEARSON CREEK</td><td>49.888</td><td>-119.062</td><td>233.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 5.7 years
<br><strong>Timeseries Summary:</strong> 2,101 daily observations, continuous record | 47.6% flagged (backwater: 710, estimated: 175, partial day: 116)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 452.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,101 daily observations, continuous record | 47.6% flagged (backwater: 710, estimated: 175, partial day: 116) | Record: 5.7 years</td></tr>
...
show(plot_station_timeseries("08NM233"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM233")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM233/08NM233_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM233/08NM233_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM233"))
:::
...
<div class="download-section">
  <a href="../../08NM233/08NM233_field_visits.csv" download class="download-btn">
