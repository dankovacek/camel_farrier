...
result = plot_station_polygon("08NB013")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NB013">stations/08NB013 folder on GitHub</a>.
:::
...
<tr><td>08NB013</td><td>GOLD RIVER ABOVE BACHELOR CREEK</td><td>51.613</td><td>-117.741</td><td>135.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 7,790 daily observations, continuous record | 36.8% flagged (backwater: 1963, estimated: 834, partial day: 71)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 349.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>7,790 daily observations, continuous record | 36.8% flagged (backwater: 1963, estimated: 834, partial day: 71) | Record: 21.3 years</td></tr>
...
show(plot_station_timeseries("08NB013"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NB013")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NB013/08NB013_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NB013/08NB013_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NB013"))
:::
