...
result = plot_station_polygon("08LF007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF007">stations/08LF007 folder on GitHub</a>.
:::
...
<tr><td>08LF007</td><td>CRISS CREEK NEAR SAVONA</td><td>50.884</td><td>-120.966</td><td>479.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 24,053 daily observations, seasonal gaps: 1394 days avg (N=12) | 35.2% flagged (backwater: 6193, estimated: 1388, partial day: 880)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1205.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>24,053 daily observations, seasonal gaps: 1394 days avg (N=12) | 35.2% flagged (backwater: 6193, estimated: 1388, partial day: 880) | Record: 111.7 years</td></tr>
...
show(plot_station_timeseries("08LF007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF007/08LF007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08LF007/08LF007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LF007/08LF007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF007"))
:::
...
<div class="download-section">
  <a href="../../08LF007/08LF007_field_visits.csv" download class="download-btn">
