...
result = plot_station_polygon("08HA001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HA001">stations/08HA001 folder on GitHub</a>.
:::
...
<tr><td>08HA001</td><td>CHEMAINUS RIVER NEAR WESTHOLME</td><td>48.878</td><td>-123.705</td><td>355.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 110.7 years
<br><strong>Timeseries Summary:</strong> 27,181 daily observations, seasonal gaps: 2207 days avg (N=6) | 3.4% flagged (estimated: 707, backwater: 158, partial day: 50)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 812.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>27,181 daily observations, seasonal gaps: 2207 days avg (N=6) | 3.4% flagged (estimated: 707, backwater: 158, partial day: 50) | Record: 110.7 years</td></tr>
...
show(plot_station_timeseries("08HA001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HA001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HA001/08HA001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08HA001/08HA001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HA001/08HA001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Best mean stats using all historic measurements except those indicating debris, vegetation, or alter...</td>
    </tr>
    <tr>
      <td>57.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extended high end of curve 57 due to event Feb 2020. Curve accomodates record high measurement 20180...</td>
    </tr>
    <tr>
      <td>57.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve accomodates record high measurement 20180129. Curve has lower offset based on observations 201...</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08HA001"))
:::
...
<div class="download-section">
  <a href="../../08HA001/08HA001_field_visits.csv" download class="download-btn">
