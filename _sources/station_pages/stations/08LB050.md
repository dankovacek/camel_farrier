...
result = plot_station_polygon("08LB050")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB050">stations/08LB050 folder on GitHub</a>.
:::
...
<tr><td>08LB050</td><td>MANN CREEK NEAR BLACKPOOL</td><td>51.576</td><td>-120.138</td><td>295.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 54.8 years
<br><strong>Timeseries Summary:</strong> 7,548 daily observations, seasonal gaps: 1383 days avg (N=9) | 21.5% flagged (backwater: 1283, estimated: 340)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 746.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>7,548 daily observations, seasonal gaps: 1383 days avg (N=9) | 21.5% flagged (backwater: 1283, estimated: 340) | Record: 54.8 years</td></tr>
...
show(plot_station_timeseries("08LB050"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB050")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB050/08LB050_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LB050/08LB050_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB050"))
:::
...
<div class="download-section">
  <a href="../../08LB050/08LB050_field_visits.csv" download class="download-btn">
