...
# 07DA014: CALUMET RIVER NEAR FORT MACKAY
...
result = plot_station_polygon("07DA014")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DA014">stations/07DA014 folder on GitHub</a>.
:::
...
<tr><td>07DA014</td><td>CALUMET RIVER NEAR FORT MACKAY</td><td>57.403</td><td>-111.683</td><td>183.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 915 daily observations, continuous record | 52.6% flagged (backwater: 437, estimated: 36, partial day: 8)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 622.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>915 daily observations, continuous record | 52.6% flagged (backwater: 437, estimated: 36, partial day: 8) | Record: 2.5 years</td></tr>
...
show(plot_station_timeseries("07DA014"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07DA014")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07DA014/07DA014_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07DA014/07DA014_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07DA014"))
:::
