...
# 08NG083: MILLER CREEK NEAR 1160 M CONTOUR
...
result = plot_station_polygon("08NG083")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG083">stations/08NG083 folder on GitHub</a>.
:::
...
<tr><td>08NG083</td><td>MILLER CREEK NEAR 1160 M CONTOUR</td><td>49.057</td><td>-115.044</td><td>7.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,101 daily observations, continuous record | 9.2% flagged (estimated: 157, backwater: 23, partial day: 14)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 16.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,101 daily observations, continuous record | 9.2% flagged (estimated: 157, backwater: 23, partial day: 14) | Record: 5.7 years</td></tr>
...
show(plot_station_timeseries("08NG083"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG083")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG083/08NG083_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG083/08NG083_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG083"))
:::
