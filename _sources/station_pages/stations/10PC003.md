...
# 10PC003: COPPERMINE RIVER ABOVE BLOODY FALLS
...
result = plot_station_polygon("10PC003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10PC003">stations/10PC003 folder on GitHub</a>.
:::
...
<tr><td>10PC003</td><td>COPPERMINE RIVER ABOVE BLOODY FALLS</td><td>67.740</td><td>-115.379</td><td>50700.0 (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 3.5 years
<br><strong>Timeseries Summary:</strong> 1,280 daily observations, continuous record | 69.1% flagged (backwater: 706, estimated: 167, partial day: 12)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 303596.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,280 daily observations, continuous record | 69.1% flagged (backwater: 706, estimated: 167, partial day: 12) | Record: 3.5 years</td></tr>
...
show(plot_station_timeseries("10PC003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10PC003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10PC003/10PC003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10PC003/10PC003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10PC003"))
:::
...
<div class="download-section">
  <a href="../../10PC003/10PC003_field_visits.csv" download class="download-btn">
