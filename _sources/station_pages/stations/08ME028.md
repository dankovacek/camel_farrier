...
result = plot_station_polygon("08ME028")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08ME028">stations/08ME028 folder on GitHub</a>.
:::
...
<tr><td>08ME028</td><td>BRIDGE RIVER ABOVE DOWNTON LAKE</td><td>50.821</td><td>-123.203</td><td>708.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 10,593 daily observations, continuous record | 44.4% flagged (backwater: 3276, estimated: 1384, partial day: 38)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1767.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>10,593 daily observations, continuous record | 44.4% flagged (backwater: 3276, estimated: 1384, partial day: 38) | Record: 29.0 years</td></tr>
...
show(plot_station_timeseries("08ME028"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08ME028")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08ME028/08ME028_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08ME028/08ME028_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08ME028/08ME028_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Curve 16.00 was created for the 2022 data year using open-water discharge measurements from 2022 and...</td>
    </tr>
    <tr>
      <td>15.002</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Same Rating updated grading</td>
    </tr>
    <tr>
      <td>15.001</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08ME028"))
:::
...
<div class="download-section">
  <a href="../../08ME028/08ME028_field_visits.csv" download class="download-btn">
