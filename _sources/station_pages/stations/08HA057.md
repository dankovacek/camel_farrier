...
# 08HA057: MAXWELL LAKE ON SALTSPRING ISLAND
...
result = plot_station_polygon("08HA057")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HA057">stations/08HA057 folder on GitHub</a>.
:::
...
<tr><td>08HA057</td><td>MAXWELL LAKE ON SALTSPRING ISLAND</td><td>48.825</td><td>-123.537</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
show(plot_station_timeseries("08HA057"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HA057")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HA057/08HA057_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HA057/08HA057_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HA057"))
:::
...
<div class="download-section">
  <a href="../../08HA057/08HA057_field_visits.csv" download class="download-btn">
