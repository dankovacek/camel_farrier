...
# 08MD007: PAVILION CREEK NEAR PAVILION LAKE
...
result = plot_station_polygon("08MD007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MD007">stations/08MD007 folder on GitHub</a>.
:::
...
<tr><td>08MD007</td><td>PAVILION CREEK NEAR PAVILION LAKE</td><td>50.910</td><td>-121.735</td><td>51.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 672 daily observations, seasonal gaps: 192 days avg (N=3)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>672 daily observations, seasonal gaps: 192 days avg (N=3) | Record: 3.4 years</td></tr>
...
show(plot_station_timeseries("08MD007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MD007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MD007/08MD007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MD007/08MD007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MD007"))
:::
...
<div class="download-section">
  <a href="../../08MD007/08MD007_field_visits.csv" download class="download-btn">
