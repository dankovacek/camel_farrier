...
result = plot_station_polygon("08FC003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08FC003">stations/08FC003 folder on GitHub</a>.
:::
...
<tr><td>08FC003</td><td>DEAN RIVER BELOW TANSWANKET CREEK</td><td>52.889</td><td>-125.771</td><td>3720.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 65.3 years
<br><strong>Timeseries Summary:</strong> 21,042 daily observations, seasonal gaps: 256 days avg (N=11) | 41.5% flagged (backwater: 8455, estimated: 202, partial day: 74)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 10119.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>21,042 daily observations, seasonal gaps: 256 days avg (N=11) | 41.5% flagged (backwater: 8455, estimated: 202, partial day: 74) | Record: 65.3 years</td></tr>
...
show(plot_station_timeseries("08FC003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08FC003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08FC003/08FC003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08FC003/08FC003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08FC003/08FC003_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Created for 2023 and in development</td>
    </tr>
    <tr>
      <td>29.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve created using open water measurements from 2021 and the 2011 and 2018 historic high measuremen...</td>
    </tr>
    <tr>
      <td>28.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve created using open water measurements from 2020 and 2021, and the 2011 and 2018 historic high ...</td>
    </tr>
    <tr>
      <td>27.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New curve for 2014.  This contains 3 record low measurements, that show the low end of Curve 26 was ...</td>
    </tr>
    <tr>
      <td>26.0</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08FC003"))
:::
...
<div class="download-section">
  <a href="../../08FC003/08FC003_field_visits.csv" download class="download-btn">
