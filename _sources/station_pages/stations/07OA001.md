...
result = plot_station_polygon("07OA001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07OA001">stations/07OA001 folder on GitHub</a>.
:::
...
<tr><td>07OA001</td><td>SOUSA CREEK NEAR HIGH LEVEL</td><td>58.591</td><td>-118.491</td><td>820.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: +0.7%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 14,210 daily observations, seasonal gaps: 104 days avg (N=54) | 32.2% flagged (backwater: 3585, estimated: 771, partial day: 214)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2991.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>14,210 daily observations, seasonal gaps: 104 days avg (N=54) | 32.2% flagged (backwater: 3585, estimated: 771, partial day: 214) | Record: 54.3 years</td></tr>
...
show(plot_station_timeseries("07OA001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07OA001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07OA001/07OA001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07OA001/07OA001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07OA001/07OA001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Curve 17 is a revision of curve 16.01 with an updated upper (floodplain) segment and the addition of...</td>
    </tr>
    <tr>
      <td>16.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extension of curve for 2022 flood</td>
    </tr>
    <tr>
      <td>16.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Section control: highly affected by weeds, beavers, and bed movement. Channel control: affected by b...</td>
    </tr>
    <tr>
      <td>15.00</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>SAME AS TABLE NO. 13.</td>
    </tr>
    <tr>
      <td>15.00</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Clone of 15.000 to circumvent L on last shift</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("07OA001"))
:::
...
<div class="download-section">
  <a href="../../07OA001/07OA001_field_visits.csv" download class="download-btn">
