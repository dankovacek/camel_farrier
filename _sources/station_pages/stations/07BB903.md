...
# 07BB903: ROMEO CREEK ABOVE ROMEO LAKE
...
result = plot_station_polygon("07BB903")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07BB903">stations/07BB903 folder on GitHub</a>.
:::
...
<tr><td>07BB903</td><td>ROMEO CREEK ABOVE ROMEO LAKE</td><td>54.072</td><td>-114.901</td><td>115.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 16.8 years
<br><strong>Timeseries Summary:</strong> 4,280 daily observations, seasonal gaps: 115 days avg (N=16) | 12.1% flagged (backwater: 436, estimated: 75, partial day: 8)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 327.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>4,280 daily observations, seasonal gaps: 115 days avg (N=16) | 12.1% flagged (backwater: 436, estimated: 75, partial day: 8) | Record: 16.8 years</td></tr>
...
show(plot_station_timeseries("07BB903"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07BB903")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07BB903/07BB903_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07BB903/07BB903_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07BB903"))
:::
...
<div class="download-section">
  <a href="../../07BB903/07BB903_field_visits.csv" download class="download-btn">
