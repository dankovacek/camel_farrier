...
# 07SA003: SNARE RIVER AT BIGSPRUCE LAKE
...
result = plot_station_polygon("07SA003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07SA003">stations/07SA003 folder on GitHub</a>.
:::
...
<tr><td>07SA003</td><td>SNARE RIVER AT BIGSPRUCE LAKE</td><td>63.512</td><td>-116.006</td><td>15200.0 (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 27.2 years
<br><strong>Timeseries Summary:</strong> 9,954 daily observations, continuous record | 61.3% flagged (estimated: 6098)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 80651.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>9,954 daily observations, continuous record | 61.3% flagged (estimated: 6098) | Record: 27.2 years</td></tr>
...
show(plot_station_timeseries("07SA003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07SA003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07SA003/07SA003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07SA003/07SA003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07SA003"))
:::
...
<div class="download-section">
  <a href="../../07SA003/07SA003_field_visits.csv" download class="download-btn">
