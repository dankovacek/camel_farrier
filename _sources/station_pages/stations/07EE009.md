...
show(plot_station_polygon("07EE009"))
:::

## Station metadata

The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07EE009">stations/07EE009 folder on GitHub</a>.
...
<tr><td>07EE009</td><td>CHUCHINKA CREEK NEAR THE MOUTH</td><td>54.530</td><td>-122.612</td><td>310.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-05</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.9994, ΔArea: +0.02%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 49.5 years
<br><strong>Timeseries Summary:</strong> 17,930 daily observations, seasonal gaps: 151 days avg (N=1) | 44.7% flagged (backwater: 7500, estimated: 468, partial day: 52)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 937.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>17,930 daily observations, seasonal gaps: 151 days avg (N=1) | 44.7% flagged (backwater: 7500, estimated: 468, partial day: 52) | Record: 49.5 years</td></tr>
...
show(plot_station_timeseries("07EE009"))
:::
...
show(plot_distributions("07EE009"))
:::
...
<div class="download-section">
  ...
  <a href="camel_farrier/07EE009/07EE009/07EE009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="camel_farrier/07EE009/07EE009/07EE009_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="camel_farrier/07EE009/07EE009/07EE009_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe dataframe table">
  ...
  <tbody>
    <tr>
      ...
      <td>Based on 2023 and 2024 qms</td>
    </tr>
    <tr>
      <td>36.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Lower end of curve uses mmt. from 2022. Upper end of curve uses historic high measurements.</td>
    </tr>
    <tr>
      <td>35.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Created using 2021 open water measurements which includes the new historic high measurement.</td>
    </tr>
    <tr>
      <td>34.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Shift during ice period</td>
    </tr>
    <tr>
      <td>33.0</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Coincident to #32 at  and above 3.950 m.</td>
    </tr>
  </tbody>
</table>
