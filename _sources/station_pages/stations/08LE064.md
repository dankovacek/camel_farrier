...
# 08LE064: SALMON RIVER NEAR FALKLAND
...
result = plot_station_polygon("08LE064")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE064">stations/08LE064 folder on GitHub</a>.
:::
...
<tr><td>08LE064</td><td>SALMON RIVER NEAR FALKLAND</td><td>50.447</td><td>-119.469</td><td>1120.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 27.7 years
<br><strong>Timeseries Summary:</strong> 2,255 daily observations, seasonal gaps: 2617 days avg (N=3) | 36.8% flagged (estimated: 641, backwater: 188)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2759.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,255 daily observations, seasonal gaps: 2617 days avg (N=3) | 36.8% flagged (estimated: 641, backwater: 188) | Record: 27.7 years</td></tr>
...
show(plot_station_timeseries("08LE064"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE064")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE064/08LE064_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE064/08LE064_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE064"))
:::
...
<div class="download-section">
  <a href="../../08LE064/08LE064_field_visits.csv" download class="download-btn">
