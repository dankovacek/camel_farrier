...
# 08LE023: WARREN CREEK NEAR SALMON ARM
...
result = plot_station_polygon("08LE023")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE023">stations/08LE023 folder on GitHub</a>.
:::
...
<tr><td>08LE023</td><td>WARREN CREEK NEAR SALMON ARM</td><td>50.490</td><td>-119.529</td><td>25.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 1.3 years
<br><strong>Timeseries Summary:</strong> 306 daily observations, seasonal gaps: 183 days avg (N=1) | 14.4% flagged (estimated: 44)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 47.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>306 daily observations, seasonal gaps: 183 days avg (N=1) | 14.4% flagged (estimated: 44) | Record: 1.3 years</td></tr>
...
show(plot_station_timeseries("08LE023"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE023")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE023/08LE023_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE023/08LE023_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE023"))
:::
...
<div class="download-section">
  <a href="../../08LE023/08LE023_field_visits.csv" download class="download-btn">
