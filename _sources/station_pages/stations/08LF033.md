...
The data representing the above plots can be downloaded from the [stations/08LF033](https://dankovacek.github.io/camel_farrier/stations/08LF033) folder in the Github repository.
