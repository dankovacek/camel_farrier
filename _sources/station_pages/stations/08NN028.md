...
result = plot_station_polygon("08NN028")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NN028">stations/08NN028 folder on GitHub</a>.
:::
...
<tr><td>08NN028</td><td>LOST HORSE CREEK NEAR CHRISTIAN VALLEY</td><td>49.366</td><td>-118.849</td><td>28.5 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 9,862 daily observations, continuous record | 35.0% flagged (backwater: 2611, estimated: 742, partial day: 99)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 71.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>9,862 daily observations, continuous record | 35.0% flagged (backwater: 2611, estimated: 742, partial day: 99) | Record: 27.0 years</td></tr>
...
show(plot_station_timeseries("08NN028"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NN028")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NN028/08NN028_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NN028/08NN028_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NN028/08NN028_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>cloned to add curve confidence grades Jan to May 2020</td>
    </tr>
    <tr>
      <td>15.03</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>cloned to add curve confidence grades</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08NN028"))
:::
...
<div class="download-section">
  <a href="../../08NN028/08NN028_field_visits.csv" download class="download-btn">
