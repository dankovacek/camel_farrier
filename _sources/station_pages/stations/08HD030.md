...
# 08HD030: PIGGOTT CREEK AT MOUNT WASHINGTON
...
result = plot_station_polygon("08HD030")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HD030">stations/08HD030 folder on GitHub</a>.
:::
...
<tr><td>08HD030</td><td>PIGGOTT CREEK AT MOUNT WASHINGTON</td><td>49.750</td><td>-125.340</td><td>8.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 4,233 daily observations, minor gaps: 60 days avg (N=4) | 25.5% flagged (estimated: 988, backwater: 46, partial day: 46)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 19.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>4,233 daily observations, minor gaps: 60 days avg (N=4) | 25.5% flagged (estimated: 988, backwater: 46, partial day: 46) | Record: 12.2 years</td></tr>
...
show(plot_station_timeseries("08HD030"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HD030")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HD030/08HD030_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HD030/08HD030_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HD030"))
:::
...
<div class="download-section">
  <a href="../../08HD030/08HD030_field_visits.csv" download class="download-btn">
