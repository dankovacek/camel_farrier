...
result = plot_station_polygon("07FB004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07FB004">stations/07FB004 folder on GitHub</a>.
:::
...
<tr><td>07FB004</td><td>DICKEBUSCH CREEK NEAR THE MOUTH</td><td>55.538</td><td>-121.597</td><td>82.4 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 47.0 years
<br><strong>Timeseries Summary:</strong> 17,045 daily observations, minor gaps: 61 days avg (N=2) | 50.7% flagged (backwater: 8037, estimated: 545, partial day: 52)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 265.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>17,045 daily observations, minor gaps: 61 days avg (N=2) | 50.7% flagged (backwater: 8037, estimated: 545, partial day: 52) | Record: 47.0 years</td></tr>
...
show(plot_station_timeseries("07FB004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07FB004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07FB004/07FB004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07FB004/07FB004_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07FB004/07FB004_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Curve created using 3 of 4 open water measurements in 2023 after most of them plotted off previous C...</td>
    </tr>
    <tr>
      <td>41.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve created using May, July and August 2022 measurements after they all plotted off previous Curve...</td>
    </tr>
    <tr>
      <td>40.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve created with May, Aug, and Sept 2021 measurements.  Upper end defined by the 1983 high water m...</td>
    </tr>
    <tr>
      <td>39.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Created using three 2020 and May 2021 open water measurements.  The upper segment is as similar as p...</td>
    </tr>
    <tr>
      <td>38.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New curve created using a clone of above the break point of 1.377, open water measurements from 2019...</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("07FB004"))
:::
...
<div class="download-section">
  <a href="../../07FB004/07FB004_field_visits.csv" download class="download-btn">
