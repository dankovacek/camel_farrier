...
result = plot_station_polygon("07GE007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07GE007">stations/07GE007 folder on GitHub</a>.
:::
...
<tr><td>07GE007</td><td>BEAR RIVER NEAR VALHALLA CENTRE</td><td>55.400</td><td>-119.384</td><td>181.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 40.4 years
<br><strong>Timeseries Summary:</strong> 10,610 daily observations, seasonal gaps: 104 days avg (N=40) | 21.0% flagged (backwater: 1932, estimated: 237, partial day: 54)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 561.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>10,610 daily observations, seasonal gaps: 104 days avg (N=40) | 21.0% flagged (backwater: 1932, estimated: 237, partial day: 54) | Record: 40.4 years</td></tr>
...
show(plot_station_timeseries("07GE007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07GE007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07GE007/07GE007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07GE007/07GE007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07GE007/07GE007_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Two segment curve representing channel, and overbank flow. The lower end of the curve is more ambigu...</td>
    </tr>
    <tr>
      <td>5.0</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07GE007"))
:::
...
<div class="download-section">
  <a href="../../07GE007/07GE007_field_visits.csv" download class="download-btn">
