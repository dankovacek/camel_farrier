...
result = plot_station_polygon("07BC007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07BC007">stations/07BC007 folder on GitHub</a>.
:::
...
<tr><td>07BC007</td><td>WABASH CREEK NEAR PIBROCH</td><td>54.210</td><td>-113.922</td><td>344.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.97, ΔArea: -1.1%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 45.3 years
<br><strong>Timeseries Summary:</strong> 11,937 daily observations, seasonal gaps: 102 days avg (N=45) | 26.0% flagged (backwater: 2111, estimated: 918, partial day: 75)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 963.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>11,937 daily observations, seasonal gaps: 102 days avg (N=45) | 26.0% flagged (backwater: 2111, estimated: 918, partial day: 75) | Record: 45.3 years</td></tr>
...
show(plot_station_timeseries("07BC007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07BC007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07BC007/07BC007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07BC007/07BC007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07BC007/07BC007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07BC007"))
:::
