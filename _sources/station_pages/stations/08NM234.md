...
# 08NM234: MOORE LAKE RESERVOIR AT THE DAM
...
result = plot_station_polygon("08NM234")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM234">stations/08NM234 folder on GitHub</a>.
:::
...
<tr><td>08NM234</td><td>MOORE LAKE RESERVOIR AT THE DAM</td><td>50.025</td><td>-119.217</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
show(plot_station_timeseries("08NM234"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM234")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM234/08NM234_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM234/08NM234_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM234"))
:::
...
<div class="download-section">
  <a href="../../08NM234/08NM234_field_visits.csv" download class="download-btn">
