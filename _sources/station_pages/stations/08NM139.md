...
# 08NM139: ESPERON CREEK NEAR KELOWNA
...
result = plot_station_polygon("08NM139")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM139">stations/08NM139 folder on GitHub</a>.
:::
...
<tr><td>08NM139</td><td>ESPERON CREEK NEAR KELOWNA</td><td>50.073</td><td>-119.686</td><td>13.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 59.2 years
<br><strong>Timeseries Summary:</strong> 6,727 daily observations, seasonal gaps: 7458 days avg (N=2) | 37.8% flagged (backwater: 2078, estimated: 439, partial day: 28)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 35.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>6,727 daily observations, seasonal gaps: 7458 days avg (N=2) | 37.8% flagged (backwater: 2078, estimated: 439, partial day: 28) | Record: 59.2 years</td></tr>
...
show(plot_station_timeseries("08NM139"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM139")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM139/08NM139_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NM139/08NM139_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM139/08NM139_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM139"))
:::
...
<div class="download-section">
  <a href="../../08NM139/08NM139_field_visits.csv" download class="download-btn">
