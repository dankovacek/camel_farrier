...
# 08NJ006: SILVERTON CREEK NEAR SILVERTON (UPPER STATION)
...
result = plot_station_polygon("08NJ006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ006">stations/08NJ006 folder on GitHub</a>.
:::
...
<tr><td>08NJ006</td><td>SILVERTON CREEK NEAR SILVERTON (UPPER STATION)</td><td>49.933</td><td>-117.280</td><td>97.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 5.2 years
<br><strong>Timeseries Summary:</strong> 1,553 daily observations, seasonal gaps: 182 days avg (N=2) | 5.2% flagged (estimated: 61, backwater: 20)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 236.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,553 daily observations, seasonal gaps: 182 days avg (N=2) | 5.2% flagged (estimated: 61, backwater: 20) | Record: 5.2 years</td></tr>
...
show(plot_station_timeseries("08NJ006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ006/08NJ006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ006/08NJ006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ006"))
:::
...
<div class="download-section">
  <a href="../../08NJ006/08NJ006_field_visits.csv" download class="download-btn">
