...
# 10VC003: CALEDONIAN RIVER ABOVE BRACEBRIDGE INLET
...
result = plot_station_polygon("10VC003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10VC003">stations/10VC003 folder on GitHub</a>.
:::
...
<tr><td>10VC003</td><td>CALEDONIAN RIVER ABOVE BRACEBRIDGE INLET</td><td>75.617</td><td>-98.583</td><td>246.0 (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3941.5 km²</td></tr>
...
show(plot_station_timeseries("10VC003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10VC003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10VC003/10VC003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10VC003"))
:::
...
<div class="download-section">
  <a href="../../10VC003/10VC003_field_visits.csv" download class="download-btn">
