...
The data representing the above plots can be downloaded from the [stations/01FB001](https://dankovacek.github.io/camel_farrier/stations/01FB001) folder in the Github repository.
