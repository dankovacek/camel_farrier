...
# 08NM070: RIDDLE CREEK NEAR WEST SUMMERLAND
...
result = plot_station_polygon("08NM070")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM070">stations/08NM070 folder on GitHub</a>.
:::
...
<tr><td>08NM070</td><td>RIDDLE CREEK NEAR WEST SUMMERLAND</td><td>49.508</td><td>-119.792</td><td>33.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 366 daily observations, seasonal gaps: 182 days avg (N=1)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 78.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>366 daily observations, seasonal gaps: 182 days avg (N=1) | Record: 1.5 years</td></tr>
...
show(plot_station_timeseries("08NM070"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM070")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM070/08NM070_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM070/08NM070_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM070"))
:::
...
<div class="download-section">
  <a href="../../08NM070/08NM070_field_visits.csv" download class="download-btn">
