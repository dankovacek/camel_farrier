...
result = plot_station_polygon("08NH002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH002">stations/08NH002 folder on GitHub</a>.
:::
...
<tr><td>08NH002</td><td>FRY CREEK NEAR LARDO</td><td>50.057</td><td>-116.861</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 275 daily observations, continuous record | 81.8% flagged (estimated: 225)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1496.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>275 daily observations, continuous record | 81.8% flagged (estimated: 225) | Record: 0.8 years</td></tr>
...
show(plot_station_timeseries("08NH002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH002/08NH002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH002/08NH002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH002"))
:::
