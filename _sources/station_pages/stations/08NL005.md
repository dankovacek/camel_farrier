...
# 08NL005: TULAMEEN RIVER NEAR PRINCETON
...
result = plot_station_polygon("08NL005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL005">stations/08NL005 folder on GitHub</a>.
:::
...
<tr><td>08NL005</td><td>TULAMEEN RIVER NEAR PRINCETON</td><td>49.448</td><td>-120.532</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 337 daily observations, seasonal gaps: 121 days avg (N=1) | 1.8% flagged (estimated: 6)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4047.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>337 daily observations, seasonal gaps: 121 days avg (N=1) | 1.8% flagged (estimated: 6) | Record: 1.3 years</td></tr>
...
show(plot_station_timeseries("08NL005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL005/08NL005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NL005/08NL005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL005"))
:::
...
<div class="download-section">
  <a href="../../08NL005/08NL005_field_visits.csv" download class="download-btn">
