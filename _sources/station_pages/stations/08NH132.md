...
result = plot_station_polygon("08NH132")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH132">stations/08NH132 folder on GitHub</a>.
:::
...
<tr><td>08NH132</td><td>KEEN CREEK BELOW KYAWATS CREEK</td><td>49.873</td><td>-117.122</td><td>92.3 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 51.4 years
<br><strong>Timeseries Summary:</strong> 18,781 daily observations, continuous record | 34.6% flagged (backwater: 5791, estimated: 659, partial day: 54)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 224.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>18,781 daily observations, continuous record | 34.6% flagged (backwater: 5791, estimated: 659, partial day: 54) | Record: 51.4 years</td></tr>
...
show(plot_station_timeseries("08NH132"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH132")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH132/08NH132_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NH132/08NH132_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NH132/08NH132_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Adjust curve confidence grades</td>
    </tr>
    <tr>
      <td>29.000</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08NH132"))
:::
...
<div class="download-section">
  <a href="../../08NH132/08NH132_field_visits.csv" download class="download-btn">
