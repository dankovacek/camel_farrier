...
# 08GF001: STAFFORD RIVER NEAR ROY
...
result = plot_station_polygon("08GF001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GF001">stations/08GF001 folder on GitHub</a>.
:::
...
<tr><td>08GF001</td><td>STAFFORD RIVER NEAR ROY</td><td>50.735</td><td>-125.478</td><td>326.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,864 daily observations, seasonal gaps: 91 days avg (N=6) | 18.8% flagged (estimated: 538)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 831.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,864 daily observations, seasonal gaps: 91 days avg (N=6) | 18.8% flagged (estimated: 538) | Record: 9.3 years</td></tr>
...
show(plot_station_timeseries("08GF001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GF001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GF001/08GF001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GF001/08GF001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GF001"))
:::
