...
# 08HDX03: CAMPBELL RIVER NEAR CAMPBELL RIVER (TEST STATION)
...
show(plot_station_polygon("08HDX03"))
:::

## Station metadata

The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HDX03">stations/08HDX03 folder on GitHub</a>.
...
<tr><td>08HDX03</td><td>CAMPBELL RIVER NEAR CAMPBELL RIVER (TEST STATION)</td><td>50.037</td><td>-125.287</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,675 daily observations, continuous record | 0.3% flagged (partial day: 5)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4176.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,675 daily observations, continuous record | 0.3% flagged (partial day: 5) | Record: 4.6 years</td></tr>
...
show(plot_station_timeseries("08HDX03"))
:::
...
show(plot_distributions("08HDX03"))
:::
...
<div class="download-section">
  ...
  <a href="camel_farrier/08HDX03/08HDX03/08HDX03_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="camel_farrier/08HDX03/08HDX03/08HDX03_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="camel_farrier/08HDX03/08HDX03/08HDX03_annual_instant_peaks.csv" download class="download-btn">
