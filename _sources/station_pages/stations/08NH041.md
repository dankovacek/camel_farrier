...
# 08NH041: MUNN CREEK NEAR AINSWORTH
...
result = plot_station_polygon("08NH041")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH041">stations/08NH041 folder on GitHub</a>.
:::
...
<tr><td>08NH041</td><td>MUNN CREEK NEAR AINSWORTH</td><td>49.736</td><td>-116.914</td><td>0.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.89, ΔArea: +7.9%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 520 daily observations, seasonal gaps: 2815 days avg (N=4) | 70.0% flagged (estimated: 364)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>520 daily observations, seasonal gaps: 2815 days avg (N=4) | 70.0% flagged (estimated: 364) | Record: 32.2 years</td></tr>
...
show(plot_station_timeseries("08NH041"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH041")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH041/08NH041_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH041/08NH041_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH041"))
:::
...
<div class="download-section">
  <a href="../../08NH041/08NH041_field_visits.csv" download class="download-btn">
