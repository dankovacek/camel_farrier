...
# 07MA004: WILLIAM RIVER ABOVE CARSWELL RIVER
...
result = plot_station_polygon("07MA004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07MA004">stations/07MA004 folder on GitHub</a>.
:::
...
<tr><td>07MA004</td><td>WILLIAM RIVER ABOVE CARSWELL RIVER</td><td>58.814</td><td>-109.003</td><td>4030.0 (0.0)</td><td>SK</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 6,939 daily observations, continuous record | 59.7% flagged (backwater: 3502, estimated: 557, partial day: 85)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 14628.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>6,939 daily observations, continuous record | 59.7% flagged (backwater: 3502, estimated: 557, partial day: 85) | Record: 19.0 years</td></tr>
...
show(plot_station_timeseries("07MA004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07MA004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07MA004/07MA004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07MA004/07MA004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07MA004"))
:::
...
<div class="download-section">
  <a href="../../07MA004/07MA004_field_visits.csv" download class="download-btn">
