...
result = plot_station_polygon("10GC003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10GC003">stations/10GC003 folder on GitHub</a>.
:::
...
<tr><td>10GC003</td><td>MARTIN RIVER AT HIGHWAY NO. 1</td><td>61.894</td><td>-121.612</td><td>2050.0 (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 52.7 years
<br><strong>Timeseries Summary:</strong> 19,238 daily observations, continuous record | 56.7% flagged (backwater: 10603, estimated: 215, partial day: 87)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 9169.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>19,238 daily observations, continuous record | 56.7% flagged (backwater: 10603, estimated: 215, partial day: 87) | Record: 52.7 years</td></tr>
...
show(plot_station_timeseries("10GC003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10GC003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10GC003/10GC003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10GC003/10GC003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10GC003/10GC003_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Provisional/Provisoire</td>
      <td>Recent mmnts plotting to L of curve 9.0</td>
    </tr>
    <tr>
      <td>9.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Provisional/Provisoire</td>
      <td>Same as curve 8 below 3.70 m.</td>
    </tr>
    <tr>
      <td>8.000</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>HQFIT1.0.   ZF = 1.46m(Aug '04)</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("10GC003"))
:::
