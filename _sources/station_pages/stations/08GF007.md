...
result = plot_station_polygon("08GF007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GF007">stations/08GF007 folder on GitHub</a>.
:::
...
<tr><td>08GF007</td><td>WAKEMAN RIVER BELOW ATWAYKELLESSE RIVER</td><td>51.103</td><td>-126.475</td><td>698.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 18.8 years
<br><strong>Timeseries Summary:</strong> 6,638 daily observations, seasonal gaps: 243 days avg (N=1) | 8.5% flagged (estimated: 412, backwater: 132, partial day: 20)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1780.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>6,638 daily observations, seasonal gaps: 243 days avg (N=1) | 8.5% flagged (estimated: 412, backwater: 132, partial day: 20) | Record: 18.8 years</td></tr>
...
show(plot_station_timeseries("08GF007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GF007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GF007/08GF007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08GF007/08GF007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08GF007/08GF007_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Best mean curve statistics using all measurements for period of record, maintaining low & high-end p...</td>
    </tr>
    <tr>
      <td>11.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve #11.00, though being much less of a statistical mean, has a more realistic exponent of 2.69. I...</td>
    </tr>
    <tr>
      <td>10.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Renamed from 8.01 to 8.00</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08GF007"))
:::
...
<div class="download-section">
  <a href="../../08GF007/08GF007_field_visits.csv" download class="download-btn">
