...
# 08NE078: WHATSHAN RIVER NEAR NEEDLES
...
result = plot_station_polygon("08NE078")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE078">stations/08NE078 folder on GitHub</a>.
:::
...
<tr><td>08NE078</td><td>WHATSHAN RIVER NEAR NEEDLES</td><td>49.912</td><td>-118.123</td><td>396.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 3,230 daily observations, seasonal gaps: 180 days avg (N=12) | 7.6% flagged (estimated: 204, partial day: 23, backwater: 17)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 966.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,230 daily observations, seasonal gaps: 180 days avg (N=12) | 7.6% flagged (estimated: 204, partial day: 23, backwater: 17) | Record: 14.7 years</td></tr>
...
show(plot_station_timeseries("08NE078"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE078")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE078/08NE078_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE078/08NE078_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE078"))
:::
