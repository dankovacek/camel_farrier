...
# 08NH020: MCGREGOR CREEK NEAR CRAWFORD BAY
...
result = plot_station_polygon("08NH020")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH020">stations/08NH020 folder on GitHub</a>.
:::
...
<tr><td>08NH020</td><td>MCGREGOR CREEK NEAR CRAWFORD BAY</td><td>49.447</td><td>-116.763</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: +1.2%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 703 daily observations, seasonal gaps: 220 days avg (N=4) | 71.7% flagged (estimated: 504)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 9.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>703 daily observations, seasonal gaps: 220 days avg (N=4) | 71.7% flagged (estimated: 504) | Record: 4.3 years</td></tr>
...
show(plot_station_timeseries("08NH020"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH020")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH020/08NH020_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH020/08NH020_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH020"))
:::
...
<div class="download-section">
  <a href="../../08NH020/08NH020_field_visits.csv" download class="download-btn">
