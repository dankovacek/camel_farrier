...
# 07AF009: NORTH ANDERSON CREEK NEAR HINTON
...
result = plot_station_polygon("07AF009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07AF009">stations/07AF009 folder on GitHub</a>.
:::
...
<tr><td>07AF009</td><td>NORTH ANDERSON CREEK NEAR HINTON</td><td>53.317</td><td>-117.400</td><td>10.6 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 2.2 years
<br><strong>Timeseries Summary:</strong> 489 daily observations, seasonal gaps: 166 days avg (N=2) | 13.7% flagged (estimated: 37, backwater: 20, partial day: 10)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 25.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>489 daily observations, seasonal gaps: 166 days avg (N=2) | 13.7% flagged (estimated: 37, backwater: 20, partial day: 10) | Record: 2.2 years</td></tr>
...
show(plot_station_timeseries("07AF009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07AF009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07AF009/07AF009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07AF009/07AF009_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07AF009"))
:::
...
<div class="download-section">
  <a href="../../07AF009/07AF009_field_visits.csv" download class="download-btn">
