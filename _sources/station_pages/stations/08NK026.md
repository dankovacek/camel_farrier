...
result = plot_station_polygon("08NK026")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NK026">stations/08NK026 folder on GitHub</a>.
:::
...
<tr><td>08NK026</td><td>HOSMER CREEK ABOVE DIVERSIONS</td><td>49.585</td><td>-114.957</td><td>6.4 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: +0.4%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 15,345 daily observations, seasonal gaps: 167 days avg (N=4) | 24.4% flagged (backwater: 2537, estimated: 1108, partial day: 92)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 15.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>15,345 daily observations, seasonal gaps: 167 days avg (N=4) | 24.4% flagged (backwater: 2537, estimated: 1108, partial day: 92) | Record: 43.8 years</td></tr>
...
show(plot_station_timeseries("08NK026"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NK026")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NK026/08NK026_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NK026/08NK026_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NK026/08NK026_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>redid upper end of curve to plot 2019, 2018 and 2017.  added a rating point above the BP to make adj...</td>
    </tr>
    <tr>
      <td>21.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New Weir pool and face constructed</td>
    </tr>
    <tr>
      <td>20.0</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08NK026"))
:::
...
<div class="download-section">
  <a href="../../08NK026/08NK026_field_visits.csv" download class="download-btn">
