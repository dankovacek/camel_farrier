...
# 10LB004: LOON RIVER NEAR THE ARCTIC CIRCLE
...
result = plot_station_polygon("10LB004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10LB004">stations/10LB004 folder on GitHub</a>.
:::
...
<tr><td>10LB004</td><td>LOON RIVER NEAR THE ARCTIC CIRCLE</td><td>66.514</td><td>-128.802</td><td>2745.0 (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 16.0 years
<br><strong>Timeseries Summary:</strong> 5,663 daily observations, seasonal gaps: 90 days avg (N=2) | 56.6% flagged (backwater: 3157, partial day: 46)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 19027.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>5,663 daily observations, seasonal gaps: 90 days avg (N=2) | 56.6% flagged (backwater: 3157, partial day: 46) | Record: 16.0 years</td></tr>
...
show(plot_station_timeseries("10LB004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10LB004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10LB004/10LB004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10LB004/10LB004_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10LB004/10LB004_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Updating E grade at high and low end. See RMD for further detail.</td>
    </tr>
    <tr>
      <td>5.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New curve created for 2014 using open water msmts back to 2006</td>
    </tr>
    <tr>
      <td>C2.1</td>
      <td>LinearTable</td>
      <td>Provisional/Provisoire</td>
      <td>Same as #1 with minor change so slope decreases</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("10LB004"))
:::
...
<div class="download-section">
  <a href="../../10LB004/10LB004_field_visits.csv" download class="download-btn">
