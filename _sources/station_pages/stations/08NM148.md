...
# 08NM148: TWIN LAKES NEAR OLALLA
...
result = plot_station_polygon("08NM148")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM148">stations/08NM148 folder on GitHub</a>.
:::
...
<tr><td>08NM148</td><td>TWIN LAKES NEAR OLALLA</td><td>49.318</td><td>-119.726</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
show(plot_station_timeseries("08NM148"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM148")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM148/08NM148_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM148/08NM148_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM148"))
:::
