...
# 08MH156: PEPIN CREEK AT INTERNATIONAL BOUNDARY
...
result = plot_station_polygon("08MH156")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH156">stations/08MH156 folder on GitHub</a>.
:::
...
<tr><td>08MH156</td><td>PEPIN CREEK AT INTERNATIONAL BOUNDARY</td><td>49.004</td><td>-122.472</td><td>12.2 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 38.6 years
<br><strong>Timeseries Summary:</strong> 8,708 daily observations, seasonal gaps: 142 days avg (N=38) | 2.6% flagged (estimated: 163, partial day: 62)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 21.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>8,708 daily observations, seasonal gaps: 142 days avg (N=38) | 2.6% flagged (estimated: 163, partial day: 62) | Record: 38.6 years</td></tr>
...
show(plot_station_timeseries("08MH156"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH156")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH156/08MH156_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08MH156/08MH156_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08MH156/08MH156_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH156"))
:::
...
<div class="download-section">
  <a href="../../08MH156/08MH156_field_visits.csv" download class="download-btn">
