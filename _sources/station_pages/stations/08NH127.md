...
# 08NH127: DUNCAN RESERVOIR AT DUNCAN DAM
...
result = plot_station_polygon("08NH127")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH127">stations/08NH127 folder on GitHub</a>.
:::
...
<tr><td>08NH127</td><td>DUNCAN RESERVOIR AT DUNCAN DAM</td><td>50.255</td><td>-116.949</td><td>nan (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
show(plot_station_timeseries("08NH127"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH127")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH127/08NH127_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NH127/08NH127_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH127"))
:::
...
<div class="download-section">
  <a href="../../08NH127/08NH127_field_visits.csv" download class="download-btn">
