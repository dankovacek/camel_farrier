...
result = plot_station_polygon("10ED007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10ED007">stations/10ED007 folder on GitHub</a>.
:::
...
<tr><td>10ED007</td><td>BLACKSTONE RIVER AT HIGHWAY NO. 7</td><td>61.060</td><td>-122.895</td><td>nan (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.98, ΔArea: +0.4%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 33.4 years
<br><strong>Timeseries Summary:</strong> 12,207 daily observations, continuous record | 57.0% flagged (backwater: 6605, estimated: 274, partial day: 84)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5967.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>12,207 daily observations, continuous record | 57.0% flagged (backwater: 6605, estimated: 274, partial day: 84) | Record: 33.4 years</td></tr>
...
show(plot_station_timeseries("10ED007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10ED007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10ED007/10ED007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10ED007/10ED007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10ED007/10ED007_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Clone of Rating Curve 9.000 to add estimate grading that was missed on curve creation.</td>
    </tr>
    <tr>
      <td>9.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Formerly rating curve 10.000, renamed after Curve 9.000 developed during COVID in 2020 was ultimatel...</td>
    </tr>
    <tr>
      <td>8.0</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("10ED007"))
:::
...
<div class="download-section">
  <a href="../../10ED007/10ED007_field_visits.csv" download class="download-btn">
