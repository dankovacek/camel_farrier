...
# 08MC016: ROSE LAKE NEAR OCHILTREE
...
result = plot_station_polygon("08MC016")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MC016">stations/08MC016 folder on GitHub</a>.
:::
...
<tr><td>08MC016</td><td>ROSE LAKE NEAR OCHILTREE</td><td>52.239</td><td>-121.760</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 228.9 km²</td></tr>
...
show(plot_station_timeseries("08MC016"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MC016")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MC016/08MC016_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08MC016/08MC016_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MC016"))
:::
...
<div class="download-section">
  <a href="../../08MC016/08MC016_field_visits.csv" download class="download-btn">
