...
result = plot_station_polygon("08LG016")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG016">stations/08LG016 folder on GitHub</a>.
:::
...
<tr><td>08LG016</td><td>PENNASK CREEK NEAR QUILCHENA</td><td>49.965</td><td>-120.135</td><td>87.6 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 103.7 years
<br><strong>Timeseries Summary:</strong> 24,038 daily observations, seasonal gaps: 494 days avg (N=28) | 42.4% flagged (backwater: 9209, estimated: 875, partial day: 109)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 207.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>24,038 daily observations, seasonal gaps: 494 days avg (N=28) | 42.4% flagged (backwater: 9209, estimated: 875, partial day: 109) | Record: 103.7 years</td></tr>
...
show(plot_station_timeseries("08LG016"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG016")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG016/08LG016_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08LG016/08LG016_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LG016/08LG016_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>co-incid. 40 0.320 and abv. 0.500 m.</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08LG016"))
:::
...
<div class="download-section">
  <a href="../../08LG016/08LG016_field_visits.csv" download class="download-btn">
