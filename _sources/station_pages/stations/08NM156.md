...
# 08NM156: BELLEVUE CREEK AT THE MOUTH
...
result = plot_station_polygon("08NM156")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM156">stations/08NM156 folder on GitHub</a>.
:::
...
<tr><td>08NM156</td><td>BELLEVUE CREEK AT THE MOUTH</td><td>49.820</td><td>-119.492</td><td>79.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 2.9 years
<br><strong>Timeseries Summary:</strong> 1,065 daily observations, continuous record | 13.5% flagged (backwater: 128, estimated: 16)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 209.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,065 daily observations, continuous record | 13.5% flagged (backwater: 128, estimated: 16) | Record: 2.9 years</td></tr>
...
show(plot_station_timeseries("08NM156"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM156")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM156/08NM156_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM156/08NM156_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM156"))
:::
...
<div class="download-section">
  <a href="../../08NM156/08NM156_field_visits.csv" download class="download-btn">
