...
# 08NM022: VERNON CREEK AT OUTLET OF SWALWELL LAKE
...
result = plot_station_polygon("08NM022")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM022">stations/08NM022 folder on GitHub</a>.
:::
...
<tr><td>08NM022</td><td>VERNON CREEK AT OUTLET OF SWALWELL LAKE</td><td>50.043</td><td>-119.243</td><td>62.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 75.2 years
<br><strong>Timeseries Summary:</strong> 13,285 daily observations, seasonal gaps: 617 days avg (N=23) | 20.3% flagged (estimated: 1908, backwater: 722, partial day: 62)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 160.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>13,285 daily observations, seasonal gaps: 617 days avg (N=23) | 20.3% flagged (estimated: 1908, backwater: 722, partial day: 62) | Record: 75.2 years</td></tr>
...
show(plot_station_timeseries("08NM022"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM022")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM022/08NM022_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM022/08NM022_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM022"))
:::
...
<div class="download-section">
  <a href="../../08NM022/08NM022_field_visits.csv" download class="download-btn">
