...
# 08NE023: MAUCHLINE CREEK NEAR ARROW PARK
...
result = plot_station_polygon("08NE023")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE023">stations/08NE023 folder on GitHub</a>.
:::
...
<tr><td>08NE023</td><td>MAUCHLINE CREEK NEAR ARROW PARK</td><td>50.082</td><td>-117.971</td><td>0.3 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.96, ΔArea: +2.2%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 3.1 years
<br><strong>Timeseries Summary:</strong> 458 daily observations, seasonal gaps: 223 days avg (N=3) | 4.8% flagged (estimated: 22)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 0.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>458 daily observations, seasonal gaps: 223 days avg (N=3) | 4.8% flagged (estimated: 22) | Record: 3.1 years</td></tr>
...
show(plot_station_timeseries("08NE023"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE023")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE023/08NE023_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE023/08NE023_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE023"))
:::
...
<div class="download-section">
  <a href="../../08NE023/08NE023_field_visits.csv" download class="download-btn">
