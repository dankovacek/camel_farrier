...
# 08LE040: BLAIR CREEK NEAR FALKLAND (UPPER STATION)
...
result = plot_station_polygon("08LE040")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE040">stations/08LE040 folder on GitHub</a>.
:::
...
<tr><td>08LE040</td><td>BLAIR CREEK NEAR FALKLAND (UPPER STATION)</td><td>50.580</td><td>-119.588</td><td>77.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 334 daily observations, continuous record</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 149.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>334 daily observations, continuous record | Record: 0.9 years</td></tr>
...
show(plot_station_timeseries("08LE040"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE040")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE040/08LE040_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE040/08LE040_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE040"))
:::
...
<div class="download-section">
  <a href="../../08LE040/08LE040_field_visits.csv" download class="download-btn">
