...
# 07DB003: DUNKIRK RIVER NEAR FORT MACKAY
...
result = plot_station_polygon("07DB003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DB003">stations/07DB003 folder on GitHub</a>.
:::
...
<tr><td>07DB003</td><td>DUNKIRK RIVER NEAR FORT MACKAY</td><td>56.851</td><td>-112.708</td><td>1570.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 49.4 years
<br><strong>Timeseries Summary:</strong> 4,200 daily observations, seasonal gaps: 6926 days avg (N=2) | 55.1% flagged (backwater: 2126, estimated: 179, partial day: 8)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5166.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>4,200 daily observations, seasonal gaps: 6926 days avg (N=2) | 55.1% flagged (backwater: 2126, estimated: 179, partial day: 8) | Record: 49.4 years</td></tr>
...
show(plot_station_timeseries("07DB003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07DB003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07DB003/07DB003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07DB003/07DB003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07DB003/07DB003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07DB003"))
:::
...
<div class="download-section">
  <a href="../../07DB003/07DB003_field_visits.csv" download class="download-btn">
