...
# 08KE028: TABOR CREEK AT HIGHWAY NO. 97 NEAR PRINCE GEORGE
...
result = plot_station_polygon("08KE028")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KE028">stations/08KE028 folder on GitHub</a>.
:::
...
<tr><td>08KE028</td><td>TABOR CREEK AT HIGHWAY NO. 97 NEAR PRINCE GEORGE</td><td>53.795</td><td>-122.652</td><td>113.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,771 daily observations, continuous record | 47.2% flagged (backwater: 1044, estimated: 263)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 335.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,771 daily observations, continuous record | 47.2% flagged (backwater: 1044, estimated: 263) | Record: 7.6 years</td></tr>
...
show(plot_station_timeseries("08KE028"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KE028")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KE028/08KE028_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KE028/08KE028_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KE028"))
:::
