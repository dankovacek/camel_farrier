...
# 08NA022: KINDERSLEY CREEK NEAR BRISCO
...
result = plot_station_polygon("08NA022")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA022">stations/08NA022 folder on GitHub</a>.
:::
...
<tr><td>08NA022</td><td>KINDERSLEY CREEK NEAR BRISCO</td><td>50.762</td><td>-116.052</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 15.5 years
<br><strong>Timeseries Summary:</strong> 732 daily observations, seasonal gaps: 1643 days avg (N=3) | 44.0% flagged (estimated: 322)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 53.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>732 daily observations, seasonal gaps: 1643 days avg (N=3) | 44.0% flagged (estimated: 322) | Record: 15.5 years</td></tr>
...
show(plot_station_timeseries("08NA022"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA022")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA022/08NA022_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA022/08NA022_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA022"))
:::
...
<div class="download-section">
  <a href="../../08NA022/08NA022_field_visits.csv" download class="download-btn">
