...
result = plot_station_polygon("08NN023")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NN023">stations/08NN023 folder on GitHub</a>.
:::
...
<tr><td>08NN023</td><td>BURRELL CREEK ABOVE GLOUCESTER CREEK</td><td>49.589</td><td>-118.312</td><td>221.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: +0.5%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 18,628 daily observations, continuous record | 26.4% flagged (backwater: 4123, estimated: 727, partial day: 61)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 529.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>18,628 daily observations, continuous record | 26.4% flagged (backwater: 4123, estimated: 727, partial day: 61) | Record: 51.0 years</td></tr>
...
show(plot_station_timeseries("08NN023"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NN023")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NN023/08NN023_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NN023/08NN023_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NN023/08NN023_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Shift to the right align to current measurements. Channel change after May 2023 high water.</td>
    </tr>
    <tr>
      <td>28.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>adjusting curve confidence</td>
    </tr>
    <tr>
      <td>28.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>scour and mmnts below curve</td>
    </tr>
    <tr>
      <td>27.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>made to adjust for curve confince for 2021</td>
    </tr>
    <tr>
      <td>27.00</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08NN023"))
:::
...
<div class="download-section">
  <a href="../../08NN023/08NN023_field_visits.csv" download class="download-btn">
