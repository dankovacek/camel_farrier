...
result = plot_station_polygon("08KC003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KC003">stations/08KC003 folder on GitHub</a>.
:::
...
<tr><td>08KC003</td><td>MUSKEG RIVER NORTH OF JOANNE LAKE</td><td>54.605</td><td>-123.237</td><td>303.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 23.6 years
<br><strong>Timeseries Summary:</strong> 7,883 daily observations, seasonal gaps: 366 days avg (N=2) | 59.2% flagged (backwater: 3678, estimated: 942, partial day: 45)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 870.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>7,883 daily observations, seasonal gaps: 366 days avg (N=2) | 59.2% flagged (backwater: 3678, estimated: 942, partial day: 45) | Record: 23.6 years</td></tr>
...
show(plot_station_timeseries("08KC003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KC003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KC003/08KC003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KC003/08KC003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KC003"))
:::
