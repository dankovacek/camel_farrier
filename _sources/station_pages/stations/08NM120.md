...
result = plot_station_polygon("08NM120")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM120">stations/08NM120 folder on GitHub</a>.
:::
...
<tr><td>08NM120</td><td>PARK RILL NEAR OLIVER</td><td>49.236</td><td>-119.572</td><td>160.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 3,570 daily observations, seasonal gaps: 184 days avg (N=19) | 56.1% flagged (estimated: 2001)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 443.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,570 daily observations, seasonal gaps: 184 days avg (N=19) | 56.1% flagged (estimated: 2001) | Record: 19.3 years</td></tr>
...
show(plot_station_timeseries("08NM120"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM120")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM120/08NM120_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM120/08NM120_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM120"))
:::
...
<div class="download-section">
  <a href="../../08NM120/08NM120_field_visits.csv" download class="download-btn">
