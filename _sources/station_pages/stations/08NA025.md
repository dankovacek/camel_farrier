...
# 08NA025: MALLARD CREEK NEAR PARSON
...
result = plot_station_polygon("08NA025")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA025">stations/08NA025 folder on GitHub</a>.
:::
...
<tr><td>08NA025</td><td>MALLARD CREEK NEAR PARSON</td><td>51.095</td><td>-116.680</td><td>7.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 275 daily observations, seasonal gaps: 243 days avg (N=1) | 38.2% flagged (estimated: 105)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 21.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>275 daily observations, seasonal gaps: 243 days avg (N=1) | 38.2% flagged (estimated: 105) | Record: 1.4 years</td></tr>
...
show(plot_station_timeseries("08NA025"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA025")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA025/08NA025_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA025/08NA025_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA025"))
:::
...
<div class="download-section">
  <a href="../../08NA025/08NA025_field_visits.csv" download class="download-btn">
