...
result = plot_station_polygon("08GE003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GE003">stations/08GE003 folder on GitHub</a>.
:::
...
<tr><td>08GE003</td><td>ICY CREEK NEAR THE MOUTH</td><td>51.228</td><td>-125.671</td><td>23.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 25.9 years
<br><strong>Timeseries Summary:</strong> 9,434 daily observations, minor gaps: 31 days avg (N=1) | 8.4% flagged (backwater: 377, estimated: 298, partial day: 119)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 59.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>9,434 daily observations, minor gaps: 31 days avg (N=1) | 8.4% flagged (backwater: 377, estimated: 298, partial day: 119) | Record: 25.9 years</td></tr>
...
show(plot_station_timeseries("08GE003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GE003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GE003/08GE003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08GE003/08GE003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08GE003/08GE003_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>All measurements since large event in mid 2021.</td>
    </tr>
    <tr>
      <td>25.00</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve renamed to allow extension of grading after 2017-09-06 measurement</td>
    </tr>
    <tr>
      <td>24.00</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08GE003"))
:::
...
<div class="download-section">
  <a href="../../08GE003/08GE003_field_visits.csv" download class="download-btn">
