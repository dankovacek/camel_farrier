...
# 08MH060: SERPENTINE RIVER NEAR PORT KELLS
...
result = plot_station_polygon("08MH060")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH060">stations/08MH060 folder on GitHub</a>.
:::
...
<tr><td>08MH060</td><td>SERPENTINE RIVER NEAR PORT KELLS</td><td>49.173</td><td>-122.756</td><td>13.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 5.5 years
<br><strong>Timeseries Summary:</strong> 1,550 daily observations, seasonal gaps: 115 days avg (N=4) | 32.1% flagged (estimated: 497)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 32.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,550 daily observations, seasonal gaps: 115 days avg (N=4) | 32.1% flagged (estimated: 497) | Record: 5.5 years</td></tr>
...
show(plot_station_timeseries("08MH060"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH060")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH060/08MH060_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH060/08MH060_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH060"))
:::
...
<div class="download-section">
  <a href="../../08MH060/08MH060_field_visits.csv" download class="download-btn">
