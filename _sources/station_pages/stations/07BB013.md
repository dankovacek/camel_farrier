...
# 07BB013: PADDLE RIVER AT HIGHWAY NO. 764
...
result = plot_station_polygon("07BB013")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07BB013">stations/07BB013 folder on GitHub</a>.
:::
...
<tr><td>07BB013</td><td>PADDLE RIVER AT HIGHWAY NO. 764</td><td>54.048</td><td>-114.670</td><td>1720.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5007.4 km²</td></tr>
...
show(plot_station_timeseries("07BB013"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07BB013")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07BB013/07BB013_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07BB013/07BB013_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07BB013"))
:::
...
<div class="download-section">
  <a href="../../07BB013/07BB013_field_visits.csv" download class="download-btn">
