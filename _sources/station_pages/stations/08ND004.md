...
# 08ND004: JORDAN RIVER NEAR REVELSTOKE
...
result = plot_station_polygon("08ND004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08ND004">stations/08ND004 folder on GitHub</a>.
:::
...
<tr><td>08ND004</td><td>JORDAN RIVER NEAR REVELSTOKE</td><td>51.014</td><td>-118.238</td><td>350.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 668 daily observations, seasonal gaps: 1178 days avg (N=3) | 69.3% flagged (estimated: 313, backwater: 150)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 862.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>668 daily observations, seasonal gaps: 1178 days avg (N=3) | 69.3% flagged (estimated: 313, backwater: 150) | Record: 11.5 years</td></tr>
...
show(plot_station_timeseries("08ND004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08ND004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08ND004/08ND004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08ND004/08ND004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08ND004"))
:::
