...
# 08NG059: LAKIT CREEK NEAR FORT STEELE
...
result = plot_station_polygon("08NG059")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG059">stations/08NG059 folder on GitHub</a>.
:::
...
<tr><td>08NG059</td><td>LAKIT CREEK NEAR FORT STEELE</td><td>49.705</td><td>-115.648</td><td>14.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.92, ΔArea: +8.9%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 306 daily observations, seasonal gaps: 638 days avg (N=2) | 36.3% flagged (estimated: 111)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>306 daily observations, seasonal gaps: 638 days avg (N=2) | 36.3% flagged (estimated: 111) | Record: 4.3 years</td></tr>
...
show(plot_station_timeseries("08NG059"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG059")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG059/08NG059_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG059/08NG059_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG059"))
:::
