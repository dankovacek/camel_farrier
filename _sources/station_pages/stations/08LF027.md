...
# 08LF027: DEADMAN RIVER ABOVE CRISS CREEK
...
result = plot_station_polygon("08LF027")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF027">stations/08LF027 folder on GitHub</a>.
:::
...
<tr><td>08LF027</td><td>DEADMAN RIVER ABOVE CRISS CREEK</td><td>50.898</td><td>-120.976</td><td>878.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 24,448 daily observations, seasonal gaps: 1600 days avg (N=10) | 22.3% flagged (backwater: 3670, partial day: 1216, estimated: 571)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2241.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>24,448 daily observations, seasonal gaps: 1600 days avg (N=10) | 22.3% flagged (backwater: 3670, partial day: 1216, estimated: 571) | Record: 110.7 years</td></tr>
...
show(plot_station_timeseries("08LF027"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF027")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF027/08LF027_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08LF027/08LF027_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LF027/08LF027_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF027"))
:::
...
<div class="download-section">
  <a href="../../08LF027/08LF027_field_visits.csv" download class="download-btn">
