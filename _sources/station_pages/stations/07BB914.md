...
# 07BB914: PADDLE RIVER RESERVOIR NEAR ROCHFORT BRIDGE
...
result = plot_station_polygon("07BB914")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07BB914">stations/07BB914 folder on GitHub</a>.
:::
...
<tr><td>07BB914</td><td>PADDLE RIVER RESERVOIR NEAR ROCHFORT BRIDGE</td><td>53.893</td><td>-115.067</td><td>612.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1757.7 km²</td></tr>
...
show(plot_station_timeseries("07BB914"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07BB914")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07BB914/07BB914_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07BB914/07BB914_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07BB914"))
:::
...
<div class="download-section">
  <a href="../../07BB914/07BB914_field_visits.csv" download class="download-btn">
