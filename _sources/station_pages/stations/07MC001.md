...
# 07MC001: OLDMAN RIVER NEAR GOLDFIELDS
...
result = plot_station_polygon("07MC001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07MC001">stations/07MC001 folder on GitHub</a>.
:::
...
<tr><td>07MC001</td><td>OLDMAN RIVER NEAR GOLDFIELDS</td><td>59.494</td><td>-108.064</td><td>937.0 (0.0)</td><td>SK</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 183 daily observations, continuous record | 87.4% flagged (backwater: 160)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3632.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>183 daily observations, continuous record | 87.4% flagged (backwater: 160) | Record: 0.5 years</td></tr>
...
show(plot_station_timeseries("07MC001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07MC001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07MC001/07MC001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07MC001/07MC001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07MC001"))
:::
...
<div class="download-section">
  <a href="../../07MC001/07MC001_field_visits.csv" download class="download-btn">
