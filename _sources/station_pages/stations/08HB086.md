...
result = plot_station_polygon("08HB086")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB086">stations/08HB086 folder on GitHub</a>.
:::
...
<tr><td>08HB086</td><td>TOFINO CREEK NEAR THE MOUTH</td><td>49.251</td><td>-125.583</td><td>38.6 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-03-10</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: +0.3%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 30.0 years
<br><strong>Timeseries Summary:</strong> 10,869 daily observations, minor gaps: 89 days avg (N=1) | 7.2% flagged (estimated: 729, partial day: 58)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 91.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>10,869 daily observations, minor gaps: 89 days avg (N=1) | 7.2% flagged (estimated: 729, partial day: 58) | Record: 30.0 years</td></tr>
...
show(plot_station_timeseries("08HB086"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB086")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB086/08HB086_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08HB086/08HB086_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HB086/08HB086_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Corrects top-end grading error reducing estimated above grade from 279  to 186 m^3/s</td>
    </tr>
    <tr>
      <td>23.000</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Shift to new curve at HW peak</td>
    </tr>
    <tr>
      <td>21.000</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Approved. Coincident w/#19  above 2.1m.</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08HB086"))
:::
...
<div class="download-section">
  <a href="../../08HB086/08HB086_field_visits.csv" download class="download-btn">
