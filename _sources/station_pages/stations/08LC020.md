...
# 08LC020: VIOLET CREEK NEAR GRINDROD (UPPER STATION)
...
result = plot_station_polygon("08LC020")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LC020">stations/08LC020 folder on GitHub</a>.
:::
...
<tr><td>08LC020</td><td>VIOLET CREEK NEAR GRINDROD (UPPER STATION)</td><td>50.695</td><td>-119.129</td><td>13.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 15.6 years
<br><strong>Timeseries Summary:</strong> 1,282 daily observations, seasonal gaps: 882 days avg (N=5) | 52.7% flagged (estimated: 675)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 34.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,282 daily observations, seasonal gaps: 882 days avg (N=5) | 52.7% flagged (estimated: 675) | Record: 15.6 years</td></tr>
...
show(plot_station_timeseries("08LC020"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LC020")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LC020/08LC020_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LC020/08LC020_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LC020"))
:::
