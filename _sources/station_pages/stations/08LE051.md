...
# 08LE051: LOAKIN CREEK (INDIAN DIVERSION) NEAR SHUSWAP
...
result = plot_station_polygon("08LE051")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE051">stations/08LE051 folder on GitHub</a>.
:::
...
<tr><td>08LE051</td><td>LOAKIN CREEK (INDIAN DIVERSION) NEAR SHUSWAP</td><td>50.820</td><td>-119.757</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 16.4 years
<br><strong>Timeseries Summary:</strong> 2,721 daily observations, seasonal gaps: 205 days avg (N=16) | 13.0% flagged (estimated: 354)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 93.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,721 daily observations, seasonal gaps: 205 days avg (N=16) | 13.0% flagged (estimated: 354) | Record: 16.4 years</td></tr>
...
show(plot_station_timeseries("08LE051"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE051")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE051/08LE051_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE051/08LE051_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE051"))
:::
...
<div class="download-section">
  <a href="../../08LE051/08LE051_field_visits.csv" download class="download-btn">
