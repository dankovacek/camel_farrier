...
# 07DA007: POPLAR CREEK NEAR FORT MCMURRAY
...
result = plot_station_polygon("07DA007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DA007">stations/07DA007 folder on GitHub</a>.
:::
...
<tr><td>07DA007</td><td>POPLAR CREEK NEAR FORT MCMURRAY</td><td>56.911</td><td>-111.463</td><td>136.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 8,280 daily observations, seasonal gaps: 3673 days avg (N=3) | 52.2% flagged (backwater: 3812, estimated: 459, partial day: 50)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1444.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>8,280 daily observations, seasonal gaps: 3673 days avg (N=3) | 52.2% flagged (backwater: 3812, estimated: 459, partial day: 50) | Record: 52.8 years</td></tr>
...
show(plot_station_timeseries("07DA007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07DA007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07DA007/07DA007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07DA007/07DA007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07DA007/07DA007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07DA007"))
:::
...
<div class="download-section">
  <a href="../../07DA007/07DA007_field_visits.csv" download class="download-btn">
