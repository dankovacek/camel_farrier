...
# 08MH123: CAMPBELL RIVER ABOVE SAM HILL CREEK
...
result = plot_station_polygon("08MH123")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH123">stations/08MH123 folder on GitHub</a>.
:::
...
<tr><td>08MH123</td><td>CAMPBELL RIVER ABOVE SAM HILL CREEK</td><td>49.024</td><td>-122.718</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 28.7 years
<br><strong>Timeseries Summary:</strong> 2,717 daily observations, seasonal gaps: 646 days avg (N=12) | 1.1% flagged (estimated: 22, partial day: 8)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 109.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,717 daily observations, seasonal gaps: 646 days avg (N=12) | 1.1% flagged (estimated: 22, partial day: 8) | Record: 28.7 years</td></tr>
...
show(plot_station_timeseries("08MH123"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH123")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH123/08MH123_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH123/08MH123_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH123"))
:::
