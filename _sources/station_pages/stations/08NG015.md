...
# 08NG015: JOSEPH CREEK AT CRANBROOK
...
result = plot_station_polygon("08NG015")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG015">stations/08NG015 folder on GitHub</a>.
:::
...
<tr><td>08NG015</td><td>JOSEPH CREEK AT CRANBROOK</td><td>49.511</td><td>-115.760</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,221 daily observations, seasonal gaps: 248 days avg (N=6) | 2.1% flagged (estimated: 26)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 351.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,221 daily observations, seasonal gaps: 248 days avg (N=6) | 2.1% flagged (estimated: 26) | Record: 7.4 years</td></tr>
...
show(plot_station_timeseries("08NG015"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG015")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG015/08NG015_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG015/08NG015_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG015"))
:::
...
<div class="download-section">
  <a href="../../08NG015/08NG015_field_visits.csv" download class="download-btn">
