...
# 08LE043: SILVER CREEK NEAR SALMON ARM
...
result = plot_station_polygon("08LE043")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE043">stations/08LE043 folder on GitHub</a>.
:::
...
<tr><td>08LE043</td><td>SILVER CREEK NEAR SALMON ARM</td><td>50.592</td><td>-119.364</td><td>25.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 25.4 years
<br><strong>Timeseries Summary:</strong> 1,983 daily observations, seasonal gaps: 730 days avg (N=10) | 0.3% flagged (estimated: 5)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 62.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,983 daily observations, seasonal gaps: 730 days avg (N=10) | 0.3% flagged (estimated: 5) | Record: 25.4 years</td></tr>
...
show(plot_station_timeseries("08LE043"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE043")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE043/08LE043_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE043/08LE043_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE043"))
:::
...
<div class="download-section">
  <a href="../../08LE043/08LE043_field_visits.csv" download class="download-btn">
