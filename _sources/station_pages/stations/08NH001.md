...
result = plot_station_polygon("08NH001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH001">stations/08NH001 folder on GitHub</a>.
:::
...
<tr><td>08NH001</td><td>DUNCAN RIVER NEAR HOWSER</td><td>50.286</td><td>-116.946</td><td>2160.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 13,789 daily observations, seasonal gaps: 2662 days avg (N=2) | 4.6% flagged (estimated: 479, backwater: 149)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 6036.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>13,789 daily observations, seasonal gaps: 2662 days avg (N=2) | 4.6% flagged (estimated: 479, backwater: 149) | Record: 52.3 years</td></tr>
...
show(plot_station_timeseries("08NH001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH001/08NH001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH001/08NH001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH001"))
:::
...
<div class="download-section">
  <a href="../../08NH001/08NH001_field_visits.csv" download class="download-btn">
