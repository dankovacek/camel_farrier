...
# 10HC006: BLACKWATER RIVER AT OUTLET OF BLACKWATER LAKE
...
result = plot_station_polygon("10HC006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10HC006">stations/10HC006 folder on GitHub</a>.
:::
...
<tr><td>10HC006</td><td>BLACKWATER RIVER AT OUTLET OF BLACKWATER LAKE</td><td>63.900</td><td>-123.323</td><td>7850.0 (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 8.7 years
<br><strong>Timeseries Summary:</strong> 3,137 daily observations, minor gaps: 28 days avg (N=1) | 50.3% flagged (backwater: 1454, estimated: 109, partial day: 15)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 47285.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>3,137 daily observations, minor gaps: 28 days avg (N=1) | 50.3% flagged (backwater: 1454, estimated: 109, partial day: 15) | Record: 8.7 years</td></tr>
...
show(plot_station_timeseries("10HC006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10HC006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10HC006/10HC006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10HC006/10HC006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10HC006"))
:::
...
<div class="download-section">
  <a href="../../10HC006/10HC006_field_visits.csv" download class="download-btn">
