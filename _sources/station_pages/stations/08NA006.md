...
The data representing the above plots can be downloaded from the [stations/08NA006](https://dankovacek.github.io/camel_farrier/stations/08NA006) folder in the Github repository.
