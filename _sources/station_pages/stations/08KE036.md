...
# 08KE036: NARCOSLI CREEK BELOW RAMSEY CREEK
...
result = plot_station_polygon("08KE036")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KE036">stations/08KE036 folder on GitHub</a>.
:::
...
<tr><td>08KE036</td><td>NARCOSLI CREEK BELOW RAMSEY CREEK</td><td>52.508</td><td>-122.679</td><td>629.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 2.6 years
<br><strong>Timeseries Summary:</strong> 671 daily observations, seasonal gaps: 91 days avg (N=3) | 5.5% flagged (estimated: 26, backwater: 9, partial day: 2)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1660.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>671 daily observations, seasonal gaps: 91 days avg (N=3) | 5.5% flagged (estimated: 26, backwater: 9, partial day: 2) | Record: 2.6 years</td></tr>
...
show(plot_station_timeseries("08KE036"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KE036")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KE036/08KE036_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KE036/08KE036_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KE036"))
:::
...
<div class="download-section">
  <a href="../../08KE036/08KE036_field_visits.csv" download class="download-btn">
