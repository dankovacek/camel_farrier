...
# 08DC003: GEORGIE RIVER NEAR STEWART
...
result = plot_station_polygon("08DC003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08DC003">stations/08DC003 folder on GitHub</a>.
:::
...
<tr><td>08DC003</td><td>GEORGIE RIVER NEAR STEWART</td><td>55.713</td><td>-130.082</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 490.6 km²</td></tr>
...
show(plot_station_timeseries("08DC003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08DC003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08DC003/08DC003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08DC003/08DC003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08DC003"))
:::
...
<div class="download-section">
  <a href="../../08DC003/08DC003_field_visits.csv" download class="download-btn">
