...
result = plot_station_polygon("07AG003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07AG003">stations/07AG003 folder on GitHub</a>.
:::
...
<tr><td>07AG003</td><td>WOLF CREEK AT HIGHWAY NO. 16A</td><td>53.598</td><td>-116.272</td><td>826.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 70.2 years
<br><strong>Timeseries Summary:</strong> 25,201 daily observations, seasonal gaps: 428 days avg (N=1) | 51.9% flagged (backwater: 12349, estimated: 640, partial day: 88)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2304.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>25,201 daily observations, seasonal gaps: 428 days avg (N=1) | 51.9% flagged (backwater: 12349, estimated: 640, partial day: 88) | Record: 70.2 years</td></tr>
...
show(plot_station_timeseries("07AG003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07AG003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07AG003/07AG003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07AG003/07AG003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07AG003/07AG003_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>New curve to modernize previous imported Compumod curve.</td>
    </tr>
    <tr>
      <td>14.0</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>same as Curve #12 above 2.18m</td>
    </tr>
    <tr>
      <td>13.0</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>extended low end of curve 01-23-04.</td>
    </tr>
    <tr>
      <td>12.0</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07AG003"))
:::
...
<div class="download-section">
  <a href="../../07AG003/07AG003_field_visits.csv" download class="download-btn">
