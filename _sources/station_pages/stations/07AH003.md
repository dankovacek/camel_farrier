...
result = plot_station_polygon("07AH003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07AH003">stations/07AH003 folder on GitHub</a>.
:::
...
<tr><td>07AH003</td><td>SAKWATAMAU RIVER NEAR WHITECOURT</td><td>54.201</td><td>-115.779</td><td>1150.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 52.2 years
<br><strong>Timeseries Summary:</strong> 13,937 daily observations, seasonal gaps: 99 days avg (N=52) | 26.7% flagged (backwater: 3305, partial day: 228, estimated: 189)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3376.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>13,937 daily observations, seasonal gaps: 99 days avg (N=52) | 26.7% flagged (backwater: 3305, partial day: 228, estimated: 189) | Record: 52.2 years</td></tr>
...
show(plot_station_timeseries("07AH003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07AH003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07AH003/07AH003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07AH003/07AH003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07AH003/07AH003_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Rating curve 11.00 was generated to reflect channel changes that occurred due to a 2023 high water e...</td>
    </tr>
    <tr>
      <td>10.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Revised curve due to low-end scour.</td>
    </tr>
    <tr>
      <td>9.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Modernize previous CompuMod Curve and adjust for scour on low end.</td>
    </tr>
    <tr>
      <td>8.1</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Extended Curve 8.000 to 3.520 m in Aquarius</td>
    </tr>
    <tr>
      <td>8.0</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Same as Curve No. 7 above 0.790 m.</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("07AH003"))
:::
...
<div class="download-section">
  <a href="../../07AH003/07AH003_field_visits.csv" download class="download-btn">
