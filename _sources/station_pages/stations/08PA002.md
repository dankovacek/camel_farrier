...
# 08PA002: SUMALLO RIVER AT THE MOUTH
...
result = plot_station_polygon("08PA002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08PA002">stations/08PA002 folder on GitHub</a>.
:::
...
<tr><td>08PA002</td><td>SUMALLO RIVER AT THE MOUTH</td><td>49.221</td><td>-121.092</td><td>208.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,924 daily observations, seasonal gaps: 90 days avg (N=1) | 3.8% flagged (estimated: 109, backwater: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 492.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,924 daily observations, seasonal gaps: 90 days avg (N=1) | 3.8% flagged (estimated: 109, backwater: 3) | Record: 8.2 years</td></tr>
...
show(plot_station_timeseries("08PA002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08PA002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08PA002/08PA002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08PA002/08PA002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08PA002"))
:::
...
<div class="download-section">
  <a href="../../08PA002/08PA002_field_visits.csv" download class="download-btn">
