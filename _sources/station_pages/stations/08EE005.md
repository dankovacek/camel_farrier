...
result = plot_station_polygon("08EE005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EE005">stations/08EE005 folder on GitHub</a>.
:::
...
<tr><td>08EE005</td><td>BULKLEY RIVER NEAR SMITHERS</td><td>54.770</td><td>-127.133</td><td>8940.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 77.6 years
<br><strong>Timeseries Summary:</strong> 7,372 daily observations, seasonal gaps: 2330 days avg (N=9) | 36.7% flagged (backwater: 2110, estimated: 577, partial day: 22)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 26073.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>7,372 daily observations, seasonal gaps: 2330 days avg (N=9) | 36.7% flagged (backwater: 2110, estimated: 577, partial day: 22) | Record: 77.6 years</td></tr>
...
show(plot_station_timeseries("08EE005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EE005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EE005/08EE005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08EE005/08EE005_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08EE005/08EE005_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Clone of Curve 11.00 - Grades revised based on 2022 data. From previous approved Curve, 'Curve 11.00...</td>
    </tr>
    <tr>
      <td>11.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve shifted to the right due to scour noted in 2019/2020 measurements.</td>
    </tr>
    <tr>
      <td>10.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Shift from curve 9.000 on move to new o-line location May 1/2018.</td>
    </tr>
    <tr>
      <td>9.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Shift from curve 8.000 during ice period</td>
    </tr>
    <tr>
      <td>8.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Shift from curve 7.000 to curve 8.000 at highwater.</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08EE005"))
:::
...
<div class="download-section">
  <a href="../../08EE005/08EE005_field_visits.csv" download class="download-btn">
