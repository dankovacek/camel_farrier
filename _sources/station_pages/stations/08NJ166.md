...
# 08NJ166: DUMONT CREEK NEAR WINLAW
...
result = plot_station_polygon("08NJ166")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ166">stations/08NJ166 folder on GitHub</a>.
:::
...
<tr><td>08NJ166</td><td>DUMONT CREEK NEAR WINLAW</td><td>49.612</td><td>-117.535</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 825 daily observations, seasonal gaps: 151 days avg (N=3) | 13.9% flagged (estimated: 115)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>825 daily observations, seasonal gaps: 151 days avg (N=3) | 13.9% flagged (estimated: 115) | Record: 3.5 years</td></tr>
...
show(plot_station_timeseries("08NJ166"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ166")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ166/08NJ166_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ166/08NJ166_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ166"))
:::
