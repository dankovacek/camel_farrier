...
result = plot_station_polygon("10GB006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10GB006">stations/10GB006 folder on GitHub</a>.
:::
...
<tr><td>10GB006</td><td>WILLOWLAKE RIVER ABOVE METAHDALI CREEK</td><td>62.650</td><td>-122.899</td><td>20200.0 (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 50.0 years
<br><strong>Timeseries Summary:</strong> 16,443 daily observations, seasonal gaps: 121 days avg (N=15) | 53.2% flagged (backwater: 8109, estimated: 378, partial day: 267)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 97776.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>16,443 daily observations, seasonal gaps: 121 days avg (N=15) | 53.2% flagged (backwater: 8109, estimated: 378, partial day: 267) | Record: 50.0 years</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10GB006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10GB006/10GB006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10GB006/10GB006_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10GB006/10GB006_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Stage-Discharge table 13.0 was established for 10GB006 on 2021-10-27. The rating period for curve 13...</td>
    </tr>
    <tr>
      <td>12.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Tweaking curve. Refining below 5 metres</td>
    </tr>
    <tr>
      <td>11.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Log-Log used to confirm top end.</td>
    </tr>
    <tr>
      <td>10.000-SC2</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("10GB006"))
:::
