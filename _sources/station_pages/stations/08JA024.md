...
# 08JA024: ENTIAKO RIVER NEAR THE MOUTH
...
result = plot_station_polygon("08JA024")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08JA024">stations/08JA024 folder on GitHub</a>.
:::
...
<tr><td>08JA024</td><td>ENTIAKO RIVER NEAR THE MOUTH</td><td>53.348</td><td>-125.351</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,370 daily observations, continuous record | 39.5% flagged (backwater: 468, estimated: 68, partial day: 5)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4923.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,370 daily observations, continuous record | 39.5% flagged (backwater: 468, estimated: 68, partial day: 5) | Record: 3.7 years</td></tr>
...
show(plot_station_timeseries("08JA024"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08JA024")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08JA024/08JA024_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08JA024/08JA024_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08JA024"))
:::
...
<div class="download-section">
  <a href="../../08JA024/08JA024_field_visits.csv" download class="download-btn">
