...
# 08NL023: OTTER CREEK AT TULAMEEN
...
result = plot_station_polygon("08NL023")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL023">stations/08NL023 folder on GitHub</a>.
:::
...
<tr><td>08NL023</td><td>OTTER CREEK AT TULAMEEN</td><td>49.546</td><td>-120.753</td><td>673.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 38.1 years
<br><strong>Timeseries Summary:</strong> 13,728 daily observations, minor gaps: 46 days avg (N=4) | 4.1% flagged (backwater: 277, estimated: 264, partial day: 28)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1608.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>13,728 daily observations, minor gaps: 46 days avg (N=4) | 4.1% flagged (backwater: 277, estimated: 264, partial day: 28) | Record: 38.1 years</td></tr>
...
show(plot_station_timeseries("08NL023"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL023")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL023/08NL023_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NL023/08NL023_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL023"))
:::
...
<div class="download-section">
  <a href="../../08NL023/08NL023_field_visits.csv" download class="download-btn">
