...
# 08LF034: HAT CREEK ABOVE MARBLE CANYON
...
result = plot_station_polygon("08LF034")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF034">stations/08LF034 folder on GitHub</a>.
:::
...
<tr><td>08LF034</td><td>HAT CREEK ABOVE MARBLE CANYON</td><td>50.792</td><td>-121.611</td><td>430.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 13.7 years
<br><strong>Timeseries Summary:</strong> 550 daily observations, seasonal gaps: 2222 days avg (N=2) | 34.4% flagged (estimated: 189)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1020.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>550 daily observations, seasonal gaps: 2222 days avg (N=2) | 34.4% flagged (estimated: 189) | Record: 13.7 years</td></tr>
...
show(plot_station_timeseries("08LF034"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF034")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF034/08LF034_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF034/08LF034_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF034"))
:::
...
<div class="download-section">
  <a href="../../08LF034/08LF034_field_visits.csv" download class="download-btn">
