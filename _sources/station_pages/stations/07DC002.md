...
# 07DC002: LOST CREEK NEAR THE MOUTH
...
result = plot_station_polygon("07DC002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DC002">stations/07DC002 folder on GitHub</a>.
:::
...
<tr><td>07DC002</td><td>LOST CREEK NEAR THE MOUTH</td><td>57.289</td><td>-110.464</td><td>418.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 549 daily observations, continuous record | 45.2% flagged (backwater: 247, partial day: 1)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1412.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>549 daily observations, continuous record | 45.2% flagged (backwater: 247, partial day: 1) | Record: 1.5 years</td></tr>
...
show(plot_station_timeseries("07DC002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07DC002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07DC002/07DC002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07DC002/07DC002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07DC002"))
:::
...
<div class="download-section">
  <a href="../../07DC002/07DC002_field_visits.csv" download class="download-btn">
