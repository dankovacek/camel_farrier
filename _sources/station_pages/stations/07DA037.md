...
# 07DA037: TAR RIVER ABOVE CANADIAN NATURAL RESOURCES LIMITED LAKE
...
result = plot_station_polygon("07DA037")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DA037">stations/07DA037 folder on GitHub</a>.
:::
...
<tr><td>07DA037</td><td>TAR RIVER ABOVE CANADIAN NATURAL RESOURCES LIMITED LAKE</td><td>57.394</td><td>-111.986</td><td>143.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 8.0 years
<br><strong>Timeseries Summary:</strong> 2,922 daily observations, continuous record | 63.2% flagged (backwater: 1627, estimated: 208, partial day: 12)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 491.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,922 daily observations, continuous record | 63.2% flagged (backwater: 1627, estimated: 208, partial day: 12) | Record: 8.0 years</td></tr>
...
show(plot_station_timeseries("07DA037"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07DA037")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07DA037/07DA037_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07DA037/07DA037_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07DA037/07DA037_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07DA037"))
:::
...
<div class="download-section">
  <a href="../../07DA037/07DA037_field_visits.csv" download class="download-btn">
