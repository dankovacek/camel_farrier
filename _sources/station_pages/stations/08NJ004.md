...
# 08NJ004: CARPENTER CREEK (SOUTH FORK) AT SANDON
...
result = plot_station_polygon("08NJ004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ004">stations/08NJ004 folder on GitHub</a>.
:::
...
<tr><td>08NJ004</td><td>CARPENTER CREEK (SOUTH FORK) AT SANDON</td><td>49.978</td><td>-117.232</td><td>50.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,279 daily observations, continuous record</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 119.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,279 daily observations, continuous record | Record: 3.5 years</td></tr>
...
show(plot_station_timeseries("08NJ004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ004/08NJ004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ004/08NJ004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ004"))
:::
...
<div class="download-section">
  <a href="../../08NJ004/08NJ004_field_visits.csv" download class="download-btn">
