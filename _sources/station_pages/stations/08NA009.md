...
# 08NA009: FORSTER CREEK NEAR WILMER
...
result = plot_station_polygon("08NA009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA009">stations/08NA009 folder on GitHub</a>.
:::
...
<tr><td>08NA009</td><td>FORSTER CREEK NEAR WILMER</td><td>50.588</td><td>-116.129</td><td>508.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 6.9 years
<br><strong>Timeseries Summary:</strong> 1,464 daily observations, seasonal gaps: 266 days avg (N=4) | 29.1% flagged (backwater: 237, estimated: 189)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1303.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,464 daily observations, seasonal gaps: 266 days avg (N=4) | 29.1% flagged (backwater: 237, estimated: 189) | Record: 6.9 years</td></tr>
...
show(plot_station_timeseries("08NA009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA009/08NA009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA009/08NA009_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA009"))
:::
...
<div class="download-section">
  <a href="../../08NA009/08NA009_field_visits.csv" download class="download-btn">
