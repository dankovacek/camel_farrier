...
# 08NM216: BROWNE LAKE RESERVOIR ABOVE THE DAM
...
result = plot_station_polygon("08NM216")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM216">stations/08NM216 folder on GitHub</a>.
:::
...
<tr><td>08NM216</td><td>BROWNE LAKE RESERVOIR ABOVE THE DAM</td><td>49.820</td><td>-119.187</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.95, ΔArea: +3.7%</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 6.3 km²</td></tr>
...
show(plot_station_timeseries("08NM216"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM216")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM216/08NM216_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM216/08NM216_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM216"))
:::
...
<div class="download-section">
  <a href="../../08NM216/08NM216_field_visits.csv" download class="download-btn">
