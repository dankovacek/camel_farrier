...
# 08EG018: CLARENCE CREEK NEAR ROSSWOOD
...
result = plot_station_polygon("08EG018")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EG018">stations/08EG018 folder on GitHub</a>.
:::
...
<tr><td>08EG018</td><td>CLARENCE CREEK NEAR ROSSWOOD</td><td>54.993</td><td>-128.807</td><td>7.2 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.97, ΔArea: +2.2%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 6,535 daily observations, seasonal gaps: 133 days avg (N=25) | 13.1% flagged (estimated: 429, backwater: 393, partial day: 33)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 27.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>6,535 daily observations, seasonal gaps: 133 days avg (N=25) | 13.1% flagged (estimated: 429, backwater: 393, partial day: 33) | Record: 27.0 years</td></tr>
...
show(plot_station_timeseries("08EG018"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EG018")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EG018/08EG018_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08EG018/08EG018_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08EG018/08EG018_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Shift during non-operational period.</td>
    </tr>
    <tr>
      <td>27.0</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08EG018"))
:::
