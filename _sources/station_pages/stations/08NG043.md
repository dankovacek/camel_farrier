...
# 08NG043: GOLD CREEK DIVERSION NEAR CRANBROOK
...
result = plot_station_polygon("08NG043")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG043">stations/08NG043 folder on GitHub</a>.
:::
...
<tr><td>08NG043</td><td>GOLD CREEK DIVERSION NEAR CRANBROOK</td><td>49.440</td><td>-115.663</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.96, ΔArea: +3.8%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 37.6 years
<br><strong>Timeseries Summary:</strong> 397 daily observations, seasonal gaps: 13332 days avg (N=1) | 46.9% flagged (estimated: 186)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 22.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>397 daily observations, seasonal gaps: 13332 days avg (N=1) | 46.9% flagged (estimated: 186) | Record: 37.6 years</td></tr>
...
show(plot_station_timeseries("08NG043"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG043")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG043/08NG043_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG043/08NG043_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG043"))
:::
...
<div class="download-section">
  <a href="../../08NG043/08NG043_field_visits.csv" download class="download-btn">
