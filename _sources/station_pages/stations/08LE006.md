...
# 08LE006: PRINGLE CREEK NEAR WESTWOLD
...
result = plot_station_polygon("08LE006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE006">stations/08LE006 folder on GitHub</a>.
:::
...
<tr><td>08LE006</td><td>PRINGLE CREEK NEAR WESTWOLD</td><td>50.479</td><td>-119.820</td><td>15.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 42.4 years
<br><strong>Timeseries Summary:</strong> 4,607 daily observations, seasonal gaps: 454 days avg (N=24) | 17.3% flagged (estimated: 795)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 52.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>4,607 daily observations, seasonal gaps: 454 days avg (N=24) | 17.3% flagged (estimated: 795) | Record: 42.4 years</td></tr>
...
show(plot_station_timeseries("08LE006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE006/08LE006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE006/08LE006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE006"))
:::
