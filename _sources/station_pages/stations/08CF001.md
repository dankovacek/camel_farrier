...
result = plot_station_polygon("08CF001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08CF001">stations/08CF001 folder on GitHub</a>.
:::
...
<tr><td>08CF001</td><td>STIKINE RIVER ABOVE BUTTERFLY CREEK</td><td>57.486</td><td>-131.750</td><td>36000.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.95, ΔArea: +5.7%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 24.2 years
<br><strong>Timeseries Summary:</strong> 8,671 daily observations, seasonal gaps: 184 days avg (N=1) | 46.2% flagged (backwater: 3679, estimated: 294, partial day: 36)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 119910.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>8,671 daily observations, seasonal gaps: 184 days avg (N=1) | 46.2% flagged (backwater: 3679, estimated: 294, partial day: 36) | Record: 24.2 years</td></tr>
...
show(plot_station_timeseries("08CF001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08CF001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08CF001/08CF001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08CF001/08CF001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08CF001"))
:::
...
<div class="download-section">
  <a href="../../08CF001/08CF001_field_visits.csv" download class="download-btn">
