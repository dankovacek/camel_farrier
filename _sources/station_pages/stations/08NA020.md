...
# 08NA020: STODDART CREEK NEAR ATHALMER
...
result = plot_station_polygon("08NA020")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA020">stations/08NA020 folder on GitHub</a>.
:::
...
<tr><td>08NA020</td><td>STODDART CREEK NEAR ATHALMER</td><td>50.568</td><td>-115.991</td><td>21.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 44.5 years
<br><strong>Timeseries Summary:</strong> 4,600 daily observations, seasonal gaps: 2331 days avg (N=5) | 35.1% flagged (estimated: 1606, partial day: 10)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 52.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>4,600 daily observations, seasonal gaps: 2331 days avg (N=5) | 35.1% flagged (estimated: 1606, partial day: 10) | Record: 44.5 years</td></tr>
...
show(plot_station_timeseries("08NA020"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA020")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA020/08NA020_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA020/08NA020_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA020"))
:::
...
<div class="download-section">
  <a href="../../08NA020/08NA020_field_visits.csv" download class="download-btn">
