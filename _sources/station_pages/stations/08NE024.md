...
# 08NE024: MCQUARRIE CREEK NEAR TRAIL
...
result = plot_station_polygon("08NE024")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE024">stations/08NE024 folder on GitHub</a>.
:::
...
<tr><td>08NE024</td><td>MCQUARRIE CREEK NEAR TRAIL</td><td>49.104</td><td>-117.698</td><td>1.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 611 daily observations, seasonal gaps: 202 days avg (N=3) | 39.6% flagged (estimated: 242)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>611 daily observations, seasonal gaps: 202 days avg (N=3) | 39.6% flagged (estimated: 242) | Record: 3.3 years</td></tr>
...
show(plot_station_timeseries("08NE024"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE024")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE024/08NE024_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE024/08NE024_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE024"))
:::
...
<div class="download-section">
  <a href="../../08NE024/08NE024_field_visits.csv" download class="download-btn">
