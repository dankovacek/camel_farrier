...
result = plot_station_polygon("08HB014")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB014">stations/08HB014 folder on GitHub</a>.
:::
...
<tr><td>08HB014</td><td>SARITA RIVER NEAR BAMFIELD</td><td>48.893</td><td>-124.969</td><td>162.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 76.9 years
<br><strong>Timeseries Summary:</strong> 26,908 daily observations, seasonal gaps: 593 days avg (N=2) | 22.7% flagged (estimated: 5604, partial day: 485, backwater: 6)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 374.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>26,908 daily observations, seasonal gaps: 593 days avg (N=2) | 22.7% flagged (estimated: 5604, partial day: 485, backwater: 6) | Record: 76.9 years</td></tr>
...
show(plot_station_timeseries("08HB014"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB014")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB014/08HB014_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08HB014/08HB014_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HB014/08HB014_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>All mmnts since the 20231018 event as well as additional high mmnts.</td>
    </tr>
    <tr>
      <td>59.000</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Approved: Qs > 905 cms (g ht 7.708) are estimates</td>
    </tr>
    <tr>
      <td>56.000</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("08HB014"))
:::
