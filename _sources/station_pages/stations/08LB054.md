...
# 08LB054: PAUL CREEK NEAR KAMLOOPS (STATION B)
...
result = plot_station_polygon("08LB054")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB054">stations/08LB054 folder on GitHub</a>.
:::
...
<tr><td>08LB054</td><td>PAUL CREEK NEAR KAMLOOPS (STATION B)</td><td>50.740</td><td>-120.190</td><td>117.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 244 daily observations, continuous record | 9.0% flagged (estimated: 22)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 389.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>244 daily observations, continuous record | 9.0% flagged (estimated: 22) | Record: 0.7 years</td></tr>
...
show(plot_station_timeseries("08LB054"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB054")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB054/08LB054_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LB054/08LB054_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB054"))
:::
...
<div class="download-section">
  <a href="../../08LB054/08LB054_field_visits.csv" download class="download-btn">
