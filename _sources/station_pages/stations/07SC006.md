...
result = plot_station_polygon("07SC006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07SC006">stations/07SC006 folder on GitHub</a>.
:::
...
<tr><td>07SC006</td><td>FLETCHER LAKE</td><td>63.700</td><td>-108.939</td><td>nan (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3037.6 km²</td></tr>
...
show(plot_station_timeseries("07SC006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07SC006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07SC006/07SC006_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07SC006/07SC006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07SC006"))
:::
