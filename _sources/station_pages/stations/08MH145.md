...
# 08MH145: DOWNES CREEK NEAR CLEARBROOK
...
result = plot_station_polygon("08MH145")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH145">stations/08MH145 folder on GitHub</a>.
:::
...
<tr><td>08MH145</td><td>DOWNES CREEK NEAR CLEARBROOK</td><td>49.075</td><td>-122.326</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 856 daily observations, seasonal gaps: 141 days avg (N=3) | 2.7% flagged (estimated: 23)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 9.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>856 daily observations, seasonal gaps: 141 days avg (N=3) | 2.7% flagged (estimated: 23) | Record: 3.5 years</td></tr>
...
show(plot_station_timeseries("08MH145"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH145")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH145/08MH145_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH145/08MH145_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH145"))
:::
