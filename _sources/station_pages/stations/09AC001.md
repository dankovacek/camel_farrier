...
result = plot_station_polygon("09AC001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09AC001">stations/09AC001 folder on GitHub</a>.
:::
...
<tr><td>09AC001</td><td>TAKHINI RIVER NEAR WHITEHORSE</td><td>60.851</td><td>-135.741</td><td>7050.0 (0.0)</td><td>YT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 76.4 years
<br><strong>Timeseries Summary:</strong> 27,762 daily observations, minor gaps: 50 days avg (N=3) | 56.8% flagged (backwater: 13982, estimated: 1573, partial day: 207)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 27927.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>27,762 daily observations, minor gaps: 50 days avg (N=3) | 56.8% flagged (backwater: 13982, estimated: 1573, partial day: 207) | Record: 76.4 years</td></tr>
...
show(plot_station_timeseries("09AC001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09AC001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09AC001/09AC001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../09AC001/09AC001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../09AC001/09AC001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Quick curve, 16.2 not valid, linear curve that should have been replaced last year</td>
    </tr>
    <tr>
      <td>16.100</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>APPROVED very slight left shift, entire curve</td>
    </tr>
    <tr>
      <td>16.000</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>late fall/winter scour, right shift fm table #15</td>
    </tr>
    <tr>
      <td>15.000</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Low-end adjustment using 1980-2006 mmnts</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("09AC001"))
:::
...
<div class="download-section">
  <a href="../../09AC001/09AC001_field_visits.csv" download class="download-btn">
