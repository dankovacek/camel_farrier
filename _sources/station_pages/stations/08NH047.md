...
# 08NH047: ATHOL CREEK NEAR KASLO
...
result = plot_station_polygon("08NH047")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH047">stations/08NH047 folder on GitHub</a>.
:::
...
<tr><td>08NH047</td><td>ATHOL CREEK NEAR KASLO</td><td>49.948</td><td>-116.912</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.94, ΔArea: +6.4%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 671 daily observations, seasonal gaps: 202 days avg (N=3) | 59.9% flagged (estimated: 402)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>671 daily observations, seasonal gaps: 202 days avg (N=3) | 59.9% flagged (estimated: 402) | Record: 3.5 years</td></tr>
...
show(plot_station_timeseries("08NH047"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH047")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH047/08NH047_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NH047/08NH047_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH047"))
:::
...
<div class="download-section">
  <a href="../../08NH047/08NH047_field_visits.csv" download class="download-btn">
