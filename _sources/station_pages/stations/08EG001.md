...
# 08EG001: BROWN CREEK NEAR PORT ESSINGTON
...
result = plot_station_polygon("08EG001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EG001">stations/08EG001 folder on GitHub</a>.
:::
...
<tr><td>08EG001</td><td>BROWN CREEK NEAR PORT ESSINGTON</td><td>54.027</td><td>-129.841</td><td>56.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 4.0 years
<br><strong>Timeseries Summary:</strong> 1,461 daily observations, continuous record | 56.7% flagged (estimated: 828)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 161.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,461 daily observations, continuous record | 56.7% flagged (estimated: 828) | Record: 4.0 years</td></tr>
...
show(plot_station_timeseries("08EG001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EG001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EG001/08EG001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08EG001/08EG001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08EG001"))
:::
...
<div class="download-section">
  <a href="../../08EG001/08EG001_field_visits.csv" download class="download-btn">
