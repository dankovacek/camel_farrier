...
result = plot_station_polygon("08LB069")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB069">stations/08LB069 folder on GitHub</a>.
:::
...
<tr><td>08LB069</td><td>BARRIERE RIVER BELOW SPRAGUE CREEK</td><td>51.245</td><td>-119.938</td><td>624.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 60.6 years
<br><strong>Timeseries Summary:</strong> 22,068 daily observations, minor gaps: 61 days avg (N=1) | 21.6% flagged (backwater: 3081, estimated: 1421, partial day: 263)</p>

<table class="dataframe table">
<tr><th>Check Category</th><th>Status</th><th>Notes</th></tr>
<tr><td><strong>Data Completeness</strong></td><td>⚠️ Warning</td><td>Missing: field_visits</td></tr>
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1602.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>22,068 daily observations, minor gaps: 61 days avg (N=1) | 21.6% flagged (backwater: 3081, estimated: 1421, partial day: 263) | Record: 60.6 years</td></tr>
...
show(plot_station_timeseries("08LB069"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB069")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB069/08LB069_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08LB069/08LB069_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LB069/08LB069_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB069"))
:::
...
<div class="download-section">
  <a href="../../08LB069/08LB069_field_visits.csv" download class="download-btn">
