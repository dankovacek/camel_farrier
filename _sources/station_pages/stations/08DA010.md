...
result = plot_station_polygon("08DA010")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08DA010">stations/08DA010 folder on GitHub</a>.
:::
...
<tr><td>08DA010</td><td>BELL-IRVING RIVER BELOW BOWSER RIVER</td><td>56.279</td><td>-129.144</td><td>5160.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: +0.8%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 7.2 years
<br><strong>Timeseries Summary:</strong> 2,618 daily observations, continuous record | 36.1% flagged (backwater: 687, estimated: 227, partial day: 31)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 16898.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,618 daily observations, continuous record | 36.1% flagged (backwater: 687, estimated: 227, partial day: 31) | Record: 7.2 years</td></tr>
...
show(plot_station_timeseries("08DA010"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08DA010")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08DA010/08DA010_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08DA010/08DA010_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08DA010"))
:::
...
<div class="download-section">
  <a href="../../08DA010/08DA010_field_visits.csv" download class="download-btn">
