...
# 07FD908: GRIMSHAW DRAINAGE NEAR GRIMSHAW
...
result = plot_station_polygon("07FD908")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07FD908">stations/07FD908 folder on GitHub</a>.
:::
...
<tr><td>07FD908</td><td>GRIMSHAW DRAINAGE NEAR GRIMSHAW</td><td>56.167</td><td>-117.600</td><td>8.1 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.63, ΔArea: +58.9%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 5,048 daily observations, seasonal gaps: 125 days avg (N=20) | 14.2% flagged (backwater: 580, estimated: 114, partial day: 23)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 36.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>5,048 daily observations, seasonal gaps: 125 days avg (N=20) | 14.2% flagged (backwater: 580, estimated: 114, partial day: 23) | Record: 20.7 years</td></tr>
...
show(plot_station_timeseries("07FD908"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07FD908")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07FD908/07FD908_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07FD908/07FD908_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07FD908"))
:::
