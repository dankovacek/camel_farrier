...
# 08NM076: PENTICTON CREEK ABOVE DIVERSION
...
result = plot_station_polygon("08NM076")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM076">stations/08NM076 folder on GitHub</a>.
:::
...
<tr><td>08NM076</td><td>PENTICTON CREEK ABOVE DIVERSION</td><td>49.492</td><td>-119.553</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,280 daily observations, seasonal gaps: 182 days avg (N=4) | 49.4% flagged (estimated: 632)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 416.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,280 daily observations, seasonal gaps: 182 days avg (N=4) | 49.4% flagged (estimated: 632) | Record: 5.5 years</td></tr>
...
show(plot_station_timeseries("08NM076"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM076")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM076/08NM076_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM076/08NM076_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM076"))
:::
...
<div class="download-section">
  <a href="../../08NM076/08NM076_field_visits.csv" download class="download-btn">
