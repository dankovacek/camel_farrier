...
# 08NG030: MAUSE CREEK NEAR FORT STEELE
...
result = plot_station_polygon("08NG030")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG030">stations/08NG030 folder on GitHub</a>.
:::
...
<tr><td>08NG030</td><td>MAUSE CREEK NEAR FORT STEELE</td><td>49.635</td><td>-115.548</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 549 daily observations, seasonal gaps: 182 days avg (N=2) | 56.5% flagged (estimated: 310)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 43.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>549 daily observations, seasonal gaps: 182 days avg (N=2) | 56.5% flagged (estimated: 310) | Record: 2.5 years</td></tr>
...
show(plot_station_timeseries("08NG030"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG030")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG030/08NG030_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG030/08NG030_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG030"))
:::
...
<div class="download-section">
  <a href="../../08NG030/08NG030_field_visits.csv" download class="download-btn">
