...
result = plot_station_polygon("09EB003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09EB003">stations/09EB003 folder on GitHub</a>.
:::
...
<tr><td>09EB003</td><td>INDIAN RIVER ABOVE THE MOUTH</td><td>63.770</td><td>-139.630</td><td>2210.0 (0.0)</td><td>YT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 43.0 years
<br><strong>Timeseries Summary:</strong> 15,675 daily observations, minor gaps: 31 days avg (N=1) | 60.0% flagged (backwater: 8848, estimated: 485, partial day: 68)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 11231.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>15,675 daily observations, minor gaps: 31 days avg (N=1) | 60.0% flagged (backwater: 8848, estimated: 485, partial day: 68) | Record: 43.0 years</td></tr>
...
show(plot_station_timeseries("09EB003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09EB003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09EB003/09EB003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../09EB003/09EB003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../09EB003/09EB003_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Mean Curve approach. Historical mmnt scatter at this location. Using statistical strength of all ope...</td>
    </tr>
    <tr>
      <td>15.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Coincides with #13 above 2.25m.</td>
    </tr>
    <tr>
      <td>13.0</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("09EB003"))
:::
...
<div class="download-section">
  <a href="../../09EB003/09EB003_field_visits.csv" download class="download-btn">
