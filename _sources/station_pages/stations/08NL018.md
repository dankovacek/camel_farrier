...
result = plot_station_polygon("08NL018")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL018">stations/08NL018 folder on GitHub</a>.
:::
...
<tr><td>08NL018</td><td>HAYES CREEK NEAR JURA</td><td>49.524</td><td>-120.411</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 398 daily observations, seasonal gaps: 273 days avg (N=3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1530.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>398 daily observations, seasonal gaps: 273 days avg (N=3) | Record: 3.3 years</td></tr>
...
show(plot_station_timeseries("08NL018"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL018")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL018/08NL018_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NL018/08NL018_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL018"))
:::
