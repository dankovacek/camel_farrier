...
# 08GA010: CAPILANO RIVER ABOVE INTAKE
...
result = plot_station_polygon("08GA010")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA010">stations/08GA010 folder on GitHub</a>.
:::
...
<tr><td>08GA010</td><td>CAPILANO RIVER ABOVE INTAKE</td><td>49.396</td><td>-123.146</td><td>173.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 39,659 daily observations, seasonal gaps: 295 days avg (N=3) | 3.5% flagged (estimated: 835, backwater: 464, partial day: 105)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 412.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>39,659 daily observations, seasonal gaps: 295 days avg (N=3) | 3.5% flagged (estimated: 835, backwater: 464, partial day: 105) | Record: 111.0 years</td></tr>
...
show(plot_station_timeseries("08GA010"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA010")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA010/08GA010_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08GA010/08GA010_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08GA010/08GA010_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA010"))
:::
...
<div class="download-section">
  <a href="../../08GA010/08GA010_field_visits.csv" download class="download-btn">
