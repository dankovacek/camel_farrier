...
result = plot_station_polygon("07SB013")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07SB013">stations/07SB013 folder on GitHub</a>.
:::
...
<tr><td>07SB013</td><td>BAKER CREEK AT OUTLET OF LOWER MARTIN LAKE</td><td>62.514</td><td>-114.410</td><td>121.0 (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: -0.2%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 42.0 years
<br><strong>Timeseries Summary:</strong> 15,127 daily observations, minor gaps: 71 days avg (N=3) | 24.8% flagged (backwater: 3074, estimated: 496, partial day: 180)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 676.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>15,127 daily observations, minor gaps: 71 days avg (N=3) | 24.8% flagged (backwater: 3074, estimated: 496, partial day: 180) | Record: 42.0 years</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07SB013")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07SB013/07SB013_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07SB013/07SB013_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07SB013/07SB013_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Rating of overall best fit  and HIGH STATISTICAL CONFIDENCE, utilizing all historical mmnts between ...</td>
    </tr>
    <tr>
      <td>5.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Rating Curve 5.000 was created in response to recent (ie. acoustic) measurements all plotting consis...</td>
    </tr>
    <tr>
      <td>4.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New curve for 2014 to revise lower end based on trail camera data.</td>
    </tr>
    <tr>
      <td>3.0</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Entire range defined by discharge measurements</td>
    </tr>
    <tr>
      <td>2.0</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07SB013"))
:::
...
<div class="download-section">
  <a href="../../07SB013/07SB013_field_visits.csv" download class="download-btn">
