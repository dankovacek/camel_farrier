...
result = plot_station_polygon("08CA001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08CA001">stations/08CA001 folder on GitHub</a>.
:::
...
<tr><td>08CA001</td><td>SPATSIZI RIVER NEAR THE MOUTH</td><td>57.670</td><td>-128.103</td><td>3400.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 14.7 years
<br><strong>Timeseries Summary:</strong> 5,386 daily observations, continuous record | 52.9% flagged (backwater: 2793, estimated: 55, partial day: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 11947.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>5,386 daily observations, continuous record | 52.9% flagged (backwater: 2793, estimated: 55, partial day: 3) | Record: 14.7 years</td></tr>
...
show(plot_station_timeseries("08CA001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08CA001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08CA001/08CA001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08CA001/08CA001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08CA001"))
:::
...
<div class="download-section">
  <a href="../../08CA001/08CA001_field_visits.csv" download class="download-btn">
