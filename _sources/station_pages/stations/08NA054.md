...
# 08NA054: SUNLIGHT CREEK NEAR INVERMERE
...
result = plot_station_polygon("08NA054")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA054">stations/08NA054 folder on GitHub</a>.
:::
...
<tr><td>08NA054</td><td>SUNLIGHT CREEK NEAR INVERMERE</td><td>50.470</td><td>-116.094</td><td>2.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 92 daily observations, continuous record | 73.9% flagged (estimated: 68)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>92 daily observations, continuous record | 73.9% flagged (estimated: 68) | Record: 0.2 years</td></tr>
...
show(plot_station_timeseries("08NA054"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA054")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA054/08NA054_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA054/08NA054_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA054"))
:::
...
<div class="download-section">
  <a href="../../08NA054/08NA054_field_visits.csv" download class="download-btn">
