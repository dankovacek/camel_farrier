...
result = plot_station_polygon("07BJ001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07BJ001">stations/07BJ001 folder on GitHub</a>.
:::
...
<tr><td>07BJ001</td><td>SWAN RIVER NEAR KINUSO</td><td>55.316</td><td>-115.417</td><td>1900.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 109.7 years
<br><strong>Timeseries Summary:</strong> 22,567 daily observations, seasonal gaps: 1590 days avg (N=11) | 47.0% flagged (backwater: 9567, partial day: 526, estimated: 507)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5731.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>22,567 daily observations, seasonal gaps: 1590 days avg (N=11) | 47.0% flagged (backwater: 9567, partial day: 526, estimated: 507) | Record: 109.7 years</td></tr>
...
show(plot_station_timeseries("07BJ001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07BJ001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07BJ001/07BJ001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07BJ001/07BJ001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07BJ001/07BJ001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Control changed in 2022. Two segment curve for channel control and floodplain. See RMD for more deta...</td>
    </tr>
    <tr>
      <td>26.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Same as Curve#22 converted to GSC datum</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("07BJ001"))
:::
...
<div class="download-section">
  <a href="../../07BJ001/07BJ001_field_visits.csv" download class="download-btn">
