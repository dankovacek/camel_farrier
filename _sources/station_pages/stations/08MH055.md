...
result = plot_station_polygon("08MH055")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH055">stations/08MH055 folder on GitHub</a>.
:::
...
<tr><td>08MH055</td><td>CHILLIWACK RIVER BELOW SLESSE CREEK</td><td>49.082</td><td>-121.721</td><td>860.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 6.1 years
<br><strong>Timeseries Summary:</strong> 2,222 daily observations, continuous record | 11.7% flagged (estimated: 237, partial day: 23)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1969.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,222 daily observations, continuous record | 11.7% flagged (estimated: 237, partial day: 23) | Record: 6.1 years</td></tr>
...
show(plot_station_timeseries("08MH055"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH055")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH055/08MH055_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH055/08MH055_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH055"))
:::
...
<div class="download-section">
  <a href="../../08MH055/08MH055_field_visits.csv" download class="download-btn">
