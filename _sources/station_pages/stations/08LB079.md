...
# 08LB079: AVOLA CREEK (SOUTH FORK) NEAR AVOLA
...
result = plot_station_polygon("08LB079")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB079">stations/08LB079 folder on GitHub</a>.
:::
...
<tr><td>08LB079</td><td>AVOLA CREEK (SOUTH FORK) NEAR AVOLA</td><td>51.782</td><td>-119.326</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.98, ΔArea: +1.1%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 0.6 years
<br><strong>Timeseries Summary:</strong> 184 daily observations, minor gaps: 30 days avg (N=1) | 0.5% flagged (estimated: 1)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 10.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>184 daily observations, minor gaps: 30 days avg (N=1) | 0.5% flagged (estimated: 1) | Record: 0.6 years</td></tr>
...
show(plot_station_timeseries("08LB079"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB079")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB079/08LB079_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LB079/08LB079_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB079"))
:::
...
<div class="download-section">
  <a href="../../08LB079/08LB079_field_visits.csv" download class="download-btn">
