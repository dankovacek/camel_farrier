...
# 08NA018: SINCLAIR CREEK AT RADIUM HOT SPRINGS
...
result = plot_station_polygon("08NA018")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA018">stations/08NA018 folder on GitHub</a>.
:::
...
<tr><td>08NA018</td><td>SINCLAIR CREEK AT RADIUM HOT SPRINGS</td><td>50.629</td><td>-116.067</td><td>94.3 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 64.5 years
<br><strong>Timeseries Summary:</strong> 9,711 daily observations, seasonal gaps: 1154 days avg (N=12) | 22.3% flagged (estimated: 1968, backwater: 200)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 234.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>9,711 daily observations, seasonal gaps: 1154 days avg (N=12) | 22.3% flagged (estimated: 1968, backwater: 200) | Record: 64.5 years</td></tr>
...
show(plot_station_timeseries("08NA018"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA018")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA018/08NA018_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA018/08NA018_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA018"))
:::
...
<div class="download-section">
  <a href="../../08NA018/08NA018_field_visits.csv" download class="download-btn">
