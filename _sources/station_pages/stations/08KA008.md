...
result = plot_station_polygon("08KA008")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KA008">stations/08KA008 folder on GitHub</a>.
:::
...
<tr><td>08KA008</td><td>MOOSE RIVER NEAR RED PASS</td><td>52.920</td><td>-118.800</td><td>458.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 14,734 daily observations, seasonal gaps: 90 days avg (N=1) | 50.8% flagged (backwater: 6102, estimated: 1312, partial day: 78)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1263.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>14,734 daily observations, seasonal gaps: 90 days avg (N=1) | 50.8% flagged (backwater: 6102, estimated: 1312, partial day: 78) | Record: 40.6 years</td></tr>
...
show(plot_station_timeseries("08KA008"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KA008")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KA008/08KA008_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KA008/08KA008_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KA008"))
:::
