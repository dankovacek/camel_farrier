...
# 08HE002: MARBLE RIVER AT OUTLET OF VICTORIA LAKE
...
result = plot_station_polygon("08HE002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HE002">stations/08HE002 folder on GitHub</a>.
:::
...
<tr><td>08HE002</td><td>MARBLE RIVER AT OUTLET OF VICTORIA LAKE</td><td>50.430</td><td>-127.404</td><td>122.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 28.2 years
<br><strong>Timeseries Summary:</strong> 8,521 daily observations, seasonal gaps: 898 days avg (N=2) | 0.3% flagged (estimated: 29)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 307.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>8,521 daily observations, seasonal gaps: 898 days avg (N=2) | 0.3% flagged (estimated: 29) | Record: 28.2 years</td></tr>
...
show(plot_station_timeseries("08HE002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HE002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HE002/08HE002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HE002/08HE002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HE002"))
:::
...
<div class="download-section">
  <a href="../../08HE002/08HE002_field_visits.csv" download class="download-btn">
