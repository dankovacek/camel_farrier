...
# 08HA009: COWICHAN LAKE NEAR LAKE COWICHAN
...
result = plot_station_polygon("08HA009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HA009">stations/08HA009 folder on GitHub</a>.
:::
...
<tr><td>08HA009</td><td>COWICHAN LAKE NEAR LAKE COWICHAN</td><td>48.824</td><td>-124.062</td><td>nan (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1356.7 km²</td></tr>
...
show(plot_station_timeseries("08HA009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HA009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HA009/08HA009_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HA009/08HA009_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HA009"))
:::
