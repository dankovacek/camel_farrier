...
# 08NE094: CAI CREEK NEAR BRILLIANT
...
result = plot_station_polygon("08NE094")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE094">stations/08NE094 folder on GitHub</a>.
:::
...
<tr><td>08NE094</td><td>CAI CREEK NEAR BRILLIANT</td><td>49.267</td><td>-117.624</td><td>2.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 3.2 years
<br><strong>Timeseries Summary:</strong> 428 daily observations, seasonal gaps: 253 days avg (N=3) | 52.8% flagged (estimated: 226)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>428 daily observations, seasonal gaps: 253 days avg (N=3) | 52.8% flagged (estimated: 226) | Record: 3.2 years</td></tr>
...
show(plot_station_timeseries("08NE094"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE094")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE094/08NE094_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE094/08NE094_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE094"))
:::
