...
# 08FA007: OWIKENO LAKE AT RIVERS INLET
...
result = plot_station_polygon("08FA007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08FA007">stations/08FA007 folder on GitHub</a>.
:::
...
<tr><td>08FA007</td><td>OWIKENO LAKE AT RIVERS INLET</td><td>51.692</td><td>-127.167</td><td>nan (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 10349.6 km²</td></tr>
...
show(plot_station_timeseries("08FA007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08FA007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08FA007/08FA007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08FA007/08FA007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08FA007"))
:::
...
<div class="download-section">
  <a href="../../08FA007/08FA007_field_visits.csv" download class="download-btn">
