...
The data used in generating the plots and tables on this page can be downloaded from the [stations/10ED001](https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10ED001) folder in the Github repository.
