...
# 08GA056: SENTINEL CREEK ABOVE GARIBALDI LAKE
...
result = plot_station_polygon("08GA056")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA056">stations/08GA056 folder on GitHub</a>.
:::
...
<tr><td>08GA056</td><td>SENTINEL CREEK ABOVE GARIBALDI LAKE</td><td>49.903</td><td>-122.997</td><td>5.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,509 daily observations, seasonal gaps: 211 days avg (N=18) | 8.1% flagged (estimated: 110, partial day: 61, backwater: 31)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 11.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,509 daily observations, seasonal gaps: 211 days avg (N=18) | 8.1% flagged (estimated: 110, partial day: 61, backwater: 31) | Record: 17.2 years</td></tr>
...
show(plot_station_timeseries("08GA056"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA056")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA056/08GA056_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08GA056/08GA056_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08GA056"))
:::
