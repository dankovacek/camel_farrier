...
# 08HD012: SPRINGER CREEK NEAR SAYWARD
...
result = plot_station_polygon("08HD012")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HD012">stations/08HD012 folder on GitHub</a>.
:::
...
<tr><td>08HD012</td><td>SPRINGER CREEK NEAR SAYWARD</td><td>50.340</td><td>-125.906</td><td>17.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,614 daily observations, continuous record | 34.6% flagged (estimated: 526, backwater: 32)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 34.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,614 daily observations, continuous record | 34.6% flagged (estimated: 526, backwater: 32) | Record: 4.4 years</td></tr>
...
show(plot_station_timeseries("08HD012"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HD012")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HD012/08HD012_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HD012/08HD012_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HD012"))
:::
