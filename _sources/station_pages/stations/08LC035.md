...
# 08LC035: FORTUNE CREEK NEAR ARMSTRONG
...
result = plot_station_polygon("08LC035")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LC035">stations/08LC035 folder on GitHub</a>.
:::
...
<tr><td>08LC035</td><td>FORTUNE CREEK NEAR ARMSTRONG</td><td>50.438</td><td>-119.142</td><td>41.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 73.4 years
<br><strong>Timeseries Summary:</strong> 8,799 daily observations, seasonal gaps: 4504 days avg (N=4) | 6.0% flagged (estimated: 421, backwater: 110)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 103.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>8,799 daily observations, seasonal gaps: 4504 days avg (N=4) | 6.0% flagged (estimated: 421, backwater: 110) | Record: 73.4 years</td></tr>
...
show(plot_station_timeseries("08LC035"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LC035")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LC035/08LC035_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LC035/08LC035_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LC035"))
:::
...
<div class="download-section">
  <a href="../../08LC035/08LC035_field_visits.csv" download class="download-btn">
