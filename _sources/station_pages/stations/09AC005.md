...
# 09AC005: KUSAWA LAKE NEAR WHITEHORSE
...
result = plot_station_polygon("09AC005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09AC005">stations/09AC005 folder on GitHub</a>.
:::
...
<tr><td>09AC005</td><td>KUSAWA LAKE NEAR WHITEHORSE</td><td>60.588</td><td>-136.144</td><td>nan (0.0)</td><td>YT</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 16515.2 km²</td></tr>
...
show(plot_station_timeseries("09AC005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09AC005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09AC005/09AC005_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../09AC005/09AC005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("09AC005"))
:::
...
<div class="download-section">
  <a href="../../09AC005/09AC005_field_visits.csv" download class="download-btn">
