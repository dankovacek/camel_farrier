...
# 10VC006: UNNAMED RIVER ABOVE BRACEBRIDGE INLET
...
result = plot_station_polygon("10VC006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10VC006">stations/10VC006 folder on GitHub</a>.
:::
...
<tr><td>10VC006</td><td>UNNAMED RIVER ABOVE BRACEBRIDGE INLET</td><td>75.700</td><td>-100.550</td><td>510.0 (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 8564.4 km²</td></tr>
...
show(plot_station_timeseries("10VC006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10VC006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10VC006/10VC006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10VC006"))
:::
...
<div class="download-section">
  <a href="../../10VC006/10VC006_field_visits.csv" download class="download-btn">
