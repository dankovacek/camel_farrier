...
result = plot_station_polygon("08LF063")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF063">stations/08LF063 folder on GitHub</a>.
:::
...
<tr><td>08LF063</td><td>GLADWIN CREEK NEAR LYTTON</td><td>50.247</td><td>-121.484</td><td>5.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 824 daily observations, seasonal gaps: 132 days avg (N=6) | 49.8% flagged (estimated: 409, backwater: 1)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 23.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>824 daily observations, seasonal gaps: 132 days avg (N=6) | 49.8% flagged (estimated: 409, backwater: 1) | Record: 4.4 years</td></tr>
...
show(plot_station_timeseries("08LF063"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF063")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF063/08LF063_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF063/08LF063_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF063"))
:::
...
<div class="download-section">
  <a href="../../08LF063/08LF063_field_visits.csv" download class="download-btn">
