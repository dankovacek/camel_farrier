...
# 10MD002: BABBAGE RIVER BELOW CARIBOU CREEK
...
result = plot_station_polygon("10MD002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10MD002">stations/10MD002 folder on GitHub</a>.
:::
...
<tr><td>10MD002</td><td>BABBAGE RIVER BELOW CARIBOU CREEK</td><td>68.839</td><td>-138.668</td><td>1500.0 (0.0)</td><td>YT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 18.4 years
<br><strong>Timeseries Summary:</strong> 6,361 daily observations, seasonal gaps: 92 days avg (N=4) | 70.1% flagged (backwater: 4304, estimated: 109, partial day: 47)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 11464.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>6,361 daily observations, seasonal gaps: 92 days avg (N=4) | 70.1% flagged (backwater: 4304, estimated: 109, partial day: 47) | Record: 18.4 years</td></tr>
...
show(plot_station_timeseries("10MD002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10MD002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10MD002/10MD002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../10MD002/10MD002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10MD002"))
:::
