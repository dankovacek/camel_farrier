...
# 08MH011: STAVE RIVER AT STAVE FALLS
...
result = plot_station_polygon("08MH011")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH011">stations/08MH011 folder on GitHub</a>.
:::
...
<tr><td>08MH011</td><td>STAVE RIVER AT STAVE FALLS</td><td>49.229</td><td>-122.355</td><td>1140.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,861 daily observations, seasonal gaps: 568 days avg (N=3) | 0.3% flagged (estimated: 10)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2264.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,861 daily observations, seasonal gaps: 568 days avg (N=3) | 0.3% flagged (estimated: 10) | Record: 12.5 years</td></tr>
...
show(plot_station_timeseries("08MH011"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH011")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH011/08MH011_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08MH011/08MH011_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08MH011/08MH011_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH011"))
:::
...
<div class="download-section">
  <a href="../../08MH011/08MH011_field_visits.csv" download class="download-btn">
