...
# 08LG027: KWINSHATIN CREEK NEAR MERRITT
...
result = plot_station_polygon("08LG027")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG027">stations/08LG027 folder on GitHub</a>.
:::
...
<tr><td>08LG027</td><td>KWINSHATIN CREEK NEAR MERRITT</td><td>50.024</td><td>-120.833</td><td>18.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 46.8 km²</td></tr>
...
show(plot_station_timeseries("08LG027"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG027")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG027/08LG027_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LG027/08LG027_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LG027"))
:::
...
<div class="download-section">
  <a href="../../08LG027/08LG027_field_visits.csv" download class="download-btn">
