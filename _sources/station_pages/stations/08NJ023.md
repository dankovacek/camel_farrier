...
# 08NJ023: SANDY CREEK NEAR NELSON
...
result = plot_station_polygon("08NJ023")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ023">stations/08NJ023 folder on GitHub</a>.
:::
...
<tr><td>08NJ023</td><td>SANDY CREEK NEAR NELSON</td><td>49.479</td><td>-117.357</td><td>11.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 11.9 years
<br><strong>Timeseries Summary:</strong> 580 daily observations, seasonal gaps: 539 days avg (N=7) | 27.4% flagged (estimated: 159)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 26.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>580 daily observations, seasonal gaps: 539 days avg (N=7) | 27.4% flagged (estimated: 159) | Record: 11.9 years</td></tr>
...
show(plot_station_timeseries("08NJ023"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ023")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ023/08NJ023_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ023/08NJ023_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ023"))
:::
...
<div class="download-section">
  <a href="../../08NJ023/08NJ023_field_visits.csv" download class="download-btn">
