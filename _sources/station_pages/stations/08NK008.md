...
# 08NK008: MAGUIRE CREEK NEAR GRASMERE
...
result = plot_station_polygon("08NK008")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NK008">stations/08NK008 folder on GitHub</a>.
:::
...
<tr><td>08NK008</td><td>MAGUIRE CREEK NEAR GRASMERE</td><td>49.176</td><td>-115.096</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 34.2 years
<br><strong>Timeseries Summary:</strong> 306 daily observations, seasonal gaps: 6087 days avg (N=2) | 52.9% flagged (estimated: 162)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 40.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>306 daily observations, seasonal gaps: 6087 days avg (N=2) | 52.9% flagged (estimated: 162) | Record: 34.2 years</td></tr>
...
show(plot_station_timeseries("08NK008"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NK008")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NK008/08NK008_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NK008/08NK008_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NK008"))
:::
...
<div class="download-section">
  <a href="../../08NK008/08NK008_field_visits.csv" download class="download-btn">
