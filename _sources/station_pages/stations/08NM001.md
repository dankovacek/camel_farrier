...
# 08NM001: OKANAGAN RIVER NEAR FAIRVIEW
...
result = plot_station_polygon("08NM001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM001">stations/08NM001 folder on GitHub</a>.
:::
...
<tr><td>08NM001</td><td>OKANAGAN RIVER NEAR FAIRVIEW</td><td>49.136</td><td>-119.578</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.97, ΔArea: -1.9%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 275 daily observations, continuous record | 40.4% flagged (estimated: 111)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 18354.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>275 daily observations, continuous record | 40.4% flagged (estimated: 111) | Record: 0.8 years</td></tr>
...
show(plot_station_timeseries("08NM001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM001/08NM001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM001/08NM001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM001"))
:::
...
<div class="download-section">
  <a href="../../08NM001/08NM001_field_visits.csv" download class="download-btn">
