...
# 08LE015: NEDS CREEK NEAR PRITCHARD (LOWER STATION)
...
result = plot_station_polygon("08LE015")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE015">stations/08LE015 folder on GitHub</a>.
:::
...
<tr><td>08LE015</td><td>NEDS CREEK NEAR PRITCHARD (LOWER STATION)</td><td>50.667</td><td>-119.839</td><td>15.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 16.3 years
<br><strong>Timeseries Summary:</strong> 1,647 daily observations, seasonal gaps: 432 days avg (N=10) | 27.4% flagged (estimated: 451)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 97.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,647 daily observations, seasonal gaps: 432 days avg (N=10) | 27.4% flagged (estimated: 451) | Record: 16.3 years</td></tr>
...
show(plot_station_timeseries("08LE015"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE015")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE015/08LE015_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE015/08LE015_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE015"))
:::
...
<div class="download-section">
  <a href="../../08LE015/08LE015_field_visits.csv" download class="download-btn">
