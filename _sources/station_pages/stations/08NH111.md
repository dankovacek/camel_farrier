...
result = plot_station_polygon("08NH111")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NH111">stations/08NH111 folder on GitHub</a>.
:::
...
<tr><td>08NH111</td><td>MOYIE LAKE AT MOYIE</td><td>49.290</td><td>-115.833</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1648.9 km²</td></tr>
...
show(plot_station_timeseries("08NH111"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NH111")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NH111/08NH111_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NH111/08NH111_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NH111"))
:::
...
<div class="download-section">
  <a href="../../08NH111/08NH111_field_visits.csv" download class="download-btn">
