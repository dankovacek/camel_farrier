...
result = plot_station_polygon("07FD009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07FD009">stations/07FD009 folder on GitHub</a>.
:::
...
<tr><td>07FD009</td><td>CLEAR RIVER NEAR BEAR CANYON</td><td>56.308</td><td>-119.680</td><td>2880.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 14,001 daily observations, seasonal gaps: 104 days avg (N=54) | 29.8% flagged (backwater: 2877, estimated: 852, partial day: 443)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 9408.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>14,001 daily observations, seasonal gaps: 104 days avg (N=54) | 29.8% flagged (backwater: 2877, estimated: 852, partial day: 443) | Record: 53.7 years</td></tr>
...
show(plot_station_timeseries("07FD009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07FD009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07FD009/07FD009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07FD009/07FD009_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07FD009/07FD009_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>See document 'P:Record07FD009201507FD009_20160218_C15.0_RDT.doc' for detailed information.</td>
    </tr>
    <tr>
      <td>14.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>UPPER END BASED ON MMNTS AT OLD LOCATION</td>
    </tr>
    <tr>
      <td>13.000-SC2</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07FD009"))
:::
...
<div class="download-section">
  <a href="../../07FD009/07FD009_field_visits.csv" download class="download-btn">
