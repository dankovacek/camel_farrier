...
# 08LG020: SPAHOMIN CREEK AT OUTLET OF PENNASK LAKE
...
result = plot_station_polygon("08LG020")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG020">stations/08LG020 folder on GitHub</a>.
:::
...
<tr><td>08LG020</td><td>SPAHOMIN CREEK AT OUTLET OF PENNASK LAKE</td><td>50.028</td><td>-120.118</td><td>130.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 5,863 daily observations, seasonal gaps: 423 days avg (N=23) | 16.6% flagged (backwater: 804, estimated: 170, partial day: 1)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 300.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>5,863 daily observations, seasonal gaps: 423 days avg (N=23) | 16.6% flagged (backwater: 804, estimated: 170, partial day: 1) | Record: 42.7 years</td></tr>
...
show(plot_station_timeseries("08LG020"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG020")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG020/08LG020_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LG020/08LG020_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LG020"))
:::
