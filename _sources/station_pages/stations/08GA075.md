...
The data used in generating the plots and tables on this page can be downloaded from the [stations/08GA075](https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA075) folder in the Github repository.
