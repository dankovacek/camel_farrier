...
result = plot_station_polygon("09AA014")
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09AA014")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09AA014/09AA014_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../09AA014/09AA014_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("09AA014"))
:::
