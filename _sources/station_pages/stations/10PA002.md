...
# 10PA002: YAMBA RIVER BELOW DARING LAKE
...
result = plot_station_polygon("10PA002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10PA002">stations/10PA002 folder on GitHub</a>.
:::
...
<tr><td>10PA002</td><td>YAMBA RIVER BELOW DARING LAKE</td><td>64.807</td><td>-111.678</td><td>2012.0 (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 24.7 years
<br><strong>Timeseries Summary:</strong> 8,772 daily observations, minor gaps: 60 days avg (N=4) | 60.9% flagged (backwater: 5216, estimated: 89, partial day: 37)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 17153.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>8,772 daily observations, minor gaps: 60 days avg (N=4) | 60.9% flagged (backwater: 5216, estimated: 89, partial day: 37) | Record: 24.7 years</td></tr>
...
show(plot_station_timeseries("10PA002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10PA002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10PA002/10PA002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10PA002/10PA002_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10PA002/10PA002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10PA002"))
:::
...
<div class="download-section">
  <a href="../../10PA002/10PA002_field_visits.csv" download class="download-btn">
