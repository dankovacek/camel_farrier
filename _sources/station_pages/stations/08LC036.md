...
# 08LC036: GARDOM CREEK NEAR GRINDROD
...
result = plot_station_polygon("08LC036")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LC036">stations/08LC036 folder on GitHub</a>.
:::
...
<tr><td>08LC036</td><td>GARDOM CREEK NEAR GRINDROD</td><td>50.612</td><td>-119.150</td><td>25.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 855 daily observations, seasonal gaps: 190 days avg (N=4) | 1.4% flagged (estimated: 12)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 106.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>855 daily observations, seasonal gaps: 190 days avg (N=4) | 1.4% flagged (estimated: 12) | Record: 4.4 years</td></tr>
...
show(plot_station_timeseries("08LC036"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LC036")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LC036/08LC036_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LC036/08LC036_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LC036"))
:::
...
<div class="download-section">
  <a href="../../08LC036/08LC036_field_visits.csv" download class="download-btn">
