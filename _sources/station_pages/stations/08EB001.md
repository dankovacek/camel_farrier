...
# 08EB001: SKEENA RIVER AT HAZELTON
...
result = plot_station_polygon("08EB001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EB001">stations/08EB001 folder on GitHub</a>.
:::
...
<tr><td>08EB001</td><td>SKEENA RIVER AT HAZELTON</td><td>55.257</td><td>-127.676</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 184 daily observations, continuous record</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 82114.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>184 daily observations, continuous record | Record: 0.5 years</td></tr>
...
show(plot_station_timeseries("08EB001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EB001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EB001/08EB001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08EB001/08EB001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08EB001"))
:::
...
<div class="download-section">
  <a href="../../08EB001/08EB001_field_visits.csv" download class="download-btn">
