...
# 08NA045: COLUMBIA RIVER NEAR FAIRMONT HOT SPRINGS
...
result = plot_station_polygon("08NA045")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NA045">stations/08NA045 folder on GitHub</a>.
:::
...
<tr><td>08NA045</td><td>COLUMBIA RIVER NEAR FAIRMONT HOT SPRINGS</td><td>50.324</td><td>-115.863</td><td>891.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 18,932 daily observations, continuous record | 8.8% flagged (estimated: 1337, backwater: 170, partial day: 164)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2180.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>18,932 daily observations, continuous record | 8.8% flagged (estimated: 1337, backwater: 170, partial day: 164) | Record: 51.8 years</td></tr>
...
show(plot_station_timeseries("08NA045"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NA045")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NA045/08NA045_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NA045/08NA045_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NA045"))
:::
...
<div class="download-section">
  <a href="../../08NA045/08NA045_field_visits.csv" download class="download-btn">
