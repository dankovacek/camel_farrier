...
# 07HA002: HEART RIVER AT PEACE RIVER
...
result = plot_station_polygon("07HA002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07HA002">stations/07HA002 folder on GitHub</a>.
:::
...
<tr><td>07HA002</td><td>HEART RIVER AT PEACE RIVER</td><td>56.231</td><td>-117.286</td><td>2250.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,315 daily observations, continuous record | 43.2% flagged (backwater: 988, estimated: 13)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 7309.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,315 daily observations, continuous record | 43.2% flagged (backwater: 988, estimated: 13) | Record: 6.3 years</td></tr>
...
show(plot_station_timeseries("07HA002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07HA002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07HA002/07HA002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07HA002/07HA002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07HA002"))
:::
...
<div class="download-section">
  <a href="../../07HA002/07HA002_field_visits.csv" download class="download-btn">
