...
# 08NM002: OKANAGAN RIVER AT OKANAGAN FALLS
...
result = plot_station_polygon("08NM002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM002">stations/08NM002 folder on GitHub</a>.
:::
...
<tr><td>08NM002</td><td>OKANAGAN RIVER AT OKANAGAN FALLS</td><td>49.342</td><td>-119.580</td><td>6720.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 110.0 years
<br><strong>Timeseries Summary:</strong> 40,118 daily observations, minor gaps: 60 days avg (N=1) | 4.3% flagged (estimated: 1446, backwater: 182, partial day: 96)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 16044.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>40,118 daily observations, minor gaps: 60 days avg (N=1) | 4.3% flagged (estimated: 1446, backwater: 182, partial day: 96) | Record: 110.0 years</td></tr>
...
show(plot_station_timeseries("08NM002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM002/08NM002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NM002/08NM002_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NM002/08NM002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM002"))
:::
...
<div class="download-section">
  <a href="../../08NM002/08NM002_field_visits.csv" download class="download-btn">
