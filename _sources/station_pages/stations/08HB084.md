...
# 08HB084: PUNTLEDGE RIVER BELOW DIVERSION
...
result = plot_station_polygon("08HB084")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB084">stations/08HB084 folder on GitHub</a>.
:::
...
<tr><td>08HB084</td><td>PUNTLEDGE RIVER BELOW DIVERSION</td><td>49.668</td><td>-125.087</td><td>479.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 31.7 years
<br><strong>Timeseries Summary:</strong> 11,568 daily observations, continuous record | 0.6% flagged (partial day: 55, estimated: 15)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1122.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>11,568 daily observations, continuous record | 0.6% flagged (partial day: 55, estimated: 15) | Record: 31.7 years</td></tr>
...
show(plot_station_timeseries("08HB084"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB084")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB084/08HB084_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08HB084/08HB084_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HB084/08HB084_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HB084"))
:::
...
<div class="download-section">
  <a href="../../08HB084/08HB084_field_visits.csv" download class="download-btn">
