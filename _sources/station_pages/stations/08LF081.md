...
result = plot_station_polygon("08LF081")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF081">stations/08LF081 folder on GitHub</a>.
:::
...
<tr><td>08LF081</td><td>AMBUSTEN CREEK NEAR THE MOUTH</td><td>50.737</td><td>-121.576</td><td>32.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 21.7 years
<br><strong>Timeseries Summary:</strong> 7,915 daily observations, continuous record | 42.0% flagged (backwater: 3033, estimated: 246, partial day: 45)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 81.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>7,915 daily observations, continuous record | 42.0% flagged (backwater: 3033, estimated: 246, partial day: 45) | Record: 21.7 years</td></tr>
...
show(plot_station_timeseries("08LF081"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF081")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF081/08LF081_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF081/08LF081_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF081"))
:::
...
<div class="download-section">
  <a href="../../08LF081/08LF081_field_visits.csv" download class="download-btn">
