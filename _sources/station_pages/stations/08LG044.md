...
# 08LG044: STUMPLAKE CREEK (BELOW FORKS) NEAR QUILCHENA
...
result = plot_station_polygon("08LG044")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG044">stations/08LG044 folder on GitHub</a>.
:::
...
<tr><td>08LG044</td><td>STUMPLAKE CREEK (BELOW FORKS) NEAR QUILCHENA</td><td>50.386</td><td>-120.192</td><td>44.5 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 245 daily observations, seasonal gaps: 212 days avg (N=1) | 26.5% flagged (estimated: 65)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 110.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>245 daily observations, seasonal gaps: 212 days avg (N=1) | 26.5% flagged (estimated: 65) | Record: 1.2 years</td></tr>
...
show(plot_station_timeseries("08LG044"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG044")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG044/08LG044_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LG044/08LG044_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LG044"))
:::
