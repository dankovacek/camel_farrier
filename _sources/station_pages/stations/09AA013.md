...
result = plot_station_polygon("09AA013")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09AA013">stations/09AA013 folder on GitHub</a>.
:::
...
<tr><td>09AA013</td><td>TUTSHI RIVER AT OUTLET OF TUTSHI LAKE</td><td>59.948</td><td>-134.333</td><td>989.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-03-10</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: +0.9%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 67.5 years
<br><strong>Timeseries Summary:</strong> 23,074 daily observations, seasonal gaps: 122 days avg (N=13) | 35.5% flagged (backwater: 5472, estimated: 2530, partial day: 188)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3905.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>23,074 daily observations, seasonal gaps: 122 days avg (N=13) | 35.5% flagged (backwater: 5472, estimated: 2530, partial day: 188) | Record: 67.5 years</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09AA013")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09AA013/09AA013_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../09AA013/09AA013_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../09AA013/09AA013_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Rating constructed with 2000-Present measurements. Acoustic measurements from 2016-2023 between the ...</td>
    </tr>
    <tr>
      <td>19.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>APPROVED COINCIDENT TO TABLE 15 AT AND ABOVE 12.3</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("09AA013"))
:::
...
<div class="download-section">
  <a href="../../09AA013/09AA013_field_visits.csv" download class="download-btn">
