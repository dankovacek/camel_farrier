...
# 08NG028: EIMER CREEK NEAR KIMBERLEY
...
result = plot_station_polygon("08NG028")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG028">stations/08NG028 folder on GitHub</a>.
:::
...
<tr><td>08NG028</td><td>EIMER CREEK NEAR KIMBERLEY</td><td>49.669</td><td>-115.981</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.73, ΔArea: -24.1%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 16.5 years
<br><strong>Timeseries Summary:</strong> 550 daily observations, seasonal gaps: 1826 days avg (N=3) | 13.6% flagged (estimated: 75)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>550 daily observations, seasonal gaps: 1826 days avg (N=3) | 13.6% flagged (estimated: 75) | Record: 16.5 years</td></tr>
...
show(plot_station_timeseries("08NG028"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG028")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG028/08NG028_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG028/08NG028_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG028"))
:::
...
<div class="download-section">
  <a href="../../08NG028/08NG028_field_visits.csv" download class="download-btn">
