...
The data representing the above plots can be downloaded from the [stations/10FB005](https://dankovacek.github.io/camel_farrier/stations/10FB005) folder in the Github repository.
