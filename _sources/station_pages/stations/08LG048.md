...
result = plot_station_polygon("08LG048")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG048">stations/08LG048 folder on GitHub</a>.
:::
...
<tr><td>08LG048</td><td>COLDWATER RIVER NEAR BROOKMERE</td><td>49.856</td><td>-120.909</td><td>316.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 59.3 years
<br><strong>Timeseries Summary:</strong> 21,551 daily observations, minor gaps: 60 days avg (N=2) | 27.3% flagged (backwater: 4981, estimated: 834, partial day: 68)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 752.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>21,551 daily observations, minor gaps: 60 days avg (N=2) | 27.3% flagged (backwater: 4981, estimated: 834, partial day: 68) | Record: 59.3 years</td></tr>
...
show(plot_station_timeseries("08LG048"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG048")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG048/08LG048_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08LG048/08LG048_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LG048/08LG048_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Clone of 49.00 with slight adjustments made as more measurements have been collected to determine mo...</td>
    </tr>
    <tr>
      <td>49.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>First rating at new site, located 300m d/s from old gauge</td>
    </tr>
    <tr>
      <td>48.02</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extension to upper end, again on 2021-11-15</td>
    </tr>
    <tr>
      <td>48.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extension to upper end</td>
    </tr>
    <tr>
      <td>48.00</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08LG048"))
:::
