...
# 08NG069: GOLD CREEK ABOVE DIVERSION
...
result = plot_station_polygon("08NG069")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG069">stations/08NG069 folder on GitHub</a>.
:::
...
<tr><td>08NG069</td><td>GOLD CREEK ABOVE DIVERSION</td><td>49.376</td><td>-115.632</td><td>84.7 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 183 daily observations, continuous record | 63.9% flagged (estimated: 117)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 206.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>183 daily observations, continuous record | 63.9% flagged (estimated: 117) | Record: 0.5 years</td></tr>
...
show(plot_station_timeseries("08NG069"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG069")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG069/08NG069_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG069/08NG069_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG069"))
:::
...
<div class="download-section">
  <a href="../../08NG069/08NG069_field_visits.csv" download class="download-btn">
