...
# 08NE027: FERGUSON CREEK NEAR EDGEWOOD
...
result = plot_station_polygon("08NE027")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE027">stations/08NE027 folder on GitHub</a>.
:::
...
<tr><td>08NE027</td><td>FERGUSON CREEK NEAR EDGEWOOD</td><td>49.850</td><td>-118.169</td><td>1.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.96, ΔArea: +0.0%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 34.3 years
<br><strong>Timeseries Summary:</strong> 672 daily observations, seasonal gaps: 2967 days avg (N=4) | 44.8% flagged (estimated: 301)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>672 daily observations, seasonal gaps: 2967 days avg (N=4) | 44.8% flagged (estimated: 301) | Record: 34.3 years</td></tr>
...
show(plot_station_timeseries("08NE027"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE027")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE027/08NE027_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE027/08NE027_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE027"))
:::
...
<div class="download-section">
  <a href="../../08NE027/08NE027_field_visits.csv" download class="download-btn">
