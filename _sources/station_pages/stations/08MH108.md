...
# 08MH108: JACOBS CREEK ABOVE JACOBS LAKE
...
result = plot_station_polygon("08MH108")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH108">stations/08MH108 folder on GitHub</a>.
:::
...
<tr><td>08MH108</td><td>JACOBS CREEK ABOVE JACOBS LAKE</td><td>49.319</td><td>-122.547</td><td>12.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 14.4 years
<br><strong>Timeseries Summary:</strong> 5,176 daily observations, minor gaps: 45 days avg (N=2) | 9.6% flagged (estimated: 315, backwater: 153, partial day: 28)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 20.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>5,176 daily observations, minor gaps: 45 days avg (N=2) | 9.6% flagged (estimated: 315, backwater: 153, partial day: 28) | Record: 14.4 years</td></tr>
...
show(plot_station_timeseries("08MH108"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH108")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH108/08MH108_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH108/08MH108_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH108"))
:::
...
<div class="download-section">
  <a href="../../08MH108/08MH108_field_visits.csv" download class="download-btn">
