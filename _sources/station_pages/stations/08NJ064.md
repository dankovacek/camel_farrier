...
# 08NJ064: RINGROSE CREEK BELOW CLAY'S DIVERSION
...
result = plot_station_polygon("08NJ064")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ064">stations/08NJ064 folder on GitHub</a>.
:::
...
<tr><td>08NJ064</td><td>RINGROSE CREEK BELOW CLAY'S DIVERSION</td><td>49.726</td><td>-117.462</td><td>1.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.89, ΔArea: +11.5%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 183 daily observations, continuous record | 55.2% flagged (estimated: 101)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>183 daily observations, continuous record | 55.2% flagged (estimated: 101) | Record: 0.5 years</td></tr>
...
show(plot_station_timeseries("08NJ064"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ064")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ064/08NJ064_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ064/08NJ064_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ064"))
:::
...
<div class="download-section">
  <a href="../../08NJ064/08NJ064_field_visits.csv" download class="download-btn">
