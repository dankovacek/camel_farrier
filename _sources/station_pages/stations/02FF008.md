...
The data representing the above plots can be downloaded from the [stations/02FF008](https://dankovacek.github.io/camel_farrier/stations/02FF008) folder in the Github repository.
