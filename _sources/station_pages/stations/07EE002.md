...
result = plot_station_polygon("07EE002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07EE002">stations/07EE002 folder on GitHub</a>.
:::
...
<tr><td>07EE002</td><td>PARSNIP RIVER NEAR FINLAY FORKS</td><td>55.848</td><td>-123.762</td><td>20300.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 10.5 years
<br><strong>Timeseries Summary:</strong> 3,591 daily observations, minor gaps: 81 days avg (N=3) | 46.4% flagged (backwater: 1492, estimated: 154, partial day: 21)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 61180.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>3,591 daily observations, minor gaps: 81 days avg (N=3) | 46.4% flagged (backwater: 1492, estimated: 154, partial day: 21) | Record: 10.5 years</td></tr>
...
show(plot_station_timeseries("07EE002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07EE002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07EE002/07EE002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07EE002/07EE002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07EE002"))
:::
...
<div class="download-section">
  <a href="../../07EE002/07EE002_field_visits.csv" download class="download-btn">
