...
# 07NB007: SALT RIVER BELOW PEACE POINT HIGHWAY
...
result = plot_station_polygon("07NB007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07NB007">stations/07NB007 folder on GitHub</a>.
:::
...
<tr><td>07NB007</td><td>SALT RIVER BELOW PEACE POINT HIGHWAY</td><td>59.833</td><td>-111.969</td><td>1670.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,922 daily observations, continuous record | 51.2% flagged (backwater: 1443, estimated: 45, partial day: 7)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 6401.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,922 daily observations, continuous record | 51.2% flagged (backwater: 1443, estimated: 45, partial day: 7) | Record: 8.0 years</td></tr>
...
show(plot_station_timeseries("07NB007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07NB007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07NB007/07NB007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07NB007/07NB007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07NB007"))
:::
