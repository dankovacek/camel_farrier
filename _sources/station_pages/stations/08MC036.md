...
# 08MC036: CHIMNEY CREEK AT DOG CREEK ROAD
...
result = plot_station_polygon("08MC036")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MC036">stations/08MC036 folder on GitHub</a>.
:::
...
<tr><td>08MC036</td><td>CHIMNEY CREEK AT DOG CREEK ROAD</td><td>52.058</td><td>-122.112</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 1.5 years
<br><strong>Timeseries Summary:</strong> 398 daily observations, seasonal gaps: 152 days avg (N=1) | 5.8% flagged (estimated: 13, backwater: 10)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 732.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>398 daily observations, seasonal gaps: 152 days avg (N=1) | 5.8% flagged (estimated: 13, backwater: 10) | Record: 1.5 years</td></tr>
...
show(plot_station_timeseries("08MC036"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MC036")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MC036/08MC036_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MC036/08MC036_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MC036"))
:::
...
<div class="download-section">
  <a href="../../08MC036/08MC036_field_visits.csv" download class="download-btn">
