...
# 10KD009: CHICK CREEK ABOVE CHICK LAKE
...
result = plot_station_polygon("10KD009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10KD009">stations/10KD009 folder on GitHub</a>.
:::
...
<tr><td>10KD009</td><td>CHICK CREEK ABOVE CHICK LAKE</td><td>65.855</td><td>-128.134</td><td>nan (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 16.9 years
<br><strong>Timeseries Summary:</strong> 4,064 daily observations, seasonal gaps: 141 days avg (N=15) | 45.2% flagged (backwater: 1170, estimated: 652, partial day: 13)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 329.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>4,064 daily observations, seasonal gaps: 141 days avg (N=15) | 45.2% flagged (backwater: 1170, estimated: 652, partial day: 13) | Record: 16.9 years</td></tr>
...
show(plot_station_timeseries("10KD009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10KD009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10KD009/10KD009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10KD009/10KD009_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10KD009/10KD009_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Rating 7.0 developed as new low measurements available to aid in curve development.  Updated rating ...</td>
    </tr>
    <tr>
      <td>6.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Provisional/Provisoire</td>
      <td>Curve developed using 2013 and 2014 open water measurements</td>
    </tr>
    <tr>
      <td>3.0</td>
      <td>LogarithmicTable</td>
      <td>Provisional/Provisoire</td>
      <td>CURVE DEVELOPED USING 2012 OPEN WATER MEASUREMENTS</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("10KD009"))
:::
...
<div class="download-section">
  <a href="../../10KD009/10KD009_field_visits.csv" download class="download-btn">
