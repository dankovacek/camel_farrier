...
# 08MF002: BOULDER CREEK NEAR LAIDLAW
...
result = plot_station_polygon("08MF002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MF002">stations/08MF002 folder on GitHub</a>.
:::
...
<tr><td>08MF002</td><td>BOULDER CREEK NEAR LAIDLAW</td><td>49.251</td><td>-121.602</td><td>29.8 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 3,563 daily observations, seasonal gaps: 5310 days avg (N=2) | 11.3% flagged (backwater: 296, estimated: 106)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 64.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,563 daily observations, seasonal gaps: 5310 days avg (N=2) | 11.3% flagged (backwater: 296, estimated: 106) | Record: 38.8 years</td></tr>
...
show(plot_station_timeseries("08MF002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MF002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MF002/08MF002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MF002/08MF002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MF002"))
:::
