...
result = plot_station_polygon("07EA007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07EA007">stations/07EA007 folder on GitHub</a>.
:::
...
<tr><td>07EA007</td><td>AKIE RIVER NEAR THE 760 M CONTOUR</td><td>57.191</td><td>-124.901</td><td>1690.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 15,402 daily observations, seasonal gaps: 167 days avg (N=4) | 52.1% flagged (backwater: 7158, estimated: 572, partial day: 294)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5772.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>15,402 daily observations, seasonal gaps: 167 days avg (N=4) | 52.1% flagged (backwater: 7158, estimated: 572, partial day: 294) | Record: 44.0 years</td></tr>
...
show(plot_station_timeseries("07EA007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07EA007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07EA007/07EA007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07EA007/07EA007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07EA007/07EA007_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>created with Aug 2022 - June 2025 open water measurements.  High end defined with 2021 and 1999 high...</td>
    </tr>
    <tr>
      <td>30.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Fits all open water measurements conducted in 2021.</td>
    </tr>
    <tr>
      <td>29.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Fits all open water measurements conducted in 2019</td>
    </tr>
    <tr>
      <td>28.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>created using open water measurements from 2017, 2018, historical high water measurements from 1999 ...</td>
    </tr>
    <tr>
      <td>27.100</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>CLONE OF 27 TO AVOID CONFLICT WITH APPROVAL LEVELS</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("07EA007"))
:::
...
<div class="download-section">
  <a href="../../07EA007/07EA007_field_visits.csv" download class="download-btn">
