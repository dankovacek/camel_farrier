...
result = plot_station_polygon("08AB001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08AB001">stations/08AB001 folder on GitHub</a>.
:::
...
<tr><td>08AB001</td><td>ALSEK RIVER ABOVE BATES RIVER</td><td>60.118</td><td>-137.978</td><td>16200.0 (0.0)</td><td>YT</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 45.5 years
<br><strong>Timeseries Summary:</strong> 16,467 daily observations, minor gaps: 38 days avg (N=4) | 52.9% flagged (backwater: 8370, estimated: 283, partial day: 53)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 64337.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>16,467 daily observations, minor gaps: 38 days avg (N=4) | 52.9% flagged (backwater: 8370, estimated: 283, partial day: 53) | Record: 45.5 years</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08AB001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08AB001/08AB001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08AB001/08AB001_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08AB001/08AB001_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Clone of 25.01 to add extend estimated grade on low end of curve based on new low flow measurements ...</td>
    </tr>
    <tr>
      <td>25.01</td>
      <td>LogarithmicTable</td>
      <td>Provisional/Provisoire</td>
      <td>Clone of 25.0 to add estimated grade.</td>
    </tr>
    <tr>
      <td>25.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Created an average curve using mmnts from 2010 to 2019, used to Breakpoints as is suggested by chann...</td>
    </tr>
    <tr>
      <td>25.0_B</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>trying only one break point on bottom end, seems a little biased L in mid area</td>
    </tr>
    <tr>
      <td>24.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Required to adjust low end and extend based on record high year.</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08AB001"))
:::
...
<div class="download-section">
  <a href="../../08AB001/08AB001_field_visits.csv" download class="download-btn">
