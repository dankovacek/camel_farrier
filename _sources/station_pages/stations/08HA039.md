...
# 08HA039: GOLDSTREAM RIVER IN GOLDSTREAM PROVINCIAL PARK
...
result = plot_station_polygon("08HA039")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HA039">stations/08HA039 folder on GitHub</a>.
:::
...
<tr><td>08HA039</td><td>GOLDSTREAM RIVER IN GOLDSTREAM PROVINCIAL PARK</td><td>48.461</td><td>-123.552</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 822 daily observations, continuous record | 10.7% flagged (estimated: 72, partial day: 16)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 85.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>822 daily observations, continuous record | 10.7% flagged (estimated: 72, partial day: 16) | Record: 2.2 years</td></tr>
...
show(plot_station_timeseries("08HA039"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HA039")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HA039/08HA039_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HA039/08HA039_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HA039"))
:::
...
<div class="download-section">
  <a href="../../08HA039/08HA039_field_visits.csv" download class="download-btn">
