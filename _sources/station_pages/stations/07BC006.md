...
result = plot_station_polygon("07BC006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07BC006">stations/07BC006 folder on GitHub</a>.
:::
...
<tr><td>07BC006</td><td>DAPP CREEK AT HIGHWAY NO. 44</td><td>54.308</td><td>-113.849</td><td>605.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 13,590 daily observations, seasonal gaps: 102 days avg (N=52) | 27.0% flagged (backwater: 2563, estimated: 1073, partial day: 31)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1912.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>13,590 daily observations, seasonal gaps: 102 days avg (N=52) | 27.0% flagged (backwater: 2563, estimated: 1073, partial day: 31) | Record: 51.7 years</td></tr>
...
show(plot_station_timeseries("07BC006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07BC006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07BC006/07BC006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07BC006/07BC006_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07BC006/07BC006_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>New Curve - Migrate from arithmatic to logarithmic</td>
    </tr>
    <tr>
      <td>7.0</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07BC006"))
:::
...
<div class="download-section">
  <a href="../../07BC006/07BC006_field_visits.csv" download class="download-btn">
