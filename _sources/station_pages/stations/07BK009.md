...
result = plot_station_polygon("07BK009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07BK009">stations/07BK009 folder on GitHub</a>.
:::
...
<tr><td>07BK009</td><td>SAWRIDGE CREEK NEAR SLAVE LAKE</td><td>55.271</td><td>-114.775</td><td>230.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 48.7 years
<br><strong>Timeseries Summary:</strong> 12,794 daily observations, seasonal gaps: 104 days avg (N=48) | 25.9% flagged (backwater: 2732, partial day: 313, estimated: 265)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 691.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>12,794 daily observations, seasonal gaps: 104 days avg (N=48) | 25.9% flagged (backwater: 2732, partial day: 313, estimated: 265) | Record: 48.7 years</td></tr>
...
show(plot_station_timeseries("07BK009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07BK009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07BK009/07BK009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07BK009/07BK009_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07BK009/07BK009_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Curve extended for July 2024 high water.</td>
    </tr>
    <tr>
      <td>13.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Extension of curve 13.00 to 0.001 m3/s. really low water in 2021</td>
    </tr>
    <tr>
      <td>13.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>3 segment curve drawn based on control features observed in pictures (see Excelt file for details). ...</td>
    </tr>
    <tr>
      <td>12.000</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Same as Curve #11 above 2.000m</td>
    </tr>
    <tr>
      <td>12.000-SC3</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07BK009"))
:::
...
<div class="download-section">
  <a href="../../07BK009/07BK009_field_visits.csv" download class="download-btn">
