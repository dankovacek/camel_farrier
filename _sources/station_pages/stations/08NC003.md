...
result = plot_station_polygon("08NC003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NC003">stations/08NC003 folder on GitHub</a>.
:::
...
<tr><td>08NC003</td><td>CANOE RIVER NEAR VALEMOUNT</td><td>52.767</td><td>-119.262</td><td>368.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 518 daily observations, continuous record | 35.7% flagged (backwater: 136, estimated: 49)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 993.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>518 daily observations, continuous record | 35.7% flagged (backwater: 136, estimated: 49) | Record: 1.4 years</td></tr>
...
show(plot_station_timeseries("08NC003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NC003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NC003/08NC003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NC003/08NC003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NC003"))
:::
