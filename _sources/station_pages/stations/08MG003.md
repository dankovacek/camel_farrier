...
result = plot_station_polygon("08MG003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MG003">stations/08MG003 folder on GitHub</a>.
:::
...
<tr><td>08MG003</td><td>GREEN RIVER NEAR PEMBERTON</td><td>50.282</td><td>-122.851</td><td>855.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 37.9 years
<br><strong>Timeseries Summary:</strong> 13,669 daily observations, minor gaps: 60 days avg (N=3) | 18.7% flagged (estimated: 1529, backwater: 667, partial day: 355)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2024.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>13,669 daily observations, minor gaps: 60 days avg (N=3) | 18.7% flagged (estimated: 1529, backwater: 667, partial day: 355) | Record: 37.9 years</td></tr>
...
show(plot_station_timeseries("08MG003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MG003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MG003/08MG003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MG003/08MG003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MG003"))
:::
...
<div class="download-section">
  <a href="../../08MG003/08MG003_field_visits.csv" download class="download-btn">
