...
result = plot_station_polygon("08MF009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MF009">stations/08MF009 folder on GitHub</a>.
:::
...
<tr><td>08MF009</td><td>SILVERHOPE CREEK NEAR HOPE</td><td>49.363</td><td>-121.469</td><td>350.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 60.2 years
<br><strong>Timeseries Summary:</strong> 3,409 daily observations, seasonal gaps: 18567 days avg (N=1) | 2.5% flagged (backwater: 61, estimated: 24)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,409 daily observations, seasonal gaps: 18567 days avg (N=1) | 2.5% flagged (backwater: 61, estimated: 24) | Record: 60.2 years</td></tr>
...
show(plot_station_timeseries("08MF009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MF009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MF009/08MF009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MF009/08MF009_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MF009"))
:::
...
<div class="download-section">
  <a href="../../08MF009/08MF009_field_visits.csv" download class="download-btn">
