...
# 08MH093: SUMAS RIVER AT ATKINSON ROAD
...
result = plot_station_polygon("08MH093")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH093">stations/08MH093 folder on GitHub</a>.
:::
...
<tr><td>08MH093</td><td>SUMAS RIVER AT ATKINSON ROAD</td><td>49.063</td><td>-122.171</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 619.6 km²</td></tr>
...
show(plot_station_timeseries("08MH093"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH093")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH093/08MH093_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08MH093/08MH093_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH093"))
:::
