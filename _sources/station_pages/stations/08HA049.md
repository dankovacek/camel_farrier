...
# 08HA049: FORD LAKE ON SALTSPRING ISLAND
...
result = plot_station_polygon("08HA049")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HA049">stations/08HA049 folder on GitHub</a>.
:::
...
<tr><td>08HA049</td><td>FORD LAKE ON SALTSPRING ISLAND</td><td>48.794</td><td>-123.474</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 17.2 km²</td></tr>
...
show(plot_station_timeseries("08HA049"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HA049")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HA049/08HA049_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HA049/08HA049_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HA049"))
:::
...
<div class="download-section">
  <a href="../../08HA049/08HA049_field_visits.csv" download class="download-btn">
