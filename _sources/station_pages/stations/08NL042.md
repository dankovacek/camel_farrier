...
# 08NL042: ISSITZ LAKE NEAR PRINCETON
...
result = plot_station_polygon("08NL042")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL042">stations/08NL042 folder on GitHub</a>.
:::
...
<tr><td>08NL042</td><td>ISSITZ LAKE NEAR PRINCETON</td><td>49.428</td><td>-120.347</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 518.9 km²</td></tr>
...
show(plot_station_timeseries("08NL042"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL042")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL042/08NL042_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NL042/08NL042_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL042"))
:::
...
<div class="download-section">
  <a href="../../08NL042/08NL042_field_visits.csv" download class="download-btn">
