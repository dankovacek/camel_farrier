...
# 08MH091: SILVERDALE CREEK NEAR MISSION
...
result = plot_station_polygon("08MH091")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MH091">stations/08MH091 folder on GitHub</a>.
:::
...
<tr><td>08MH091</td><td>SILVERDALE CREEK NEAR MISSION</td><td>49.148</td><td>-122.337</td><td>17.1 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 35.8 years
<br><strong>Timeseries Summary:</strong> 12,997 daily observations, minor gaps: 46 days avg (N=2) | 7.8% flagged (estimated: 501, backwater: 338, partial day: 176)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 47.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>12,997 daily observations, minor gaps: 46 days avg (N=2) | 7.8% flagged (estimated: 501, backwater: 338, partial day: 176) | Record: 35.8 years</td></tr>
...
show(plot_station_timeseries("08MH091"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MH091")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MH091/08MH091_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MH091/08MH091_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MH091"))
:::
...
<div class="download-section">
  <a href="../../08MH091/08MH091_field_visits.csv" download class="download-btn">
