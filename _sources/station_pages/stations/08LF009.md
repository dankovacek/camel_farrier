...
# 08LF009: DEADMAN RIVER ABOVE WALHACHIN FLUME
...
result = plot_station_polygon("08LF009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF009">stations/08LF009 folder on GitHub</a>.
:::
...
<tr><td>08LF009</td><td>DEADMAN RIVER ABOVE WALHACHIN FLUME</td><td>50.878</td><td>-120.972</td><td>1170.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 245 daily observations, seasonal gaps: 213 days avg (N=1) | 5.7% flagged (estimated: 14)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3624.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>245 daily observations, seasonal gaps: 213 days avg (N=1) | 5.7% flagged (estimated: 14) | Record: 1.3 years</td></tr>
...
show(plot_station_timeseries("08LF009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF009/08LF009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF009/08LF009_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF009"))
:::
