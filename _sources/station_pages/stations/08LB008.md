...
# 08LB008: JAMIESON CREEK ABOVE BRITISH COLUMBIA FRUITLANDS DIVERSION
...
result = plot_station_polygon("08LB008")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LB008">stations/08LB008 folder on GitHub</a>.
:::
...
<tr><td>08LB008</td><td>JAMIESON CREEK ABOVE BRITISH COLUMBIA FRUITLANDS DIVERSION</td><td>50.885</td><td>-120.290</td><td>230.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,224 daily observations, seasonal gaps: 126 days avg (N=6) | 8.5% flagged (estimated: 104)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 597.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,224 daily observations, seasonal gaps: 126 days avg (N=6) | 8.5% flagged (estimated: 104) | Record: 5.4 years</td></tr>
...
show(plot_station_timeseries("08LB008"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LB008")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LB008/08LB008_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LB008/08LB008_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LB008"))
:::
...
<div class="download-section">
  <a href="../../08LB008/08LB008_field_visits.csv" download class="download-btn">
