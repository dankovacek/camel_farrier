...
# 08HB095: NAHMINT RIVER SOUTH TRIBUTARY MID VALLEY
...
result = plot_station_polygon("08HB095")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB095">stations/08HB095 folder on GitHub</a>.
:::
...
<tr><td>08HB095</td><td>NAHMINT RIVER SOUTH TRIBUTARY MID VALLEY</td><td>49.206</td><td>-125.242</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 456 daily observations, continuous record | 0.4% flagged (partial day: 2)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 11.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>456 daily observations, continuous record | 0.4% flagged (partial day: 2) | Record: 1.2 years</td></tr>
...
show(plot_station_timeseries("08HB095"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB095")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB095/08HB095_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HB095/08HB095_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HB095"))
:::
...
<div class="download-section">
  <a href="../../08HB095/08HB095_field_visits.csv" download class="download-btn">
