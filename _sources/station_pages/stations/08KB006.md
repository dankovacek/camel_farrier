...
result = plot_station_polygon("08KB006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KB006">stations/08KB006 folder on GitHub</a>.
:::
...
<tr><td>08KB006</td><td>MULLER CREEK NEAR THE MOUTH</td><td>54.297</td><td>-120.977</td><td>103.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 47.9 years
<br><strong>Timeseries Summary:</strong> 16,829 daily observations, minor gaps: 84 days avg (N=8) | 51.5% flagged (backwater: 7705, estimated: 876, partial day: 85)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 301.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>16,829 daily observations, minor gaps: 84 days avg (N=8) | 51.5% flagged (backwater: 7705, estimated: 876, partial day: 85) | Record: 47.9 years</td></tr>
...
show(plot_station_timeseries("08KB006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KB006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KB006/08KB006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08KB006/08KB006_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08KB006/08KB006_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Three of the four 2023 open water measurements plot >5% negative off previous Curve 25.00, including...</td>
    </tr>
    <tr>
      <td>25.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve created using open water measurements from 2021 and 2022. The upper end is defined by the high...</td>
    </tr>
    <tr>
      <td>24.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve for 2020/01/28 Review Period</td>
    </tr>
    <tr>
      <td>23.01</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>extension of curve 23.000 to accomodate highwater and rainfall events</td>
    </tr>
    <tr>
      <td>23.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>left of curve 22.000 at mid to low stages</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08KB006"))
:::
