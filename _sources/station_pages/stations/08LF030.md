...
# 08LF030: DURAND CREEK (FERGUSON DIVERSION) NEAR SAVONA
...
result = plot_station_polygon("08LF030")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF030">stations/08LF030 folder on GitHub</a>.
:::
...
<tr><td>08LF030</td><td>DURAND CREEK (FERGUSON DIVERSION) NEAR SAVONA</td><td>50.663</td><td>-120.764</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 949 daily observations, seasonal gaps: 258 days avg (N=8)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 337.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>949 daily observations, seasonal gaps: 258 days avg (N=8) | Record: 8.2 years</td></tr>
...
show(plot_station_timeseries("08LF030"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF030")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF030/08LF030_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF030/08LF030_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF030"))
:::
