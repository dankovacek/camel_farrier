...
The data representing the above plots can be downloaded from the [stations/05NG010](https://dankovacek.github.io/camel_farrier/stations/05NG010) folder in the Github repository.
