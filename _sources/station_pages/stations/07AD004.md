...
# 07AD004: WHISKEYJACK CREEK NEAR HINTON
...
result = plot_station_polygon("07AD004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07AD004">stations/07AD004 folder on GitHub</a>.
:::
...
<tr><td>07AD004</td><td>WHISKEYJACK CREEK NEAR HINTON</td><td>53.381</td><td>-117.537</td><td>3.1 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 6,662 daily observations, seasonal gaps: 122 days avg (N=31) | 9.8% flagged (backwater: 344, estimated: 249, partial day: 61)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>6,662 daily observations, seasonal gaps: 122 days avg (N=31) | 9.8% flagged (backwater: 344, estimated: 249, partial day: 61) | Record: 28.6 years</td></tr>
...
show(plot_station_timeseries("07AD004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07AD004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07AD004/07AD004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07AD004/07AD004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07AD004"))
:::
