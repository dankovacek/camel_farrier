...
# 08JC006: MURRAY CREEK AT VANDERHOOF
...
result = plot_station_polygon("08JC006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08JC006">stations/08JC006 folder on GitHub</a>.
:::
...
<tr><td>08JC006</td><td>MURRAY CREEK AT VANDERHOOF</td><td>54.030</td><td>-124.015</td><td>125.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 12.6 years
<br><strong>Timeseries Summary:</strong> 4,199 daily observations, minor gaps: 50 days avg (N=8) | 40.9% flagged (backwater: 1249, estimated: 468)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 341.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>4,199 daily observations, minor gaps: 50 days avg (N=8) | 40.9% flagged (backwater: 1249, estimated: 468) | Record: 12.6 years</td></tr>
...
show(plot_station_timeseries("08JC006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08JC006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08JC006/08JC006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08JC006/08JC006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08JC006"))
:::
