...
# 08ME005: BRIDGE RIVER NEAR GOLD BRIDGE
...
result = plot_station_polygon("08ME005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08ME005">stations/08ME005 folder on GitHub</a>.
:::
...
<tr><td>08ME005</td><td>BRIDGE RIVER NEAR GOLD BRIDGE</td><td>50.851</td><td>-122.846</td><td>1650.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 6,179 daily observations, continuous record | 30.2% flagged (backwater: 1783, estimated: 86)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4175.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>6,179 daily observations, continuous record | 30.2% flagged (backwater: 1783, estimated: 86) | Record: 16.9 years</td></tr>
...
show(plot_station_timeseries("08ME005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08ME005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08ME005/08ME005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08ME005/08ME005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08ME005"))
:::
...
<div class="download-section">
  <a href="../../08ME005/08ME005_field_visits.csv" download class="download-btn">
