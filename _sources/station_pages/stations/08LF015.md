...
# 08LF015: HAT CREEK NEAR CACHE CREEK
...
result = plot_station_polygon("08LF015")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF015">stations/08LF015 folder on GitHub</a>.
:::
...
<tr><td>08LF015</td><td>HAT CREEK NEAR CACHE CREEK</td><td>50.884</td><td>-121.420</td><td>658.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 83.7 years
<br><strong>Timeseries Summary:</strong> 11,628 daily observations, seasonal gaps: 2705 days avg (N=7) | 52.1% flagged (backwater: 3711, estimated: 2294, partial day: 57)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1653.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>11,628 daily observations, seasonal gaps: 2705 days avg (N=7) | 52.1% flagged (backwater: 3711, estimated: 2294, partial day: 57) | Record: 83.7 years</td></tr>
...
show(plot_station_timeseries("08LF015"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF015")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF015/08LF015_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF015/08LF015_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF015"))
:::
...
<div class="download-section">
  <a href="../../08LF015/08LF015_field_visits.csv" download class="download-btn">
