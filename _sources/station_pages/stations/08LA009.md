...
# 08LA009: CLEARWATER RIVER AT INLET TO CLEARWATER LAKE
...
result = plot_station_polygon("08LA009")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LA009">stations/08LA009 folder on GitHub</a>.
:::
...
<tr><td>08LA009</td><td>CLEARWATER RIVER AT INLET TO CLEARWATER LAKE</td><td>52.349</td><td>-120.264</td><td>2380.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 13.8 years
<br><strong>Timeseries Summary:</strong> 4,236 daily observations, minor gaps: 82 days avg (N=10) | 22.8% flagged (estimated: 832, backwater: 101, partial day: 33)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 6395.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>4,236 daily observations, minor gaps: 82 days avg (N=10) | 22.8% flagged (estimated: 832, backwater: 101, partial day: 33) | Record: 13.8 years</td></tr>
...
show(plot_station_timeseries("08LA009"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LA009")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LA009/08LA009_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LA009/08LA009_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LA009"))
:::
