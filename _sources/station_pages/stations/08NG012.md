...
result = plot_station_polygon("08NG012")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG012">stations/08NG012 folder on GitHub</a>.
:::
...
<tr><td>08NG012</td><td>ST. MARY RIVER AT WYCLIFFE</td><td>49.600</td><td>-115.863</td><td>2360.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 81.0 years
<br><strong>Timeseries Summary:</strong> 18,570 daily observations, seasonal gaps: 1836 days avg (N=6) | 26.6% flagged (backwater: 3955, estimated: 848, partial day: 136)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5714.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>18,570 daily observations, seasonal gaps: 1836 days avg (N=6) | 26.6% flagged (backwater: 3955, estimated: 848, partial day: 136) | Record: 81.0 years</td></tr>
...
show(plot_station_timeseries("08NG012"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG012")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG012/08NG012_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG012/08NG012_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG012"))
:::
...
<div class="download-section">
  <a href="../../08NG012/08NG012_field_visits.csv" download class="download-btn">
