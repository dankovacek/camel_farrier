...
result = plot_station_polygon("08KE014")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KE014">stations/08KE014 folder on GitHub</a>.
:::
...
<tr><td>08KE014</td><td>NAVER CREEK AT HIXON</td><td>53.426</td><td>-122.589</td><td>658.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 6,299 daily observations, seasonal gaps: 295 days avg (N=3) | 31.9% flagged (backwater: 1902, estimated: 105)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1825.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>6,299 daily observations, seasonal gaps: 295 days avg (N=3) | 31.9% flagged (backwater: 1902, estimated: 105) | Record: 19.7 years</td></tr>
...
show(plot_station_timeseries("08KE014"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KE014")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KE014/08KE014_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KE014/08KE014_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KE014"))
:::
