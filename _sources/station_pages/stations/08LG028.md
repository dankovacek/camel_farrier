...
# 08LG028: NICOLA RIVER AT OUTLET OF DOUGLAS LAKE
...
result = plot_station_polygon("08LG028")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LG028">stations/08LG028 folder on GitHub</a>.
:::
...
<tr><td>08LG028</td><td>NICOLA RIVER AT OUTLET OF DOUGLAS LAKE</td><td>50.140</td><td>-120.284</td><td>1300.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 96.5 years
<br><strong>Timeseries Summary:</strong> 3,079 daily observations, seasonal gaps: 6434 days avg (N=5) | 5.7% flagged (estimated: 162, backwater: 7, partial day: 5)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3116.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,079 daily observations, seasonal gaps: 6434 days avg (N=5) | 5.7% flagged (estimated: 162, backwater: 7, partial day: 5) | Record: 96.5 years</td></tr>
...
show(plot_station_timeseries("08LG028"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LG028")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LG028/08LG028_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LG028/08LG028_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LG028"))
:::
