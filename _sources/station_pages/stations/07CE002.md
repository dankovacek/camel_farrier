...
result = plot_station_polygon("07CE002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07CE002">stations/07CE002 folder on GitHub</a>.
:::
...
<tr><td>07CE002</td><td>CHRISTINA RIVER NEAR CHARD</td><td>55.837</td><td>-110.869</td><td>4860.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 12,125 daily observations, seasonal gaps: 112 days avg (N=31) | 37.8% flagged (backwater: 4134, partial day: 239, estimated: 212)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 15417.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>12,125 daily observations, seasonal gaps: 112 days avg (N=31) | 37.8% flagged (backwater: 4134, partial day: 239, estimated: 212) | Record: 42.7 years</td></tr>
...
show(plot_station_timeseries("07CE002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07CE002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07CE002/07CE002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07CE002/07CE002_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07CE002/07CE002_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Rating Model #10.00 accounts for scour on the section control during 2023 freshet. The channel contr...</td>
    </tr>
    <tr>
      <td>9.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Downstream deposition apparent, required new model.</td>
    </tr>
    <tr>
      <td>8.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Adjusted to represent latest data. Breakpoint represents flooding of shifting islands on control.</td>
    </tr>
    <tr>
      <td>7.0</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>New curve to accommodate 2013 high water measurements.  New Curve # 7.000 - Post High Water of 2013....</td>
    </tr>
    <tr>
      <td>6.0</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>HQFIT1.0, extended curve.  Same 0 flow as curve 5.</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("07CE002"))
:::
...
<div class="download-section">
  <a href="../../07CE002/07CE002_field_visits.csv" download class="download-btn">
