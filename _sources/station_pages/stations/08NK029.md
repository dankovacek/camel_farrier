...
# 08NK029: KILMARNOCK CREEK NEAR THE MOUTH
...
result = plot_station_polygon("08NK029")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NK029">stations/08NK029 folder on GitHub</a>.
:::
...
<tr><td>08NK029</td><td>KILMARNOCK CREEK NEAR THE MOUTH</td><td>50.169</td><td>-114.861</td><td>43.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 11.5 years
<br><strong>Timeseries Summary:</strong> 3,143 daily observations, seasonal gaps: 132 days avg (N=8) | 8.1% flagged (backwater: 150, estimated: 77, partial day: 27)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 106.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,143 daily observations, seasonal gaps: 132 days avg (N=8) | 8.1% flagged (backwater: 150, estimated: 77, partial day: 27) | Record: 11.5 years</td></tr>
...
show(plot_station_timeseries("08NK029"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NK029")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NK029/08NK029_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NK029/08NK029_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NK029"))
:::
