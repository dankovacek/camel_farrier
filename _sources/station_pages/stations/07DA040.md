...
# 07DA040: BIG CREEK NEAR THE MOUTH
...
result = plot_station_polygon("07DA040")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DA040">stations/07DA040 folder on GitHub</a>.
:::
...
<tr><td>07DA040</td><td>BIG CREEK NEAR THE MOUTH</td><td>57.643</td><td>-111.489</td><td>323.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: +0.6%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,922 daily observations, continuous record | 59.9% flagged (backwater: 1511, estimated: 219, partial day: 19)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1126.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,922 daily observations, continuous record | 59.9% flagged (backwater: 1511, estimated: 219, partial day: 19) | Record: 8.0 years</td></tr>
...
show(plot_station_timeseries("07DA040"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07DA040")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07DA040/07DA040_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07DA040/07DA040_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07DA040/07DA040_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07DA040"))
:::
...
<div class="download-section">
  <a href="../../07DA040/07DA040_field_visits.csv" download class="download-btn">
