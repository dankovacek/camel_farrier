...
# 07DB005: MACKAY RIVER ABOVE DUNKIRK RIVER
...
result = plot_station_polygon("07DB005")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DB005">stations/07DB005 folder on GitHub</a>.
:::
...
<tr><td>07DB005</td><td>MACKAY RIVER ABOVE DUNKIRK RIVER</td><td>56.760</td><td>-112.614</td><td>1010.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: -0.0%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 8.3 years
<br><strong>Timeseries Summary:</strong> 2,262 daily observations, seasonal gaps: 98 days avg (N=8) | 31.7% flagged (backwater: 577, estimated: 131, partial day: 10)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3599.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,262 daily observations, seasonal gaps: 98 days avg (N=8) | 31.7% flagged (backwater: 577, estimated: 131, partial day: 10) | Record: 8.3 years</td></tr>
...
show(plot_station_timeseries("07DB005"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07DB005")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07DB005/07DB005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07DB005/07DB005_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07DB005"))
:::
...
<div class="download-section">
  <a href="../../07DB005/07DB005_field_visits.csv" download class="download-btn">
