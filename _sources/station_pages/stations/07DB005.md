...
show(plot_station_polygon("07DB005"))
:::

## Station metadata

The data used in generating the tables on this page can be downloaded from the <a href="../../stations/07DB005/">stations/07DB005</a> folder (<a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DB005">view on GitHub</a>).
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-05</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.9900, ΔArea: -0.02%</td></tr>
</table>
...
show(plot_distributions("07DB005"))
:::
...
<div class="download-section">
  ...
  <a href="/stations/07DB005/07DB005_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="/stations/07DB005/07DB005_annual_instant_peaks.csv" download class="download-btn">
