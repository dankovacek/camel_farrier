...
# 08LE053: SHUSWAP LAKE NEAR SICAMOUS
...
result = plot_station_polygon("08LE053")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE053">stations/08LE053 folder on GitHub</a>.
:::
...
<tr><td>08LE053</td><td>SHUSWAP LAKE NEAR SICAMOUS</td><td>50.851</td><td>-119.012</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 38618.1 km²</td></tr>
...
show(plot_station_timeseries("08LE053"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE053")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE053/08LE053_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08LE053/08LE053_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE053"))
:::
...
<div class="download-section">
  <a href="../../08LE053/08LE053_field_visits.csv" download class="download-btn">
