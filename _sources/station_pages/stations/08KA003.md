...
result = plot_station_polygon("08KA003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KA003">stations/08KA003 folder on GitHub</a>.
:::
...
<tr><td>08KA003</td><td>HOLMES RIVER NEAR MCBRIDE</td><td>53.253</td><td>-120.056</td><td>785.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 886 daily observations, seasonal gaps: 131 days avg (N=3) | 1.8% flagged (estimated: 16)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2244.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>886 daily observations, seasonal gaps: 131 days avg (N=3) | 1.8% flagged (estimated: 16) | Record: 3.5 years</td></tr>
...
show(plot_station_timeseries("08KA003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KA003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KA003/08KA003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KA003/08KA003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KA003"))
:::
...
<div class="download-section">
  <a href="../../08KA003/08KA003_field_visits.csv" download class="download-btn">
