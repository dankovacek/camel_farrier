...
# 07PA002: WHITESAND RIVER NEAR ALTA/NWT BOUNDARY
...
result = plot_station_polygon("07PA002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07PA002">stations/07PA002 folder on GitHub</a>.
:::
...
<tr><td>07PA002</td><td>WHITESAND RIVER NEAR ALTA/NWT BOUNDARY</td><td>60.005</td><td>-115.579</td><td>3410.0 (0.0)</td><td>NT</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 9.0 years
<br><strong>Timeseries Summary:</strong> 3,074 daily observations, minor gaps: 71 days avg (N=3) | 49.7% flagged (backwater: 1448, estimated: 75, partial day: 6)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 13454.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>3,074 daily observations, minor gaps: 71 days avg (N=3) | 49.7% flagged (backwater: 1448, estimated: 75, partial day: 6) | Record: 9.0 years</td></tr>
...
show(plot_station_timeseries("07PA002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07PA002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07PA002/07PA002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07PA002/07PA002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07PA002"))
:::
...
<div class="download-section">
  <a href="../../07PA002/07PA002_field_visits.csv" download class="download-btn">
