...
# 08LF024: TRANQUILLE RIVER NEAR KAMLOOPS
...
result = plot_station_polygon("08LF024")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF024">stations/08LF024 folder on GitHub</a>.
:::
...
<tr><td>08LF024</td><td>TRANQUILLE RIVER NEAR KAMLOOPS</td><td>50.736</td><td>-120.517</td><td>596.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 69.3 years
<br><strong>Timeseries Summary:</strong> 2,534 daily observations, seasonal gaps: 1751 days avg (N=13) | 7.6% flagged (estimated: 192)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1102.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,534 daily observations, seasonal gaps: 1751 days avg (N=13) | 7.6% flagged (estimated: 192) | Record: 69.3 years</td></tr>
...
show(plot_station_timeseries("08LF024"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF024")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF024/08LF024_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF024/08LF024_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF024"))
:::
...
<div class="download-section">
  <a href="../../08LF024/08LF024_field_visits.csv" download class="download-btn">
