...
# 08NL043: SUMMERS CREEK AT OUTLET OF MISSEZULA LAKE
...
result = plot_station_polygon("08NL043")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL043">stations/08NL043 folder on GitHub</a>.
:::
...
<tr><td>08NL043</td><td>SUMMERS CREEK AT OUTLET OF MISSEZULA LAKE</td><td>49.767</td><td>-120.496</td><td>123.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,894 daily observations, seasonal gaps: 216 days avg (N=9) | 26.2% flagged (estimated: 496)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 359.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,894 daily observations, seasonal gaps: 216 days avg (N=9) | 26.2% flagged (estimated: 496) | Record: 10.5 years</td></tr>
...
show(plot_station_timeseries("08NL043"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL043")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL043/08NL043_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NL043/08NL043_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL043"))
:::
...
<div class="download-section">
  <a href="../../08NL043/08NL043_field_visits.csv" download class="download-btn">
