...
# 10TM001: ASTON RIVER ABOVE ASTON BAY
...
result = plot_station_polygon("10TM001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10TM001">stations/10TM001 folder on GitHub</a>.
:::
...
<tr><td>10TM001</td><td>ASTON RIVER ABOVE ASTON BAY</td><td>73.500</td><td>-94.133</td><td>961.0 (0.0)</td><td>NU</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 11817.5 km²</td></tr>
...
show(plot_station_timeseries("10TM001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10TM001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10TM001/10TM001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("10TM001"))
:::
...
<div class="download-section">
  <a href="../../10TM001/10TM001_field_visits.csv" download class="download-btn">
