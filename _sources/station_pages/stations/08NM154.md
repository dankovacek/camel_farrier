...
# 08NM154: COLDSTREAM CREEK AT THE MOUTH
...
result = plot_station_polygon("08NM154")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NM154">stations/08NM154 folder on GitHub</a>.
:::
...
<tr><td>08NM154</td><td>COLDSTREAM CREEK AT THE MOUTH</td><td>50.226</td><td>-119.250</td><td>205.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 518 daily observations, continuous record | 13.7% flagged (estimated: 68, backwater: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 495.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>518 daily observations, continuous record | 13.7% flagged (estimated: 68, backwater: 3) | Record: 1.4 years</td></tr>
...
show(plot_station_timeseries("08NM154"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NM154")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NM154/08NM154_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NM154/08NM154_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NM154"))
:::
...
<div class="download-section">
  <a href="../../08NM154/08NM154_field_visits.csv" download class="download-btn">
