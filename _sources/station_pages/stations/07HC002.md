...
result = plot_station_polygon("07HC002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07HC002">stations/07HC002 folder on GitHub</a>.
:::
...
<tr><td>07HC002</td><td>BUCHANAN CREEK NEAR MANNING</td><td>56.895</td><td>-117.489</td><td>232.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.94, ΔArea: +1.9%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 10,207 daily observations, seasonal gaps: 110 days avg (N=39) | 30.1% flagged (backwater: 2192, estimated: 779, partial day: 103)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 750.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>10,207 daily observations, seasonal gaps: 110 days avg (N=39) | 30.1% flagged (backwater: 2192, estimated: 779, partial day: 103) | Record: 39.7 years</td></tr>
...
show(plot_station_timeseries("07HC002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07HC002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07HC002/07HC002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07HC002/07HC002_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07HC002/07HC002_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Compumod to stage/Q rating curve</td>
    </tr>
    <tr>
      <td>6.01</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>SAME AS 6.00 WITH ZERO VALUE</td>
    </tr>
    <tr>
      <td>6.000</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("07HC002"))
:::
