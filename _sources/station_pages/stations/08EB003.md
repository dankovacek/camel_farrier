...
result = plot_station_polygon("08EB003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08EB003">stations/08EB003 folder on GitHub</a>.
:::
...
<tr><td>08EB003</td><td>SKEENA RIVER AT GLEN VOWELL</td><td>55.301</td><td>-127.673</td><td>26000.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-03-10</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 1.00, ΔArea: +0.4%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 25.2 years
<br><strong>Timeseries Summary:</strong> 9,223 daily observations, continuous record | 34.8% flagged (backwater: 2808, estimated: 383, partial day: 21)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 81855.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>9,223 daily observations, continuous record | 34.8% flagged (backwater: 2808, estimated: 383, partial day: 21) | Record: 25.2 years</td></tr>
...
show(plot_station_timeseries("08EB003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08EB003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08EB003/08EB003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08EB003/08EB003_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08EB003/08EB003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08EB003"))
:::
...
<div class="download-section">
  <a href="../../08EB003/08EB003_field_visits.csv" download class="download-btn">
