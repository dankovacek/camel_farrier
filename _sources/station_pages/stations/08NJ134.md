...
# 08NJ134: CODY CREEK NEAR SANDON
...
result = plot_station_polygon("08NJ134")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ134">stations/08NJ134 folder on GitHub</a>.
:::
...
<tr><td>08NJ134</td><td>CODY CREEK NEAR SANDON</td><td>49.969</td><td>-117.194</td><td>15.3 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: +1.1%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 732 daily observations, seasonal gaps: 304 days avg (N=3) | 53.3% flagged (estimated: 390)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 36.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>732 daily observations, seasonal gaps: 304 days avg (N=3) | 53.3% flagged (estimated: 390) | Record: 4.5 years</td></tr>
...
show(plot_station_timeseries("08NJ134"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ134")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ134/08NJ134_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ134/08NJ134_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ134"))
:::
...
<div class="download-section">
  <a href="../../08NJ134/08NJ134_field_visits.csv" download class="download-btn">
