...
# 08ND003: ILLECILLEWAET RIVER NEAR REVELSTOKE
...
result = plot_station_polygon("08ND003")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08ND003">stations/08ND003 folder on GitHub</a>.
:::
...
<tr><td>08ND003</td><td>ILLECILLEWAET RIVER NEAR REVELSTOKE</td><td>50.986</td><td>-118.182</td><td>1230.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,589 daily observations, minor gaps: 55 days avg (N=6) | 8.6% flagged (estimated: 136)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 3056.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,589 daily observations, minor gaps: 55 days avg (N=6) | 8.6% flagged (estimated: 136) | Record: 5.3 years</td></tr>
...
show(plot_station_timeseries("08ND003"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08ND003")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08ND003/08ND003_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08ND003/08ND003_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08ND003"))
:::
...
<div class="download-section">
  <a href="../../08ND003/08ND003_field_visits.csv" download class="download-btn">
