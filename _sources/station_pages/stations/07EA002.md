...
result = plot_station_polygon("07EA002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07EA002">stations/07EA002 folder on GitHub</a>.
:::
...
<tr><td>07EA002</td><td>KWADACHA RIVER NEAR WARE</td><td>57.450</td><td>-125.637</td><td>2410.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 38.4 years
<br><strong>Timeseries Summary:</strong> 12,421 daily observations, seasonal gaps: 322 days avg (N=5) | 68.5% flagged (backwater: 5856, estimated: 2601, partial day: 52)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 8432.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>12,421 daily observations, seasonal gaps: 322 days avg (N=5) | 68.5% flagged (backwater: 5856, estimated: 2601, partial day: 52) | Record: 38.4 years</td></tr>
...
show(plot_station_timeseries("07EA002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07EA002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07EA002/07EA002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07EA002/07EA002_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07EA002"))
:::
