...
result = plot_station_polygon("08ED002")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08ED002">stations/08ED002 folder on GitHub</a>.
:::
...
<tr><td>08ED002</td><td>MORICE RIVER NEAR HOUSTON</td><td>54.117</td><td>-127.427</td><td>1900.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 62.7 years
<br><strong>Timeseries Summary:</strong> 22,828 daily observations, seasonal gaps: 92 days avg (N=1) | 8.7% flagged (estimated: 1444, backwater: 361, partial day: 188)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5433.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>22,828 daily observations, seasonal gaps: 92 days avg (N=1) | 8.7% flagged (estimated: 1444, backwater: 361, partial day: 188) | Record: 62.7 years</td></tr>
...
show(plot_station_timeseries("08ED002"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08ED002")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08ED002/08ED002_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08ED002/08ED002_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08ED002/08ED002_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Shift at Highwater</td>
    </tr>
    <tr>
      <td>18.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Shifted to new logarithmic curve on Jan 10/2011 visit. Bank erosion occurring at site.</td>
    </tr>
    <tr>
      <td>20.000</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Shift at Highwater July 26/2012.</td>
    </tr>
    <tr>
      <td>17.010</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Approved: Shift @ HW</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("08ED002"))
:::
...
<div class="download-section">
  <a href="../../08ED002/08ED002_field_visits.csv" download class="download-btn">
