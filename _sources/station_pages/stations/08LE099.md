...
# 08LE099: NORTH PAXTON CREEK ABOVE DIVERSIONS
...
result = plot_station_polygon("08LE099")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE099">stations/08LE099 folder on GitHub</a>.
:::
...
<tr><td>08LE099</td><td>NORTH PAXTON CREEK ABOVE DIVERSIONS</td><td>50.534</td><td>-119.812</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 366 daily observations, seasonal gaps: 183 days avg (N=1) | 7.1% flagged (estimated: 26)</p>
...
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>366 daily observations, seasonal gaps: 183 days avg (N=1) | 7.1% flagged (estimated: 26) | Record: 1.5 years</td></tr>
...
show(plot_station_timeseries("08LE099"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE099")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE099/08LE099_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE099/08LE099_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE099"))
:::
...
<div class="download-section">
  <a href="../../08LE099/08LE099_field_visits.csv" download class="download-btn">
