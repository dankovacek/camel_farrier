...
# 08NN027: BEAVERDELL CREEK NEAR BEAVERDELL
...
result = plot_station_polygon("08NN027")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NN027">stations/08NN027 folder on GitHub</a>.
:::
...
<tr><td>08NN027</td><td>BEAVERDELL CREEK NEAR BEAVERDELL</td><td>49.486</td><td>-119.028</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 8.6 years
<br><strong>Timeseries Summary:</strong> 1,864 daily observations, seasonal gaps: 159 days avg (N=8) | 44.5% flagged (estimated: 809, backwater: 21)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 320.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,864 daily observations, seasonal gaps: 159 days avg (N=8) | 44.5% flagged (estimated: 809, backwater: 21) | Record: 8.6 years</td></tr>
...
show(plot_station_timeseries("08NN027"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NN027")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NN027/08NN027_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NN027/08NN027_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NN027"))
:::
