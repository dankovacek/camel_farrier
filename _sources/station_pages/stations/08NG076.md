...
result = plot_station_polygon("08NG076")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG076">stations/08NG076 folder on GitHub</a>.
:::
...
<tr><td>08NG076</td><td>MATHER CREEK BELOW HOULE CREEK</td><td>49.714</td><td>-115.897</td><td>135.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 52.5 years
<br><strong>Timeseries Summary:</strong> 19,146 daily observations, minor gaps: 31 days avg (N=1) | 33.3% flagged (backwater: 4220, estimated: 1788, partial day: 360)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 329.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>19,146 daily observations, minor gaps: 31 days avg (N=1) | 33.3% flagged (backwater: 4220, estimated: 1788, partial day: 360) | Record: 52.5 years</td></tr>
...
show(plot_station_timeseries("08NG076"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG076")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG076/08NG076_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NG076/08NG076_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NG076/08NG076_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Ott moved, new curve as control also has been tampered with by public</td>
    </tr>
    <tr>
      <td>57.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Rating change after the sensor was relocated to a new control</td>
    </tr>
    <tr>
      <td>56.02</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Curve cloned to adjust curve confidence</td>
    </tr>
    <tr>
      <td>56.01</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08NG076"))
:::
...
<div class="download-section">
  <a href="../../08NG076/08NG076_field_visits.csv" download class="download-btn">
