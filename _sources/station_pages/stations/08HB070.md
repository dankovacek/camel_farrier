...
# 08HB070: MCCOY LAKE NEAR ALBERNI
...
result = plot_station_polygon("08HB070")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB070">stations/08HB070 folder on GitHub</a>.
:::
...
<tr><td>08HB070</td><td>MCCOY LAKE NEAR ALBERNI</td><td>49.265</td><td>-124.884</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
show(plot_station_timeseries("08HB070"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB070")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB070/08HB070_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HB070/08HB070_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HB070"))
:::
