...
# 08NG006: LINKLATER CREEK NEAR NEWGATE
...
result = plot_station_polygon("08NG006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG006">stations/08NG006 folder on GitHub</a>.
:::
...
<tr><td>08NG006</td><td>LINKLATER CREEK NEAR NEWGATE</td><td>49.039</td><td>-115.234</td><td>94.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 52.4 years
<br><strong>Timeseries Summary:</strong> 1,435 daily observations, seasonal gaps: 2214 days avg (N=8) | 5.6% flagged (estimated: 81)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 215.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,435 daily observations, seasonal gaps: 2214 days avg (N=8) | 5.6% flagged (estimated: 81) | Record: 52.4 years</td></tr>
...
show(plot_station_timeseries("08NG006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG006/08NG006_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG006/08NG006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG006"))
:::
...
<div class="download-section">
  <a href="../../08NG006/08NG006_field_visits.csv" download class="download-btn">
