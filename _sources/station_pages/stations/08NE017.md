...
# 08NE017: SHEEP CREEK NEAR SALMO
...
result = plot_station_polygon("08NE017")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NE017">stations/08NE017 folder on GitHub</a>.
:::
...
<tr><td>08NE017</td><td>SHEEP CREEK NEAR SALMO</td><td>49.143</td><td>-117.253</td><td>134.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 315.7 km²</td></tr>
...
show(plot_station_timeseries("08NE017"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NE017")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NE017/08NE017_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NE017/08NE017_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NE017"))
:::
...
<div class="download-section">
  <a href="../../08NE017/08NE017_field_visits.csv" download class="download-btn">
