...
# 08NN004: KETTLE RIVER AT KETTLE VALLEY
...
result = plot_station_polygon("08NN004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NN004">stations/08NN004 folder on GitHub</a>.
:::
...
<tr><td>08NN004</td><td>KETTLE RIVER AT KETTLE VALLEY</td><td>49.057</td><td>-118.942</td><td>4560.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 8.4 years
<br><strong>Timeseries Summary:</strong> 2,923 daily observations, minor gaps: 50 days avg (N=3) | 20.8% flagged (backwater: 589, estimated: 20)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 10922.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>2,923 daily observations, minor gaps: 50 days avg (N=3) | 20.8% flagged (backwater: 589, estimated: 20) | Record: 8.4 years</td></tr>
...
show(plot_station_timeseries("08NN004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NN004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NN004/08NN004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NN004/08NN004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NN004"))
:::
...
<div class="download-section">
  <a href="../../08NN004/08NN004_field_visits.csv" download class="download-btn">
