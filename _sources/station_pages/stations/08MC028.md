...
# 08MC028: BORLAND CREEK ABOVE EAGLE MEADOWS DAM
...
result = plot_station_polygon("08MC028")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08MC028">stations/08MC028 folder on GitHub</a>.
:::
...
<tr><td>08MC028</td><td>BORLAND CREEK ABOVE EAGLE MEADOWS DAM</td><td>52.092</td><td>-121.806</td><td>4.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 4.3 years
<br><strong>Timeseries Summary:</strong> 854 daily observations, seasonal gaps: 182 days avg (N=4) | 64.8% flagged (estimated: 553)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 254.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>854 daily observations, seasonal gaps: 182 days avg (N=4) | 64.8% flagged (estimated: 553) | Record: 4.3 years</td></tr>
...
show(plot_station_timeseries("08MC028"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08MC028")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08MC028/08MC028_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08MC028/08MC028_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08MC028"))
:::
...
<div class="download-section">
  <a href="../../08MC028/08MC028_field_visits.csv" download class="download-btn">
