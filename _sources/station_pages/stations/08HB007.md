...
# 08HB007: PUNTLEDGE RIVER NEAR CUMBERLAND
...
result = plot_station_polygon("08HB007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB007">stations/08HB007 folder on GitHub</a>.
:::
...
<tr><td>08HB007</td><td>PUNTLEDGE RIVER NEAR CUMBERLAND</td><td>49.664</td><td>-125.093</td><td>453.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 39.3 years
<br><strong>Timeseries Summary:</strong> 14,365 daily observations, continuous record</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1121.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>14,365 daily observations, continuous record | Record: 39.3 years</td></tr>
...
show(plot_station_timeseries("08HB007"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB007/08HB007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HB007/08HB007_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HB007"))
:::
