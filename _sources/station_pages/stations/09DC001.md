...
result = plot_station_polygon("09DC001")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09DC001">stations/09DC001 folder on GitHub</a>.
:::
...
<tr><td>09DC001</td><td>MAYO RIVER NEAR MAYO</td><td>63.702</td><td>-135.862</td><td>2260.0 (0.0)</td><td>YT</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,096 daily observations, seasonal gaps: 156 days avg (N=7) | 29.4% flagged (backwater: 280, estimated: 42)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 11614.1 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,096 daily observations, seasonal gaps: 156 days avg (N=7) | 29.4% flagged (backwater: 280, estimated: 42) | Record: 6.0 years</td></tr>
...
show(plot_station_timeseries("09DC001"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09DC001")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09DC001/09DC001_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../09DC001/09DC001_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("09DC001"))
:::
