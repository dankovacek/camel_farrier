...
# 07DA013: PIERRE RIVER NEAR FORT MACKAY
...
result = plot_station_polygon("07DA013")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07DA013">stations/07DA013 folder on GitHub</a>.
:::
...
<tr><td>07DA013</td><td>PIERRE RIVER NEAR FORT MACKAY</td><td>57.465</td><td>-111.654</td><td>123.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: -1.0%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 2.5 years
<br><strong>Timeseries Summary:</strong> 884 daily observations, minor gaps: 31 days avg (N=1) | 49.5% flagged (backwater: 420, partial day: 15, estimated: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 453.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>884 daily observations, minor gaps: 31 days avg (N=1) | 49.5% flagged (backwater: 420, partial day: 15, estimated: 3) | Record: 2.5 years</td></tr>
...
show(plot_station_timeseries("07DA013"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07DA013")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07DA013/07DA013_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07DA013/07DA013_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07DA013"))
:::
...
<div class="download-section">
  <a href="../../07DA013/07DA013_field_visits.csv" download class="download-btn">
