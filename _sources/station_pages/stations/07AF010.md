...
result = plot_station_polygon("07AF010")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07AF010">stations/07AF010 folder on GitHub</a>.
:::
...
<tr><td>07AF010</td><td>SUNDANCE CREEK NEAR BICKERDIKE</td><td>53.567</td><td>-116.703</td><td>178.0 (0.0)</td><td>AB</td><td>A</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 13,815 daily observations, seasonal gaps: 101 days avg (N=52) | 26.9% flagged (backwater: 3447, estimated: 212, partial day: 51)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 504.8 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>13,815 daily observations, seasonal gaps: 101 days avg (N=52) | 26.9% flagged (backwater: 3447, estimated: 212, partial day: 51) | Record: 52.2 years</td></tr>
...
show(plot_station_timeseries("07AF010"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07AF010")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07AF010/07AF010_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../07AF010/07AF010_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../07AF010/07AF010_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>2 Segment curve. Covers stage from 0.843 m to 3.102 m. Discharge graded as estimated below 0.091 m^3...</td>
    </tr>
    <tr>
      <td>13.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Modernize previous Compumod curve.</td>
    </tr>
    <tr>
      <td>12.000</td>
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Same as Curve #11 above GHT 1.025m</td>
    </tr>
    <tr>
      <td>12.000-SC1</td>
      <td>LinearTable</td>
    ...
    <tr>
      ...
      <td>LinearTable</td>
      <td>Final/Finales</td>
      <td>Same as Curve #10 above GHT 1.690m.</td>
    </tr>
  </tbody>
</table>
...
show(generate_field_visits_table("07AF010"))
:::
...
<div class="download-section">
  <a href="../../07AF010/07AF010_field_visits.csv" download class="download-btn">
