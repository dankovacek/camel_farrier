...
# 08NJ145: RICE CREEK NEAR APPLEDALE
...
result = plot_station_polygon("08NJ145")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NJ145">stations/08NJ145 folder on GitHub</a>.
:::
...
<tr><td>08NJ145</td><td>RICE CREEK NEAR APPLEDALE</td><td>49.643</td><td>-117.557</td><td>2.3 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.98, ΔArea: +0.7%</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,040 daily observations, seasonal gaps: 1940 days avg (N=8) | 38.8% flagged (estimated: 404)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5.9 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,040 daily observations, seasonal gaps: 1940 days avg (N=8) | 38.8% flagged (estimated: 404) | Record: 45.3 years</td></tr>
...
show(plot_station_timeseries("08NJ145"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NJ145")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NJ145/08NJ145_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NJ145/08NJ145_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NJ145"))
:::
