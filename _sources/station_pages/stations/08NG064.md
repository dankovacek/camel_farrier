...
# 08NG064: SUPPLY CREEK NEAR BULL RIVER
...
result = plot_station_polygon("08NG064")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NG064">stations/08NG064 folder on GitHub</a>.
:::
...
<tr><td>08NG064</td><td>SUPPLY CREEK NEAR BULL RIVER</td><td>49.479</td><td>-115.329</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 184 daily observations, seasonal gaps: 273 days avg (N=1) | 63.6% flagged (estimated: 117)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 22.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>184 daily observations, seasonal gaps: 273 days avg (N=1) | 63.6% flagged (estimated: 117) | Record: 1.2 years</td></tr>
...
show(plot_station_timeseries("08NG064"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NG064")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NG064/08NG064_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NG064/08NG064_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NG064"))
:::
