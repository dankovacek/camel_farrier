...
# 08NK017: WHITING CREEK NEAR NATAL
...
result = plot_station_polygon("08NK017")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NK017">stations/08NK017 folder on GitHub</a>.
:::
...
<tr><td>08NK017</td><td>WHITING CREEK NEAR NATAL</td><td>49.772</td><td>-114.901</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 488 daily observations, seasonal gaps: 243 days avg (N=3) | 16.4% flagged (estimated: 80)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>488 daily observations, seasonal gaps: 243 days avg (N=3) | 16.4% flagged (estimated: 80) | Record: 3.3 years</td></tr>
...
show(plot_station_timeseries("08NK017"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NK017")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NK017/08NK017_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NK017/08NK017_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NK017"))
:::
