...
# 08HB092: SOUTH NANAIMO RIVER NEAR JUNCTION
...
result = plot_station_polygon("08HB092")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HB092">stations/08HB092 folder on GitHub</a>.
:::
...
<tr><td>08HB092</td><td>SOUTH NANAIMO RIVER NEAR JUNCTION</td><td>49.060</td><td>-124.126</td><td>211.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 27.5 years
<br><strong>Timeseries Summary:</strong> 8,897 daily observations, seasonal gaps: 164 days avg (N=7) | 5.1% flagged (estimated: 395, partial day: 59)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 479.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>8,897 daily observations, seasonal gaps: 164 days avg (N=7) | 5.1% flagged (estimated: 395, partial day: 59) | Record: 27.5 years</td></tr>
...
show(plot_station_timeseries("08HB092"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HB092")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HB092/08HB092_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08HB092/08HB092_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08HB092/08HB092_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HB092"))
:::
...
<div class="download-section">
  <a href="../../08HB092/08HB092_field_visits.csv" download class="download-btn">
