...
result = plot_station_polygon("08LF095")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LF095">stations/08LF095 folder on GitHub</a>.
:::
...
<tr><td>08LF095</td><td>MCDONALD CREEK NEAR BRIDGE LAKE</td><td>51.432</td><td>-120.615</td><td>20.4 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,292 daily observations, seasonal gaps: 138 days avg (N=11) | 10.2% flagged (estimated: 113, backwater: 98, partial day: 22)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 47.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,292 daily observations, seasonal gaps: 138 days avg (N=11) | 10.2% flagged (estimated: 113, backwater: 98, partial day: 22) | Record: 10.4 years</td></tr>
...
show(plot_station_timeseries("08LF095"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LF095")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LF095/08LF095_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LF095/08LF095_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LF095"))
:::
