...
# 08HA033: SHAWNIGAN CREEK NEAR MILL BAY
...
result = plot_station_polygon("08HA033")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HA033">stations/08HA033 folder on GitHub</a>.
:::
...
<tr><td>08HA033</td><td>SHAWNIGAN CREEK NEAR MILL BAY</td><td>48.658</td><td>-123.569</td><td>93.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 35.6 years
<br><strong>Timeseries Summary:</strong> 12,906 daily observations, seasonal gaps: 92 days avg (N=1) | 7.5% flagged (estimated: 716, partial day: 209, backwater: 49)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 212.3 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>12,906 daily observations, seasonal gaps: 92 days avg (N=1) | 7.5% flagged (estimated: 716, partial day: 209, backwater: 49) | Record: 35.6 years</td></tr>
...
show(plot_station_timeseries("08HA033"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HA033")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HA033/08HA033_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HA033/08HA033_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HA033"))
:::
...
<div class="download-section">
  <a href="../../08HA033/08HA033_field_visits.csv" download class="download-btn">
