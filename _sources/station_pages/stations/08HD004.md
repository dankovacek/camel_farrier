...
result = plot_station_polygon("08HD004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08HD004">stations/08HD004 folder on GitHub</a>.
:::
...
<tr><td>08HD004</td><td>CAMPBELL RIVER NEAR QUINSAM</td><td>49.965</td><td>-125.586</td><td>1150.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,279 daily observations, continuous record | 16.9% flagged (partial day: 169, estimated: 47)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2791.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>1,279 daily observations, continuous record | 16.9% flagged (partial day: 169, estimated: 47) | Record: 3.5 years</td></tr>
...
show(plot_station_timeseries("08HD004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08HD004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08HD004/08HD004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08HD004/08HD004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08HD004"))
:::
...
<div class="download-section">
  <a href="../../08HD004/08HD004_field_visits.csv" download class="download-btn">
