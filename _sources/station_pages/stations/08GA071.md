...
result = plot_station_polygon("08GA071")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08GA071">stations/08GA071 folder on GitHub</a>.
:::
...
<tr><td>08GA071</td><td>ELAHO RIVER NEAR THE MOUTH</td><td>50.114</td><td>-123.428</td><td>1200.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 43.9 years
<br><strong>Timeseries Summary:</strong> 16,040 daily observations, continuous record | 14.7% flagged (backwater: 1569, estimated: 615, partial day: 171)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2981.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>16,040 daily observations, continuous record | 14.7% flagged (backwater: 1569, estimated: 615, partial day: 171) | Record: 43.9 years</td></tr>
...
show(plot_station_timeseries("08GA071"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08GA071")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08GA071/08GA071_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08GA071/08GA071_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08GA071/08GA071_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Refinement of  incorrect lower and upper end estimate</td>
    </tr>
    <tr>
      <td>20.001</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Refinement of curve 19.000. 20.000 had incorrect lower end estimate</td>
    </tr>
    <tr>
      <td>20.000</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>Refinement of curve 19.000</td>
    </tr>
    <tr>
      <td>19.000</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08GA071"))
:::
...
<div class="download-section">
  <a href="../../08GA071/08GA071_field_visits.csv" download class="download-btn">
