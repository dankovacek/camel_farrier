...
result = plot_station_polygon("10LB007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/10LB007">stations/10LB007 folder on GitHub</a>.
:::
...
<tr><td>10LB007</td><td>TIEDA RIVER NEAR THE MOUTH</td><td>66.693</td><td>-129.286</td><td>nan (0.0)</td><td>NT</td><td>A</td></tr>
</table>
...
<tr><td><strong>v1.1.0</strong></td><td>2026-02-11</td><td>HYDAT_polygons</td><td>June 2024 / juin 2024 (2024-06-01)</td><td><em>Official revision date</em></td><td>JSI: 0.99, ΔArea: +0.1%</td></tr>
</table>
...
<br><strong>Record Length:</strong> 15.9 years
<br><strong>Timeseries Summary:</strong> 3,848 daily observations, seasonal gaps: 179 days avg (N=11) | 30.0% flagged (backwater: 1092, partial day: 37, estimated: 25)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 5677.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>3,848 daily observations, seasonal gaps: 179 days avg (N=11) | 30.0% flagged (backwater: 1092, partial day: 37, estimated: 25) | Record: 15.9 years</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("10LB007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../10LB007/10LB007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../10LB007/10LB007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../10LB007/10LB007_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Implemented in 2019 using 2019-2021 measurements with gauge corrected elevations.</td>
    </tr>
    <tr>
      <td>4.0</td>
      <td>LogarithmicTable</td>
    ...
    <tr>
      ...
      <td>LogarithmicTable</td>
      <td>Provisional/Provisoire</td>
      <td>Developed based on 2011 and 2012 open water measurements</td>
    </tr>
    <tr>
      <td>1.0</td>
      <td>LinearTable</td>
...
show(generate_field_visits_table("10LB007"))
:::
...
<div class="download-section">
  <a href="../../10LB007/10LB007_field_visits.csv" download class="download-btn">
