...
result = plot_station_polygon("08KA007")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KA007">stations/08KA007 folder on GitHub</a>.
:::
...
<tr><td>08KA007</td><td>FRASER RIVER AT RED PASS</td><td>52.986</td><td>-119.007</td><td>1710.0 (0.0)</td><td>BC</td><td>A</td></tr>
</table>
...
<br><strong>Record Length:</strong> 69.6 years
<br><strong>Timeseries Summary:</strong> 25,417 daily observations, continuous record | 7.9% flagged (estimated: 1051, backwater: 806, partial day: 156)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 4658.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>25,417 daily observations, continuous record | 7.9% flagged (estimated: 1051, backwater: 806, partial day: 156) | Record: 69.6 years</td></tr>
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KA007")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KA007/08KA007_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08KA007/08KA007_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08KA007/08KA007_annual_instant_peaks.csv" download class="download-btn">
...
<table class="dataframe tufte-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Used curve 37.00 with upper rating point moved right, lower rating point unchanged, and offset tweak...</td>
    </tr>
    <tr>
      <td>37.00</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>bottom end is trending to the left.  The rating was drawn with measurements from 2017 & 2018.  The u...</td>
    </tr>
    <tr>
      <td>36</td>
      <td>LogarithmicTable</td>
      <td>Final/Finales</td>
      <td>right of curve 36</td>
    </tr>
    <tr>
      <td>35</td>
      <td>LogarithmicTable</td>
...
show(generate_field_visits_table("08KA007"))
:::
