...
result = plot_station_polygon("09DC006")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/09DC006">stations/09DC006 folder on GitHub</a>.
:::
...
<tr><td>09DC006</td><td>STEWART RIVER NEAR MAYO</td><td>63.591</td><td>-135.898</td><td>nan (0.0)</td><td>YT</td><td>A</td></tr>
</table>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 161152.7 km²</td></tr>
...
show(plot_station_timeseries("09DC006"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("09DC006")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../09DC006/09DC006_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../09DC006/09DC006_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("09DC006"))
:::
