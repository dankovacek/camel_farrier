...
# 07FD016: SOUTH DAWSON CREEK AT THE MOUTH
...
result = plot_station_polygon("07FD016")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07FD016">stations/07FD016 folder on GitHub</a>.
:::
...
<tr><td>07FD016</td><td>SOUTH DAWSON CREEK AT THE MOUTH</td><td>55.756</td><td>-120.250</td><td>85.2 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,070 daily observations, seasonal gaps: 151 days avg (N=4) | 24.6% flagged (estimated: 263)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 270.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,070 daily observations, seasonal gaps: 151 days avg (N=4) | 24.6% flagged (estimated: 263) | Record: 4.6 years</td></tr>
...
show(plot_station_timeseries("07FD016"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07FD016")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07FD016/07FD016_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07FD016/07FD016_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07FD016"))
:::
...
<div class="download-section">
  <a href="../../07FD016/07FD016_field_visits.csv" download class="download-btn">
