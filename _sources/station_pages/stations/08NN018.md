...
# 08NN018: JULY CREEK NEAR GRAND FORKS
...
result = plot_station_polygon("08NN018")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NN018">stations/08NN018 folder on GitHub</a>.
:::
...
<tr><td>08NN018</td><td>JULY CREEK NEAR GRAND FORKS</td><td>49.014</td><td>-118.541</td><td>45.6 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 1,862 daily observations, seasonal gaps: 175 days avg (N=9) | 3.4% flagged (estimated: 63)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 102.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>1,862 daily observations, seasonal gaps: 175 days avg (N=9) | 3.4% flagged (estimated: 63) | Record: 9.4 years</td></tr>
...
show(plot_station_timeseries("08NN018"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NN018")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NN018/08NN018_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NN018/08NN018_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NN018"))
:::
...
<div class="download-section">
  <a href="../../08NN018/08NN018_field_visits.csv" download class="download-btn">
