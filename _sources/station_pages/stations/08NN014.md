...
# 08NN014: CHRISTINA CREEK AT OUTLET OF CHRISTINA LAKE
...
result = plot_station_polygon("08NN014")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NN014">stations/08NN014 folder on GitHub</a>.
:::
...
<tr><td>08NN014</td><td>CHRISTINA CREEK AT OUTLET OF CHRISTINA LAKE</td><td>49.042</td><td>-118.207</td><td>492.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 2.0 years
<br><strong>Timeseries Summary:</strong> 730 daily observations, continuous record | 15.3% flagged (estimated: 112)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 1154.2 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>730 daily observations, continuous record | 15.3% flagged (estimated: 112) | Record: 2.0 years</td></tr>
...
show(plot_station_timeseries("08NN014"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NN014")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NN014/08NN014_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  <a href="../../08NN014/08NN014_daily_levels.csv" download class="download-btn">
    📈 Download Daily Levels CSV
  </a>
  
  
  <a href="../../08NN014/08NN014_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NN014"))
:::
...
<div class="download-section">
  <a href="../../08NN014/08NN014_field_visits.csv" download class="download-btn">
