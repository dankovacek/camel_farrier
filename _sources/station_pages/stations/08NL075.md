...
# 08NL075: SIMILKAMEEN RIVER ABOVE MEMALOOSE CREEK
...
result = plot_station_polygon("08NL075")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08NL075">stations/08NL075 folder on GitHub</a>.
:::
...
<tr><td>08NL075</td><td>SIMILKAMEEN RIVER ABOVE MEMALOOSE CREEK</td><td>49.116</td><td>-120.835</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 795 daily observations, seasonal gaps: 1946 days avg (N=1) | 31.3% flagged (estimated: 151, backwater: 95, partial day: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 152.0 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>795 daily observations, seasonal gaps: 1946 days avg (N=1) | 31.3% flagged (estimated: 151, backwater: 95, partial day: 3) | Record: 7.5 years</td></tr>
...
show(plot_station_timeseries("08NL075"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08NL075")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08NL075/08NL075_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08NL075/08NL075_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08NL075"))
:::
