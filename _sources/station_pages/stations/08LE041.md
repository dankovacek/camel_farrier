...
# 08LE041: TAPPEN CREEK NEAR TAPPEN
...
result = plot_station_polygon("08LE041")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08LE041">stations/08LE041 folder on GitHub</a>.
:::
...
<tr><td>08LE041</td><td>TAPPEN CREEK NEAR TAPPEN</td><td>50.784</td><td>-119.349</td><td>26.9 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 2,962 daily observations, seasonal gaps: 1421 days avg (N=14) | 1.9% flagged (estimated: 55)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 276.7 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>2,962 daily observations, seasonal gaps: 1421 days avg (N=14) | 1.9% flagged (estimated: 55) | Record: 62.6 years</td></tr>
...
show(plot_station_timeseries("08LE041"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08LE041")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08LE041/08LE041_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08LE041/08LE041_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08LE041"))
:::
...
<div class="download-section">
  <a href="../../08LE041/08LE041_field_visits.csv" download class="download-btn">
