...
# 08FC004: DEAN RIVER ABOVE TOWDYSTAN LAKE
...
result = plot_station_polygon("08FC004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08FC004">stations/08FC004 folder on GitHub</a>.
:::
...
<tr><td>08FC004</td><td>DEAN RIVER ABOVE TOWDYSTAN LAKE</td><td>52.260</td><td>-125.085</td><td>316.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 823 daily observations, seasonal gaps: 103 days avg (N=5) | 5.5% flagged (estimated: 43, backwater: 2)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 778.6 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>823 daily observations, seasonal gaps: 103 days avg (N=5) | 5.5% flagged (estimated: 43, backwater: 2) | Record: 3.7 years</td></tr>
...
show(plot_station_timeseries("08FC004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08FC004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08FC004/08FC004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08FC004/08FC004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08FC004"))
:::
...
<div class="download-section">
  <a href="../../08FC004/08FC004_field_visits.csv" download class="download-btn">
