...
result = plot_station_polygon("07AA004")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/07AA004">stations/07AA004 folder on GitHub</a>.
:::
...
<tr><td>07AA004</td><td>MALIGNE RIVER NEAR JASPER</td><td>52.931</td><td>-118.028</td><td>908.0 (0.0)</td><td>AB</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 81.6 years
<br><strong>Timeseries Summary:</strong> 10,229 daily observations, seasonal gaps: 4892 days avg (N=4) | 3.4% flagged (estimated: 306, partial day: 40, backwater: 3)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 2415.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>10,229 daily observations, seasonal gaps: 4892 days avg (N=4) | 3.4% flagged (estimated: 306, partial day: 40, backwater: 3) | Record: 81.6 years</td></tr>
...
show(plot_station_timeseries("07AA004"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("07AA004")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../07AA004/07AA004_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../07AA004/07AA004_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("07AA004"))
:::
