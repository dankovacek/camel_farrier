...
# 08KA012: SWIFT CREEK NEAR THE MOUTH
...
result = plot_station_polygon("08KA012")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KA012">stations/08KA012 folder on GitHub</a>.
:::
...
<tr><td>08KA012</td><td>SWIFT CREEK NEAR THE MOUTH</td><td>52.838</td><td>-119.267</td><td>132.0 (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Record Length:</strong> 15.0 years
<br><strong>Timeseries Summary:</strong> 5,387 daily observations, minor gaps: 46 days avg (N=2) | 43.3% flagged (backwater: 2118, estimated: 217)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 363.4 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>✅ Passed</td><td>5,387 daily observations, minor gaps: 46 days avg (N=2) | 43.3% flagged (backwater: 2118, estimated: 217) | Record: 15.0 years</td></tr>
...
show(plot_station_timeseries("08KA012"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KA012")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KA012/08KA012_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KA012/08KA012_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KA012"))
:::
...
<div class="download-section">
  <a href="../../08KA012/08KA012_field_visits.csv" download class="download-btn">
