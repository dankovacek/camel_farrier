...
# 08KE031: GENERAL CREEK ABOVE DIVERSION
...
result = plot_station_polygon("08KE031")
...
:::{margin}
The data used in generating the tables on this page can be downloaded from the <a href="https://github.com/dankovacek/camel_farrier/tree/main/book_docs/stations/08KE031">stations/08KE031 folder on GitHub</a>.
:::
...
<tr><td>08KE031</td><td>GENERAL CREEK ABOVE DIVERSION</td><td>52.590</td><td>-122.533</td><td>nan (0.0)</td><td>BC</td><td>D</td></tr>
</table>
...
<br><strong>Timeseries Summary:</strong> 428 daily observations, seasonal gaps: 151 days avg (N=1) | 27.3% flagged (estimated: 117)</p>
...
<tr><td><strong>Polygon Bounds</strong></td><td>✅ Passed</td><td>Catchment area: 24.5 km²</td></tr>
<tr><td><strong>Hydrometric Continuity</strong></td><td>⚠️ Warning</td><td>428 daily observations, seasonal gaps: 151 days avg (N=1) | 27.3% flagged (estimated: 117) | Record: 1.6 years</td></tr>
...
show(plot_station_timeseries("08KE031"))
:::
...
from scripts.utils.bokeh_adapters import show_with_notes
result = plot_distributions("08KE031")
show(show_with_notes(result))
:::
...
<div class="download-section">
  ...
  <a href="../../08KE031/08KE031_daily_flows.csv" download class="download-btn">
    📊 Download Daily Flows CSV
  </a>
  
  
  
  <a href="../../08KE031/08KE031_annual_instant_peaks.csv" download class="download-btn">
...
show(generate_field_visits_table("08KE031"))
:::
...
<div class="download-section">
  <a href="../../08KE031/08KE031_field_visits.csv" download class="download-btn">
