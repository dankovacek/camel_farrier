# Revision Changelog for Catchment Polygons
...
The HYSETS dataset {cite}`arsenault2020comprehensive` is used as the baseline polygon set for this exercise.
...
```{admonition} Arsenault et al. (2020)
