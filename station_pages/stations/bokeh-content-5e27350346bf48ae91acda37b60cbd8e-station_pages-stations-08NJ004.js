(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d5c156e1-9e92-485c-a510-21121fbe4545");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd5c156e1-9e92-485c-a510-21121fbe4545' but no matching script tag was found.")
        }
