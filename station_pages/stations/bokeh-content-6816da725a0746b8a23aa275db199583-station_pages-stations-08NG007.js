(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c6d6a15a-9c23-431a-b507-6be1536dd213");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c6d6a15a-9c23-431a-b507-6be1536dd213' but no matching script tag was found.")
        }
