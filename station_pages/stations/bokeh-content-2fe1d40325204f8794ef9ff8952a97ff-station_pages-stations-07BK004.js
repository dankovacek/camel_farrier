(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c67915c0-3601-47ea-8435-e7454e05f41a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c67915c0-3601-47ea-8435-e7454e05f41a' but no matching script tag was found.")
        }
