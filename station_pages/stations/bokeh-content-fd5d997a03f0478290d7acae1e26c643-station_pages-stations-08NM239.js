(function() {
  const fn = function() {
    ...
    const element = document.getElementById("db0cc315-4cc6-49ab-a387-aa25d034f2db");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'db0cc315-4cc6-49ab-a387-aa25d034f2db' but no matching script tag was found.")
        }
