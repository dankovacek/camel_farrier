(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ec8be461-784c-4e36-b66d-d765548c1c04");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ec8be461-784c-4e36-b66d-d765548c1c04' but no matching script tag was found.")
        }
