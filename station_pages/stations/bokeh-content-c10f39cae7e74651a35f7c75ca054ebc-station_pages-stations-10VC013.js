(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d339f4c0-881d-4a96-8e46-e05c17ca43db");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd339f4c0-881d-4a96-8e46-e05c17ca43db' but no matching script tag was found.")
        }
