(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bd36f774-79db-4acf-bca4-859157dd7d83");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bd36f774-79db-4acf-bca4-859157dd7d83' but no matching script tag was found.")
        }
