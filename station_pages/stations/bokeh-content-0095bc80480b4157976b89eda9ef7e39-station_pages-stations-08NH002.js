(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f02b524a-0b17-4865-87c8-fe12b2dbfe91");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f02b524a-0b17-4865-87c8-fe12b2dbfe91' but no matching script tag was found.")
        }
