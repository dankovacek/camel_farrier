(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b905ba41-8360-4bea-aa89-e3041815a981");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b905ba41-8360-4bea-aa89-e3041815a981' but no matching script tag was found.")
        }
