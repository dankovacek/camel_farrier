(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fac6bacc-f570-49c8-a679-2b771cef17ac");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fac6bacc-f570-49c8-a679-2b771cef17ac' but no matching script tag was found.")
        }
