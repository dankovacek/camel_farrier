(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a5111821-2774-46a2-b040-4bcdc1f0e290");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a5111821-2774-46a2-b040-4bcdc1f0e290' but no matching script tag was found.")
        }
