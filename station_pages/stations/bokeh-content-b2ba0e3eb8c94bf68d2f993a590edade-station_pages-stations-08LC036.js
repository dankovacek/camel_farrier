(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b8437baa-66ff-402d-9f15-300671aa8349");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b8437baa-66ff-402d-9f15-300671aa8349' but no matching script tag was found.")
        }
