(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a6ba2d1c-a8e8-4efa-a54c-95a4e388e5cd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a6ba2d1c-a8e8-4efa-a54c-95a4e388e5cd' but no matching script tag was found.")
        }
