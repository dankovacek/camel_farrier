(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e6b604a2-f657-43c5-ae7c-fb450c78c721");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e6b604a2-f657-43c5-ae7c-fb450c78c721' but no matching script tag was found.")
        }
