(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a87c2794-8ace-46b4-bdb2-bfd3a2669b3e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a87c2794-8ace-46b4-bdb2-bfd3a2669b3e' but no matching script tag was found.")
        }
