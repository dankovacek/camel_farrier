(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d3d52369-a191-4eff-b4fc-437e0f3e2da7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd3d52369-a191-4eff-b4fc-437e0f3e2da7' but no matching script tag was found.")
        }
