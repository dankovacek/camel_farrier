(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b7aad3e5-3102-46a7-adb4-61191bee121b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b7aad3e5-3102-46a7-adb4-61191bee121b' but no matching script tag was found.")
        }
