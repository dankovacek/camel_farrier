(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bfe4de21-7da3-4adf-b271-9a868111f1b2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bfe4de21-7da3-4adf-b271-9a868111f1b2' but no matching script tag was found.")
        }
