(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a70ce067-3080-4963-836b-e2e3b967be47");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a70ce067-3080-4963-836b-e2e3b967be47' but no matching script tag was found.")
        }
