(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c0972c50-844b-40d9-85d3-09a474b81107");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c0972c50-844b-40d9-85d3-09a474b81107' but no matching script tag was found.")
        }
