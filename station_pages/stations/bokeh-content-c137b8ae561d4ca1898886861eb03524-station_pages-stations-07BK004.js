(function() {
  const fn = function() {
    ...
    const element = document.getElementById("be15325b-9c40-491e-a694-b57dc7d4585d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'be15325b-9c40-491e-a694-b57dc7d4585d' but no matching script tag was found.")
        }
