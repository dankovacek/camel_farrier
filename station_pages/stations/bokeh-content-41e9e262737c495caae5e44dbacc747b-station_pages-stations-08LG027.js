(function() {
  const fn = function() {
    ...
    const element = document.getElementById("aad148b2-23eb-4365-b600-3c5cb11423d0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'aad148b2-23eb-4365-b600-3c5cb11423d0' but no matching script tag was found.")
        }
