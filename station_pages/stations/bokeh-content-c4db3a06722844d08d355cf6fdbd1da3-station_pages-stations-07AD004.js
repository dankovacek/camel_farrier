(function() {
  const fn = function() {
    ...
    const element = document.getElementById("aaa286d5-b677-4188-9f06-e37a50d6e05b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'aaa286d5-b677-4188-9f06-e37a50d6e05b' but no matching script tag was found.")
        }
