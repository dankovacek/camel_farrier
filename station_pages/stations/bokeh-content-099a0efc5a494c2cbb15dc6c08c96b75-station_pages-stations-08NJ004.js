(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ce7fd098-e3e3-4923-9a92-527395847d39");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ce7fd098-e3e3-4923-9a92-527395847d39' but no matching script tag was found.")
        }
