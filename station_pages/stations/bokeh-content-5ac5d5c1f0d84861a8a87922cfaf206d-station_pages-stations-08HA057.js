(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c3c408aa-2bc6-4490-83c7-95836b769cc1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c3c408aa-2bc6-4490-83c7-95836b769cc1' but no matching script tag was found.")
        }
