(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e5f6a568-dfd0-4def-af04-235ca1f6ed86");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e5f6a568-dfd0-4def-af04-235ca1f6ed86' but no matching script tag was found.")
        }
