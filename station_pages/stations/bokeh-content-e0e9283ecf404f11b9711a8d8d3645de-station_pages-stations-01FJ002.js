(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f3d4b11d-479d-4ed6-be84-57cf46c6388a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f3d4b11d-479d-4ed6-be84-57cf46c6388a' but no matching script tag was found.")
        }
