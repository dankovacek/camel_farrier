(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef425208-4bd9-409b-afaa-7dc1fd9813dc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef425208-4bd9-409b-afaa-7dc1fd9813dc' but no matching script tag was found.")
        }
