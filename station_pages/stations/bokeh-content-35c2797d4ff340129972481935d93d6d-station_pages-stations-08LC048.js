(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cb017ba4-a6a3-43f9-a693-afd85129ff3c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cb017ba4-a6a3-43f9-a693-afd85129ff3c' but no matching script tag was found.")
        }
