(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b80c2664-01df-43a2-acb4-912d5608de3b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b80c2664-01df-43a2-acb4-912d5608de3b' but no matching script tag was found.")
        }
