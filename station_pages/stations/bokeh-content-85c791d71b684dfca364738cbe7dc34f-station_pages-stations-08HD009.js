(function() {
  const fn = function() {
    ...
    const element = document.getElementById("be4276c8-eb27-47cd-85dc-052ad823aeb5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'be4276c8-eb27-47cd-85dc-052ad823aeb5' but no matching script tag was found.")
        }
