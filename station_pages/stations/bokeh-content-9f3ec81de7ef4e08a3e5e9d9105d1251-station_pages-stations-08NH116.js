(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f73e441f-bf38-4570-89b2-99d10ba9d915");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f73e441f-bf38-4570-89b2-99d10ba9d915' but no matching script tag was found.")
        }
