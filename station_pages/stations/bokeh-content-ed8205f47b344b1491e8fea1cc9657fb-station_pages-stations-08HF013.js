(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bc58a428-c99e-45dc-9558-fa76ec5b8563");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bc58a428-c99e-45dc-9558-fa76ec5b8563' but no matching script tag was found.")
        }
