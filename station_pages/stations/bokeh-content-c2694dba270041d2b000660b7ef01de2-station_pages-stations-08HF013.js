(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d9d3e635-e781-416c-a080-2c659257f4e2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd9d3e635-e781-416c-a080-2c659257f4e2' but no matching script tag was found.")
        }
