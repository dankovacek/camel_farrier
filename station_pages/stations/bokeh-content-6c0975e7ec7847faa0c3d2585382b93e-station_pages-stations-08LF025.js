(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f0632cfd-fcae-460d-a689-f701e6e2812b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f0632cfd-fcae-460d-a689-f701e6e2812b' but no matching script tag was found.")
        }
