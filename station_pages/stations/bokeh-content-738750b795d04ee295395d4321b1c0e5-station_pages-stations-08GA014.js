(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c1745fa2-e333-49e8-863f-763f4e2eeaf4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c1745fa2-e333-49e8-863f-763f4e2eeaf4' but no matching script tag was found.")
        }
