(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fb05dc96-ead0-4a56-a496-c7594fe9d214");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fb05dc96-ead0-4a56-a496-c7594fe9d214' but no matching script tag was found.")
        }
