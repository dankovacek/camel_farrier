(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fa32038d-5ca3-4050-9b52-5623df69c6c4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fa32038d-5ca3-4050-9b52-5623df69c6c4' but no matching script tag was found.")
        }
