(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d00bd66c-1807-43d7-8156-fd01b7e533b5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd00bd66c-1807-43d7-8156-fd01b7e533b5' but no matching script tag was found.")
        }
