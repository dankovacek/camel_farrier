(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b2568435-df55-4019-81fa-dfeee152a7f2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b2568435-df55-4019-81fa-dfeee152a7f2' but no matching script tag was found.")
        }
