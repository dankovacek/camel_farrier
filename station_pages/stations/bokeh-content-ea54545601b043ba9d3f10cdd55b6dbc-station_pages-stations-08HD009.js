(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bd3052ac-2047-414d-bd7a-52ca75f45d3b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bd3052ac-2047-414d-bd7a-52ca75f45d3b' but no matching script tag was found.")
        }
