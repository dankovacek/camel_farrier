(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a967df95-7ccf-4752-bb05-b8cabbbad051");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a967df95-7ccf-4752-bb05-b8cabbbad051' but no matching script tag was found.")
        }
