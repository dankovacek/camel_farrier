(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dc7418e2-3250-48d4-bc18-166095a26d92");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dc7418e2-3250-48d4-bc18-166095a26d92' but no matching script tag was found.")
        }
