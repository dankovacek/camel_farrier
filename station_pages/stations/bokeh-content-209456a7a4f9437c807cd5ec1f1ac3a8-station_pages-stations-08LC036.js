(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bb77ae56-34f0-48f8-9b68-54490695fe9d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb77ae56-34f0-48f8-9b68-54490695fe9d' but no matching script tag was found.")
        }
