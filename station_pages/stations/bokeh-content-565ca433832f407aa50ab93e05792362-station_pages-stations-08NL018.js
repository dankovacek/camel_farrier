(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c1359152-8792-45b7-a1d0-0921ab84f764");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c1359152-8792-45b7-a1d0-0921ab84f764' but no matching script tag was found.")
        }
