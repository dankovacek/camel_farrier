(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cd098535-0ad1-46c3-9e95-27d8f1886aed");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cd098535-0ad1-46c3-9e95-27d8f1886aed' but no matching script tag was found.")
        }
