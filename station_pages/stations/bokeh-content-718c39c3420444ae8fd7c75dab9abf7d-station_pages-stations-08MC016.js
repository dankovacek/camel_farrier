(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a864d379-5844-4903-b79d-305cb411c581");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a864d379-5844-4903-b79d-305cb411c581' but no matching script tag was found.")
        }
