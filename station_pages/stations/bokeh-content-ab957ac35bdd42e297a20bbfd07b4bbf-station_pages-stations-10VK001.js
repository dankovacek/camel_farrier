(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f6ee22ef-d83e-4206-afab-b4d113a7e0ec");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f6ee22ef-d83e-4206-afab-b4d113a7e0ec' but no matching script tag was found.")
        }
