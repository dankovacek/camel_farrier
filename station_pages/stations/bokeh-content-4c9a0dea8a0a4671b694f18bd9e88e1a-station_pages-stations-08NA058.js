(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cbba0bbd-ebec-41c6-ad54-eff449dbd519");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cbba0bbd-ebec-41c6-ad54-eff449dbd519' but no matching script tag was found.")
        }
