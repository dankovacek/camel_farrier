(function() {
  const fn = function() {
    ...
    const element = document.getElementById("db6340fa-0105-45a9-b66f-94274e044848");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'db6340fa-0105-45a9-b66f-94274e044848' but no matching script tag was found.")
        }
