(function() {
  const fn = function() {
    ...
    const element = document.getElementById("af9f65d4-9f18-4095-b2e2-bd5d59556e99");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'af9f65d4-9f18-4095-b2e2-bd5d59556e99' but no matching script tag was found.")
        }
