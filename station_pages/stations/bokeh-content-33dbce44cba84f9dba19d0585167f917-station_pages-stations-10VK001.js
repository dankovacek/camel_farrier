(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b7d4aebb-db46-4325-9581-1433fbdd2b94");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b7d4aebb-db46-4325-9581-1433fbdd2b94' but no matching script tag was found.")
        }
