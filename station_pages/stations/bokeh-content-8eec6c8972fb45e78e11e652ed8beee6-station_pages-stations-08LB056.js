(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bb439f64-e485-4eab-af4f-5d7e47dca15c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb439f64-e485-4eab-af4f-5d7e47dca15c' but no matching script tag was found.")
        }
