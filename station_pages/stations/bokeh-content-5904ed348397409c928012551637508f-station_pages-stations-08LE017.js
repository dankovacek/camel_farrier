(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ca127990-a90d-4a97-8fa4-e09dcacc8247");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ca127990-a90d-4a97-8fa4-e09dcacc8247' but no matching script tag was found.")
        }
