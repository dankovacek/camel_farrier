(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eb7f4a8e-f15d-4fab-a5b3-f7eeac7cb8a9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eb7f4a8e-f15d-4fab-a5b3-f7eeac7cb8a9' but no matching script tag was found.")
        }
