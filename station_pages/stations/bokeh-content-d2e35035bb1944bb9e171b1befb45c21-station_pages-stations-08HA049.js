(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cee874b3-94b7-481d-b8d5-8fa48713c383");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cee874b3-94b7-481d-b8d5-8fa48713c383' but no matching script tag was found.")
        }
