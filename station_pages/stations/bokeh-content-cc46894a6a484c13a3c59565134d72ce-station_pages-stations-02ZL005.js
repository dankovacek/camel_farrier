(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d977cf1b-24e1-4292-b0b4-e86307de64d1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd977cf1b-24e1-4292-b0b4-e86307de64d1' but no matching script tag was found.")
        }
