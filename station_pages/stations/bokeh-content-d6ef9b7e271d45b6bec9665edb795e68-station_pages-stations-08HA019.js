(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e7042532-ce12-4864-b54c-cb47386e2979");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e7042532-ce12-4864-b54c-cb47386e2979' but no matching script tag was found.")
        }
