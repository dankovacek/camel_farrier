(function() {
  const fn = function() {
    ...
    const element = document.getElementById("adc2124c-c5d6-4663-a553-efebbb25c79c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'adc2124c-c5d6-4663-a553-efebbb25c79c' but no matching script tag was found.")
        }
