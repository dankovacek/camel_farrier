(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b8410596-76fc-4bb4-9936-e00cd7020041");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b8410596-76fc-4bb4-9936-e00cd7020041' but no matching script tag was found.")
        }
