(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c8472dc5-8158-46a2-8684-632f278f925e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c8472dc5-8158-46a2-8684-632f278f925e' but no matching script tag was found.")
        }
