(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bb7171ec-d0b9-43e0-a2e4-152407983265");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb7171ec-d0b9-43e0-a2e4-152407983265' but no matching script tag was found.")
        }
