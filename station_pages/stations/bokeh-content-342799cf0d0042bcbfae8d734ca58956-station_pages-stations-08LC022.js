(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d2468407-22b0-4c06-a7da-bee273184347");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd2468407-22b0-4c06-a7da-bee273184347' but no matching script tag was found.")
        }
