(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fa04d507-ff74-420a-8db3-7079b0a50787");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fa04d507-ff74-420a-8db3-7079b0a50787' but no matching script tag was found.")
        }
