(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d715370e-aae0-48b3-bd5c-a904cfd54ac3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd715370e-aae0-48b3-bd5c-a904cfd54ac3' but no matching script tag was found.")
        }
