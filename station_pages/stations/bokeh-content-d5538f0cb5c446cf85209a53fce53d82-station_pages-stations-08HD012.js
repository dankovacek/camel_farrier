(function() {
  const fn = function() {
    ...
    const element = document.getElementById("df31057b-5f32-4577-8619-74529b26a596");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'df31057b-5f32-4577-8619-74529b26a596' but no matching script tag was found.")
        }
