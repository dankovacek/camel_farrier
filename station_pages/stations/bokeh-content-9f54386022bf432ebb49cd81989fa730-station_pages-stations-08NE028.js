(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c6e0d82b-9e67-49fe-b593-2201e2f6af8a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c6e0d82b-9e67-49fe-b593-2201e2f6af8a' but no matching script tag was found.")
        }
