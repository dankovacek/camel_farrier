(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c4ee51fe-eb32-4566-a9cc-692918b1cb9d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c4ee51fe-eb32-4566-a9cc-692918b1cb9d' but no matching script tag was found.")
        }
