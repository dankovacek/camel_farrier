(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f2521088-9019-4fe2-a679-c4b2ec55fe19");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f2521088-9019-4fe2-a679-c4b2ec55fe19' but no matching script tag was found.")
        }
