(function() {
  const fn = function() {
    ...
    const element = document.getElementById("aafa05f2-41f2-4ed5-bbe9-d18b8122d52c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'aafa05f2-41f2-4ed5-bbe9-d18b8122d52c' but no matching script tag was found.")
        }
