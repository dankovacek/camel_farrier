(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b4f00271-51d6-4931-b7ff-f1364fe02635");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b4f00271-51d6-4931-b7ff-f1364fe02635' but no matching script tag was found.")
        }
