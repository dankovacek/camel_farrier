(function() {
  const fn = function() {
    ...
    const element = document.getElementById("df4fd338-f98d-4c25-b1d4-af76086eca84");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'df4fd338-f98d-4c25-b1d4-af76086eca84' but no matching script tag was found.")
        }
