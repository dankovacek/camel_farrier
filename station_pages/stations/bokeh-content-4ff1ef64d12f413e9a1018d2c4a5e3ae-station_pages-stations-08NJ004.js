(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef8db138-e5c2-442d-b4a7-4e6ecff9291e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef8db138-e5c2-442d-b4a7-4e6ecff9291e' but no matching script tag was found.")
        }
