(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fa530762-a329-4964-97f9-6506a2692f0d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fa530762-a329-4964-97f9-6506a2692f0d' but no matching script tag was found.")
        }
