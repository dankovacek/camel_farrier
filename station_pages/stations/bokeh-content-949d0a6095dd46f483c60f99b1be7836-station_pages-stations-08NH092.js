(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bcc6d920-a33a-441d-9c3a-68bf1628d836");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bcc6d920-a33a-441d-9c3a-68bf1628d836' but no matching script tag was found.")
        }
