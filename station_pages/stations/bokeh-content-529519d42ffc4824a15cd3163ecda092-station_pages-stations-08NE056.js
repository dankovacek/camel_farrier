(function() {
  const fn = function() {
    ...
    const element = document.getElementById("af23c678-5e61-4a7b-982f-8737b1f1e27f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'af23c678-5e61-4a7b-982f-8737b1f1e27f' but no matching script tag was found.")
        }
