(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a1ba08ac-6ac5-4533-a3e3-2131ee9bb743");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a1ba08ac-6ac5-4533-a3e3-2131ee9bb743' but no matching script tag was found.")
        }
