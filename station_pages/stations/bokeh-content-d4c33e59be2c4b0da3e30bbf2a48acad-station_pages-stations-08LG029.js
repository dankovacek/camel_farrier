(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d72986e1-9d0b-4ce9-8a9f-279af3fc25d1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd72986e1-9d0b-4ce9-8a9f-279af3fc25d1' but no matching script tag was found.")
        }
