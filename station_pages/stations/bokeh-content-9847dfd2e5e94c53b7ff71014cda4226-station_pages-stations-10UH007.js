(function() {
  const fn = function() {
    ...
    const element = document.getElementById("be829adb-bd39-465e-bb4c-69c50815e68a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'be829adb-bd39-465e-bb4c-69c50815e68a' but no matching script tag was found.")
        }
