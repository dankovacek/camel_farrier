(function() {
  const fn = function() {
    ...
    const element = document.getElementById("df72852f-b6e3-4396-858b-dcd41766fb7d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'df72852f-b6e3-4396-858b-dcd41766fb7d' but no matching script tag was found.")
        }
