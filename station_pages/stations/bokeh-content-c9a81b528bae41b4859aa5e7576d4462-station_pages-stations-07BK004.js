(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bf6c9e61-d0c0-47c6-9751-0ff496299402");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bf6c9e61-d0c0-47c6-9751-0ff496299402' but no matching script tag was found.")
        }
