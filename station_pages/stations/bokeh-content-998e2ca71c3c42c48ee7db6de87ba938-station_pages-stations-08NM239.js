(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b9729f90-f59d-4aad-b614-c7e8e0b01c51");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b9729f90-f59d-4aad-b614-c7e8e0b01c51' but no matching script tag was found.")
        }
