(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bf407bc1-b556-4185-9c42-a33a741a862e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bf407bc1-b556-4185-9c42-a33a741a862e' but no matching script tag was found.")
        }
