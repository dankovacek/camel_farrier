(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fbc02bac-ca94-40e8-bcd4-09cd801e1b60");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fbc02bac-ca94-40e8-bcd4-09cd801e1b60' but no matching script tag was found.")
        }
