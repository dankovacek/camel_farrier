(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d4e11187-c7db-4cff-ac35-b541372e2f82");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd4e11187-c7db-4cff-ac35-b541372e2f82' but no matching script tag was found.")
        }
