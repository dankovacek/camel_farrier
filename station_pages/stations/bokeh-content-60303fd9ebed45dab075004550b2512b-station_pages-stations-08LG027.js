(function() {
  const fn = function() {
    ...
    const element = document.getElementById("db499089-2bbe-402c-88d3-48f00c7471eb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'db499089-2bbe-402c-88d3-48f00c7471eb' but no matching script tag was found.")
        }
