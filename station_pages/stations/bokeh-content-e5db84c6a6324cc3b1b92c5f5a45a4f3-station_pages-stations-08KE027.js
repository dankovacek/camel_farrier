(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ec0e1cde-30c6-4794-b490-3bf46881d045");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ec0e1cde-30c6-4794-b490-3bf46881d045' but no matching script tag was found.")
        }
