(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f0fc6b55-979d-417f-854c-29574b9d263b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f0fc6b55-979d-417f-854c-29574b9d263b' but no matching script tag was found.")
        }
