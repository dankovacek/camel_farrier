(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f3f8eff5-ce97-42e1-b9a6-197836479687");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f3f8eff5-ce97-42e1-b9a6-197836479687' but no matching script tag was found.")
        }
