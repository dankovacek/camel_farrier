(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f01303f2-e14e-4240-ba00-31b328f253f4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f01303f2-e14e-4240-ba00-31b328f253f4' but no matching script tag was found.")
        }
