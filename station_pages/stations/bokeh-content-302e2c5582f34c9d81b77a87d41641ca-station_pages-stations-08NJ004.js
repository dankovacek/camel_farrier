(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e0496fd4-68e3-4110-b923-a0908d80cfeb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e0496fd4-68e3-4110-b923-a0908d80cfeb' but no matching script tag was found.")
        }
