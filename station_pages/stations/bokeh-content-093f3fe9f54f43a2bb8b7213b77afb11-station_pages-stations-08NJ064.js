(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cbe3b4eb-1d25-4960-87ab-9d7547621dde");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cbe3b4eb-1d25-4960-87ab-9d7547621dde' but no matching script tag was found.")
        }
