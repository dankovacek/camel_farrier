(function() {
  const fn = function() {
    ...
    const element = document.getElementById("de9de510-0657-4d72-8935-3571bd494a37");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de9de510-0657-4d72-8935-3571bd494a37' but no matching script tag was found.")
        }
