(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e108af54-8557-4141-b0b3-602623c75d50");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e108af54-8557-4141-b0b3-602623c75d50' but no matching script tag was found.")
        }
