(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d42efc3f-e16c-45d0-aa26-74ef4cf8fec7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd42efc3f-e16c-45d0-aa26-74ef4cf8fec7' but no matching script tag was found.")
        }
