(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e40aaab6-642f-414e-a9b1-d3a55f09b7d9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e40aaab6-642f-414e-a9b1-d3a55f09b7d9' but no matching script tag was found.")
        }
