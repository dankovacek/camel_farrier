(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bd6677fe-dc3e-4809-9cae-51140417c56f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bd6677fe-dc3e-4809-9cae-51140417c56f' but no matching script tag was found.")
        }
