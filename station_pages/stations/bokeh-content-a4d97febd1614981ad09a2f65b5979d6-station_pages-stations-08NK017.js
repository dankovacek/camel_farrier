(function() {
  const fn = function() {
    ...
    const element = document.getElementById("de775af4-3420-4c73-9740-1639447c8f80");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de775af4-3420-4c73-9740-1639447c8f80' but no matching script tag was found.")
        }
