(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e2680157-f6b8-4ff4-8b03-55c60c975ffc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e2680157-f6b8-4ff4-8b03-55c60c975ffc' but no matching script tag was found.")
        }
