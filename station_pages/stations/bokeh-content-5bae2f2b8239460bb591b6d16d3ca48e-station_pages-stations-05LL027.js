(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e377b955-d741-44a1-9c6f-7b0d2431bda8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e377b955-d741-44a1-9c6f-7b0d2431bda8' but no matching script tag was found.")
        }
