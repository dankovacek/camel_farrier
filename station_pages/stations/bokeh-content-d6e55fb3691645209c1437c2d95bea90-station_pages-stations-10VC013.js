(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c860d9eb-8a00-43a7-855e-f949c939d4d8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c860d9eb-8a00-43a7-855e-f949c939d4d8' but no matching script tag was found.")
        }
