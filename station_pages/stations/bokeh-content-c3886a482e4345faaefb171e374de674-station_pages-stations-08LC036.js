(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d6d1e933-0d3a-4956-b579-08e8bcd3c6d6");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd6d1e933-0d3a-4956-b579-08e8bcd3c6d6' but no matching script tag was found.")
        }
