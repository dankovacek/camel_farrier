(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a630178b-abfb-43cd-b287-5fadc0f80a33");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a630178b-abfb-43cd-b287-5fadc0f80a33' but no matching script tag was found.")
        }
