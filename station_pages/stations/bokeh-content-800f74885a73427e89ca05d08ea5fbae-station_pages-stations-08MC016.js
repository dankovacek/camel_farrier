(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b96e56c4-3aa0-4aaa-ae07-4930b19b8b31");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b96e56c4-3aa0-4aaa-ae07-4930b19b8b31' but no matching script tag was found.")
        }
