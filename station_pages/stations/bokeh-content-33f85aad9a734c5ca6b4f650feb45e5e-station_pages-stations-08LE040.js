(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef007634-ee3a-413f-aff3-467e7d3ec2b5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef007634-ee3a-413f-aff3-467e7d3ec2b5' but no matching script tag was found.")
        }
