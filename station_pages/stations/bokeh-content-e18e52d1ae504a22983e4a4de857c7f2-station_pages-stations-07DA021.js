(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eeb6d679-481c-48c9-9593-afa9c6690cb1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eeb6d679-481c-48c9-9593-afa9c6690cb1' but no matching script tag was found.")
        }
