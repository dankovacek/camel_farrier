(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b3ef6a81-05de-4615-8bc9-5654bcc464ac");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b3ef6a81-05de-4615-8bc9-5654bcc464ac' but no matching script tag was found.")
        }
