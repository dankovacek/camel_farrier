(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e0f02a8f-6645-40d2-b076-df3325002fec");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e0f02a8f-6645-40d2-b076-df3325002fec' but no matching script tag was found.")
        }
