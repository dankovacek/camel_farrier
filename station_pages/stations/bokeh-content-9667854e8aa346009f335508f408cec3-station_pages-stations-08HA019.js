(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ece892c1-48e7-468b-b4f6-e8112ad62207");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ece892c1-48e7-468b-b4f6-e8112ad62207' but no matching script tag was found.")
        }
