(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bd8186b5-2856-414c-a87f-d646c403c449");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bd8186b5-2856-414c-a87f-d646c403c449' but no matching script tag was found.")
        }
