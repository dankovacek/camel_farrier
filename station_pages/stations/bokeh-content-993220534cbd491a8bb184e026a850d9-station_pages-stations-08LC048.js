(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f3ae5216-4cda-4ac4-91fa-386be5354296");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f3ae5216-4cda-4ac4-91fa-386be5354296' but no matching script tag was found.")
        }
