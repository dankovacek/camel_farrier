(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b56728b3-28ab-4a5b-9102-c0ebb8ec3c8a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b56728b3-28ab-4a5b-9102-c0ebb8ec3c8a' but no matching script tag was found.")
        }
