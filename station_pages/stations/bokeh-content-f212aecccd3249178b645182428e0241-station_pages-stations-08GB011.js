(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b3951ba2-b656-431e-83e1-8fcdbe70c9c4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b3951ba2-b656-431e-83e1-8fcdbe70c9c4' but no matching script tag was found.")
        }
