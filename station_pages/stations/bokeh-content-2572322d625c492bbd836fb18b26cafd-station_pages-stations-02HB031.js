(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ea39b31e-8b68-452e-b74a-0e8b8470e26d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ea39b31e-8b68-452e-b74a-0e8b8470e26d' but no matching script tag was found.")
        }
