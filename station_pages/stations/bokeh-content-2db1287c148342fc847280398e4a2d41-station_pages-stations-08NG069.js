(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f78bc92f-7a84-43ec-b3d5-4b6432f1ca27");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f78bc92f-7a84-43ec-b3d5-4b6432f1ca27' but no matching script tag was found.")
        }
