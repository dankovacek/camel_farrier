(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e0567faf-6691-443d-a0f6-533dd96dc762");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e0567faf-6691-443d-a0f6-533dd96dc762' but no matching script tag was found.")
        }
