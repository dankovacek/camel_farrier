(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e45ba2bf-e95f-406c-9b7a-c1a270ef5d98");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e45ba2bf-e95f-406c-9b7a-c1a270ef5d98' but no matching script tag was found.")
        }
