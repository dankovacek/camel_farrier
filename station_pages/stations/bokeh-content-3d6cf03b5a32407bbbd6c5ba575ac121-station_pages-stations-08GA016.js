(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e28727ee-a7ea-4546-8324-e5e40a5a37b7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e28727ee-a7ea-4546-8324-e5e40a5a37b7' but no matching script tag was found.")
        }
