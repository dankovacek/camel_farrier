(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fc332a92-81fe-4ba0-8091-939c4933d8e3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fc332a92-81fe-4ba0-8091-939c4933d8e3' but no matching script tag was found.")
        }
