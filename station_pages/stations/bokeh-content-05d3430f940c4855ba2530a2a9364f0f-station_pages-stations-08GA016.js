(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c3c41a0e-9444-40f0-ad79-b0bc3e5722df");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c3c41a0e-9444-40f0-ad79-b0bc3e5722df' but no matching script tag was found.")
        }
