(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b9a4fe2f-20f3-49b8-b47a-cfd2cb6e7b48");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b9a4fe2f-20f3-49b8-b47a-cfd2cb6e7b48' but no matching script tag was found.")
        }
