(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eefaab36-b60c-4c08-b6b4-107d59593e4a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eefaab36-b60c-4c08-b6b4-107d59593e4a' but no matching script tag was found.")
        }
