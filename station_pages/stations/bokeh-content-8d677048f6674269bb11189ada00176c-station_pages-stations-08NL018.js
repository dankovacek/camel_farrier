(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c4680203-d1fd-482d-84ce-b20a1952c506");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c4680203-d1fd-482d-84ce-b20a1952c506' but no matching script tag was found.")
        }
