(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f033c9a6-c8af-464a-916c-6905d27e5acb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f033c9a6-c8af-464a-916c-6905d27e5acb' but no matching script tag was found.")
        }
