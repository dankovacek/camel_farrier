(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e71964ae-0850-467b-84f4-2741f5e65680");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e71964ae-0850-467b-84f4-2741f5e65680' but no matching script tag was found.")
        }
