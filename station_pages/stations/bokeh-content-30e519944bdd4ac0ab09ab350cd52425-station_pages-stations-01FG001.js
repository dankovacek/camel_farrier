(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cb2a3436-7060-4bbc-b23a-619f893c62dc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cb2a3436-7060-4bbc-b23a-619f893c62dc' but no matching script tag was found.")
        }
