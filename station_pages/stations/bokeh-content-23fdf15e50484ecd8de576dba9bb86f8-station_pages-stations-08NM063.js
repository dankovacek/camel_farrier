(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bee0e5c1-fd84-4841-a0d6-857de2fdc43e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bee0e5c1-fd84-4841-a0d6-857de2fdc43e' but no matching script tag was found.")
        }
