(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d99288df-2e92-4de1-9199-471c301afe9c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd99288df-2e92-4de1-9199-471c301afe9c' but no matching script tag was found.")
        }
