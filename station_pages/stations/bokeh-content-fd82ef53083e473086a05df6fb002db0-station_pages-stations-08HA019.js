(function() {
  const fn = function() {
    ...
    const element = document.getElementById("aff0a8fe-700f-491e-a25f-86d80a186591");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'aff0a8fe-700f-491e-a25f-86d80a186591' but no matching script tag was found.")
        }
