(function() {
  const fn = function() {
    ...
    const element = document.getElementById("db08645e-9d5d-4912-843c-bb5bd2603a43");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'db08645e-9d5d-4912-843c-bb5bd2603a43' but no matching script tag was found.")
        }
