(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b816253f-ad9f-484f-aed2-30d06f4e11ed");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b816253f-ad9f-484f-aed2-30d06f4e11ed' but no matching script tag was found.")
        }
