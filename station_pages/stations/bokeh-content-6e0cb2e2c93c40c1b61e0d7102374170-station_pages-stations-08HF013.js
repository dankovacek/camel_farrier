(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ba8d62b1-33eb-4b0f-bcf8-99e7c6ab60ff");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ba8d62b1-33eb-4b0f-bcf8-99e7c6ab60ff' but no matching script tag was found.")
        }
