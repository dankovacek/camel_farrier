(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a9782e41-fa17-4634-8040-3921cb3da033");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a9782e41-fa17-4634-8040-3921cb3da033' but no matching script tag was found.")
        }
