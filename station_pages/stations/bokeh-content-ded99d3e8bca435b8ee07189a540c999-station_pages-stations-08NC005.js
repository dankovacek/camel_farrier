(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c97c65e0-17c4-4bcb-90f8-a6579efb26a2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c97c65e0-17c4-4bcb-90f8-a6579efb26a2' but no matching script tag was found.")
        }
