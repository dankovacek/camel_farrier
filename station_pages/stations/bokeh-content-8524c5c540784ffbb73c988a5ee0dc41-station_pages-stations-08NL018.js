(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b1d8cede-6461-4b65-8477-778c8ee16f9e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b1d8cede-6461-4b65-8477-778c8ee16f9e' but no matching script tag was found.")
        }
