(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eaf0f75f-6cee-4840-a2e6-2889e839209b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eaf0f75f-6cee-4840-a2e6-2889e839209b' but no matching script tag was found.")
        }
