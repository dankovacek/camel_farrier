(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a94ea097-1999-4309-8593-2c5a8e4d36b7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a94ea097-1999-4309-8593-2c5a8e4d36b7' but no matching script tag was found.")
        }
