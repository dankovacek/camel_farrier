(function() {
  const fn = function() {
    ...
    const element = document.getElementById("be34d6a0-2b76-4b11-949b-fc503fe6042e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'be34d6a0-2b76-4b11-949b-fc503fe6042e' but no matching script tag was found.")
        }
