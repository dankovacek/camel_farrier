(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a45c1c9a-d232-489a-b14c-62fc9084b09c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a45c1c9a-d232-489a-b14c-62fc9084b09c' but no matching script tag was found.")
        }
