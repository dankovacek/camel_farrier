(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d0b66d5f-0eef-4190-ad24-f195bb185d95");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd0b66d5f-0eef-4190-ad24-f195bb185d95' but no matching script tag was found.")
        }
