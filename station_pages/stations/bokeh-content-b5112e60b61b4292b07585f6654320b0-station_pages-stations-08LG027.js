(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e9ba154e-754a-4958-98ad-b3003306404e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e9ba154e-754a-4958-98ad-b3003306404e' but no matching script tag was found.")
        }
