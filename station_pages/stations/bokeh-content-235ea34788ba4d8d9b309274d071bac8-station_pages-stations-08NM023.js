(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c2321710-a013-4d40-809c-ea4cd415a748");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c2321710-a013-4d40-809c-ea4cd415a748' but no matching script tag was found.")
        }
