(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d4a8a88a-d07e-4404-a258-8005d1c328e7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd4a8a88a-d07e-4404-a258-8005d1c328e7' but no matching script tag was found.")
        }
