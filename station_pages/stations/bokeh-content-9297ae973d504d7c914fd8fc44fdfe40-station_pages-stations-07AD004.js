(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d4ce4d2c-0739-4b19-9357-b21ee887e610");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd4ce4d2c-0739-4b19-9357-b21ee887e610' but no matching script tag was found.")
        }
