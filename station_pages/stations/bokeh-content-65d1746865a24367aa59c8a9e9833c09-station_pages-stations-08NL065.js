(function() {
  const fn = function() {
    ...
    const element = document.getElementById("baf8ff73-95c7-4673-8670-6c0b6ba1216f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'baf8ff73-95c7-4673-8670-6c0b6ba1216f' but no matching script tag was found.")
        }
