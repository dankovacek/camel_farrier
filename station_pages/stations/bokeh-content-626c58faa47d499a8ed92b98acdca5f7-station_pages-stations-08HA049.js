(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e3b002da-f7ed-430a-a54e-341b47b97f97");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e3b002da-f7ed-430a-a54e-341b47b97f97' but no matching script tag was found.")
        }
