(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b8dfecc3-910f-4638-b77c-4d7cd78b02c3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b8dfecc3-910f-4638-b77c-4d7cd78b02c3' but no matching script tag was found.")
        }
