(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fc60116a-0ff3-4bac-91c6-bb9f43c3f955");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fc60116a-0ff3-4bac-91c6-bb9f43c3f955' but no matching script tag was found.")
        }
