(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e3043a1e-62e0-4661-95e0-93e19880c5f4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e3043a1e-62e0-4661-95e0-93e19880c5f4' but no matching script tag was found.")
        }
