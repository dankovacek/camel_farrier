(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a5231a07-db30-4b8b-95d5-537665512b03");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a5231a07-db30-4b8b-95d5-537665512b03' but no matching script tag was found.")
        }
