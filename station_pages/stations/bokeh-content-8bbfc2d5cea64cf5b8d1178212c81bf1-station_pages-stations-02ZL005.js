(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d339d0bf-ee7f-4f84-b219-d42c5ae59745");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd339d0bf-ee7f-4f84-b219-d42c5ae59745' but no matching script tag was found.")
        }
