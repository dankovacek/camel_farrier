(function() {
  const fn = function() {
    ...
    const element = document.getElementById("baa12476-ee53-4728-82b7-ff0b9d1cce5a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'baa12476-ee53-4728-82b7-ff0b9d1cce5a' but no matching script tag was found.")
        }
