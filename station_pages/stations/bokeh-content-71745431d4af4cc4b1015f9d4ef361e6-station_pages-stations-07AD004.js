(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d70dbb41-4361-45b2-ab47-064ada8f536b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd70dbb41-4361-45b2-ab47-064ada8f536b' but no matching script tag was found.")
        }
