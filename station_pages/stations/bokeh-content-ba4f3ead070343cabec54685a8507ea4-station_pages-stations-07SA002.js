(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eadaf80f-1cd9-4328-8656-54f342f085e2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eadaf80f-1cd9-4328-8656-54f342f085e2' but no matching script tag was found.")
        }
