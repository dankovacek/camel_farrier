(function() {
  const fn = function() {
    ...
    const element = document.getElementById("da27e401-687a-4fc9-ae6b-10c4063425d3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'da27e401-687a-4fc9-ae6b-10c4063425d3' but no matching script tag was found.")
        }
