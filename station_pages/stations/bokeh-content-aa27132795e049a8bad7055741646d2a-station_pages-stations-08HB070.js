(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ac50724f-a6f0-4322-af73-f79131ffcded");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ac50724f-a6f0-4322-af73-f79131ffcded' but no matching script tag was found.")
        }
