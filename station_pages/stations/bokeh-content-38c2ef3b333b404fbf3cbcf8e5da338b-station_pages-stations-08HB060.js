(function() {
  const fn = function() {
    ...
    const element = document.getElementById("be2a0523-1de2-4632-b633-9b25765b0fd7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'be2a0523-1de2-4632-b633-9b25765b0fd7' but no matching script tag was found.")
        }
