(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e564d8bb-1ac5-4429-8f66-dd93d186baed");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e564d8bb-1ac5-4429-8f66-dd93d186baed' but no matching script tag was found.")
        }
