(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b381cf00-423c-42f6-9a18-f4b585f2cd93");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b381cf00-423c-42f6-9a18-f4b585f2cd93' but no matching script tag was found.")
        }
