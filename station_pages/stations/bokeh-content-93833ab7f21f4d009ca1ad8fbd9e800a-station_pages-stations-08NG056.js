(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b0481575-a1b8-4c2d-8bb5-118add706208");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b0481575-a1b8-4c2d-8bb5-118add706208' but no matching script tag was found.")
        }
