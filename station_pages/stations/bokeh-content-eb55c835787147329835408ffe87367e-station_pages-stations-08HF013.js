(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d476d89f-6957-4aee-8ad7-996a001e7cb7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd476d89f-6957-4aee-8ad7-996a001e7cb7' but no matching script tag was found.")
        }
