(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fef11a64-44fb-400b-9342-740c542daaf2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fef11a64-44fb-400b-9342-740c542daaf2' but no matching script tag was found.")
        }
