(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c8b2698b-ec22-4450-be13-fdcb8ef056cd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c8b2698b-ec22-4450-be13-fdcb8ef056cd' but no matching script tag was found.")
        }
