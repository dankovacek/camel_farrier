(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef462da6-0072-4d84-8765-497e89dcaf93");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef462da6-0072-4d84-8765-497e89dcaf93' but no matching script tag was found.")
        }
