(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cc6933ab-dba8-493d-b8d2-13351b865f90");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cc6933ab-dba8-493d-b8d2-13351b865f90' but no matching script tag was found.")
        }
