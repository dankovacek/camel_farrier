(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d7681ff2-b12d-4a88-b780-64853b59d8a9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd7681ff2-b12d-4a88-b780-64853b59d8a9' but no matching script tag was found.")
        }
