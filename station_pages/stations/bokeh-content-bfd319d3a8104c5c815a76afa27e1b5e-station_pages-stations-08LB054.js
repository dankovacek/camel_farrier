(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b4e63b6a-d4cb-433a-9120-0c5782d5ebdd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b4e63b6a-d4cb-433a-9120-0c5782d5ebdd' but no matching script tag was found.")
        }
