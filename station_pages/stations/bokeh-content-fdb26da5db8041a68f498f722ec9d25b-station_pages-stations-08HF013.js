(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c774ac73-3527-46bb-a77d-2a863d4f9579");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c774ac73-3527-46bb-a77d-2a863d4f9579' but no matching script tag was found.")
        }
