(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b6b62aa2-ec20-451a-b0c8-a445703eacbc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b6b62aa2-ec20-451a-b0c8-a445703eacbc' but no matching script tag was found.")
        }
