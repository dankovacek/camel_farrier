(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cf266c42-f10d-4759-84ba-c3eebe033d03");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cf266c42-f10d-4759-84ba-c3eebe033d03' but no matching script tag was found.")
        }
