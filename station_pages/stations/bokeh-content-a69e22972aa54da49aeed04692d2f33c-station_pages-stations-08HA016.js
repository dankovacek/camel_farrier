(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b8aa94d9-61c4-420f-aa56-4202a0eefad8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b8aa94d9-61c4-420f-aa56-4202a0eefad8' but no matching script tag was found.")
        }
