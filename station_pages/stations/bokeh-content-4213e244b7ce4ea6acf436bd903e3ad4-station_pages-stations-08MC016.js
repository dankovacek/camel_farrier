(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fb3bd880-dccf-481f-b217-9e2758c5e4ae");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fb3bd880-dccf-481f-b217-9e2758c5e4ae' but no matching script tag was found.")
        }
