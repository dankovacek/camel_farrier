(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a813c445-23eb-4ae4-b5d6-f12d1656c75b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a813c445-23eb-4ae4-b5d6-f12d1656c75b' but no matching script tag was found.")
        }
