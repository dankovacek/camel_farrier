(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a309160b-e8b0-4324-9e3f-83f3eeaafe39");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a309160b-e8b0-4324-9e3f-83f3eeaafe39' but no matching script tag was found.")
        }
