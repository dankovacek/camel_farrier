(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a9739f76-7bd4-42ad-87ef-f02a49971ee5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a9739f76-7bd4-42ad-87ef-f02a49971ee5' but no matching script tag was found.")
        }
