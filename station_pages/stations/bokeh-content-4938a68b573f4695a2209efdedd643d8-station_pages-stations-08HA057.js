(function() {
  const fn = function() {
    ...
    const element = document.getElementById("def7c577-9498-4167-a1ef-0e3b2687f650");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'def7c577-9498-4167-a1ef-0e3b2687f650' but no matching script tag was found.")
        }
