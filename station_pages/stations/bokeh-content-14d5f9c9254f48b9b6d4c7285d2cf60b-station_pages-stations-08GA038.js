(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b63350a8-4f0e-4ea1-ada0-af89d2767b41");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b63350a8-4f0e-4ea1-ada0-af89d2767b41' but no matching script tag was found.")
        }
