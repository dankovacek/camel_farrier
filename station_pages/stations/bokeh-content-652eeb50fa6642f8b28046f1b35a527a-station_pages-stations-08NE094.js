(function() {
  const fn = function() {
    ...
    const element = document.getElementById("be65c58d-01b7-47df-bb32-1cf421053508");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'be65c58d-01b7-47df-bb32-1cf421053508' but no matching script tag was found.")
        }
