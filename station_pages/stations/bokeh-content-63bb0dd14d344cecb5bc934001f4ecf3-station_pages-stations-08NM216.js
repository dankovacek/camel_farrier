(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b0bb46df-c0d0-46a1-b376-266a8f67664f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b0bb46df-c0d0-46a1-b376-266a8f67664f' but no matching script tag was found.")
        }
