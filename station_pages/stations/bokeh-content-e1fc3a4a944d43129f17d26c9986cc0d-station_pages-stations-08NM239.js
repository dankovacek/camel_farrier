(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d5c0b007-9f08-421f-bef7-2efb10decc9d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd5c0b007-9f08-421f-bef7-2efb10decc9d' but no matching script tag was found.")
        }
