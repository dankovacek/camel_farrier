(function() {
  const fn = function() {
    ...
    const element = document.getElementById("df9b2a1c-ca24-4a5e-b3c3-72a7a38ad683");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'df9b2a1c-ca24-4a5e-b3c3-72a7a38ad683' but no matching script tag was found.")
        }
