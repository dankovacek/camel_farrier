(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fd48f040-94aa-4041-9e9c-2366db79decd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fd48f040-94aa-4041-9e9c-2366db79decd' but no matching script tag was found.")
        }
