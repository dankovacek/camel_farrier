(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cc0506a6-db9b-44ff-9a42-fce391535697");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cc0506a6-db9b-44ff-9a42-fce391535697' but no matching script tag was found.")
        }
