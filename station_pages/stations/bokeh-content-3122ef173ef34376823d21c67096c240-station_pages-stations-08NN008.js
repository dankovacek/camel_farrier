(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bafa9c55-89a5-49c5-a147-a6786178f9ae");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bafa9c55-89a5-49c5-a147-a6786178f9ae' but no matching script tag was found.")
        }
