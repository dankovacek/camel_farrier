(function() {
  const fn = function() {
    ...
    const element = document.getElementById("da0579a7-3321-49da-af49-45d9393b4897");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'da0579a7-3321-49da-af49-45d9393b4897' but no matching script tag was found.")
        }
