(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b8bf19dd-f885-43b6-b3b1-7b947d3b3bbc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b8bf19dd-f885-43b6-b3b1-7b947d3b3bbc' but no matching script tag was found.")
        }
