(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a932abc8-686f-4af3-8ad5-765f6b794513");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a932abc8-686f-4af3-8ad5-765f6b794513' but no matching script tag was found.")
        }
