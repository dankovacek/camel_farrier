(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f10ee750-b4a0-434e-a8f2-52d358154ea5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f10ee750-b4a0-434e-a8f2-52d358154ea5' but no matching script tag was found.")
        }
