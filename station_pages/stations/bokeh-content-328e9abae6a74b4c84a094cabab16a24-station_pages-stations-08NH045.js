(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bc5c4d9f-372c-4571-8af4-671d973b819e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bc5c4d9f-372c-4571-8af4-671d973b819e' but no matching script tag was found.")
        }
