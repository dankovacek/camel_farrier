(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c86ffa05-fd42-49e8-8091-a596b4230354");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c86ffa05-fd42-49e8-8091-a596b4230354' but no matching script tag was found.")
        }
