(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e1c06754-bccf-4462-a109-dca2a3e44c20");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e1c06754-bccf-4462-a109-dca2a3e44c20' but no matching script tag was found.")
        }
