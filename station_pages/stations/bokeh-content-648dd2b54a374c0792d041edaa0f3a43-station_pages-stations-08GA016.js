(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b0a278c8-394f-4663-973e-8ea0f4b2a3ad");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b0a278c8-394f-4663-973e-8ea0f4b2a3ad' but no matching script tag was found.")
        }
