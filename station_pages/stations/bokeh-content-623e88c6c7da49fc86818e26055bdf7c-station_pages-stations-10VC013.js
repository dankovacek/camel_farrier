(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dc122748-e549-43d2-9cac-ae4f0d38af68");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dc122748-e549-43d2-9cac-ae4f0d38af68' but no matching script tag was found.")
        }
