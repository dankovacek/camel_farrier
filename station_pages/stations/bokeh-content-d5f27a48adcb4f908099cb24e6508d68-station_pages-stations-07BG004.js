(function() {
  const fn = function() {
    ...
    const element = document.getElementById("db6f81c4-3a70-4130-974c-3eab8faa5363");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'db6f81c4-3a70-4130-974c-3eab8faa5363' but no matching script tag was found.")
        }
