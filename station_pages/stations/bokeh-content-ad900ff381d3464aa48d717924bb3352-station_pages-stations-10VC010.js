(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e2476fb8-a8b9-43de-98c9-96d570dcb3fa");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e2476fb8-a8b9-43de-98c9-96d570dcb3fa' but no matching script tag was found.")
        }
