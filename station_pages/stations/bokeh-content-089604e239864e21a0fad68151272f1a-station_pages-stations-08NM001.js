(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ce22289a-2343-4220-94f2-bf414ab679e1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ce22289a-2343-4220-94f2-bf414ab679e1' but no matching script tag was found.")
        }
