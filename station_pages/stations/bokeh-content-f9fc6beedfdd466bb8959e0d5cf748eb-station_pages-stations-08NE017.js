(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c9e07ef2-15f0-409d-936b-0151c95b30ad");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c9e07ef2-15f0-409d-936b-0151c95b30ad' but no matching script tag was found.")
        }
