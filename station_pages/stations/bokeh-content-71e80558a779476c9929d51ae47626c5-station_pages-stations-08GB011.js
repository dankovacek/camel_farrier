(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b35ab7ff-6857-4e36-ab4d-f6b9f9e51a35");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b35ab7ff-6857-4e36-ab4d-f6b9f9e51a35' but no matching script tag was found.")
        }
