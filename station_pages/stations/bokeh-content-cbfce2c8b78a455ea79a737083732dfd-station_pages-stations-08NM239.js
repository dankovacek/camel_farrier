(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bb396dac-c1d9-45f0-a615-57f8903a3f2a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb396dac-c1d9-45f0-a615-57f8903a3f2a' but no matching script tag was found.")
        }
