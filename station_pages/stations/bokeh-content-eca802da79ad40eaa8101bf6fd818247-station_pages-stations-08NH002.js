(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a834726d-aed6-49a6-8660-812a12f77d18");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a834726d-aed6-49a6-8660-812a12f77d18' but no matching script tag was found.")
        }
