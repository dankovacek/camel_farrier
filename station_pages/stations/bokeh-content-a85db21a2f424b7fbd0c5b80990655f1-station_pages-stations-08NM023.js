(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ad45e147-68b5-47f1-8a39-17f4976b1972");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ad45e147-68b5-47f1-8a39-17f4976b1972' but no matching script tag was found.")
        }
