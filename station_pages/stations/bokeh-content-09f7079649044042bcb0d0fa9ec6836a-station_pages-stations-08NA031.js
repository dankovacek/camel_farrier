(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b3af5ccf-73fc-4897-a6fd-fe31fa0a9164");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b3af5ccf-73fc-4897-a6fd-fe31fa0a9164' but no matching script tag was found.")
        }
