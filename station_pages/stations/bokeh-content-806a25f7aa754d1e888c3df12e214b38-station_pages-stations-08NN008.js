(function() {
  const fn = function() {
    ...
    const element = document.getElementById("afe2c80f-decb-487f-b4c1-55866354d653");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'afe2c80f-decb-487f-b4c1-55866354d653' but no matching script tag was found.")
        }
