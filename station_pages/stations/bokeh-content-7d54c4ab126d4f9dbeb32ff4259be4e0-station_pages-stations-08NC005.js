(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eff2c306-3640-493b-8413-ba3e166001d4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eff2c306-3640-493b-8413-ba3e166001d4' but no matching script tag was found.")
        }
