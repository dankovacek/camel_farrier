(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ddb00739-33c4-4e8f-97aa-ecf01b16cf52");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ddb00739-33c4-4e8f-97aa-ecf01b16cf52' but no matching script tag was found.")
        }
