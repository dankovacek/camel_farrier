(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fe4a327d-56f6-4e00-a202-ba10a964d6d0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fe4a327d-56f6-4e00-a202-ba10a964d6d0' but no matching script tag was found.")
        }
