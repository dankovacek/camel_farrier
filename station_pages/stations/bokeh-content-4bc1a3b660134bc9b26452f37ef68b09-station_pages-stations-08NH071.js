(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a6259362-cac3-4e83-826e-b32628111cf8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a6259362-cac3-4e83-826e-b32628111cf8' but no matching script tag was found.")
        }
