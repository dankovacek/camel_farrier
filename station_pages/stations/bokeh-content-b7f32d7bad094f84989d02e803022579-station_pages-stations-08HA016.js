(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef6e5066-22dd-4f54-a814-f05998c1f892");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef6e5066-22dd-4f54-a814-f05998c1f892' but no matching script tag was found.")
        }
