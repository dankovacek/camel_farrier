(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ec2a1d4b-a10c-47c7-b489-413fce322893");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ec2a1d4b-a10c-47c7-b489-413fce322893' but no matching script tag was found.")
        }
