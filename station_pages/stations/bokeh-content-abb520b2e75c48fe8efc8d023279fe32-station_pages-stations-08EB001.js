(function() {
  const fn = function() {
    ...
    const element = document.getElementById("aa137d52-ffd2-493a-9389-a4c2a454d22b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'aa137d52-ffd2-493a-9389-a4c2a454d22b' but no matching script tag was found.")
        }
