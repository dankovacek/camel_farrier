(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a428a08b-92ee-4729-add0-eacc4a874e0f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a428a08b-92ee-4729-add0-eacc4a874e0f' but no matching script tag was found.")
        }
