(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b30eb6a1-bccc-4aff-8348-d3179232a425");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b30eb6a1-bccc-4aff-8348-d3179232a425' but no matching script tag was found.")
        }
