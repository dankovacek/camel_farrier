(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ab05552c-b9a9-484c-8937-7c9781061edb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ab05552c-b9a9-484c-8937-7c9781061edb' but no matching script tag was found.")
        }
