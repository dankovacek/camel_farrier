(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bfaaec67-6d0e-415d-a36a-4fbf55018a2f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bfaaec67-6d0e-415d-a36a-4fbf55018a2f' but no matching script tag was found.")
        }
