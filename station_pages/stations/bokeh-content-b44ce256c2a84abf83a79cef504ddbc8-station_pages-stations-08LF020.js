(function() {
  const fn = function() {
    ...
    const element = document.getElementById("abd945e2-27a2-4562-932f-806b780545d8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'abd945e2-27a2-4562-932f-806b780545d8' but no matching script tag was found.")
        }
