(function() {
  const fn = function() {
    ...
    const element = document.getElementById("da741bca-26ef-4554-80f5-9772258fac8d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'da741bca-26ef-4554-80f5-9772258fac8d' but no matching script tag was found.")
        }
