(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef8ce6cc-6718-447f-8ad1-29a8d8ea0dcd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef8ce6cc-6718-447f-8ad1-29a8d8ea0dcd' but no matching script tag was found.")
        }
