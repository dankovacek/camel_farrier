(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d87cbe51-f8b5-4db4-9c87-c4fa6b3de424");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd87cbe51-f8b5-4db4-9c87-c4fa6b3de424' but no matching script tag was found.")
        }
