(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fefb6919-1187-4875-8f75-7da566cd4af9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fefb6919-1187-4875-8f75-7da566cd4af9' but no matching script tag was found.")
        }
