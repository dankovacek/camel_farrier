(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e478238e-e0a2-40df-a90f-fdca01208cb3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e478238e-e0a2-40df-a90f-fdca01208cb3' but no matching script tag was found.")
        }
