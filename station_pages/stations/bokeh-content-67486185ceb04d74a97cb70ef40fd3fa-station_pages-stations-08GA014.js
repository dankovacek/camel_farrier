(function() {
  const fn = function() {
    ...
    const element = document.getElementById("daccfa96-67ce-4989-b332-0bf84becb0c7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'daccfa96-67ce-4989-b332-0bf84becb0c7' but no matching script tag was found.")
        }
