(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cfc70212-9474-4714-85c6-e9c8491e3fcf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cfc70212-9474-4714-85c6-e9c8491e3fcf' but no matching script tag was found.")
        }
