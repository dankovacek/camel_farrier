(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d779b041-c1cd-4c5f-96ca-397927abe3e6");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd779b041-c1cd-4c5f-96ca-397927abe3e6' but no matching script tag was found.")
        }
