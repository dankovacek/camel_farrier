(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eb12f0ed-250f-4fb6-8e74-dd054e654214");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eb12f0ed-250f-4fb6-8e74-dd054e654214' but no matching script tag was found.")
        }
