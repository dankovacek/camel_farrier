(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d4d538fb-8858-4803-8633-3092b77f2231");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd4d538fb-8858-4803-8633-3092b77f2231' but no matching script tag was found.")
        }
