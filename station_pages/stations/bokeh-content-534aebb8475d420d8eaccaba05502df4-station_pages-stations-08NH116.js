(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b8640e87-8e0b-47f5-baa8-002a4fc14460");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b8640e87-8e0b-47f5-baa8-002a4fc14460' but no matching script tag was found.")
        }
