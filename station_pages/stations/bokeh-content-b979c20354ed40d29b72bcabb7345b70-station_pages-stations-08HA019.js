(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dd3c4a8d-0309-435c-b080-f4d3b6250673");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dd3c4a8d-0309-435c-b080-f4d3b6250673' but no matching script tag was found.")
        }
