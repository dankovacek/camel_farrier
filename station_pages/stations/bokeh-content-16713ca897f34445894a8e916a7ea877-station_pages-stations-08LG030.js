(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a4d39500-c087-47d5-9e91-9483f251c45b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a4d39500-c087-47d5-9e91-9483f251c45b' but no matching script tag was found.")
        }
