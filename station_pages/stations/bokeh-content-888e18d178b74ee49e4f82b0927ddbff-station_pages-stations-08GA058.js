(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b889ca37-d4cc-4f8c-bc10-50efed4cdd73");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b889ca37-d4cc-4f8c-bc10-50efed4cdd73' but no matching script tag was found.")
        }
