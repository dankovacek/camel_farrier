(function() {
  const fn = function() {
    ...
    const element = document.getElementById("af6c6bd8-b574-4213-9b30-287136a64647");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'af6c6bd8-b574-4213-9b30-287136a64647' but no matching script tag was found.")
        }
