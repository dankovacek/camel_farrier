(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eabb8887-5e97-4b10-8445-faceef76eef5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eabb8887-5e97-4b10-8445-faceef76eef5' but no matching script tag was found.")
        }
