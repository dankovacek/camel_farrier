(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b6d486d9-80e1-4873-b4a5-493eef0561bd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b6d486d9-80e1-4873-b4a5-493eef0561bd' but no matching script tag was found.")
        }
