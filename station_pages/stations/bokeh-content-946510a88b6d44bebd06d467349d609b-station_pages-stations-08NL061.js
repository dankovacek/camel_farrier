(function() {
  const fn = function() {
    ...
    const element = document.getElementById("da1d288f-e83c-4c39-b886-39665fbb27cd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'da1d288f-e83c-4c39-b886-39665fbb27cd' but no matching script tag was found.")
        }
