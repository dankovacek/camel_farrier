(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e9613897-c742-442b-94fa-aeb56739ae71");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e9613897-c742-442b-94fa-aeb56739ae71' but no matching script tag was found.")
        }
