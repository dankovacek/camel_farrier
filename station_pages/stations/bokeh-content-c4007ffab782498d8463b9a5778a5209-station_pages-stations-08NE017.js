(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e283d4a2-4150-430c-95ad-d076208250a2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e283d4a2-4150-430c-95ad-d076208250a2' but no matching script tag was found.")
        }
