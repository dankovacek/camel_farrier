(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a9e31d70-c63b-4269-bcf6-14f854c64beb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a9e31d70-c63b-4269-bcf6-14f854c64beb' but no matching script tag was found.")
        }
