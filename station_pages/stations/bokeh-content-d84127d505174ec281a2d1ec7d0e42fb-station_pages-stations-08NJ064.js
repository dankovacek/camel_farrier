(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bb9c8b2e-8158-4ff5-b241-87c56e0d940d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb9c8b2e-8158-4ff5-b241-87c56e0d940d' but no matching script tag was found.")
        }
