(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b97c3a6e-5f04-484a-81db-d62587f69a64");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b97c3a6e-5f04-484a-81db-d62587f69a64' but no matching script tag was found.")
        }
