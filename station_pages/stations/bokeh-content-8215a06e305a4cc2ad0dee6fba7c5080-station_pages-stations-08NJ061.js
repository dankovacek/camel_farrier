(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b96aac1d-088d-4e86-9199-33acfc228f04");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b96aac1d-088d-4e86-9199-33acfc228f04' but no matching script tag was found.")
        }
