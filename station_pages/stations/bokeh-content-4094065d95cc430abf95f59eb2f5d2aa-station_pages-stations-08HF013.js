(function() {
  const fn = function() {
    ...
    const element = document.getElementById("af4ee036-4101-4a37-a2bf-432af291b433");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'af4ee036-4101-4a37-a2bf-432af291b433' but no matching script tag was found.")
        }
