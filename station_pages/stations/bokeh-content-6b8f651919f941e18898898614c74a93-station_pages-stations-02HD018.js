(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dfd8d072-2404-4301-999c-0c3e67786137");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dfd8d072-2404-4301-999c-0c3e67786137' but no matching script tag was found.")
        }
