(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ccfe1a2e-39f7-429c-9308-c977fe91f0f5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ccfe1a2e-39f7-429c-9308-c977fe91f0f5' but no matching script tag was found.")
        }
