(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f996832c-232a-4630-853d-fda61e33efec");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f996832c-232a-4630-853d-fda61e33efec' but no matching script tag was found.")
        }
