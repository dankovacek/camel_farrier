(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fba96a81-b045-4bc5-ac02-6e7c4b4431ff");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fba96a81-b045-4bc5-ac02-6e7c4b4431ff' but no matching script tag was found.")
        }
