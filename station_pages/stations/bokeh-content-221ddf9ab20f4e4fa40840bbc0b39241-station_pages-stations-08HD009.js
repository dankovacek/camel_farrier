(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b8ff73e0-3a7a-451a-b5d4-766acdc829d0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b8ff73e0-3a7a-451a-b5d4-766acdc829d0' but no matching script tag was found.")
        }
