(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cfe820c5-189a-4325-807d-7185e6627ae5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cfe820c5-189a-4325-807d-7185e6627ae5' but no matching script tag was found.")
        }
