(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d3b7d692-6532-4a30-a114-6434b0243fbf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd3b7d692-6532-4a30-a114-6434b0243fbf' but no matching script tag was found.")
        }
