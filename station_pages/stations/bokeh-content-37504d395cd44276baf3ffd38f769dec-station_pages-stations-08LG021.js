(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fd67bb42-62db-4632-bd4c-88bd06bdba3f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fd67bb42-62db-4632-bd4c-88bd06bdba3f' but no matching script tag was found.")
        }
