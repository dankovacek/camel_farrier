(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a6d0be2b-3d1d-4b9a-a1ec-0c87be8fd60d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a6d0be2b-3d1d-4b9a-a1ec-0c87be8fd60d' but no matching script tag was found.")
        }
