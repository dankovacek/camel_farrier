(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d0816146-6ba6-43dd-8a2f-16a285a1f906");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd0816146-6ba6-43dd-8a2f-16a285a1f906' but no matching script tag was found.")
        }
