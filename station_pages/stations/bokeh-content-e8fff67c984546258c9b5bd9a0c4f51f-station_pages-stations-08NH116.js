(function() {
  const fn = function() {
    ...
    const element = document.getElementById("de79d70e-3ce3-40d9-9eaa-18eaa095df19");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de79d70e-3ce3-40d9-9eaa-18eaa095df19' but no matching script tag was found.")
        }
