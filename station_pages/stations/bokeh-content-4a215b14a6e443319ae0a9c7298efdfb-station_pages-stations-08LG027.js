(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fa0ea24b-89bf-4732-a1a4-152cb5ec4fc7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fa0ea24b-89bf-4732-a1a4-152cb5ec4fc7' but no matching script tag was found.")
        }
