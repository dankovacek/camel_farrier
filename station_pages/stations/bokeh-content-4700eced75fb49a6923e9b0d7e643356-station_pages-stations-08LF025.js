(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a436d6b3-59ca-4cea-b7f5-70793e81a245");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a436d6b3-59ca-4cea-b7f5-70793e81a245' but no matching script tag was found.")
        }
