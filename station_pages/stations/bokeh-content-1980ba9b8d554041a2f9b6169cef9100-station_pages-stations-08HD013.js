(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c9f7f987-f8bf-4460-affe-14d20f94d752");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c9f7f987-f8bf-4460-affe-14d20f94d752' but no matching script tag was found.")
        }
