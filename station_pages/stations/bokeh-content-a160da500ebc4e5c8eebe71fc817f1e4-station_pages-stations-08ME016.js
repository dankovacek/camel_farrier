(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fcd275c7-678c-405d-b643-b76d5ae5b7c4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fcd275c7-678c-405d-b643-b76d5ae5b7c4' but no matching script tag was found.")
        }
