(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e884dde6-606b-4baa-a080-5cb824fa6b6b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e884dde6-606b-4baa-a080-5cb824fa6b6b' but no matching script tag was found.")
        }
