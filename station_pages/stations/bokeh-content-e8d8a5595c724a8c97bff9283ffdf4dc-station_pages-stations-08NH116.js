(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ada07761-02c8-4646-82bd-8e0ac6140407");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ada07761-02c8-4646-82bd-8e0ac6140407' but no matching script tag was found.")
        }
