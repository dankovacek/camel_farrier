(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b268e3e2-9d96-4f24-aa10-30d215eba2a0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b268e3e2-9d96-4f24-aa10-30d215eba2a0' but no matching script tag was found.")
        }
