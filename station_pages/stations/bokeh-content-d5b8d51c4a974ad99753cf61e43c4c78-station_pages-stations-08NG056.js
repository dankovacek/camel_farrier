(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bb97c085-8202-43ad-97b3-519aa821090f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb97c085-8202-43ad-97b3-519aa821090f' but no matching script tag was found.")
        }
