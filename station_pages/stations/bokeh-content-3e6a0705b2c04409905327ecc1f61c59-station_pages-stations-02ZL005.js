(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fb641bf5-f673-46f7-b343-7de74006355c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fb641bf5-f673-46f7-b343-7de74006355c' but no matching script tag was found.")
        }
