(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bdea926e-40c3-406e-a21d-b5777fa5d212");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bdea926e-40c3-406e-a21d-b5777fa5d212' but no matching script tag was found.")
        }
