(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b48a5371-6e18-47ca-a582-9074eba4d4fe");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b48a5371-6e18-47ca-a582-9074eba4d4fe' but no matching script tag was found.")
        }
