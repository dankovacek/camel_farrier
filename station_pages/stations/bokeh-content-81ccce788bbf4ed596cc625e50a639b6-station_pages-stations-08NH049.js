(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a4aabeae-205c-4ab9-9886-30fe10f23c6e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a4aabeae-205c-4ab9-9886-30fe10f23c6e' but no matching script tag was found.")
        }
