(function() {
  const fn = function() {
    ...
    const element = document.getElementById("db4191a7-3843-4e6b-9bd3-ec2db6aae445");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'db4191a7-3843-4e6b-9bd3-ec2db6aae445' but no matching script tag was found.")
        }
