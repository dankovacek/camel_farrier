(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a6762a05-b487-4777-8c78-2201a6915f7f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a6762a05-b487-4777-8c78-2201a6915f7f' but no matching script tag was found.")
        }
