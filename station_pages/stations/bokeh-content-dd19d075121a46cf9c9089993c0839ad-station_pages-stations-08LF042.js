(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b69d84fa-e2c8-46f3-9cbb-af090deb4786");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b69d84fa-e2c8-46f3-9cbb-af090deb4786' but no matching script tag was found.")
        }
