(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b06fc5d9-7c4e-4ddb-b03a-cc43c85ccc19");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b06fc5d9-7c4e-4ddb-b03a-cc43c85ccc19' but no matching script tag was found.")
        }
