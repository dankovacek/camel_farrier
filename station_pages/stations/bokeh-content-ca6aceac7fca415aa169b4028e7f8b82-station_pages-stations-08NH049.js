(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eefa8542-b51a-480e-9952-6994dfeff58e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eefa8542-b51a-480e-9952-6994dfeff58e' but no matching script tag was found.")
        }
