(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e0e73207-6515-42aa-be24-4ff95424f539");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e0e73207-6515-42aa-be24-4ff95424f539' but no matching script tag was found.")
        }
