(function() {
  const fn = function() {
    ...
    const element = document.getElementById("be2e6343-a005-49b6-bc42-e912a63a314e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'be2e6343-a005-49b6-bc42-e912a63a314e' but no matching script tag was found.")
        }
