(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b2e7863f-0633-4cdd-8963-ddebc4b57acf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b2e7863f-0633-4cdd-8963-ddebc4b57acf' but no matching script tag was found.")
        }
