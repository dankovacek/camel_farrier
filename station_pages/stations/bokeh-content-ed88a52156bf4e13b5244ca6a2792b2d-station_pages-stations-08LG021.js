(function() {
  const fn = function() {
    ...
    const element = document.getElementById("af5b93cd-c63f-4655-a120-2af404d622ab");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'af5b93cd-c63f-4655-a120-2af404d622ab' but no matching script tag was found.")
        }
