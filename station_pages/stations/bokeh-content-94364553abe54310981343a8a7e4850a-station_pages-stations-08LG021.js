(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b3dd307c-9497-42c3-8569-ca5abbbc3a39");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b3dd307c-9497-42c3-8569-ca5abbbc3a39' but no matching script tag was found.")
        }
