(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b60fb636-2e48-4d9c-aa80-7f62c16ecc2b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b60fb636-2e48-4d9c-aa80-7f62c16ecc2b' but no matching script tag was found.")
        }
