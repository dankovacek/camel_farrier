(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b38f84b0-247b-4c6b-aac3-3034cc581b54");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b38f84b0-247b-4c6b-aac3-3034cc581b54' but no matching script tag was found.")
        }
