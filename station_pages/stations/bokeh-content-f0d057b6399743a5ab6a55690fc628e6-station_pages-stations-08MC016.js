(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bdc3c261-d1ec-4193-844c-34afeaa5278b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bdc3c261-d1ec-4193-844c-34afeaa5278b' but no matching script tag was found.")
        }
