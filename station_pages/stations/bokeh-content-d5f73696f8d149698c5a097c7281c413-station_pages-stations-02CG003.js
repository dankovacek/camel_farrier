(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eea1aa28-6286-4ef1-a986-17e9320b19ba");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eea1aa28-6286-4ef1-a986-17e9320b19ba' but no matching script tag was found.")
        }
