(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fc15baad-8004-46d3-97ee-e805885f83c7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fc15baad-8004-46d3-97ee-e805885f83c7' but no matching script tag was found.")
        }
