(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e975584c-0fc1-4f64-a473-2cd3dec3d870");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e975584c-0fc1-4f64-a473-2cd3dec3d870' but no matching script tag was found.")
        }
