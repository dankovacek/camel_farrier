(function() {
  const fn = function() {
    ...
    const element = document.getElementById("feb3b026-666f-44c3-b2f6-e354cfd3d040");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'feb3b026-666f-44c3-b2f6-e354cfd3d040' but no matching script tag was found.")
        }
