(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b70be72e-cbcf-492e-9581-acfc5b4fcff9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b70be72e-cbcf-492e-9581-acfc5b4fcff9' but no matching script tag was found.")
        }
