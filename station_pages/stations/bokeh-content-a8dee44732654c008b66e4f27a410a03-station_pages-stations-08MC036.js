(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ca180d42-809e-4e9c-8937-0655bbfd8922");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ca180d42-809e-4e9c-8937-0655bbfd8922' but no matching script tag was found.")
        }
