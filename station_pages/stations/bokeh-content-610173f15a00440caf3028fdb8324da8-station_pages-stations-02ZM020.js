(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b8b084b7-cae2-4b50-9cc8-d497659a4280");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b8b084b7-cae2-4b50-9cc8-d497659a4280' but no matching script tag was found.")
        }
