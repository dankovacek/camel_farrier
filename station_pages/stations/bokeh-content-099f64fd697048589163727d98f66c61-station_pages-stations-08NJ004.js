(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bc64696a-f705-4740-9b23-fbe172c36989");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bc64696a-f705-4740-9b23-fbe172c36989' but no matching script tag was found.")
        }
