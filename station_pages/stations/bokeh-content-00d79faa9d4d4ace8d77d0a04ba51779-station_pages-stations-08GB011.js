(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef08f53e-ded4-4ef3-9656-0298a56c3db3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef08f53e-ded4-4ef3-9656-0298a56c3db3' but no matching script tag was found.")
        }
