(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e510f38c-32fb-40cf-b03b-1cec4f16ed62");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e510f38c-32fb-40cf-b03b-1cec4f16ed62' but no matching script tag was found.")
        }
