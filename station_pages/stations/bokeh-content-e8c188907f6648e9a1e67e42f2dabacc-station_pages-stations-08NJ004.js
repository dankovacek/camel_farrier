(function() {
  const fn = function() {
    ...
    const element = document.getElementById("de9d6eab-ba67-45a3-889a-594bfaff90ce");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de9d6eab-ba67-45a3-889a-594bfaff90ce' but no matching script tag was found.")
        }
