(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cf173e24-b069-4443-9a79-605eec9b6b4b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cf173e24-b069-4443-9a79-605eec9b6b4b' but no matching script tag was found.")
        }
