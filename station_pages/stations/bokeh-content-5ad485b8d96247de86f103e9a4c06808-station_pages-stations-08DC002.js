(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a2942871-e282-4efc-b65e-d6f180b39db1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a2942871-e282-4efc-b65e-d6f180b39db1' but no matching script tag was found.")
        }
