(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eeb3e14c-045f-46bb-8714-a57a44e18c13");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eeb3e14c-045f-46bb-8714-a57a44e18c13' but no matching script tag was found.")
        }
