(function() {
  const fn = function() {
    ...
    const element = document.getElementById("df2c4e81-ffdb-45a3-8862-638d17b82d5a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'df2c4e81-ffdb-45a3-8862-638d17b82d5a' but no matching script tag was found.")
        }
