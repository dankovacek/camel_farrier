(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bf4b3267-76c8-4a0c-8445-67a24e31a676");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bf4b3267-76c8-4a0c-8445-67a24e31a676' but no matching script tag was found.")
        }
