(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bb5d8632-b74f-42ac-8b17-0667a385229d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb5d8632-b74f-42ac-8b17-0667a385229d' but no matching script tag was found.")
        }
