(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a7641484-6476-4d87-a4cf-e75ccb5d88c0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a7641484-6476-4d87-a4cf-e75ccb5d88c0' but no matching script tag was found.")
        }
