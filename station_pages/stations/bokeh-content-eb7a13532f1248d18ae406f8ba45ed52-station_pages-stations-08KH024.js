(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dee77403-1066-4ac6-bc42-4c71730e37df");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dee77403-1066-4ac6-bc42-4c71730e37df' but no matching script tag was found.")
        }
