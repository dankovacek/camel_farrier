(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ebd15a0d-d8c9-4ee3-811e-94870a48cdd3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ebd15a0d-d8c9-4ee3-811e-94870a48cdd3' but no matching script tag was found.")
        }
