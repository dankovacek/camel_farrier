(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cff257bf-169a-4bb0-9aec-044f19ba49df");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cff257bf-169a-4bb0-9aec-044f19ba49df' but no matching script tag was found.")
        }
