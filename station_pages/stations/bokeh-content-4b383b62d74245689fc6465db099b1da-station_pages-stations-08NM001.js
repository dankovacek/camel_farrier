(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ecf226f1-0b3d-4aa2-8525-915b1cdbf864");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ecf226f1-0b3d-4aa2-8525-915b1cdbf864' but no matching script tag was found.")
        }
