(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d242cf55-d8d7-4219-a198-9f8bedcad551");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd242cf55-d8d7-4219-a198-9f8bedcad551' but no matching script tag was found.")
        }
