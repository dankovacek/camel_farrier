(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ea81835b-746e-4691-8328-68ab7d589ecb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ea81835b-746e-4691-8328-68ab7d589ecb' but no matching script tag was found.")
        }
