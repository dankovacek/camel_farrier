(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e95af048-ad12-482d-98cb-0c4feb9bdd45");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e95af048-ad12-482d-98cb-0c4feb9bdd45' but no matching script tag was found.")
        }
