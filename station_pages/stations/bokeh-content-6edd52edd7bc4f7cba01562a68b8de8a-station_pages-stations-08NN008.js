(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b0e940cc-ec2d-48db-bb34-822cac2b300b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b0e940cc-ec2d-48db-bb34-822cac2b300b' but no matching script tag was found.")
        }
