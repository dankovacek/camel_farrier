(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d2976922-358a-48a5-b5ce-1cb299671737");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd2976922-358a-48a5-b5ce-1cb299671737' but no matching script tag was found.")
        }
