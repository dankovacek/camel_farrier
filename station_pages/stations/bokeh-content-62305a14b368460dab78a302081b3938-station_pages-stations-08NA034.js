(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d5269a03-bb71-4dcc-b523-3a5cd81d200c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd5269a03-bb71-4dcc-b523-3a5cd81d200c' but no matching script tag was found.")
        }
