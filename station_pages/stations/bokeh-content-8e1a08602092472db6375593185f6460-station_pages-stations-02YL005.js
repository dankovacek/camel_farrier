(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fb6d87f9-819d-4283-94e3-5e460b98575d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fb6d87f9-819d-4283-94e3-5e460b98575d' but no matching script tag was found.")
        }
