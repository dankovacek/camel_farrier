(function() {
  const fn = function() {
    ...
    const element = document.getElementById("afefe375-dae7-4635-a5ff-4008f180dbed");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'afefe375-dae7-4635-a5ff-4008f180dbed' but no matching script tag was found.")
        }
