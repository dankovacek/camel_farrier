(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b390e41d-ca40-4dd1-84c4-0e65dcfe960f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b390e41d-ca40-4dd1-84c4-0e65dcfe960f' but no matching script tag was found.")
        }
