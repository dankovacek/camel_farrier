(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b0206956-fb1c-4597-ad5b-2cc67ca14386");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b0206956-fb1c-4597-ad5b-2cc67ca14386' but no matching script tag was found.")
        }
