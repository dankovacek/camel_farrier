(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d63507a2-642a-4337-85d3-311b77189bf8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd63507a2-642a-4337-85d3-311b77189bf8' but no matching script tag was found.")
        }
