(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b505052a-7429-474c-80f7-d756927b97ff");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b505052a-7429-474c-80f7-d756927b97ff' but no matching script tag was found.")
        }
