(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f6276b98-4d01-4d9c-bb80-c3fff9d40adb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f6276b98-4d01-4d9c-bb80-c3fff9d40adb' but no matching script tag was found.")
        }
