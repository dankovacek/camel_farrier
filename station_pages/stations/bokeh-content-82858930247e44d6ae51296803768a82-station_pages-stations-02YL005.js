(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bb28a43a-a655-407a-9bae-59a6402f3682");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb28a43a-a655-407a-9bae-59a6402f3682' but no matching script tag was found.")
        }
