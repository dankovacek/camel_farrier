(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c2c6060d-4621-447b-8644-1c2847cf7ff5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c2c6060d-4621-447b-8644-1c2847cf7ff5' but no matching script tag was found.")
        }
