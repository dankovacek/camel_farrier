(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c52ea073-69ea-4f3f-a627-f0f44be14aeb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c52ea073-69ea-4f3f-a627-f0f44be14aeb' but no matching script tag was found.")
        }
