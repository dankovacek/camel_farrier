(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cb2833a0-3381-45f4-997a-6b9b98a7944f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cb2833a0-3381-45f4-997a-6b9b98a7944f' but no matching script tag was found.")
        }
