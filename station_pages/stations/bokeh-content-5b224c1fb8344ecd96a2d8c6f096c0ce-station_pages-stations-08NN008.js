(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c56bd110-36ee-4dc3-8ecc-10c4f8fac823");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c56bd110-36ee-4dc3-8ecc-10c4f8fac823' but no matching script tag was found.")
        }
