(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d96a30cb-055a-49be-9887-e9ebe0185523");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd96a30cb-055a-49be-9887-e9ebe0185523' but no matching script tag was found.")
        }
