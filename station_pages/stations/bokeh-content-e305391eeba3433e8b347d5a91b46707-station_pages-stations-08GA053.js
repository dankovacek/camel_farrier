(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f296aadb-4300-46e2-8761-26acfb0adb5d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f296aadb-4300-46e2-8761-26acfb0adb5d' but no matching script tag was found.")
        }
