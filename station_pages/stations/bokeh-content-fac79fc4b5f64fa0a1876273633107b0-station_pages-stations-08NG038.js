(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bbaa0603-72a5-4af3-9ad6-8721944f9ff5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bbaa0603-72a5-4af3-9ad6-8721944f9ff5' but no matching script tag was found.")
        }
