(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bc77f48f-a812-4647-9c77-520cdbeeee4a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bc77f48f-a812-4647-9c77-520cdbeeee4a' but no matching script tag was found.")
        }
