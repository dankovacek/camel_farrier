(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cb4ae092-6343-4461-a3b8-3c09bb66699f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cb4ae092-6343-4461-a3b8-3c09bb66699f' but no matching script tag was found.")
        }
