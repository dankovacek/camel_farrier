(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bc85f8a4-a4cc-477e-831b-7c7a29e47fb1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bc85f8a4-a4cc-477e-831b-7c7a29e47fb1' but no matching script tag was found.")
        }
