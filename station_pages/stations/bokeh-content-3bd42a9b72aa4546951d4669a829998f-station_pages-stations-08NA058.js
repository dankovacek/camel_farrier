(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e3bc8739-4870-4892-9641-ad4d667ccaca");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e3bc8739-4870-4892-9641-ad4d667ccaca' but no matching script tag was found.")
        }
