(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b3fc070e-ca24-41e5-a898-417e8d8db256");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b3fc070e-ca24-41e5-a898-417e8d8db256' but no matching script tag was found.")
        }
