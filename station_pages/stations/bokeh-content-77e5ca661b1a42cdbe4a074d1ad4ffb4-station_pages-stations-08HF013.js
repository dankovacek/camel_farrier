(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b389618f-0a23-435f-8a84-8135b484804f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b389618f-0a23-435f-8a84-8135b484804f' but no matching script tag was found.")
        }
