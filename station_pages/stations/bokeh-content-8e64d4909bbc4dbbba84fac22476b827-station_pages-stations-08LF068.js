(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e4766d34-5514-4176-8666-797242adc50a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e4766d34-5514-4176-8666-797242adc50a' but no matching script tag was found.")
        }
