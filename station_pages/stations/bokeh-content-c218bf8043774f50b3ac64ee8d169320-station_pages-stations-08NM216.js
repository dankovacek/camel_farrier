(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f042d82f-2237-49c6-8111-82fb6c5d9437");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f042d82f-2237-49c6-8111-82fb6c5d9437' but no matching script tag was found.")
        }
