(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b0e0b25d-94ea-4f1c-b9b0-851eb2d40e3e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b0e0b25d-94ea-4f1c-b9b0-851eb2d40e3e' but no matching script tag was found.")
        }
