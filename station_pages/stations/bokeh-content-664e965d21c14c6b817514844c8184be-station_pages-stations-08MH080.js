(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fd2ae88d-796d-4985-9f24-a84bedfba6ce");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fd2ae88d-796d-4985-9f24-a84bedfba6ce' but no matching script tag was found.")
        }
