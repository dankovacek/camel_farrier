(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bc6d7715-e2b6-4b44-a3e7-f028cd0d834e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bc6d7715-e2b6-4b44-a3e7-f028cd0d834e' but no matching script tag was found.")
        }
