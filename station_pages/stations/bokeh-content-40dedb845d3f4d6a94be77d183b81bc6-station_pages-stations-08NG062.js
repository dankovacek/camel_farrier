(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bed22fba-c6ad-496c-a88b-cb9c1be6a3cf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bed22fba-c6ad-496c-a88b-cb9c1be6a3cf' but no matching script tag was found.")
        }
