(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e64cba38-cb8f-4537-b7c5-e05dc4944bb8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e64cba38-cb8f-4537-b7c5-e05dc4944bb8' but no matching script tag was found.")
        }
