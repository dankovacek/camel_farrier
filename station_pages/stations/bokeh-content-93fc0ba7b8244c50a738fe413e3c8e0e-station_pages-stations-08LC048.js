(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b56cdca8-cccc-4970-a83c-ef1696ec9b70");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b56cdca8-cccc-4970-a83c-ef1696ec9b70' but no matching script tag was found.")
        }
