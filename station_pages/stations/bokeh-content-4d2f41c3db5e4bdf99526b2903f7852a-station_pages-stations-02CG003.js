(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eb80b1cf-ade0-4aae-a71a-4b60a336df54");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eb80b1cf-ade0-4aae-a71a-4b60a336df54' but no matching script tag was found.")
        }
