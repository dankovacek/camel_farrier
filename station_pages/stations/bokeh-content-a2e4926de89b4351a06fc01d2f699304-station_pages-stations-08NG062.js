(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f732a642-9fd8-4628-bfcb-1128ac6a369d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f732a642-9fd8-4628-bfcb-1128ac6a369d' but no matching script tag was found.")
        }
