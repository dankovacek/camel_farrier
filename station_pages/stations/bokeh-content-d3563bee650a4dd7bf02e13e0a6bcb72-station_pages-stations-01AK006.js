(function() {
  const fn = function() {
    ...
    const element = document.getElementById("efccd5d9-d953-49ae-a87c-1244805cc789");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'efccd5d9-d953-49ae-a87c-1244805cc789' but no matching script tag was found.")
        }
