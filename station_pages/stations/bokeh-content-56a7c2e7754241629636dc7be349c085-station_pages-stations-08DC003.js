(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a6f43a96-a266-4c7a-ba57-e8462ba78aca");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a6f43a96-a266-4c7a-ba57-e8462ba78aca' but no matching script tag was found.")
        }
