(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fda698e5-6217-411a-b34d-c963f86ba661");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fda698e5-6217-411a-b34d-c963f86ba661' but no matching script tag was found.")
        }
