(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bf11393c-04d3-4faa-9356-f8164828c04f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bf11393c-04d3-4faa-9356-f8164828c04f' but no matching script tag was found.")
        }
