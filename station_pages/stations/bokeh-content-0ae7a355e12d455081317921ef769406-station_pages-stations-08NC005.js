(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bfe37d63-cea8-4093-a1c1-ed3048850fa7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bfe37d63-cea8-4093-a1c1-ed3048850fa7' but no matching script tag was found.")
        }
