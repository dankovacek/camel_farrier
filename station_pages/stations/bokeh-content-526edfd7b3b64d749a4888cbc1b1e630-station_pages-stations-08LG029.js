(function() {
  const fn = function() {
    ...
    const element = document.getElementById("da0e01ff-4a2d-4e8a-acc6-2b58c2031275");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'da0e01ff-4a2d-4e8a-acc6-2b58c2031275' but no matching script tag was found.")
        }
