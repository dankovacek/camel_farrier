(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a383de91-e411-40a9-8bf6-223810473171");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a383de91-e411-40a9-8bf6-223810473171' but no matching script tag was found.")
        }
