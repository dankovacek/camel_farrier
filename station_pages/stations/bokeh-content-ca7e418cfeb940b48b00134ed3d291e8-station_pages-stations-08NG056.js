(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d5793579-c2bc-4bbb-b127-43ad44d9cf36");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd5793579-c2bc-4bbb-b127-43ad44d9cf36' but no matching script tag was found.")
        }
