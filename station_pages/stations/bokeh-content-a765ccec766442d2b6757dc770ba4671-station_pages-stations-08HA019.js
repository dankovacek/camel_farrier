(function() {
  const fn = function() {
    ...
    const element = document.getElementById("febd2355-254c-4ab4-a719-f2327eaa7a4f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'febd2355-254c-4ab4-a719-f2327eaa7a4f' but no matching script tag was found.")
        }
