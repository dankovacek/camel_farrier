(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a36a4331-f350-4043-a068-87a6c702bbbd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a36a4331-f350-4043-a068-87a6c702bbbd' but no matching script tag was found.")
        }
