(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b5bdb791-60eb-437c-b43d-da69715005e3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b5bdb791-60eb-437c-b43d-da69715005e3' but no matching script tag was found.")
        }
