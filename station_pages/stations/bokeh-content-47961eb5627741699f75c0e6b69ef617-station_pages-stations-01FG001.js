(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dfef61a7-871a-488c-93d1-12fc4c3a078d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dfef61a7-871a-488c-93d1-12fc4c3a078d' but no matching script tag was found.")
        }
