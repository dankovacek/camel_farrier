(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eba024f9-39a1-4671-93d2-1c541c7ee679");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eba024f9-39a1-4671-93d2-1c541c7ee679' but no matching script tag was found.")
        }
