(function() {
  const fn = function() {
    ...
    const element = document.getElementById("de1a0304-078a-4d33-8334-f3d290bd2269");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de1a0304-078a-4d33-8334-f3d290bd2269' but no matching script tag was found.")
        }
