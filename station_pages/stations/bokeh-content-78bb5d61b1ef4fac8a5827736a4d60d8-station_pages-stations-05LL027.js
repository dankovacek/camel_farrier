(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c72f0c64-97c4-4666-ba65-eff8096bc8a8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c72f0c64-97c4-4666-ba65-eff8096bc8a8' but no matching script tag was found.")
        }
