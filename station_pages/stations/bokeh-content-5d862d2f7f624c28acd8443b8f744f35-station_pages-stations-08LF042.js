(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d87bd345-b8a8-436c-b14e-45bcd0db54f9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd87bd345-b8a8-436c-b14e-45bcd0db54f9' but no matching script tag was found.")
        }
