(function() {
  const fn = function() {
    ...
    const element = document.getElementById("adca6a19-61c0-4de8-81f2-212a97502d5e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'adca6a19-61c0-4de8-81f2-212a97502d5e' but no matching script tag was found.")
        }
