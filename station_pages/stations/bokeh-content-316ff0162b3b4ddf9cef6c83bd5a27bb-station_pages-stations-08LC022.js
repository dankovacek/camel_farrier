(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a1b376e8-9870-444c-a79e-ad4bafefd847");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a1b376e8-9870-444c-a79e-ad4bafefd847' but no matching script tag was found.")
        }
