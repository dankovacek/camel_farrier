(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c48fec1c-3e8c-47e7-86e0-cfed64691dca");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c48fec1c-3e8c-47e7-86e0-cfed64691dca' but no matching script tag was found.")
        }
