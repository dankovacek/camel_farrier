(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d5c7ae53-f528-4470-8739-c57314128f94");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd5c7ae53-f528-4470-8739-c57314128f94' but no matching script tag was found.")
        }
