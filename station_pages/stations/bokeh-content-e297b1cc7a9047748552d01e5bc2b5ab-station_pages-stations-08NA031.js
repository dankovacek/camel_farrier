(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b35ee6a6-a50f-4db4-9dbb-01bf17f11459");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b35ee6a6-a50f-4db4-9dbb-01bf17f11459' but no matching script tag was found.")
        }
