(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c668d552-8321-45e7-8354-b890e969cecd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c668d552-8321-45e7-8354-b890e969cecd' but no matching script tag was found.")
        }
