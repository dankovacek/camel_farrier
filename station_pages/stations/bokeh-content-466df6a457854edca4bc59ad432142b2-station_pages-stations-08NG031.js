(function() {
  const fn = function() {
    ...
    const element = document.getElementById("beca5f85-f9b4-4e8d-912c-873a00cdeff2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'beca5f85-f9b4-4e8d-912c-873a00cdeff2' but no matching script tag was found.")
        }
