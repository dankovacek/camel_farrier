(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bf26c27b-7467-445a-8735-e822c52c1bc8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bf26c27b-7467-445a-8735-e822c52c1bc8' but no matching script tag was found.")
        }
