(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ed438976-e686-414d-a588-64d1d7c62cbe");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ed438976-e686-414d-a588-64d1d7c62cbe' but no matching script tag was found.")
        }
