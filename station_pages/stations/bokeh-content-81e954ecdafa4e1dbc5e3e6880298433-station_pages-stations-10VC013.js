(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d4a02381-5c59-4019-b967-90ae6753ffd1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd4a02381-5c59-4019-b967-90ae6753ffd1' but no matching script tag was found.")
        }
