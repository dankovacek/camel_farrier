(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d2053635-0d71-416b-8af9-6ddbc7710d9b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd2053635-0d71-416b-8af9-6ddbc7710d9b' but no matching script tag was found.")
        }
