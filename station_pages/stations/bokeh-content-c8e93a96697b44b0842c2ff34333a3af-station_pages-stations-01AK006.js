(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cfb9f681-9bda-44c6-b626-2ded8f739bfd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cfb9f681-9bda-44c6-b626-2ded8f739bfd' but no matching script tag was found.")
        }
