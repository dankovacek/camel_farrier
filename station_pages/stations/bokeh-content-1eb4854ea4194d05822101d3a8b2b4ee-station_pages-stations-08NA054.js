(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fca03579-ae3c-46e1-b061-4a70bfef9b3a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fca03579-ae3c-46e1-b061-4a70bfef9b3a' but no matching script tag was found.")
        }
