(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d72725ff-c27e-4c42-a5b0-d454ef288c0a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd72725ff-c27e-4c42-a5b0-d454ef288c0a' but no matching script tag was found.")
        }
