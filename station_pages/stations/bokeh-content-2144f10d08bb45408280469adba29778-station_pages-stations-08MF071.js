(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d4d16804-8172-467b-8b87-4d114cb04e6f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd4d16804-8172-467b-8b87-4d114cb04e6f' but no matching script tag was found.")
        }
