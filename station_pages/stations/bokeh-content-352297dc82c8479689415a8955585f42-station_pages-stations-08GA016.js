(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dbc2864b-655a-4505-ba91-ae35833986b8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dbc2864b-655a-4505-ba91-ae35833986b8' but no matching script tag was found.")
        }
