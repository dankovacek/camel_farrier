(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c8b125aa-555f-4e2e-a923-31da7f99a348");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c8b125aa-555f-4e2e-a923-31da7f99a348' but no matching script tag was found.")
        }
