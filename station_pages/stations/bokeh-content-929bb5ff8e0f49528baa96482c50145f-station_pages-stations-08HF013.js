(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ec3dcda4-2c5a-40ff-86e0-47939af54740");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ec3dcda4-2c5a-40ff-86e0-47939af54740' but no matching script tag was found.")
        }
