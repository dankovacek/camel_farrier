(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f7d87bba-e590-4b36-ab90-9bc77b5a97ad");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f7d87bba-e590-4b36-ab90-9bc77b5a97ad' but no matching script tag was found.")
        }
