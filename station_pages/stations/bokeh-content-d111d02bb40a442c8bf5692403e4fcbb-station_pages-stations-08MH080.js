(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d64c085c-1875-461f-bf78-030d2a3ebaf8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd64c085c-1875-461f-bf78-030d2a3ebaf8' but no matching script tag was found.")
        }
