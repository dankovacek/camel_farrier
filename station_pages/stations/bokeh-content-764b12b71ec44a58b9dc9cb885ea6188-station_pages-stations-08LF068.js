(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d439457e-cc60-4466-a7a7-aea7fa19605d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd439457e-cc60-4466-a7a7-aea7fa19605d' but no matching script tag was found.")
        }
