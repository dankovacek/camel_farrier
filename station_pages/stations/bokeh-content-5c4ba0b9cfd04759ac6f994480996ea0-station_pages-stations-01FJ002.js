(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b264291e-9a8d-4be0-beb4-a425e2ca5f11");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b264291e-9a8d-4be0-beb4-a425e2ca5f11' but no matching script tag was found.")
        }
