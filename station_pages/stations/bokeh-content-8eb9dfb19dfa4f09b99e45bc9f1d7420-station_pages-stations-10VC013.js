(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cfbd6445-003e-44f1-9762-adca15968c26");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cfbd6445-003e-44f1-9762-adca15968c26' but no matching script tag was found.")
        }
