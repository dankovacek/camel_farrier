(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f3410056-5a0f-40fb-9282-4b6530420098");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f3410056-5a0f-40fb-9282-4b6530420098' but no matching script tag was found.")
        }
