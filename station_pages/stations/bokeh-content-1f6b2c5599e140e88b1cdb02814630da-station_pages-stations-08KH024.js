(function() {
  const fn = function() {
    ...
    const element = document.getElementById("be9356da-e879-4a4d-bb1d-cf77da072361");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'be9356da-e879-4a4d-bb1d-cf77da072361' but no matching script tag was found.")
        }
