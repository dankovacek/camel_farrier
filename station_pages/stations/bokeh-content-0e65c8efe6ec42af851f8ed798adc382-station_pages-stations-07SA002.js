(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cd998057-9cf5-4659-8f8a-1e1bcc88be2f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cd998057-9cf5-4659-8f8a-1e1bcc88be2f' but no matching script tag was found.")
        }
