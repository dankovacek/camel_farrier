(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a72245ca-bbcf-4e37-85b3-a845f78404d7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a72245ca-bbcf-4e37-85b3-a845f78404d7' but no matching script tag was found.")
        }
