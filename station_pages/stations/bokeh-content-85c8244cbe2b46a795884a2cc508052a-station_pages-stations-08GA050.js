(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b898759e-d043-4d5d-ac99-b3fa7cede9c1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b898759e-d043-4d5d-ac99-b3fa7cede9c1' but no matching script tag was found.")
        }
