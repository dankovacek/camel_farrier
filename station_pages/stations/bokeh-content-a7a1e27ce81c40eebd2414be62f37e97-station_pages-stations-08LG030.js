(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f85f972a-6d18-4663-b905-ba093be3c64c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f85f972a-6d18-4663-b905-ba093be3c64c' but no matching script tag was found.")
        }
