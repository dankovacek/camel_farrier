(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef0b0387-0559-463e-a981-26c172933119");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef0b0387-0559-463e-a981-26c172933119' but no matching script tag was found.")
        }
