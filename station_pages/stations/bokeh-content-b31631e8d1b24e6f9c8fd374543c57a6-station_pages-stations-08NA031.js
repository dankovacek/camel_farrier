(function() {
  const fn = function() {
    ...
    const element = document.getElementById("adbc6e8c-47e7-4bbe-9f7d-ceeb1d60950e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'adbc6e8c-47e7-4bbe-9f7d-ceeb1d60950e' but no matching script tag was found.")
        }
