(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bcf45b39-e2c0-4c57-b0e3-56d0740778a8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bcf45b39-e2c0-4c57-b0e3-56d0740778a8' but no matching script tag was found.")
        }
