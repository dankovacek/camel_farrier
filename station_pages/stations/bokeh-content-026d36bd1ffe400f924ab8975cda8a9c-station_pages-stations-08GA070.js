(function() {
  const fn = function() {
    ...
    const element = document.getElementById("efb565aa-2f01-4aeb-9786-e24d3778269f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'efb565aa-2f01-4aeb-9786-e24d3778269f' but no matching script tag was found.")
        }
