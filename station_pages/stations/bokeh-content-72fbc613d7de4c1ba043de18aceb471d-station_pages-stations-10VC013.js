(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fd143197-a7ea-4507-874c-1c9a7eda1e1e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fd143197-a7ea-4507-874c-1c9a7eda1e1e' but no matching script tag was found.")
        }
