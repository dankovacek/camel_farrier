(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c268cd9c-969a-4150-951a-aaa735e5c116");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c268cd9c-969a-4150-951a-aaa735e5c116' but no matching script tag was found.")
        }
