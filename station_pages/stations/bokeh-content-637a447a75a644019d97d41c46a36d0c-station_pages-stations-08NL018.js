(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c476aeef-21f0-42eb-a59e-4f7330e40504");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c476aeef-21f0-42eb-a59e-4f7330e40504' but no matching script tag was found.")
        }
