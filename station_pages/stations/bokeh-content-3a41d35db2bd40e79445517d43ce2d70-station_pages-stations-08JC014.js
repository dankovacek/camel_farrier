(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cb88f1cb-1df8-4d19-9e03-70ba836e9cae");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cb88f1cb-1df8-4d19-9e03-70ba836e9cae' but no matching script tag was found.")
        }
