(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bf561c10-6c6c-4dfa-a7a3-ff37dc874ca5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bf561c10-6c6c-4dfa-a7a3-ff37dc874ca5' but no matching script tag was found.")
        }
