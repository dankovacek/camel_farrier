(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b105bb1c-8dca-4619-9225-156107d02ec3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b105bb1c-8dca-4619-9225-156107d02ec3' but no matching script tag was found.")
        }
