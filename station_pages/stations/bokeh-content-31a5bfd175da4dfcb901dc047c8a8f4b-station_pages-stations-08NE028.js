(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bf7debfa-63ef-4c94-a0a8-fcc28859233e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bf7debfa-63ef-4c94-a0a8-fcc28859233e' but no matching script tag was found.")
        }
