(function() {
  const fn = function() {
    ...
    const element = document.getElementById("febc6bfe-8de0-4dce-8b6a-d3caf5baa708");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'febc6bfe-8de0-4dce-8b6a-d3caf5baa708' but no matching script tag was found.")
        }
