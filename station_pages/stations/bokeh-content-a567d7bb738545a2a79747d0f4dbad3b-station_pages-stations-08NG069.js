(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bfefee29-7875-441b-853e-0a51fe0dfba6");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bfefee29-7875-441b-853e-0a51fe0dfba6' but no matching script tag was found.")
        }
