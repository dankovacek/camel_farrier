(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ecae690d-b742-44e1-bac2-e611cae9a290");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ecae690d-b742-44e1-bac2-e611cae9a290' but no matching script tag was found.")
        }
