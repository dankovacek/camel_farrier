(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cb12762e-8172-428f-8b95-293eb5a19b7c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cb12762e-8172-428f-8b95-293eb5a19b7c' but no matching script tag was found.")
        }
