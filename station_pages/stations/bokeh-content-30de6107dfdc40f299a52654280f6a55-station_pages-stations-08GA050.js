(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d34a98d2-732b-472d-a89e-54b76ace16bc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd34a98d2-732b-472d-a89e-54b76ace16bc' but no matching script tag was found.")
        }
