(function() {
  const fn = function() {
    ...
    const element = document.getElementById("abb92513-3dcb-4590-a332-ef5c18414e23");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'abb92513-3dcb-4590-a332-ef5c18414e23' but no matching script tag was found.")
        }
