(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f0fb07af-2fd3-4302-b4ff-2b9c995767b5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f0fb07af-2fd3-4302-b4ff-2b9c995767b5' but no matching script tag was found.")
        }
