(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f6dfa7be-1296-448c-afe3-5d6ae6aab834");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f6dfa7be-1296-448c-afe3-5d6ae6aab834' but no matching script tag was found.")
        }
