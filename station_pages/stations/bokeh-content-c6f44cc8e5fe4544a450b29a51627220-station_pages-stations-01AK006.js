(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f48708c3-d1ba-47f4-927c-12a61b750c41");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f48708c3-d1ba-47f4-927c-12a61b750c41' but no matching script tag was found.")
        }
