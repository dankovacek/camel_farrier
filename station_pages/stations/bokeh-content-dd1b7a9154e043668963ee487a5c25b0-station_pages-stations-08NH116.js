(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cfa10088-10fa-4877-afee-6f6e228507f8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cfa10088-10fa-4877-afee-6f6e228507f8' but no matching script tag was found.")
        }
