(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ccf096d6-1acd-4987-a2ca-21375ada510f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ccf096d6-1acd-4987-a2ca-21375ada510f' but no matching script tag was found.")
        }
