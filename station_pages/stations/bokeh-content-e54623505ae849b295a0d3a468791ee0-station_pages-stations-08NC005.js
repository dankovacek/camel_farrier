(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bab2c8b8-48c5-46ad-abfa-39b39e020dbc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bab2c8b8-48c5-46ad-abfa-39b39e020dbc' but no matching script tag was found.")
        }
