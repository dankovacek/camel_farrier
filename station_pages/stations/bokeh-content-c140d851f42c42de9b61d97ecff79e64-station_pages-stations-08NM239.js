(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b716700b-6765-4715-993f-27809ab27297");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b716700b-6765-4715-993f-27809ab27297' but no matching script tag was found.")
        }
