(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a1703d02-439f-498a-8162-fbcdc103d06b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a1703d02-439f-498a-8162-fbcdc103d06b' but no matching script tag was found.")
        }
