(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a5470b68-34a0-4fe5-b6ac-e4073de65715");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a5470b68-34a0-4fe5-b6ac-e4073de65715' but no matching script tag was found.")
        }
