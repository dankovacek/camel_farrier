(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c252905b-c616-4e46-86a2-d960e9aa19f2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c252905b-c616-4e46-86a2-d960e9aa19f2' but no matching script tag was found.")
        }
