(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b9b7c327-f187-4530-9933-d9ac75b6dfb6");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b9b7c327-f187-4530-9933-d9ac75b6dfb6' but no matching script tag was found.")
        }
