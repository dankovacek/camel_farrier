(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f6968115-f1ce-41f5-ab4b-132c077f9c46");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f6968115-f1ce-41f5-ab4b-132c077f9c46' but no matching script tag was found.")
        }
