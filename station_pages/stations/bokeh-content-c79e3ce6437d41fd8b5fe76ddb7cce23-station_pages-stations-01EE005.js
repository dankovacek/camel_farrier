(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e70f0e10-9421-4e4b-97da-187666765fde");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e70f0e10-9421-4e4b-97da-187666765fde' but no matching script tag was found.")
        }
