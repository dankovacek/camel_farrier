(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bfc036fe-da49-481d-ac8c-65ceba4a24ac");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bfc036fe-da49-481d-ac8c-65ceba4a24ac' but no matching script tag was found.")
        }
