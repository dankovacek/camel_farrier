(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b8b614b2-93e2-478c-ac0d-26665fd24083");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b8b614b2-93e2-478c-ac0d-26665fd24083' but no matching script tag was found.")
        }
