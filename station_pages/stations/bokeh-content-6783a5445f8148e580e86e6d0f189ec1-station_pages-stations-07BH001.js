(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f0454c56-babe-4c89-b30c-40bff8e257c1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f0454c56-babe-4c89-b30c-40bff8e257c1' but no matching script tag was found.")
        }
