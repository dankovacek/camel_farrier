(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ecc9a1c4-1817-42ca-8246-4937ab0de3c3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ecc9a1c4-1817-42ca-8246-4937ab0de3c3' but no matching script tag was found.")
        }
