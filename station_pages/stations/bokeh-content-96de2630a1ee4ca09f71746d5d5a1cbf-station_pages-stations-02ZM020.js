(function() {
  const fn = function() {
    ...
    const element = document.getElementById("baf9bfc2-9a83-4db7-8c94-cbbed148411f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'baf9bfc2-9a83-4db7-8c94-cbbed148411f' but no matching script tag was found.")
        }
