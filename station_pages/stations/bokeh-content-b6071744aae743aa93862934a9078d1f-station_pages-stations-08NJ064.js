(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a762d933-dd25-40a0-8949-0187cee2567e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a762d933-dd25-40a0-8949-0187cee2567e' but no matching script tag was found.")
        }
