(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b5d88f46-56fe-4550-839b-007faa71e9ad");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b5d88f46-56fe-4550-839b-007faa71e9ad' but no matching script tag was found.")
        }
