(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bc6f95ef-cd86-4a71-824d-651c1e881ff3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bc6f95ef-cd86-4a71-824d-651c1e881ff3' but no matching script tag was found.")
        }
