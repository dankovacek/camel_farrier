(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a1566b4e-d590-4796-8a75-8a551b0b5e23");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a1566b4e-d590-4796-8a75-8a551b0b5e23' but no matching script tag was found.")
        }
