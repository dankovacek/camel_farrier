(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eb87400c-2ded-4ec7-858d-fcec2602c495");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eb87400c-2ded-4ec7-858d-fcec2602c495' but no matching script tag was found.")
        }
