(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cb6d1742-e88c-4394-bc50-b845fb8945a2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cb6d1742-e88c-4394-bc50-b845fb8945a2' but no matching script tag was found.")
        }
