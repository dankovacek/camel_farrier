(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ee9ae021-daa1-4a21-872f-01ea263dc256");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ee9ae021-daa1-4a21-872f-01ea263dc256' but no matching script tag was found.")
        }
