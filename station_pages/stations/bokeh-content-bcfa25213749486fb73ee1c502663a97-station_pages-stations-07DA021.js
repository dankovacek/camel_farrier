(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ed60c5a2-f548-4945-bb57-e360140e3278");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ed60c5a2-f548-4945-bb57-e360140e3278' but no matching script tag was found.")
        }
