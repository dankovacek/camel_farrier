(function() {
  const fn = function() {
    ...
    const element = document.getElementById("df9a59bd-4b61-4428-b48c-fcded266b145");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'df9a59bd-4b61-4428-b48c-fcded266b145' but no matching script tag was found.")
        }
