(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b941579f-fa7f-421d-b72a-cfc9a3d58b0a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b941579f-fa7f-421d-b72a-cfc9a3d58b0a' but no matching script tag was found.")
        }
