(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d6f9a21a-b86d-4dd7-8d5d-d7ddf737704a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd6f9a21a-b86d-4dd7-8d5d-d7ddf737704a' but no matching script tag was found.")
        }
