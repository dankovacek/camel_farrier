(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a84cfc60-7454-45f6-95e6-4d3c3e220119");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a84cfc60-7454-45f6-95e6-4d3c3e220119' but no matching script tag was found.")
        }
