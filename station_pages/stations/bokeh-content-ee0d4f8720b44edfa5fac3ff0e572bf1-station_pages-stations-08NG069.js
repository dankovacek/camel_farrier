(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c04896ca-921e-4bf7-b1eb-1df133d893a9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c04896ca-921e-4bf7-b1eb-1df133d893a9' but no matching script tag was found.")
        }
