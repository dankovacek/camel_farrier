(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c3477257-630d-4a3d-833d-016c514f650e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c3477257-630d-4a3d-833d-016c514f650e' but no matching script tag was found.")
        }
