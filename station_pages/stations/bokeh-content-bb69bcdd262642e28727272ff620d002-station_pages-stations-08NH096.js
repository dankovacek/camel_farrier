(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b2d88e93-9ce8-43f4-a800-c07cf8cb7c2b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b2d88e93-9ce8-43f4-a800-c07cf8cb7c2b' but no matching script tag was found.")
        }
