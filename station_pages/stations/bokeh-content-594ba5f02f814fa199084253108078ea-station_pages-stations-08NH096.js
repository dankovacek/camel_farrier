(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e436af0e-56fa-4d6a-a2fe-9da08afd7f0f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e436af0e-56fa-4d6a-a2fe-9da08afd7f0f' but no matching script tag was found.")
        }
