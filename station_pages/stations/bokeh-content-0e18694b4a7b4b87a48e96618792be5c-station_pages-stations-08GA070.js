(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c4826247-96d2-4b3c-8172-762aee68ea18");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c4826247-96d2-4b3c-8172-762aee68ea18' but no matching script tag was found.")
        }
