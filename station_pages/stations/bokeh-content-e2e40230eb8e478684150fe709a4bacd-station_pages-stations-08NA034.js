(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e2b2adb4-62e0-41ea-9222-868a5721ac5d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e2b2adb4-62e0-41ea-9222-868a5721ac5d' but no matching script tag was found.")
        }
