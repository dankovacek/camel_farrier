(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b9a0aa18-68b3-498b-9de8-965ffeeceb25");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b9a0aa18-68b3-498b-9de8-965ffeeceb25' but no matching script tag was found.")
        }
