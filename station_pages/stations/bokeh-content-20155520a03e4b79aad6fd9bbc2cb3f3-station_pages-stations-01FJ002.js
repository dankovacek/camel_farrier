(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cc474078-deb1-444d-af7b-5182e3852320");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cc474078-deb1-444d-af7b-5182e3852320' but no matching script tag was found.")
        }
