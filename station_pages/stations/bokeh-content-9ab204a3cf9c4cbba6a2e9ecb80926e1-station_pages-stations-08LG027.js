(function() {
  const fn = function() {
    ...
    const element = document.getElementById("de06a514-9039-4e77-bd7f-6a96cc0ddefb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de06a514-9039-4e77-bd7f-6a96cc0ddefb' but no matching script tag was found.")
        }
