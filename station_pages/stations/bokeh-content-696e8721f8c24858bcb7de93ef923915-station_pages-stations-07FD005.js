(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dfb50d39-4235-4aa3-969a-22e8d4242251");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dfb50d39-4235-4aa3-969a-22e8d4242251' but no matching script tag was found.")
        }
