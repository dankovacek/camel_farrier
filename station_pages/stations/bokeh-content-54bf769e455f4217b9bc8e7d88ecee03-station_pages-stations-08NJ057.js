(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a8cb7e6d-95a9-476e-b230-e7aa08d34928");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a8cb7e6d-95a9-476e-b230-e7aa08d34928' but no matching script tag was found.")
        }
