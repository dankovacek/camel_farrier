(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b4c1d68f-f506-43b5-8748-da5679be80de");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b4c1d68f-f506-43b5-8748-da5679be80de' but no matching script tag was found.")
        }
