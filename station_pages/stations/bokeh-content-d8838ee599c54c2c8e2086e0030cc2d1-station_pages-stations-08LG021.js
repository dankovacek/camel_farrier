(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a9bbfc2b-25ad-442b-acaf-715a66c34303");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a9bbfc2b-25ad-442b-acaf-715a66c34303' but no matching script tag was found.")
        }
