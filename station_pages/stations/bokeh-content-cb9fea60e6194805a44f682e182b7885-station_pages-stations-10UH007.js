(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e2022e69-9438-4001-847f-f2a92b997be2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e2022e69-9438-4001-847f-f2a92b997be2' but no matching script tag was found.")
        }
