(function() {
  const fn = function() {
    ...
    const element = document.getElementById("afbe1bb8-9227-4115-bcc8-e7e1ee759ee0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'afbe1bb8-9227-4115-bcc8-e7e1ee759ee0' but no matching script tag was found.")
        }
