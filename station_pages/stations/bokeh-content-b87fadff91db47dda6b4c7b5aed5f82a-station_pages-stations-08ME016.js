(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d482d577-765b-49e4-9977-6f795e978cd3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd482d577-765b-49e4-9977-6f795e978cd3' but no matching script tag was found.")
        }
