(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eb7c1cd9-7a56-4414-aad5-412096d660a3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eb7c1cd9-7a56-4414-aad5-412096d660a3' but no matching script tag was found.")
        }
