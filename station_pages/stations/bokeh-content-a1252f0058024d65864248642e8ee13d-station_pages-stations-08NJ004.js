(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fd10061e-84d2-4334-8b03-53c86b54dd2f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fd10061e-84d2-4334-8b03-53c86b54dd2f' but no matching script tag was found.")
        }
