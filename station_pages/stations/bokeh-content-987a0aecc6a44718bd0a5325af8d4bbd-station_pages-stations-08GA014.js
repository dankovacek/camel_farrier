(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef660ee8-4b8e-4959-b5fc-57cf9de95e67");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef660ee8-4b8e-4959-b5fc-57cf9de95e67' but no matching script tag was found.")
        }
