(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fc395b8c-f6ee-498e-87ab-2caf4370d25e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fc395b8c-f6ee-498e-87ab-2caf4370d25e' but no matching script tag was found.")
        }
