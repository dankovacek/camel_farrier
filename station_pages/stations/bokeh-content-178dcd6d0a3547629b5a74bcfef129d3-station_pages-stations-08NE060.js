(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c4e344ff-e286-46f8-b305-7a41de75ecbc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c4e344ff-e286-46f8-b305-7a41de75ecbc' but no matching script tag was found.")
        }
