(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bc6e5aa4-5a2f-4d0e-b891-d646209f2064");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bc6e5aa4-5a2f-4d0e-b891-d646209f2064' but no matching script tag was found.")
        }
