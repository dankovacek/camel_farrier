(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bcf91f43-b7e5-409f-a125-36435d6d9b22");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bcf91f43-b7e5-409f-a125-36435d6d9b22' but no matching script tag was found.")
        }
