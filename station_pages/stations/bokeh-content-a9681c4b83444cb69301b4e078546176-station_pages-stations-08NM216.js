(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d532f751-dda5-4ad9-add2-0aaf9fa2b7eb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd532f751-dda5-4ad9-add2-0aaf9fa2b7eb' but no matching script tag was found.")
        }
