(function() {
  const fn = function() {
    ...
    const element = document.getElementById("aec37689-d889-42ba-9d24-ef13ea6fa29c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'aec37689-d889-42ba-9d24-ef13ea6fa29c' but no matching script tag was found.")
        }
