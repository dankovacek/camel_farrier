(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bcd701ea-3633-4c52-8452-e716547b8235");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bcd701ea-3633-4c52-8452-e716547b8235' but no matching script tag was found.")
        }
