(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d157865c-5f6c-4870-b625-7ef525642a96");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd157865c-5f6c-4870-b625-7ef525642a96' but no matching script tag was found.")
        }
