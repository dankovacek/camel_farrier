(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b442a30e-0b46-4fff-953b-4919ff2cf340");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b442a30e-0b46-4fff-953b-4919ff2cf340' but no matching script tag was found.")
        }
