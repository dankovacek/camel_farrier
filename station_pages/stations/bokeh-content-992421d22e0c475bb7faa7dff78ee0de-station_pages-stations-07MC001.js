(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d18997ef-34ca-4896-a945-f7ad9158fa76");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd18997ef-34ca-4896-a945-f7ad9158fa76' but no matching script tag was found.")
        }
