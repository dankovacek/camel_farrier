(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d6ab6339-c925-40ec-89af-ee482a6534b0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd6ab6339-c925-40ec-89af-ee482a6534b0' but no matching script tag was found.")
        }
