(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dfab72ce-ae5d-4c74-8d85-dfa41cde0807");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dfab72ce-ae5d-4c74-8d85-dfa41cde0807' but no matching script tag was found.")
        }
