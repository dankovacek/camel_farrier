(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c0604746-d5d1-4861-9178-2cee8db5542b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c0604746-d5d1-4861-9178-2cee8db5542b' but no matching script tag was found.")
        }
