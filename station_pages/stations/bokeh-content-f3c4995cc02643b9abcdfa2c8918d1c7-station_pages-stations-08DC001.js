(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fd6d0897-6997-48e5-8f2f-66be0f37a1db");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fd6d0897-6997-48e5-8f2f-66be0f37a1db' but no matching script tag was found.")
        }
