(function() {
  const fn = function() {
    ...
    const element = document.getElementById("de0c2954-b090-4113-b2d4-11f39361928d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de0c2954-b090-4113-b2d4-11f39361928d' but no matching script tag was found.")
        }
