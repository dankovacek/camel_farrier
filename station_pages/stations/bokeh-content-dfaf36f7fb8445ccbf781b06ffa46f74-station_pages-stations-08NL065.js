(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d998cd8d-e613-4474-98fc-e11bc9869073");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd998cd8d-e613-4474-98fc-e11bc9869073' but no matching script tag was found.")
        }
