(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bfed7637-4d2a-4c29-a7be-83330b46955e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bfed7637-4d2a-4c29-a7be-83330b46955e' but no matching script tag was found.")
        }
