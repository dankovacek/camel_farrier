(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c25ffe8c-c2ec-46af-812b-ef546058840e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c25ffe8c-c2ec-46af-812b-ef546058840e' but no matching script tag was found.")
        }
