(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eef841db-c695-417a-b8d6-2ba0d6ce1510");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eef841db-c695-417a-b8d6-2ba0d6ce1510' but no matching script tag was found.")
        }
