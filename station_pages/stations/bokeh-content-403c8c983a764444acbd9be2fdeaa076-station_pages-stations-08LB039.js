(function() {
  const fn = function() {
    ...
    const element = document.getElementById("be02f5fa-1aee-4c8d-a674-fbafde33a73d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'be02f5fa-1aee-4c8d-a674-fbafde33a73d' but no matching script tag was found.")
        }
