(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bea3d803-01e0-419e-b41c-4b54ae3967d3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bea3d803-01e0-419e-b41c-4b54ae3967d3' but no matching script tag was found.")
        }
