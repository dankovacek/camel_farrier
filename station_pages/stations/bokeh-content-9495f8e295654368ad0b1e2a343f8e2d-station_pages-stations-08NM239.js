(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fc288c97-cd5c-445c-a1d7-519de412bf24");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fc288c97-cd5c-445c-a1d7-519de412bf24' but no matching script tag was found.")
        }
