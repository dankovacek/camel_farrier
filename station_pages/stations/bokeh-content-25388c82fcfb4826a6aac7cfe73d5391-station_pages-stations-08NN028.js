(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c6066fb4-94a0-4723-9587-a350ff7af74b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c6066fb4-94a0-4723-9587-a350ff7af74b' but no matching script tag was found.")
        }
