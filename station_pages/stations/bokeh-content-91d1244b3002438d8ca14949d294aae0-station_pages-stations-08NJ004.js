(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f660caaf-fadd-4400-bb93-291aecaf46ce");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f660caaf-fadd-4400-bb93-291aecaf46ce' but no matching script tag was found.")
        }
