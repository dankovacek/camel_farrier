(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c0ba197b-afb3-4d84-90fb-36e1f239a15e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c0ba197b-afb3-4d84-90fb-36e1f239a15e' but no matching script tag was found.")
        }
