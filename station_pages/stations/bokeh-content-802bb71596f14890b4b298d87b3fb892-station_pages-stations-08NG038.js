(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b0cd9371-101d-4c84-b53f-21e7b14c03d2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b0cd9371-101d-4c84-b53f-21e7b14c03d2' but no matching script tag was found.")
        }
