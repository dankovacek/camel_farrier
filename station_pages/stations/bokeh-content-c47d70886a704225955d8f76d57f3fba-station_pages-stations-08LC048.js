(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f217f02e-2b46-4863-a5dd-41fd2bd2ad64");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f217f02e-2b46-4863-a5dd-41fd2bd2ad64' but no matching script tag was found.")
        }
