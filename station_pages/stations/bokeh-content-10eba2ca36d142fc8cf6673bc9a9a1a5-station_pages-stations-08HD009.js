(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b63dbee4-e8bd-4b4b-b1f2-f2ec4558b9fc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b63dbee4-e8bd-4b4b-b1f2-f2ec4558b9fc' but no matching script tag was found.")
        }
