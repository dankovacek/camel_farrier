(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a6ef5afb-aaae-41b2-b7f5-e548e22740e6");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a6ef5afb-aaae-41b2-b7f5-e548e22740e6' but no matching script tag was found.")
        }
