(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d51db421-69dd-456c-af3e-346f924d9458");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd51db421-69dd-456c-af3e-346f924d9458' but no matching script tag was found.")
        }
