(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bd23492e-1047-4179-962b-c8d8775b2aed");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bd23492e-1047-4179-962b-c8d8775b2aed' but no matching script tag was found.")
        }
