(function() {
  const fn = function() {
    ...
    const element = document.getElementById("afd923d5-f095-4adc-bbc8-67662fb3452a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'afd923d5-f095-4adc-bbc8-67662fb3452a' but no matching script tag was found.")
        }
