(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bccc56e3-c939-4868-bcea-1416120e619d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bccc56e3-c939-4868-bcea-1416120e619d' but no matching script tag was found.")
        }
