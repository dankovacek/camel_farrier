(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef0d1246-0e21-4f05-be5a-18c892c64369");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef0d1246-0e21-4f05-be5a-18c892c64369' but no matching script tag was found.")
        }
