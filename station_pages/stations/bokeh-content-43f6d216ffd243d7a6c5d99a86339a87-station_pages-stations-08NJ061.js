(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a0809c04-89f9-4fdf-9073-95567bcf1ef1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a0809c04-89f9-4fdf-9073-95567bcf1ef1' but no matching script tag was found.")
        }
