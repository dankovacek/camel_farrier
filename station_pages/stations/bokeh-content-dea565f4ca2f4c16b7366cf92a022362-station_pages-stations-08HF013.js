(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c0ecfeeb-ce11-40ec-863f-6851a1aefd3e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c0ecfeeb-ce11-40ec-863f-6851a1aefd3e' but no matching script tag was found.")
        }
