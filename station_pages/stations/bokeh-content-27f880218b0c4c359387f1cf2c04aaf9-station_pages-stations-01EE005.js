(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a0f5745c-2d55-4d01-9693-d0000a45a6e2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a0f5745c-2d55-4d01-9693-d0000a45a6e2' but no matching script tag was found.")
        }
