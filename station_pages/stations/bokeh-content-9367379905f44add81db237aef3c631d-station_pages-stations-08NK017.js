(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d5c6afed-563a-4040-adf7-f949dbc007a9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd5c6afed-563a-4040-adf7-f949dbc007a9' but no matching script tag was found.")
        }
