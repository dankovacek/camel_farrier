(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cb1a939d-bb27-49f2-be09-556a3dabf8a3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cb1a939d-bb27-49f2-be09-556a3dabf8a3' but no matching script tag was found.")
        }
