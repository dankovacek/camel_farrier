(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dfadf826-6939-4493-8b02-a818822516b4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dfadf826-6939-4493-8b02-a818822516b4' but no matching script tag was found.")
        }
