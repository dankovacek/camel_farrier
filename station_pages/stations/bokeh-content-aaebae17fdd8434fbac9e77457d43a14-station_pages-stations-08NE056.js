(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eabde577-1e92-4edf-a932-230cedd4d2ce");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eabde577-1e92-4edf-a932-230cedd4d2ce' but no matching script tag was found.")
        }
