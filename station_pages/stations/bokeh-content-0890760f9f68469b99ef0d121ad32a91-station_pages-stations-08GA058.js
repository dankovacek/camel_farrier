(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bec447eb-54e7-4ef2-9d4a-dfdace7df9b0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bec447eb-54e7-4ef2-9d4a-dfdace7df9b0' but no matching script tag was found.")
        }
