(function() {
  const fn = function() {
    ...
    const element = document.getElementById("be24ff31-89cf-4386-9b17-871a3b7694ae");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'be24ff31-89cf-4386-9b17-871a3b7694ae' but no matching script tag was found.")
        }
