(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b5888d81-63eb-4489-a168-799a30c968db");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b5888d81-63eb-4489-a168-799a30c968db' but no matching script tag was found.")
        }
