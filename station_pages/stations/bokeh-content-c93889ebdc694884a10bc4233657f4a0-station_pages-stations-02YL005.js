(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e6b170a6-d528-48e4-8098-a3f1c43ae08a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e6b170a6-d528-48e4-8098-a3f1c43ae08a' but no matching script tag was found.")
        }
