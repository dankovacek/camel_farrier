(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c25efabb-18e8-4e83-b045-6775f572e7f4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c25efabb-18e8-4e83-b045-6775f572e7f4' but no matching script tag was found.")
        }
