(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d7565c1a-1846-43ac-bf54-db1d9424003c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd7565c1a-1846-43ac-bf54-db1d9424003c' but no matching script tag was found.")
        }
