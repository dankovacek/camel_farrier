(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a187c6df-b5d1-47e5-8adc-82bce21c98d9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a187c6df-b5d1-47e5-8adc-82bce21c98d9' but no matching script tag was found.")
        }
