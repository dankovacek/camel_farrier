(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f1bf1c3b-75a6-498c-9820-67b6bea1a917");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f1bf1c3b-75a6-498c-9820-67b6bea1a917' but no matching script tag was found.")
        }
