(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d350f171-ca36-426e-9cf7-f13e67ed2deb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd350f171-ca36-426e-9cf7-f13e67ed2deb' but no matching script tag was found.")
        }
