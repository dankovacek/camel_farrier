(function() {
  const fn = function() {
    ...
    const element = document.getElementById("afd82b9f-7b67-43ac-8bab-4586615b79de");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'afd82b9f-7b67-43ac-8bab-4586615b79de' but no matching script tag was found.")
        }
