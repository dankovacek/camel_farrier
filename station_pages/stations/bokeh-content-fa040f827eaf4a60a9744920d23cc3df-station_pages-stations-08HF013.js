(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ff146aa2-8c43-4248-8690-220fafc043f3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ff146aa2-8c43-4248-8690-220fafc043f3' but no matching script tag was found.")
        }
