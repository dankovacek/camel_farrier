(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ce0bcec9-b085-4ac1-94b1-f679977e1861");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ce0bcec9-b085-4ac1-94b1-f679977e1861' but no matching script tag was found.")
        }
