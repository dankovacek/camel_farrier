(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a4df9f61-16d5-437e-b380-a73da959abf0");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a4df9f61-16d5-437e-b380-a73da959abf0' but no matching script tag was found.")
        }
