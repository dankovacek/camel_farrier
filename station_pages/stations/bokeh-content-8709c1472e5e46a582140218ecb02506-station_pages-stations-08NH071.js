(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b517b4c7-a3f6-4d19-855d-1b8982cd1424");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b517b4c7-a3f6-4d19-855d-1b8982cd1424' but no matching script tag was found.")
        }
