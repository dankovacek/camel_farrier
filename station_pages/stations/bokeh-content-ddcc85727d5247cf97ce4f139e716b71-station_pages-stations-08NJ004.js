(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b88d3cd5-e7c2-40b1-8f8c-0e4e83760690");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b88d3cd5-e7c2-40b1-8f8c-0e4e83760690' but no matching script tag was found.")
        }
