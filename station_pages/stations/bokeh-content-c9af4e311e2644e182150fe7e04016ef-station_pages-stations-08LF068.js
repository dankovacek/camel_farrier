(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cea15f6c-b5fa-4014-9ce4-f647469d3bdb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cea15f6c-b5fa-4014-9ce4-f647469d3bdb' but no matching script tag was found.")
        }
