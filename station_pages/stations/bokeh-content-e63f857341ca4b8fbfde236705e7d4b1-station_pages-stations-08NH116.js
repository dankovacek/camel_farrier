(function() {
  const fn = function() {
    ...
    const element = document.getElementById("edfb3bb7-6789-49ae-97b6-b1e430072752");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'edfb3bb7-6789-49ae-97b6-b1e430072752' but no matching script tag was found.")
        }
