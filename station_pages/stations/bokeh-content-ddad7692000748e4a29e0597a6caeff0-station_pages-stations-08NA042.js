(function() {
  const fn = function() {
    ...
    const element = document.getElementById("dc27fb0a-5d21-4d32-b3ed-fc8f6ceff22e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dc27fb0a-5d21-4d32-b3ed-fc8f6ceff22e' but no matching script tag was found.")
        }
