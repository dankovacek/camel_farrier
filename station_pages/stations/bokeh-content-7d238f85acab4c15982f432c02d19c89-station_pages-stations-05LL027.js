(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bb6b55d3-2cc4-474d-8f4f-02018227cf18");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb6b55d3-2cc4-474d-8f4f-02018227cf18' but no matching script tag was found.")
        }
