(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bf79353b-d5ea-42b4-812b-add0144e4f0b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bf79353b-d5ea-42b4-812b-add0144e4f0b' but no matching script tag was found.")
        }
