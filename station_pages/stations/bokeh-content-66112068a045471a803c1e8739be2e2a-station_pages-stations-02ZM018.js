(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eb350ddb-0af0-4069-96d1-8c828e604a57");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eb350ddb-0af0-4069-96d1-8c828e604a57' but no matching script tag was found.")
        }
