(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b64682f9-6e92-4dce-9cc4-d7614b59a611");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b64682f9-6e92-4dce-9cc4-d7614b59a611' but no matching script tag was found.")
        }
