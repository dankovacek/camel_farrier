(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bb032edd-4d2e-44d2-9987-3cbaa7aad4fa");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb032edd-4d2e-44d2-9987-3cbaa7aad4fa' but no matching script tag was found.")
        }
