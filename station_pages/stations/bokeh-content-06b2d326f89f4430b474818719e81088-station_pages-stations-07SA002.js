(function() {
  const fn = function() {
    ...
    const element = document.getElementById("db1b87e3-f462-4948-b28d-b58e75dc2698");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'db1b87e3-f462-4948-b28d-b58e75dc2698' but no matching script tag was found.")
        }
