(function() {
  const fn = function() {
    ...
    const element = document.getElementById("de645dd1-7dd1-49ec-8213-341eb924cfd1");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de645dd1-7dd1-49ec-8213-341eb924cfd1' but no matching script tag was found.")
        }
