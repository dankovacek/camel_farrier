(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c7184682-c351-4ab8-a55f-9fc037abffdb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c7184682-c351-4ab8-a55f-9fc037abffdb' but no matching script tag was found.")
        }
