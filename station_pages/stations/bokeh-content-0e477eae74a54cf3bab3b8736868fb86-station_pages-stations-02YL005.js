(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eb44d057-d3a0-4575-b3ab-8a69b03f9002");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eb44d057-d3a0-4575-b3ab-8a69b03f9002' but no matching script tag was found.")
        }
