(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cf097fb3-903f-4bc2-8d25-0829ac3293df");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cf097fb3-903f-4bc2-8d25-0829ac3293df' but no matching script tag was found.")
        }
