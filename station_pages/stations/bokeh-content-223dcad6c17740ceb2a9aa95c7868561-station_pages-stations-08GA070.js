(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c3513d8d-f89e-4023-8e4b-05a4889c18b2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c3513d8d-f89e-4023-8e4b-05a4889c18b2' but no matching script tag was found.")
        }
