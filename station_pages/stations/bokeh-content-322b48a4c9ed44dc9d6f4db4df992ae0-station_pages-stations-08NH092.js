(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d016c40b-c431-4eb0-9751-1971564b3c6b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd016c40b-c431-4eb0-9751-1971564b3c6b' but no matching script tag was found.")
        }
