(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f3b796e0-d289-4c5a-805c-ca9b3e685cdb");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f3b796e0-d289-4c5a-805c-ca9b3e685cdb' but no matching script tag was found.")
        }
