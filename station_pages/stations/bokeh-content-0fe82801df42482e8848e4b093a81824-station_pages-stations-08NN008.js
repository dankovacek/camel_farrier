(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e2ac9060-a541-4868-8eb8-73e3ff748303");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e2ac9060-a541-4868-8eb8-73e3ff748303' but no matching script tag was found.")
        }
