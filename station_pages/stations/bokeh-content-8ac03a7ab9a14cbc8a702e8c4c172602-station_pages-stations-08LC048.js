(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a764f595-597a-4893-aafc-65e6fce4d154");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a764f595-597a-4893-aafc-65e6fce4d154' but no matching script tag was found.")
        }
