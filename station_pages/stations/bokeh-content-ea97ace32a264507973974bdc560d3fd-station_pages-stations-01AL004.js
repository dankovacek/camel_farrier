(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b34f2e30-98e7-4fa7-8370-33fc44accb42");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b34f2e30-98e7-4fa7-8370-33fc44accb42' but no matching script tag was found.")
        }
