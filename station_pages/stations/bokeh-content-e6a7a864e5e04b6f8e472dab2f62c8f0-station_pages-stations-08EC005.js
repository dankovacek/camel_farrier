(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a4062637-948a-4585-ad01-d8ff11092275");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a4062637-948a-4585-ad01-d8ff11092275' but no matching script tag was found.")
        }
