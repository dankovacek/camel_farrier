(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e0a47455-2f5b-4984-b88c-a6fb0208d28a");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e0a47455-2f5b-4984-b88c-a6fb0208d28a' but no matching script tag was found.")
        }
