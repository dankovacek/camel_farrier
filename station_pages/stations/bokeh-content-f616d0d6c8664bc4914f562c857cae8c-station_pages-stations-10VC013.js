(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d98051bc-8a83-49f5-829e-56d8023a75ca");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd98051bc-8a83-49f5-829e-56d8023a75ca' but no matching script tag was found.")
        }
