(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f37f95ee-2eff-41ac-a790-d48e2c431e5e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f37f95ee-2eff-41ac-a790-d48e2c431e5e' but no matching script tag was found.")
        }
