(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c51586ec-8070-4821-9d88-0b4532b87fcf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c51586ec-8070-4821-9d88-0b4532b87fcf' but no matching script tag was found.")
        }
