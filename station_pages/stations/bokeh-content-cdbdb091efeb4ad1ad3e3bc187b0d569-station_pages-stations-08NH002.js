(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef80b199-8366-4a48-a8c3-d454e50f9801");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef80b199-8366-4a48-a8c3-d454e50f9801' but no matching script tag was found.")
        }
