(function() {
  const fn = function() {
    ...
    const element = document.getElementById("af2749da-67c6-4cd7-8a4a-5acf76107f2b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'af2749da-67c6-4cd7-8a4a-5acf76107f2b' but no matching script tag was found.")
        }
