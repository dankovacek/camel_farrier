(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a117a876-87be-4c47-abec-7bd44a75ddd9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a117a876-87be-4c47-abec-7bd44a75ddd9' but no matching script tag was found.")
        }
