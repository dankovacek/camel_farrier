(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c087e9b1-15ae-434e-8010-5749e2b4e46c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c087e9b1-15ae-434e-8010-5749e2b4e46c' but no matching script tag was found.")
        }
