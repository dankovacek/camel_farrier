(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d2586eb4-5a07-440b-802b-7d547390bd06");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd2586eb4-5a07-440b-802b-7d547390bd06' but no matching script tag was found.")
        }
