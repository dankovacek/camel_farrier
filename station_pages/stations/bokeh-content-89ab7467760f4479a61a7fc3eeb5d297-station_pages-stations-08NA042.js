(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e610339b-c528-4aca-baaa-495656f526b4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e610339b-c528-4aca-baaa-495656f526b4' but no matching script tag was found.")
        }
