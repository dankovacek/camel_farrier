(function() {
  const fn = function() {
    ...
    const element = document.getElementById("afaa2ee7-6cfb-4963-9456-c028e86ae508");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'afaa2ee7-6cfb-4963-9456-c028e86ae508' but no matching script tag was found.")
        }
