(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b9060073-2088-4cdf-b018-0027c6f2e1ba");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b9060073-2088-4cdf-b018-0027c6f2e1ba' but no matching script tag was found.")
        }
