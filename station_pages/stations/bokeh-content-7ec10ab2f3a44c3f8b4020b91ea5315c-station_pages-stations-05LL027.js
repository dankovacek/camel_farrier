(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d33db172-20cb-47c0-a2ef-ceecee3a4866");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd33db172-20cb-47c0-a2ef-ceecee3a4866' but no matching script tag was found.")
        }
