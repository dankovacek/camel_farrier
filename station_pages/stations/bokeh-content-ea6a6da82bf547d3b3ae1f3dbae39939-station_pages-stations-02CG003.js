(function() {
  const fn = function() {
    ...
    const element = document.getElementById("de49a666-42ec-4cb5-8dfe-dcc5333a4ba7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'de49a666-42ec-4cb5-8dfe-dcc5333a4ba7' but no matching script tag was found.")
        }
