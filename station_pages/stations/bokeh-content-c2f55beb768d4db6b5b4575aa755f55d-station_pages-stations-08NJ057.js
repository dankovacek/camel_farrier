(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d948b4b6-70df-4009-8476-102ace9bdda7");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd948b4b6-70df-4009-8476-102ace9bdda7' but no matching script tag was found.")
        }
