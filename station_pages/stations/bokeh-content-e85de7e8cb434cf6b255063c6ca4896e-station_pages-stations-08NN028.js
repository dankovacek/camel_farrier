(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cc00cd63-e680-4813-aa06-f5c85c7019a2");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cc00cd63-e680-4813-aa06-f5c85c7019a2' but no matching script tag was found.")
        }
