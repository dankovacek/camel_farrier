(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cc025613-20a6-47f5-887f-3bb4ee2db5e8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cc025613-20a6-47f5-887f-3bb4ee2db5e8' but no matching script tag was found.")
        }
