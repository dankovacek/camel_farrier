(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cf1881f8-961a-49fb-ba20-900a6251c61f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cf1881f8-961a-49fb-ba20-900a6251c61f' but no matching script tag was found.")
        }
