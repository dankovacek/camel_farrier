(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a60db04c-e1fe-4300-a360-4ce0045feadf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a60db04c-e1fe-4300-a360-4ce0045feadf' but no matching script tag was found.")
        }
