(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bb409d1a-ba70-4b1a-be52-f84700eabe63");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bb409d1a-ba70-4b1a-be52-f84700eabe63' but no matching script tag was found.")
        }
