(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e436b4af-b05a-4ae7-ba3f-ab510830a454");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e436b4af-b05a-4ae7-ba3f-ab510830a454' but no matching script tag was found.")
        }
