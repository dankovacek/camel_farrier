(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fcf05509-e17a-4a0e-90af-2729a682bf39");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fcf05509-e17a-4a0e-90af-2729a682bf39' but no matching script tag was found.")
        }
