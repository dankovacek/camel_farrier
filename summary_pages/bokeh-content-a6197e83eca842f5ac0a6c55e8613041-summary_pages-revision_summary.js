(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cb1a4cda-76ee-41ba-beb6-6f55917e1666");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cb1a4cda-76ee-41ba-beb6-6f55917e1666' but no matching script tag was found.")
        }
