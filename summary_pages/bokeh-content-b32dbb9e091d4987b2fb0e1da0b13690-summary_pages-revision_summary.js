(function() {
  const fn = function() {
    ...
    const element = document.getElementById("caf246c8-ea8c-4115-9fac-a4a7a9247299");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'caf246c8-ea8c-4115-9fac-a4a7a9247299' but no matching script tag was found.")
        }
