(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f96cfb56-a4fb-4185-afa3-4a8064b3b8a3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f96cfb56-a4fb-4185-afa3-4a8064b3b8a3' but no matching script tag was found.")
        }
