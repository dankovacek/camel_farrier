(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bf91e8a3-4e9b-4087-98e0-bc1c4061f984");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bf91e8a3-4e9b-4087-98e0-bc1c4061f984' but no matching script tag was found.")
        }
