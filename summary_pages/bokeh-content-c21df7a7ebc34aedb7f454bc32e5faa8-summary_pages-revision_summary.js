(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b411df7c-ce98-44d9-b8fa-aefe3b21043f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b411df7c-ce98-44d9-b8fa-aefe3b21043f' but no matching script tag was found.")
        }
