(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eef558c8-3614-4770-ab90-562768279251");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eef558c8-3614-4770-ab90-562768279251' but no matching script tag was found.")
        }
