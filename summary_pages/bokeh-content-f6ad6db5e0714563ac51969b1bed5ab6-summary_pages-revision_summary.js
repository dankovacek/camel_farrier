(function() {
  const fn = function() {
    ...
    const element = document.getElementById("faf23336-d6d5-4a0c-a25d-5b9f8d0d82dd");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'faf23336-d6d5-4a0c-a25d-5b9f8d0d82dd' but no matching script tag was found.")
        }
