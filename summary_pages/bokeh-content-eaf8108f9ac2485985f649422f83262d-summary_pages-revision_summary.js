(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c960e139-dcd6-4f60-9247-a532cca5ad3d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c960e139-dcd6-4f60-9247-a532cca5ad3d' but no matching script tag was found.")
        }
