(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bfe581fa-6e97-41a9-9c19-1451ddceb265");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bfe581fa-6e97-41a9-9c19-1451ddceb265' but no matching script tag was found.")
        }
