(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c4da1af1-ffbd-4147-8c18-86fc83975140");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c4da1af1-ffbd-4147-8c18-86fc83975140' but no matching script tag was found.")
        }
