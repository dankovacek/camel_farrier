(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f575b278-16c9-43a0-b610-54de54aa8185");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f575b278-16c9-43a0-b610-54de54aa8185' but no matching script tag was found.")
        }
