(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d0e8a607-2ade-4705-85d7-c1eefa894635");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd0e8a607-2ade-4705-85d7-c1eefa894635' but no matching script tag was found.")
        }
