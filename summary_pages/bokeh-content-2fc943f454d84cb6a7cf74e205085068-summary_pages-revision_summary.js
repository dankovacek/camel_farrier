(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c54134b9-786f-40d9-99cc-2109d30e9a5b");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c54134b9-786f-40d9-99cc-2109d30e9a5b' but no matching script tag was found.")
        }
