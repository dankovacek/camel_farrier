(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d64d98ea-dd24-49f5-85af-c0a850bd98a9");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd64d98ea-dd24-49f5-85af-c0a850bd98a9' but no matching script tag was found.")
        }
