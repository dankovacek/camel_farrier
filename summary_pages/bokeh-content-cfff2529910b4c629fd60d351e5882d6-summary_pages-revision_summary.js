(function() {
  const fn = function() {
    ...
    const element = document.getElementById("e9346b2c-db80-446f-bdf8-e64389903fca");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e9346b2c-db80-446f-bdf8-e64389903fca' but no matching script tag was found.")
        }
