(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eefc7f2b-6205-4742-87c9-153b24aa27a4");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eefc7f2b-6205-4742-87c9-153b24aa27a4' but no matching script tag was found.")
        }
