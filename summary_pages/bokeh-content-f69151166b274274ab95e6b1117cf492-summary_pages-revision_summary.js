(function() {
  const fn = function() {
    ...
    const element = document.getElementById("ef2a781c-1308-4aad-899f-847064c61caf");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ef2a781c-1308-4aad-899f-847064c61caf' but no matching script tag was found.")
        }
