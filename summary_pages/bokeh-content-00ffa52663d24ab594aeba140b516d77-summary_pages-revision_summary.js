(function() {
  const fn = function() {
    ...
    const element = document.getElementById("c440a002-5478-433c-bcc8-e9cdb2e998da");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'c440a002-5478-433c-bcc8-e9cdb2e998da' but no matching script tag was found.")
        }
