(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b6fa40d4-deb6-4606-8ffd-2b012ff1d46c");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b6fa40d4-deb6-4606-8ffd-2b012ff1d46c' but no matching script tag was found.")
        }
