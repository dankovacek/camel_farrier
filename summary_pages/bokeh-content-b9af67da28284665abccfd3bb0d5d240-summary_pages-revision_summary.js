(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a7ce7ec4-a3a5-425e-8731-2f7d64a906f5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a7ce7ec4-a3a5-425e-8731-2f7d64a906f5' but no matching script tag was found.")
        }
