(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eba2c82e-0dfb-4801-9900-cce87f2afbac");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eba2c82e-0dfb-4801-9900-cce87f2afbac' but no matching script tag was found.")
        }
