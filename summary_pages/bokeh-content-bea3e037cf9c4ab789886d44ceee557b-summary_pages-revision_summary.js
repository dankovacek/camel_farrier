(function() {
  const fn = function() {
    ...
    const element = document.getElementById("fa01a124-3591-46a5-8924-960104cada86");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'fa01a124-3591-46a5-8924-960104cada86' but no matching script tag was found.")
        }
