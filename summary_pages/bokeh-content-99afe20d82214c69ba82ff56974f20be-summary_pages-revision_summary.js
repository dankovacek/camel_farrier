(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cb354ee5-e7f8-42ce-bc5c-bd2d02fb5dc8");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cb354ee5-e7f8-42ce-bc5c-bd2d02fb5dc8' but no matching script tag was found.")
        }
