(function() {
  const fn = function() {
    ...
    const element = document.getElementById("eea1ba58-0931-41c6-b07a-2700f5210033");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'eea1ba58-0931-41c6-b07a-2700f5210033' but no matching script tag was found.")
        }
