(function() {
  const fn = function() {
    ...
    const element = document.getElementById("f4d65874-579a-4409-9028-f49c92346d0d");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f4d65874-579a-4409-9028-f49c92346d0d' but no matching script tag was found.")
        }
