(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cc528568-5768-498b-8796-225a67106a79");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cc528568-5768-498b-8796-225a67106a79' but no matching script tag was found.")
        }
